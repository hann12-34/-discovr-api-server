/**
 * Import Script for Shipyards Night Market Events
 * 
 * This script connects to MongoDB and imports events from the Shipyards Night Market scraper
 */

const { MongoClient } = require('mongodb');
const shipyardsNightMarketScraper = require('./scrapers/cities/vancouver/shipyardsNightMarket');

// MongoDB connection URI - directly using localhost for testing
 ...
 */
async function importShipyardsNightMarketEvents() {
  console.log('🔄 Starting Shipyards Night Market import process...');
...
importShipyardsNightMarketEvents();

/**
 * Import Queen Elizabeth Theatre Events
 * 
 * This script scrapes events from Queen Elizabeth Theatre and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const queenElizabethTheatre = require('./scrapers/cities/vancouver/queenElizabethTheatre');
...
async function importQueenElizabethEvents() {
  console.log('🔄 Starting Queen Elizabeth Theatre events import process...');
  ...
  try {
    ...
    const events = await queenElizabethTheatre.scrape();

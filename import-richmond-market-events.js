/**
 * Import Richmond Night Market Events
 * 
 * This script scrapes events from Richmond Night Market and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const richmondNightMarket = require('./scrapers/cities/vancouver/richmondNightMarket');
...
async function importRichmondNightMarketEvents() {
  console.log('🔄 Starting Richmond Night Market events import process...');
...
importRichmondNightMarketEvents()

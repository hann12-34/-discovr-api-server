/**
 * Import Junction Public Market Events
 * 
 * This script scrapes events from Junction Public Market and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const junctionPublicMarket = require('./scrapers/cities/vancouver/junctionPublicMarket');
...
async function importJunctionMarketEvents() {
  console.log('🔄 Starting Junction Public Market import process...');
  ...
  try {
    ...
    // Scrape events
    console.log('🔍 Scraping events from Junction Public Market...');

const DOXAFilmFestivalEvents = require('./scrapers/cities/vancouver/doxaFilmFestivalEvents');

/**
 * Test script for DOXA Documentary Film Festival events scraper
 */
async function testDOXAFilmFestival() {
...
// Run the test
testDOXAFilmFestival().catch(console.error);

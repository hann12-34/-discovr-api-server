 ...
 * 
 * This script runs The Pearl Vancouver scraper and imports the events into MongoDB
 */

require('dotenv').config();
const { MongoClient } = require('mongodb');
const { scrape } = require('./scrapers/pearl-scraper');
...
async function importEvents() {
  ...
  try {
    ...
    console.log(`📋 Found ${scrapedEvents.length} events from The Pearl Vancouver`);

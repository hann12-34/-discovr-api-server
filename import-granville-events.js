/**
 * Import Granville Island Events
 * 
 * This script scrapes events from Granville Island and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const granvilleIslandScraper = require('./scrapers/cities/vancouver/granvilleIsland');
...
async function importGranvilleIslandEvents() {
  console.log('🔄 Starting Granville Island events import process...');

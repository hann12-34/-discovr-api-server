/**
 * Unified Import Script for All Vancouver Scrapers
 * 
 * This script imports events from all Vancouver scrapers to the cloud MongoDB database
 */
...
/**
 * Connect to MongoDB and import events from all scrapers
 */
async function importAllEvents() {
  console.log('🔄 Starting import process for all Vancouver events...');
  ...
  try {
    ...
    console.log(`📋 Found ${scrapers.length} Vancouver scrapers`);
    ...
    for (const scraper of scrapers) {
      try {
        ...
        for (const event of events) {
          // Make sure event has sourceIdentifier (fix for undefined sourceIdentifier issue)

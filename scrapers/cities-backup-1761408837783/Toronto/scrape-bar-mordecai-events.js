...
async function scrapeEvents(city = 'Toronto') {
    ...
    try {
        ...
        if (events.length === 0) {
            ...
            events.push({
                id: generateEventId('Bar Mordecai Experience', VENUE_NAME, new Date()),
                title: 'Bar Mordecai Experience',
                description: 'Experience Bar Mordecai, Toronto\'s distinctive cocktail bar featuring creative drinks and unique atmosphere.',

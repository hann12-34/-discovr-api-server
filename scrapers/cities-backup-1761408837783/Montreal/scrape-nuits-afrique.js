...
class NuitsAfriqueEvents {
    constructor() {
        this.baseUrl = 'https://nuits-afrique.com';
        this.eventsUrl = 'https://nuits-afrique.com/events';
        this.source = 'Festival Nuits d\'Afrique';
        this.city = 'Montreal';
        this.province = 'QC';
        this.isEnabled = true;
    }
...
async function scrapeEvents() {
  const scraper = new NuitsAfriqueEvents();

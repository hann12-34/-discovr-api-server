...
class PochaMtlEvents {
    constructor() {
        this.baseUrl = 'https://pocha-mtl.com';
        this.eventsUrl = 'https://pocha-mtl.com/events';
        this.source = 'Pocha MTL';
        this.city = 'Montreal';
        this.province = 'QC';
        this.isEnabled = true;
    }
...
async function scrapeEvents() {
  const scraper = new PochaMtlEvents();

...
class TheatreMaisonneuveEvents {
    constructor() {
        this.source = 'Theatre Maisonneuve';
        this.city = 'Montreal';
        this.province = 'QC';
        this.baseUrl = 'https://placedesarts.com';
        this.eventsUrl = 'https://placedesarts.com/en/events/theatre-maisonneuve';
    };
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description && description.length > 20 ? description : `${title} - ${title} at Theatre Maisonneuve`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
async function scrapeEvents() {
  const scraper = new TheatreMaisonneuveEvents();

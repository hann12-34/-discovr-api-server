...
/**
 * Boulevard 44 Events Scraper
 * Scrapes events from Boulevard 44 in Montreal
 */
class Boulevard44Events {
    constructor() {
        this.name = 'Boulevard 44';
            ...
            $('.event, .event-item, .event-card, .show, .party, .listing, .card').each((index, element) => {
                try {
                    ...
                    const eventData = {
                        ...
                        name: title,
                        title: title,
                        description: description && description.length > 20 ? description : `${title} - ${title} at Boulevard 44`,

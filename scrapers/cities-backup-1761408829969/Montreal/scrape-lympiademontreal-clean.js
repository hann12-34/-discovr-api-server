...
class OlympiaDeMontrealEvents {
    constructor() {
        this.source = 'Olympia de Montréal';
        this.city = 'Montreal';
        this.province = 'QC';
        this.baseUrl = 'https://olympiademontreal.com';
        this.eventsUrl = 'https://olympiademontreal.com/events';
    };
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description && description.length > 20 ? description : `${title} - ${title} at Olympia de Montréal`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
async function scrapeEvents() {
  const scraper = new OlympiaDeMontrealEvents();

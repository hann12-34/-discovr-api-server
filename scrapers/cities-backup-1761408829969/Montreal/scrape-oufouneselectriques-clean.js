...
class LesFoufounesElectriquesEvents {
    constructor() {
        this.source = 'Les Foufounes Electriques';
        this.city = 'Montreal';
        this.province = 'QC';
        this.baseUrl = 'https://foufounes.qc.ca';
        this.eventsUrl = 'https://foufounes.qc.ca/evenements';
    };
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description && description.length > 20 ? description : `${title} - ${title} at Les Foufounes Electriques`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
async function scrapeEvents() {
  const scraper = new LesFoufounesElectriquesEvents();

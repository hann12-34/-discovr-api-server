...
class NewspeakMontrealEvents {
    constructor() {
        this.baseUrl = 'https://www.newspeakmtl.com';
        this.eventsUrl = 'https://www.newspeakmtl.com/events';
        this.source = 'Newspeak Montreal';
        this.city = 'Montreal';
        this.province = 'QC';
        this.isEnabled = true;
    }
...
async function scrapeEvents() {
  const scraper = new NewspeakMontrealEvents();

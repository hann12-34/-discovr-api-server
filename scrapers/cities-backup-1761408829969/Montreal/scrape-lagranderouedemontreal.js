...
class LaGrandeRouedeMontrealEvents {
    constructor() {
        this.name = 'La Grande Roue de Montreal';
        this.eventsUrl = 'https://lagranderouedemontreal.com/events';
        this.source = 'lagranderouedemontreal';
        this.city = 'Montreal';
                ...
                try {
                    ...
                    if (eventDate && this.isEventLive(eventDate)) {
                        const eventData = {
                            ...
                            name: title,
                            title: title,
                            description: description && description.length > 20 ? description : `${title} - ${title} at La Grande Roue de Montreal`,
                            date: eventDate,
                            venue: {

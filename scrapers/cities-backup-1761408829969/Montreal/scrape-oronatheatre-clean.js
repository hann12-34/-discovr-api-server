...
class CoronaTheatreEvents {
    constructor() {
        ...
        this.city = 'Montreal';
        this.province = 'QC';
        this.baseUrl = 'https://coronatheatre.com';
        this.eventsUrl = 'https://coronatheatre.com/events';
    };
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description && description.length > 20 ? description : `${title} - ${title} at Corona Theatre`,
                            dateText,
                            price,
                            url: eventUrl
                        });

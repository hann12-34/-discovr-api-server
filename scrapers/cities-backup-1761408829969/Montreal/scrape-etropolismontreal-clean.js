...
class MetropolisMontrealEvents {
    constructor() {
        ...
        this.city = 'Montreal';
        this.province = 'QC';
        this.baseUrl = 'https://theatremetropolis.com';
        this.eventsUrl = 'https://theatremetropolis.com/en/events';
    };
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description && description.length > 20 ? description : `${title} - ${title} at Metropolis Montreal`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
async function scrapeEvents() {
  const scraper = new MetropolisMontrealEvents();

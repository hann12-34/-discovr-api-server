...
async function scrapeEvents(city = 'Toronto') {
    ...
    console.log(`🏨 Scraping The Hoxton events for ${city}...`);
    ...
    try {
        ...
        console.log(`✅ Scraped ${events.length} events from The Hoxton`);
        return filterEvents(events);
        
    } catch (error) {
        console.log(`❌ Error scraping The Hoxton events: ${error.message}`);
        return [];
    }
}

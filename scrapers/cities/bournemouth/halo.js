/**
 * Halo Bournemouth Events Scraper
 * URL: https://www.halobournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHalo(city = 'Bournemouth') {
  console.log('👼 Scraping Halo...');
  ...
  try {
    ...
    await page.goto('https://www.halobournemouth.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Halo events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Halo error:', error.message);
    return [];
  }
}

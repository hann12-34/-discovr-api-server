/**
 * The Edge Bournemouth Events Scraper
 * URL: https://www.theedgebournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEdge(city = 'Bournemouth') {
  console.log('🎸 Scraping The Edge...');
  ...
  try {
    ...
    await page.goto('https://www.theedgebournemouth.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Edge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Edge error:', error.message);
    return [];
  }
}

module.exports = scrapeEdge;

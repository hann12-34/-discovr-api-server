/**
 * Libertine Bournemouth Events Scraper
 * URL: https://www.libertinebournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLibertine(city = 'Bournemouth') {
  console.log('🎉 Scraping Libertine...');
  ...
  try {
    ...
    await page.goto('https://www.libertinebournemouth.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Libertine events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Libertine error:', error.message);
    return [];
  }
}

module.exports = scrapeLibertine;

/**
 * Smokin Aces Bournemouth Events Scraper
 * URL: https://www.smokinacesbournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSmokinAces(city = 'Bournemouth') {
  console.log('♠️ Scraping Smokin Aces...');
  ...
  try {
    ...
    await page.goto('https://www.smokinacesbournemouth.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Smokin Aces',
          address: 'Old Christchurch Rd, Bournemouth BH1 1LB',
          city: 'Bournemouth'
        },
        latitude: 50.7195,
        longitude: -1.8815,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Smokin Aces events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Smokin Aces error:', error.message);
    return [];
  }
}

module.exports = scrapeSmokinAces;

/**
 * The Anvil Bournemouth Events Scraper
 * URL: https://www.theanvilbournemouth.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAnvil(city = 'Bournemouth') {
  console.log('🔨 Scraping The Anvil...');
  ...
  try {
    ...
    await page.goto('https://www.theanvilbournemouth.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Anvil',
          address: 'Old Christchurch Rd, Bournemouth BH1 1PF',
          city: 'Bournemouth'
        },
        latitude: 50.7192,
        longitude: -1.8808,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Anvil events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Anvil error:', error.message);
    return [];
  }
}

module.exports = scrapeAnvil;

/**
 * Aruba Bournemouth Events Scraper
 * URL: https://www.arubabournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAruba(city = 'Bournemouth') {
  console.log('🏝️ Scraping Aruba...');
  ...
  try {
    ...
    await page.goto('https://www.arubabournemouth.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Aruba events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Aruba error:', error.message);
    return [];
  }
}

module.exports = scrapeAruba;

/**
 * The Vic Bournemouth Events Scraper
 * URL: https://www.thevicbournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVic(city = 'Bournemouth') {
  console.log('🎭 Scraping The Vic...');
  ...
  try {
    ...
    await page.goto('https://www.thevicbournemouth.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Vic',
          address: 'Charminster Rd, Bournemouth BH8 8UE',
          city: 'Bournemouth'
        },
        latitude: 50.7285,
        longitude: -1.8635,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Vic events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Vic error:', error.message);
    return [];
  }
}

module.exports = scrapeVic;

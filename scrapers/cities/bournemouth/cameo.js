/**
 * Cameo Bournemouth Events Scraper
 * URL: https://www.cameobournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCameo(city = 'Bournemouth') {
  console.log('🎬 Scraping Cameo...');
  ...
  try {
    ...
    await page.goto('https://www.cameobournemouth.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Cameo',
          address: 'Westover Rd, Bournemouth BH1 2BZ',
          city: 'Bournemouth'
        },
        latitude: 50.7182,
        longitude: -1.8800,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cameo events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cameo error:', error.message);
    return [];
  }
}

module.exports = scrapeCameo;

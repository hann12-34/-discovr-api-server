/**
 * The Old Fire Station Bournemouth Events Scraper
 * URL: https://www.oldfirestation.org.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOldFireStation(city = 'Bournemouth') {
  console.log('🚒 Scraping Old Fire Station...');
  ...
  try {
    ...
    await page.goto('https://www.oldfirestation.org.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Bournemouth',
        category: 'Arts',
        source: 'Old Fire Station'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Old Fire Station events`);

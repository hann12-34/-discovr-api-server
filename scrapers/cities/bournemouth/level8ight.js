/**
 * Level8ight Bournemouth Events Scraper
 * URL: https://www.level8ight.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLevel8ight(city = 'Bournemouth') {
  console.log('🎉 Scraping Level8ight...');
  ...
  try {
    ...
    await page.goto('https://www.level8ight.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Level8ight events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Level8ight error:', error.message);
    return [];
  }
}

module.exports = scrapeLevel8ight;

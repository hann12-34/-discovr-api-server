/**
 * Chaplin Bournemouth Events Scraper
 * URL: https://www.chaplinbournemouth.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeChaplin(city = 'Bournemouth') {
  console.log('🎬 Scraping Chaplin...');
  ...
  try {
    ...
    await page.goto('https://www.chaplinbournemouth.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Chaplin',
          address: 'Yelverton Rd, Bournemouth BH1 1DA',
          city: 'Bournemouth'
        },
        latitude: 50.7225,
        longitude: -1.8745,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Chaplin events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Chaplin error:', error.message);
    return [];
  }
}

module.exports = scrapeChaplin;

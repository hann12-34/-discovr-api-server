/**
 * The Angel Bournemouth Events Scraper
 * URL: https://www.theangelwinton.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAngel(city = 'Bournemouth') {
  console.log('👼 Scraping The Angel...');
  ...
  try {
    ...
    await page.goto('https://www.theangelwinton.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Angel',
          address: '323 Wimborne Rd, Bournemouth BH9 2AE',
          city: 'Bournemouth'
        },
        latitude: 50.7360,
        longitude: -1.8560,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Angel events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Angel error:', error.message);
    return [];
  }
}

module.exports = scrapeAngel;

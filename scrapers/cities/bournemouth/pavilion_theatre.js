/**
 * Pavilion Theatre Bournemouth Events Scraper
...
async function scrapePavilion(city = 'Bournemouth') {
  console.log('🎭 Scraping Pavilion Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.bournemouthpavilion.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Bournemouth',
        category: 'Arts',
        source: 'Pavilion Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Pavilion Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Pavilion Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapePavilion;

/**
 * The Student Union Bournemouth Events Scraper
 * URL: https://www.subu.org.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStudentUnion(city = 'Bournemouth') {
  console.log('🎓 Scraping Student Union...');
  ...
  try {
    ...
    await page.goto('https://www.subu.org.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Talbot Campus, Fern Barrow, Poole BH12 5BB',
          city: 'Bournemouth'
        },
        latitude: 50.7415,
        longitude: -1.8785,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Student Union events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Student Union error:', error.message);
    return [];
  }
}

module.exports = scrapeStudentUnion;

...
/**
 * Brutopia Montreal Events Scraper
 * URL: https://brutopia.net
 */
class BrutopiaEvents {
    constructor() {
        this.baseUrl = 'https://brutopia.net';
        this.eventsUrl = 'https://brutopia.net/events';
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in BrutopiaEvents');
    }
};
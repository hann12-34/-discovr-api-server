...
const EVENTS_URL = 'https://www.divingbellsocial.com/';
const VENUE_NAME = 'Diving Bell Social Club';
const VENUE_ADDRESS = '3956 Boulevard Saint-Laurent Montreal QC H2W 1Y3';

async function divingbellsocialclubnightlifeEvents(city = 'Montreal') {
...
module.exports = divingbellsocialclubnightlifeEvents;

...
class BelmontEvents {
    constructor() {
        this.baseUrl = 'https://belmont.ca';
        this.eventsUrl = 'https://belmont.ca/events';
        this.source = 'Belmont';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Belmont`,
            date: eventDate,
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in BelmontEvents');
    }
};
...
const VENUE_NAME = 'Foufounes Electriques';
const VENUE_ADDRESS = '87 Rue Sainte-Catherine E Montreal QC H2X 1K5';

async function foufouneselectriquesnightlifeEvents(city = 'Montreal') {
...
module.exports = foufouneselectriquesnightlifeEvents;

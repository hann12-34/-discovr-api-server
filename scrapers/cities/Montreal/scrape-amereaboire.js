...
/**
 * À Mère À Boire Montreal Events Scraper
 * URL: https://amereaboire.com
 */
class MreBoireEvents {
    constructor() {
        this.baseUrl = 'https://amereaboire.com';
        this.eventsUrl = 'https://amereaboire.com/events';
        this.source = 'À Mère À Boire';
        this.city = 'Montreal';
        this.province = 'QC';
    }
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in MreBoireEvents');
    }
};
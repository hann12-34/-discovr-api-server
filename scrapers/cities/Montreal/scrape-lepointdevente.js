...
const LePointDeVenteEvents = {
  ...
  _parseSingleDate(daeventDateText) {
    ...
    if (monthDayYearMatch2) {
      ...
      if (monthDayYearMatch2[1]) {
        ...
        year = parseInt(monthDayYearMatch2[3]);
      } else {
        month = monthDayYearMatch2[4];
  ...
  createEventObject(id, title, description, startDate, endDate, imageUrl, sourceUrl) {
    ...
    const categoryKeywords = {
      ...
      'comedy': ['comedy', 'humor', 'stand-up', 'humorist'],
      'sport': ['sport', 'hockey', 'soccer', 'game'],
...
module.exports = LePointDeVenteEvents;
module.exports.scrapeEvents = LePointDeVenteEvents.scrape;
...
/**
 * Le Balcon Montreal Events Scraper
 * URL: https://lebalcon.ca
 */
class LeBalconEvents {
    constructor() {
        this.baseUrl = 'https://lebalcon.ca';
        this.eventsUrl = 'https://lebalcon.ca/events';
        this.source = 'Le Balcon';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Le Balcon`,
            date: eventDate,
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in LeBalconEvents');
    }
};
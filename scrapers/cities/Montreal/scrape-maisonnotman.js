...
/**
 * Maison Notman Montreal Events Scraper
 * URL: https://maisonnotman.ca
 */
class MaisonNotmanEvents {
    constructor() {
        this.baseUrl = 'https://maisonnotman.ca';
        this.eventsUrl = 'https://maisonnotman.ca/events';
        this.source = 'Maison Notman';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Maison Notman`,
            date: eventDate,
...
module.exports = MaisonNotmanEvents;

// Function export wrapper added by targeted fixer
module.exports = async (city) => {
    const scraper = new MaisonNotmanEvents();
    if (typeof scraper.scrape === 'function') {
        return await scraper.scrape(city);
    } else {
        throw new Error('No scrape method found in MaisonNotmanEvents');
    }
};
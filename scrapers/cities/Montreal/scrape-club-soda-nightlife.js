...
const EVENTS_URL = 'https://www.evenko.ca/en/events/venue/club-soda';
const VENUE_NAME = 'Club Soda';
const VENUE_ADDRESS = '1225 Boulevard Saint-Laurent Montreal QC H2X 2S6';

async function clubsodanightlifeEvents(city = 'Montreal') {
...
module.exports = clubsodanightlifeEvents;

...
const EVENTS_URL = 'https://www.lebelmont.com/';
const VENUE_NAME = 'Le Belmont';
const VENUE_ADDRESS = '4483 Boulevard Saint-Laurent Montreal QC H2T 1R2';

async function lebelmontnightlifeEvents(city = 'Montreal') {
...
module.exports = lebelmontnightlifeEvents;

...
/**
 * Cabaret Mado Montreal Events Scraper
 * URL: https://cabaretmado.com
 */
class CabaretMadoEvents {
    constructor() {
        this.baseUrl = 'https://cabaretmado.com';
        this.eventsUrl = 'https://cabaretmado.com/events';
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Cabaret Mado`,
            date: eventDate,
...
module.exports = CabaretMadoEvents;
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in CabaretMadoEvents');
    }
};
...
const EVENTS_URL = 'https://www.instagram.com/tokyobarmtl/';
const VENUE_NAME = 'Tokyo Bar';
const VENUE_ADDRESS = '3709 Boulevard Saint-Laurent Montreal QC H2X 2V7';

async function tokyobarnightlifeEvents(city = 'Montreal') {
...
module.exports = tokyobarnightlifeEvents;

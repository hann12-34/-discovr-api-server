...
/**
 * Ye Olde Orchard Montreal Events Scraper
 * URL: https://yeoldeorchard.com
 */
class YeOldeOrchardEvents {
    constructor() {
        this.baseUrl = 'https://yeoldeorchard.com';
        this.eventsUrl = 'https://yeoldeorchard.com/events';
        this.source = 'Ye Olde Orchard';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Ye Olde Orchard`,
            date: eventDate,
...
module.exports = YeOldeOrchardEvents;

// Function export wrapper added by targeted fixer
module.exports = async (city) => {
    const scraper = new YeOldeOrchardEvents();
    if (typeof scraper.scrape === 'function') {
        return await scraper.scrape(city);
    } else {
        throw new Error('No scrape method found in YeOldeOrchardEvents');
    }
};
...
const EVENTS_URL = 'https://newcitygas.com/events/';
const VENUE_NAME = 'New City Gas';
const VENUE_ADDRESS = '950 Rue Ottawa Montreal QC H3C 1S4';

async function newcitygasnightlifeEvents(city = 'Montreal') {
...
module.exports = newcitygasnightlifeEvents;

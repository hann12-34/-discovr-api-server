...
/**
 * Mont Royal Montreal Events Scraper
 * URL: https://montroyal.ca
 */
class MontRoyalEvents {
    constructor() {
        this.baseUrl = 'https://montroyal.ca';
        this.eventsUrl = 'https://montroyal.ca/events';
        this.source = 'Mont Royal';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Mont Royal`,
            date: eventDate,
...
module.exports = MontRoyalEvents;

// Function export wrapper added by targeted fixer
module.exports = async (city) => {
    const scraper = new MontRoyalEvents();
    if (typeof scraper.scrape === 'function') {
        return await scraper.scrape(city);
    } else {
        throw new Error('No scrape method found in MontRoyalEvents');
    }
};
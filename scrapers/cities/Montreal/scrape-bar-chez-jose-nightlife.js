...
const EVENTS_URL = 'https://www.instagram.com/barchezjose/';
const VENUE_NAME = 'Bar Chez Jose';
const VENUE_ADDRESS = '173 Rue Ontario E Montreal QC H2X 1H5';

async function barchezjosenightlifeEvents(city = 'Montreal') {
...
module.exports = barchezjosenightlifeEvents;

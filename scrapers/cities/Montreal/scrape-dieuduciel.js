...
/**
 * Dieu du Ciel! Montreal Events Scraper
 * URL: https://dieuduciel.com
 */
class DieuduCielEvents {
    constructor() {
        this.baseUrl = 'https://dieuduciel.com';
        this.eventsUrl = 'https://dieuduciel.com/events';
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Dieu du Ciel!`,
            date: eventDate,
...
module.exports = DieuduCielEvents;
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in DieuduCielEvents');
    }
};
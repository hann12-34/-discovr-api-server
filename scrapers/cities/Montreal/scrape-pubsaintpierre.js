...
/**
 * Pub Saint-Pierre Montreal Events Scraper
 * URL: https://pubsaintpierre.ca
 */
class PubSaintPierreEvents {
    constructor() {
        this.baseUrl = 'https://pubsaintpierre.ca';
        this.eventsUrl = 'https://pubsaintpierre.ca/events';
        this.source = 'Pub Saint-Pierre';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Pub Saint-Pierre`,
            date: eventDate,
...
module.exports = PubSaintPierreEvents;

// Function export wrapper added by targeted fixer
module.exports = async (city) => {
    const scraper = new PubSaintPierreEvents();
    if (typeof scraper.scrape === 'function') {
        return await scraper.scrape(city);
    } else {
        throw new Error('No scrape method found in PubSaintPierreEvents');
    }
};
...
/**
 * Le Belmont Montreal Events Scraper
 * URL: https://lebelmont.ca
 */
class LeBelmontEvents {
    constructor() {
        this.baseUrl = 'https://lebelmont.ca';
        this.eventsUrl = 'https://lebelmont.ca/events';
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Le Belmont`,
            date: eventDate,
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in LeBelmontEvents');
    }
};
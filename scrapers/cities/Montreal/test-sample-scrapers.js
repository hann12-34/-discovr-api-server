...
/**
 * Focused test script for a sample of Montreal scrapers
 * Tests just 2-3 scrapers at a time for targeted verification
 */

// Sample of scrapers to test (just a few at a time from 62 available)
const sampleScrapers = [
  './scrape-just-for-laughs.js',
  './scrape-montreal-science-centre.js',
  './scrape-fantasia-film-festival.js'
];

async function testSampleScrapers() {
  console.log('🧪 Testing sample Montreal scrapers...\n');
  ...
  console.log(`\n🏁 Sample test completed for ${sampleScrapers.length} Montreal scrapers`);
}

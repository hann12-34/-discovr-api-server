...
const EVENTS_URL = 'https://ra.co/clubs/108766/events';
const VENUE_NAME = 'Newspeak';
const VENUE_ADDRESS = '5589 Boulevard Saint-Laurent Montreal QC H2T 1S8';

async function newspeaknightlifeEvents(city = 'Montreal') {
...
module.exports = newspeaknightlifeEvents;

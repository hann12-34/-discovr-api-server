...
/**
 * Gokudo Montreal Events Scraper
 * URL: https://gokudo.ca
 */
class GokudoEvents {
    constructor() {
        this.baseUrl = 'https://gokudo.ca';
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Gokudo`,
            date: eventDate,
            venue: {
                name: this.source,
                city: this.city,
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in GokudoEvents');
    }
};
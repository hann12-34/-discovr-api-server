...
/**
 * Club Unity Montreal Events Scraper
 * URL: https://clubunity.com
 */
class ClubUnityEvents {
    constructor() {
        this.baseUrl = 'https://clubunity.com';
        this.eventsUrl = 'https://clubunity.com/events';
        this.source = 'Club Unity';
        this.city = 'Montreal';
        this.province = 'QC';
    }
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Club Unity`,
            date: eventDate,
...
module.exports = ClubUnityEvents;
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in ClubUnityEvents');
    }
};
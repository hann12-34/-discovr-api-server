...
const EVENTS_URL = 'https://stereo-nightclub.com/en/events/';
const VENUE_NAME = 'Stereo Nightclub';
const VENUE_ADDRESS = '858 Rue Sainte-Catherine E Montreal QC H2L 2E3';

async function stereonightclubnightlifeEvents(city = 'Montreal') {
...
module.exports = stereonightclubnightlifeEvents;

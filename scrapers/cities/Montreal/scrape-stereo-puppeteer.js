/**
 * Stereo Nightclub Montreal (Puppeteer)
 * Montreal's legendary afterhours club
 * URL: https://www.stereobar.com
 */
...
async function scrape(city = 'Montreal') {
  console.log('🎧 Scraping Stereo Nightclub with Puppeteer...');
  ...
  try {
    ...
    console.log('  📡 Loading Stereo events...');
    await page.goto('https://www.stereobar.com/events', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Stereo events`);
    ...
    const formattedEvents = events.map(event => {
      ...
      return {
        ...
        venue: { name: 'Stereo Nightclub', address: '858 Rue Sainte-Catherine E, Montreal, QC', city: 'Montreal' },
        city: 'Montreal',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Stereo error:', error.message);
    return [];
  }
}

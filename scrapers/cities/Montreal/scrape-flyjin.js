...
/**
 * Fly Jin Montreal Events Scraper
 * URL: https://flyjin.ca
 */
class FlyJinEvents {
    constructor() {
        this.baseUrl = 'https://flyjin.ca';
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Fly Jin`,
            date: eventDate,
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in FlyJinEvents');
    }
};
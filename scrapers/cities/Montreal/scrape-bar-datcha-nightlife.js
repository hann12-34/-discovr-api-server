...
const EVENTS_URL = 'https://www.bardatcha.com/';
const VENUE_NAME = 'Bar Datcha';
const VENUE_ADDRESS = '4601 Boulevard Saint-Laurent Montreal QC H2T 1R2';

async function bardatchanightlifeEvents(city = 'Montreal') {
...
module.exports = bardatchanightlifeEvents;

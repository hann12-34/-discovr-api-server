...
/**
 * Ma Brasserie Montreal Events Scraper
 * URL: https://mabrasserie.com
 */
class MaBrasserieEvents {
    constructor() {
        this.baseUrl = 'https://mabrasserie.com';
        this.eventsUrl = 'https://mabrasserie.com/events';
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Ma Brasserie`,
            date: eventDate,
...
module.exports = MaBrasserieEvents;
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in MaBrasserieEvents');
    }
};
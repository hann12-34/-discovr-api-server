...
const EVENTS_URL = 'https://www.instagram.com/cafe.cleo/';
const VENUE_NAME = 'Cafe Cleo';
const VENUE_ADDRESS = '3865 Boulevard Saint-Laurent Montreal QC H2W 1Y2';

async function cafecleonightlifeEvents(city = 'Montreal') {
...
module.exports = cafecleonightlifeEvents;

...
const EVENTS_URL = 'https://www.instagram.com/salondaome/';
const VENUE_NAME = 'Salon Daome';
const VENUE_ADDRESS = '141 Avenue du Mont-Royal E Montreal QC H2T 1N8';

async function salondaomenightlifeEvents(city = 'Montreal') {
...
module.exports = salondaomenightlifeEvents;

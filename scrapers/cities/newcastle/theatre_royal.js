/**
 * Theatre Royal Newcastle Events Scraper
 * URL: https://www.theatreroyal.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheatreRoyal(city = 'Newcastle') {
  ...
  try {
    ...
    await page.goto('https://www.theatreroyal.co.uk/whats-on', {

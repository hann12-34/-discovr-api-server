/**
 * Riverside Newcastle Events Scraper
 * URL: https://www.riversidecabaret.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRiverside(city = 'Newcastle') {
  console.log('🎪 Scraping Riverside...');
  ...
  try {
    ...
    await page.goto('https://www.riversidecabaret.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Riverside',
          address: '23-25 Melbourne St, Newcastle upon Tyne NE1 2JQ',
          city: 'Newcastle'
        },
        latitude: 54.9705,
        longitude: -1.6025,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Riverside events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Riverside error:', error.message);
    return [];
  }
}

module.exports = scrapeRiverside;

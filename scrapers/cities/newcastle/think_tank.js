/**
 * Think Tank Newcastle Events Scraper
 * URL: https://www.thinktankunderground.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThinkTank(city = 'Newcastle') {
  console.log('🎵 Scraping Think Tank...');
  ...
  try {
    ...
    await page.goto('https://www.thinktankunderground.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Think Tank events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Think Tank error:', error.message);
    return [];
  }
}

module.exports = scrapeThinkTank;

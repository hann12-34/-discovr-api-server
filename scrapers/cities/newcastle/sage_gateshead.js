/**
 * Sage Gateshead Newcastle Events Scraper
 * URL: https://sagegateshead.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSageGateshead(city = 'Newcastle') {
  console.log('🎻 Scraping Sage Gateshead...');
  ...
  try {
    ...
    await page.goto('https://sagegateshead.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Sage Gateshead',
          address: 'St Marys Square, Gateshead NE8 2JR',
          city: 'Newcastle'
        },
        latitude: 54.9690,
        longitude: -1.6005,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sage Gateshead events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sage Gateshead error:', error.message);
    return [];
  }
}

module.exports = scrapeSageGateshead;

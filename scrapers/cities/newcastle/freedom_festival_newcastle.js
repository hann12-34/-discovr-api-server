/**
 * Freedom Festival Newcastle Events Scraper
...
async function scrapeFreedomFest(city = 'Newcastle') {
  console.log('🎵 Scraping Freedom Festival...');
  ...
  try {
    ...
    await page.goto('https://www.freedomfestival.co.uk', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Freedom Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Freedom Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeFreedomFest;

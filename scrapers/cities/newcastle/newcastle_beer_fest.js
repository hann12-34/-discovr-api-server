/**
 * Newcastle Beer & Cider Festival Events Scraper
 * URL: https://www.newcastlebeerfestival.org.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBeerFest(city = 'Newcastle') {
  ...
  try {
    ...
    await page.goto('https://www.newcastlebeerfestival.org.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Northumbria University, Newcastle',
          city: 'Newcastle'
        },
        latitude: 54.9783,
        longitude: -1.6069,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Beer Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Beer Festival error:', error.message);
    return [];
  }
}

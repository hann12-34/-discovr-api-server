/**
 * Utilita Arena Newcastle Events Scraper
 * URL: https://www.utilitaarenanewcastle.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeUtilitaArena(city = 'Newcastle') {
  ...
  try {
    ...
    await page.goto('https://www.utilitaarenanewcastle.co.uk/whats-on', {

/**
 * The Loft Newcastle Events Scraper
 * URL: https://www.theloftnewcastle.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheLoft(city = 'Newcastle') {
  console.log('🎉 Scraping The Loft...');
  ...
  try {
    ...
    await page.goto('https://www.theloftnewcastle.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Loft',
          address: 'Collingwood St, Newcastle upon Tyne NE1 1JE',
          city: 'Newcastle'
        },
        latitude: 54.9710,
        longitude: -1.6130,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Loft events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Loft error:', error.message);
    return [];
  }
}

module.exports = scrapeTheLoft;

/**
 * St James Park Newcastle Events Scraper
 * URL: https://www.nufc.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStJamesPark(city = 'Newcastle') {
  console.log('⚽ Scraping St James Park...');
  ...
  try {
    ...
    await page.goto('https://www.nufc.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} St James Park events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  St James Park error:', error.message);
    return [];
  }
}

module.exports = scrapeStJamesPark;

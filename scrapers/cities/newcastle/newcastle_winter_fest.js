/**
 * Newcastle Winter Festival Events Scraper
...
async function scrapeWinterFest(city = 'Newcastle') {
  console.log('❄️ Scraping Winter Festival...');
  ...
  try {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="event"], a[href*="winter"], .event, article, [class*="event"]').forEach(el => {
        try {
...
module.exports = scrapeWinterFest;

/**
 * Northumbria Students Union Newcastle Events Scraper
 * URL: https://www.mynsu.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNorthumbriaStudents(city = 'Newcastle') {
  console.log('🎓 Scraping Northumbria Students Union...');
  ...
  try {
    ...
    await page.goto('https://www.mynsu.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Northumbria Students Union events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Northumbria Students Union error:', error.message);
    return [];
  }
}

module.exports = scrapeNorthumbriaStudents;

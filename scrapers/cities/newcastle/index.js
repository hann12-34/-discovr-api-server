...
const scrapeCosmicBallroom = require('./cosmic_ballroom');
const scrapeDigital = require('./digital');
const scrapeFreedomFestivalNewcastle = require('./freedom_festival_newcastle');
const scrapeHeadOfSteam = require('./head_of_steam');
const scrapeNewcastleBeerFest = require('./newcastle_beer_fest');
const scrapeNewcastleChristmasMarket = require('./newcastle_christmas_market');
const scrapeNewcastleCityHall = require('./newcastle_city_hall');
const scrapeNewcastleComedyFest = require('./newcastle_comedy_fest');
...
const scrapeNewcastleJazzFest = require('./newcastle_jazz_fest');
...
const scrapeTheJazzCafe = require('./the_jazz_cafe');
const scrapeTheLoft = require('./the_loft');
const scrapeTheatreRoyal = require('./theatre_royal');
const scrapeThinkTank = require('./think_tank');

/**
 * The Globe Newcastle Events Scraper
 * URL: https://www.theglobenewcastle.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheGlobe(city = 'Newcastle') {
  ...
  try {
    ...
    await page.goto('https://www.theglobenewcastle.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Globe',
          address: '11 Railway St, Newcastle upon Tyne NE4 7AD',
          city: 'Newcastle'
        },
        latitude: 54.9740,
        longitude: -1.6240,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Globe events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Globe error:', error.message);
    return [];
  }
}

module.exports = scrapeTheGlobe;

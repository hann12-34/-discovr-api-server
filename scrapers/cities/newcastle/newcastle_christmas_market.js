/**
 * Newcastle Christmas Market Events Scraper
...
async function scrapeChristmasMarket(city = 'Newcastle') {
  ...
  try {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="event"], a[href*="christmas"], .event, article, [class*="event"]').forEach(el => {
        try {

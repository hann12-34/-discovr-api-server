/**
 * Digital Newcastle Events Scraper
 * URL: https://www.yourfutureisdigital.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDigital(city = 'Newcastle') {
  console.log('💻 Scraping Digital...');
  ...
  try {
    ...
    await page.goto('https://www.yourfutureisdigital.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Digital events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Digital error:', error.message);
    return [];
  }
}

module.exports = scrapeDigital;

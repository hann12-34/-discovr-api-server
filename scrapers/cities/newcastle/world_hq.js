/**
 * World HQ Newcastle Events Scraper
 * URL: https://www.yourworldhq.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWorldHQ(city = 'Newcastle') {
  console.log('🌍 Scraping World HQ...');
  ...
  try {
    ...
    await page.goto('https://www.yourworldhq.com/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} World HQ events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  World HQ error:', error.message);
    return [];
  }
}

module.exports = scrapeWorldHQ;

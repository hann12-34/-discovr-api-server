/**
 * Newcastle Comedy Festival Events Scraper
 * URL: https://www.newcastlecomedyfestival.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNewcastleComedy(city = 'Newcastle') {
  console.log('😂 Scraping Newcastle Comedy Festival...');
  ...
  try {
    ...
    await page.goto('https://www.newcastlecomedyfestival.co.uk', {
...
module.exports = scrapeNewcastleComedy;

/**
 * The Jazz Cafe Newcastle Events Scraper
 * URL: https://www.thejazzcafenewcastle.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeJazzCafe(city = 'Newcastle') {
  console.log('🎷 Scraping The Jazz Cafe...');
  ...
  try {
    ...
    await page.goto('https://www.thejazzcafenewcastle.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Newcastle',
        category: 'Nightlife',
        source: 'The Jazz Cafe'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Jazz Cafe events`);

/**
 * Brighton Comedy Festival Events Scraper
 * URL: https://www.brightoncomedyfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeComedyFest(city = 'Brighton') {
  ...
  try {
    ...
    await page.goto('https://www.brightoncomedyfestival.com', {

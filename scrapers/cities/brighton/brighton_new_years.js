/**
 * Brighton New Year's Eve Events Scraper
...
async function scrapeNYEBrighton(city = 'Brighton') {
  console.log('🎆 Scraping New Year Eve Brighton...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} NYE Brighton events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  NYE Brighton error:', error.message);
    return [];
  }
}

module.exports = scrapeNYEBrighton;

/**
 * Coalition Brighton Events Scraper
 * URL: https://coalitionbrighton.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCoalition(city = 'Brighton') {
  console.log('🎉 Scraping Coalition...');
  ...
  try {
    ...
    await page.goto('https://coalitionbrighton.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Coalition events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Coalition error:', error.message);
    return [];
  }
}

module.exports = scrapeCoalition;

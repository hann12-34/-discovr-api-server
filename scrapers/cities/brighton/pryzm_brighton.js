/**
 * Pryzm Brighton Events Scraper
 * Popular nightclub in Brighton
 * URL: https://pryzm.co.uk/brighton
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePryzmBrighton(city = 'Brighton') {
  console.log('🎉 Scraping Pryzm Brighton...');
  ...
  try {
    ...
    await page.goto('https://pryzm.co.uk/brighton', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Pryzm',
          address: 'West Street, Brighton BN1 2RE',
          city: 'Brighton'
        },
        city: 'Brighton',
        category: 'Nightlife',
        source: 'Pryzm Brighton'
      });
    }
...
module.exports = scrapePryzmBrighton;

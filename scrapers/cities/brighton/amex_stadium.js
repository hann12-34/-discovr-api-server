/**
 * Amex Stadium Brighton Events Scraper
 * URL: https://www.brightonandhovealbion.com/tickets/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAmexStadium(city = 'Brighton') {
  console.log('🏟️ Scraping Amex Stadium...');
  ...
  try {
    ...
    await page.goto('https://www.brightonandhovealbion.com/tickets/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Amex Stadium events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Amex Stadium error:', error.message);
    return [];
  }
}

module.exports = scrapeAmexStadium;

...
async function scrapePierEvents(city = 'Brighton') {
  console.log('🎡 Scraping Brighton Pier Events...');
  ...
  try {
    ...
    await page.goto('https://www.brightonpier.co.uk', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Brighton Pier events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Brighton Pier error:', error.message);
    return [];
  }
}

module.exports = scrapePierEvents;

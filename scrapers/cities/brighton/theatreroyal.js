/**
 * Theatre Royal Brighton Events Scraper
 * URL: https://theatreroyalbrighton.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheatreRoyal(city = 'Brighton') {
  ...
  try {
    ...
    await page.goto('https://theatreroyalbrighton.co.uk/whats-on', {

/**
 * Brighton Trans Pride Events Scraper
 * URL: https://www.transpridebrighton.org
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTransPride(city = 'Brighton') {
  console.log('🏳️‍⚧️ Scraping Trans Pride...');
  ...
  try {
    ...
    await page.goto('https://www.transpridebrighton.org', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Trans Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Trans Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeTransPride;

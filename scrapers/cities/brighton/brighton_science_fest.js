/**
 * Brighton Science Festival Events Scraper
 * URL: https://www.brightonscience.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeScienceFest(city = 'Brighton') {
  ...
  try {
    ...
    await page.goto('https://www.brightonscience.com', {

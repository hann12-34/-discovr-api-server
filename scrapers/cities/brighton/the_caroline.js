/**
 * The Caroline Brighton Events Scraper
 * URL: https://www.thecarolinebrighton.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheCaroline(city = 'Brighton') {
  console.log('🎵 Scraping The Caroline...');
  ...
  try {
    ...
    await page.goto('https://www.thecarolinebrighton.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Caroline',
          address: 'Madeira Dr, Brighton BN2 1PS',
          city: 'Brighton'
        },
        latitude: 50.8150,
        longitude: -0.1285,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Caroline events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Caroline error:', error.message);
    return [];
  }
}

module.exports = scrapeTheCaroline;

/**
 * Brighton Marathon Events Scraper
...
async function scrapeMarathon(city = 'Brighton') {
  console.log('🏃 Scraping Brighton Marathon...');
  ...
  try {
    ...
    await page.goto('https://www.brightonmarathon.co.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Brighton',
        category: 'Festival',
        source: 'Brighton Marathon'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Brighton Marathon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Brighton Marathon error:', error.message);
    return [];
  }
}

/**
 * Volks Tavern Brighton Events Scraper
 * URL: https://www.volkstavern.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVolksTavern(city = 'Brighton') {
  console.log('🍺 Scraping Volks Tavern...');
  ...
  try {
    ...
    await page.goto('https://www.volkstavern.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Volks Tavern',
          address: '3 The Colonnade, Madeira Dr, Brighton BN2 1EN',
          city: 'Brighton'
        },
        latitude: 50.8145,
        longitude: -0.1275,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Volks Tavern events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Volks Tavern error:', error.message);
    return [];
  }
}

module.exports = scrapeVolksTavern;

/**
 * Brighton Food & Drink Festival Events Scraper
 * URL: https://www.brightonfoodfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFoodFest(city = 'Brighton') {
  ...
  try {
    ...
    await page.goto('https://www.brightonfoodfestival.com', {

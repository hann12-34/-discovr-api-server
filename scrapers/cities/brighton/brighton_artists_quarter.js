/**
 * Brighton Artists Open Houses Events Scraper
 * URL: https://www.brightonopenhouses.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeArtistsOpenHouses(city = 'Brighton') {
  console.log('🎨 Scraping Artists Open Houses...');
  ...
  try {
    ...
    await page.goto('https://www.brightonopenhouses.co.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Various Brighton Studios',
          address: 'Brighton City',
          city: 'Brighton'
        },
        latitude: 50.8225,
        longitude: -0.1372,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Artists Open Houses events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Artists Open Houses error:', error.message);
    return [];
  }
}

module.exports = scrapeArtistsOpenHouses;

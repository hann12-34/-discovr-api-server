/**
 * Brighton Jazz Festival Events Scraper
...
async function scrapeJazzFest(city = 'Brighton') {
  console.log('🎷 Scraping Jazz Events...');
  ...
  try {
    ...
    await page.goto('https://www.visitbrighton.com/whats-on', {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="event"], a[href*="jazz"], .event, article, [class*="event"]').forEach(el => {
        try {
    ...
    console.error('  ⚠️  Jazz Events error:', error.message);
    return [];
  }
}

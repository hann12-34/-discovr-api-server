/**
 * Brighton Pride Events Scraper
 * URL: https://www.brighton-pride.org
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBrightonPride(city = 'Brighton') {
  console.log('🏳️‍🌈 Scraping Brighton Pride...');
  ...
  try {
    ...
    await page.goto('https://www.brighton-pride.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Brighton Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Brighton Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeBrightonPride;

/**
 * Concorde 2 Brighton Events Scraper
 * URL: https://concorde2.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeConcorde2(city = 'Brighton') {
  console.log('🎸 Scraping Concorde 2...');
  ...
  try {
    ...
    await page.goto('https://concorde2.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Concorde 2 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Concorde 2 error:', error.message);
    return [];
  }
}

module.exports = scrapeConcorde2;

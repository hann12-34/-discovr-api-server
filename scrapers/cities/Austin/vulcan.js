/**
 * Vulcan Gas Company Austin Events Scraper
 * Electronic music club
 * URL: https://vulcanatx.com/
 */
...
async function scrapeVulcan(city = 'Austin') {
  console.log('🎧 Scraping Vulcan Gas Company Austin...');
  ...
  try {
    ...
    await page.goto('https://vulcanatx.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Vulcan events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Vulcan Gas Company', address: '418 E 6th Street, Austin TX 78701', city: 'Austin' },
        latitude: 30.2676,
        longitude: -97.7370,
        city: 'Austin',
        category: 'Nightlife',
        source: 'Vulcan Gas Company'
      });
    }
    ...
    console.error('  ⚠️  Vulcan error:', error.message);
    return [];
  }
}

module.exports = scrapeVulcan;

/**
 * Kingdom Austin Nightclub Events Scraper
 * Popular nightclub on E 7th St
 * URL: https://www.kingdomaustin.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKingdomAustin(city = 'Austin') {
  console.log('👑 Scraping Kingdom Austin...');
  ...
  try {
    ...
    await page.goto('https://www.kingdomaustin.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Kingdom Austin',
          address: '505 E 7th St, Austin, TX 78701',
          city: 'Austin'
        },
        city: 'Austin',
        category: 'Nightlife',
        source: 'Kingdom Austin'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Kingdom Austin events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Kingdom Austin error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeKingdomAustin;

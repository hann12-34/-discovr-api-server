/**
 * SXSW Festival Austin Events Scraper
 * URL: https://www.sxsw.com/festivals
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSXSW(city = 'Austin') {
  console.log('🎸 Scraping SXSW Festival...');
  ...
  try {
    ...
    await page.goto('https://www.sxsw.com/festivals', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SXSW events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  SXSW error:', error.message);
    return [];
  }
}

module.exports = scrapeSXSW;

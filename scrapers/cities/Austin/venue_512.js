/**
 * Venue 512 Austin Events Scraper
 * URL: https://venue512.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVenue512(city = 'Austin') {
  console.log('🎸 Scraping Venue 512...');
  ...
  try {
    ...
    await page.goto('https://venue512.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Venue 512',
          address: '408 E 6th Street, Austin TX 78701',
          city: 'Austin'
        },
        latitude: 30.2679,
        longitude: -97.7381,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Venue 512 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Venue 512 error:', error.message);
    return [];
  }
}

module.exports = scrapeVenue512;

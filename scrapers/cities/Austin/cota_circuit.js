/**
 * Circuit of the Americas Austin Events Scraper
...
async function scrapeCOTA(city = 'Austin') {
  console.log('🏎️ Scraping Circuit of the Americas...');
  ...
  try {
    ...
    await page.goto('https://circuitoftheamericas.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '9201 Circuit of the Americas Boulevard, Austin TX 78617',
          city: 'Austin'
        },
        latitude: 30.1347,
        longitude: -97.6411,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} COTA events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  COTA error:', error.message);
    return [];
  }
}

module.exports = scrapeCOTA;

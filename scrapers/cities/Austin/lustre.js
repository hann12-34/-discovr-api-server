/**
 * Lustre Pearl Austin Events Scraper
 * URL: https://www.lustrepearl.com/austin/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLustrePearl(city = 'Austin') {
  console.log('🍺 Scraping Lustre Pearl Austin...');
  ...
  try {
    ...
    await page.goto('https://www.lustrepearl.com/austin/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lustre Pearl events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lustre Pearl error:', error.message);
    return [];
  }
}

module.exports = scrapeLustrePearl;

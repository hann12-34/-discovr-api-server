/**
 * Scoot Inn Austin Events Scraper
 * Historic live music venue
 * URL: https://scootinnaustin.com/
 */
...
async function scrapeScootInn(city = 'Austin') {
  console.log('🎸 Scraping Scoot Inn Austin...');
  ...
  try {
    ...
    await page.goto('https://scootinnaustin.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Scoot Inn events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Scoot Inn', address: '1308 E 4th Street, Austin TX 78702', city: 'Austin' },
        latitude: 30.2622,
        longitude: -97.7295,
        city: 'Austin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Scoot Inn error:', error.message);
    return [];
  }
}

module.exports = scrapeScootInn;

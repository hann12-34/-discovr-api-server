/**
 * Paramount Theatre Austin Events Scraper
 * URL: https://www.austintheatre.org/events/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeParamount(city = 'Austin') {
  console.log('🎭 Scraping Paramount Theatre Austin...');
  ...
  try {
    ...
    await page.goto('https://www.austintheatre.org/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Paramount Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Paramount Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeParamount;

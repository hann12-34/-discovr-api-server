...
async function scrapeSxsw(city = 'Austin') {
  ...
  try {
    ...
    await page.goto('https://sxsw.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'SXSW Festival',
          address: 'Austin Convention Center, TX 78701',
          city: 'Austin'
        },
        latitude: 30.2631,
        longitude: -97.7397,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SXSW Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  SXSW Festival error: ${error.message}`);
    return [];
  }
}

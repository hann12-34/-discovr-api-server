 ...
 * URL: https://www.theparishaustin.com/events
 */
...
async function scrapeParish(city = 'Austin') {
  console.log('🎸 Scraping The Parish...');
  ...
  try {
    ...
    await page.goto('https://www.theparishaustin.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Parish events`);

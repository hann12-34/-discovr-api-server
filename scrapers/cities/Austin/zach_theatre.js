/**
 * ZACH Theatre Austin Events Scraper
 * URL: https://www.zachtheatre.org/shows-and-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeZACHTheatre(city = 'Austin') {
  console.log('🎭 Scraping ZACH Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.zachtheatre.org/shows-and-events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ZACH Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ZACH Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeZACHTheatre;

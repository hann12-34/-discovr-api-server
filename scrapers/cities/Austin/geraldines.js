/**
 * Geraldine's Austin Events Scraper
 * URL: https://geraldinesaustin.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGeraldines(city = 'Austin') {
  console.log('🎵 Scraping Geraldine\'s Austin...');
  ...
  try {
    ...
    await page.goto('https://geraldinesaustin.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Geraldine's events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Geraldine\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeGeraldines;

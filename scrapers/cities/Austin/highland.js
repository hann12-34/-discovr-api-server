/**
 * The Highland Austin Events Scraper
 * Bar and venue on East 6th
 * URL: https://www.thehighlandaustin.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHighland(city = 'Austin') {
  console.log('🎸 Scraping The Highland Austin...');
  ...
  try {
    ...
    await page.goto('https://www.thehighlandaustin.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Highland events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Highland error:', error.message);
    return [];
  }
}

module.exports = scrapeHighland;

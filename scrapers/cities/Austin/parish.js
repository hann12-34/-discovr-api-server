/**
 * The Parish Austin Events Scraper
 * Live music venue
...
async function scrapeParish(city = 'Austin') {
  console.log('🎸 Scraping The Parish Austin...');
  ...
  try {
    ...
    await page.goto('https://www.theparishaustin.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Parish events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Parish', address: '214 E 6th Street, Austin TX 78701', city: 'Austin' },
        latitude: 30.2672,
        longitude: -97.7411,
        city: 'Austin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Parish error:', error.message);
    return [];
  }
}

module.exports = scrapeParish;

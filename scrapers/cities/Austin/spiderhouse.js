/**
 * Spider House Ballroom Austin Events Scraper
 * Live music and event venue
 * URL: https://spiderhouseballroom.com/
 */
...
async function scrapeSpiderHouse(city = 'Austin') {
  console.log('🎸 Scraping Spider House Ballroom Austin...');
  ...
  try {
    ...
    await page.goto('https://spiderhouseballroom.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Austin',
        category: 'Nightlife',
        source: 'Spider House Ballroom'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} valid Spider House events`);

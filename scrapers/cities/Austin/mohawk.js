/**
 * Mohawk Austin Events Scraper
 * Live music venue on Red River
...
async function scrapeMohawk(city = 'Austin') {
  console.log('🎸 Scraping Mohawk Austin...');
  ...
  try {
    ...
    await page.goto('https://www.mohawkaustin.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Live at Mohawk Austin`,
        date: isoDate,
        ...
        venue: {
          name: 'Mohawk',
          address: '912 Red River Street, Austin TX 78701',
          city: 'Austin'
        },
        latitude: 30.2694,
        longitude: -97.7371,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Mohawk events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mohawk error:', error.message);
    return [];
  }
}

module.exports = scrapeMohawk;

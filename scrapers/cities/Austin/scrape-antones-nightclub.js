 ...
 * URL: https://antonesnightclub.com/events
 */
...
async function scrapeAntonesNightclub(city = 'Austin') {
  console.log('🎭 Scraping Antones Nightclub...');
  try {
    const resp = await axios.get('https://antonesnightclub.com/events', {
      ...
      try {
        ...
        for (const item of items) {
          ...
          events.push({
            ...
            imageUrl: img,
            venue: { name: 'Antones Nightclub', address: addr || '305 E 5th St, Austin, TX 78701', city: 'Austin' },
            latitude: 30.2664,
            longitude: -97.7399,
            city: 'Austin',
            category: 'Events',
      ...
      $events.each((_, el) => {
        try {
          ...
          if (eventUrl && !eventUrl.startsWith('http')) {
            const base = new URL('https://antonesnightclub.com/events');
          ...
          if (img && !img.startsWith('http')) {
            try { img = new URL(img, 'https://antonesnightclub.com/events').href; } catch(e) { img = null; }
          }
          ...
          events.push({
            ...
            url: eventUrl,
            imageUrl: img,
            venue: { name: 'Antones Nightclub', address: '305 E 5th St, Austin, TX 78701', city: 'Austin' },
            latitude: 30.2664,
            longitude: -97.7399,
            city: 'Austin',
            category: 'Events',
    ...
    console.log('  ✅ Antones Nightclub:', futureEvents.length, 'events');
...
module.exports = scrapeAntonesNightclub;

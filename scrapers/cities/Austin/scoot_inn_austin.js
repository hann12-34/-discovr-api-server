 ...
 * URL: https://scootinnaustin.com/events
 */
...
async function scrapeScootInn(city = 'Austin') {
  console.log('🎸 Scraping Scoot Inn...');
  ...
  try {
    ...
    await page.goto('https://scootinnaustin.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Scoot Inn events`);

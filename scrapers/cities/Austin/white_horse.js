/**
 * The White Horse Austin Events Scraper
 * Honky tonk bar on East 6th
 * URL: https://www.thewhitehorseaustin.com/
 */
...
async function scrapeWhiteHorse(city = 'Austin') {
  console.log('🤠 Scraping The White Horse Austin...');
  ...
  try {
    ...
    await page.goto('https://www.thewhitehorseaustin.com/', {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('.eventlist-event, .event, article, .summary-item, .collection-item').forEach(el => {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Austin',
        category: 'Nightlife',
        source: 'The White Horse'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} valid White Horse events`);

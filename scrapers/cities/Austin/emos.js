...
async function scrapeEmos(city = 'Austin') {
  console.log('🎸 Scraping Emo\'s Austin...');
  ...
  try {
    ...
    await page.goto('https://www.emosaustin.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Emo's events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Emo's", address: '2015 E Riverside Dr, Austin TX 78741', city: 'Austin' },
        latitude: 30.2458,
        longitude: -97.7234,
        city: 'Austin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Emo\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeEmos;

...
async function scrapeParamountAustin(city = 'Austin') {
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Paramount events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Paramount error:', error.message);
    return [];
  }
}

module.exports = scrapeParamountAustin;

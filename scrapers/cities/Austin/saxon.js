/**
 * Saxon Pub Austin Events Scraper
 * Legendary songwriter venue
...
async function scrapeSaxonPub(city = 'Austin') {
  console.log('🎸 Scraping Saxon Pub Austin...');
  ...
  try {
    ...
    await page.goto('https://thesaxonpub.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Saxon Pub events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Saxon Pub', address: '1320 S Lamar Blvd, Austin TX 78704', city: 'Austin' },
        latitude: 30.2518,
        longitude: -97.7671,
        city: 'Austin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Saxon Pub error:', error.message);
    return [];
  }
}

module.exports = scrapeSaxonPub;

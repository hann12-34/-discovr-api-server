/**
 * Far Out Lounge Austin Events Scraper
 * URL: https://faroutaustin.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFarOut(city = 'Austin') {
  console.log('🎸 Scraping Far Out Lounge...');
  ...
  try {
    ...
    await page.goto('https://faroutaustin.com/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Far Out Lounge',
          address: '7420 S 1st Street, Austin TX 78745',
          city: 'Austin'
        },
        latitude: 30.2054,
        longitude: -97.7895,
        city: 'Austin',
        category: 'Nightlife',
        source: 'Far Out Lounge'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Far Out events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Far Out error:', error.message);
    return [];
  }
}

module.exports = scrapeFarOut;

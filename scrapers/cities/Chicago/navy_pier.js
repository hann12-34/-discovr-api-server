/**
 * Navy Pier Chicago Events Scraper
 * URL: https://navypier.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNavyPier(city = 'Chicago') {
  console.log('🎡 Scraping Navy Pier...');
  ...
  try {
    ...
    await page.goto('https://navypier.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Navy Pier events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Navy Pier error:', error.message);
    return [];
  }
}

module.exports = scrapeNavyPier;

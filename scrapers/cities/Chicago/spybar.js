/**
 * Spybar Chicago Events Scraper
 * Popular nightclub in Chicago
 * URL: https://www.spybarchicago.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSpybar(city = 'Chicago') {
  console.log('🕵️ Scraping Spybar Chicago...');
  ...
  try {
    ...
    await page.goto('https://www.spybarchicago.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Spybar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Spybar error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeSpybar;

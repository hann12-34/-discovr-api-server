/**
 * Zanies Comedy Club Chicago Events Scraper
...
async function scrapeZanies(city = 'Chicago') {
  console.log('😂 Scraping Zanies Comedy...');
  ...
  try {
    ...
    await page.goto('https://chicago.zanies.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '1548 N Wells Street, Chicago IL 60610',
          city: 'Chicago'
        },
        latitude: 41.9103,
        longitude: -87.6345,
        city: 'Chicago',
        category: 'Nightlife',
        source: 'Zanies Comedy'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Zanies events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Zanies error:', error.message);
    return [];
  }
}

module.exports = scrapeZanies;

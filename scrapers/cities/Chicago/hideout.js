/**
 * Hideout Chicago Events Scraper
 * Indie music venue
 * URL: https://www.hideoutchicago.com/
 */
...
async function scrapeHideout(city = 'Chicago') {
  console.log('🎸 Scraping Hideout Chicago...');
  ...
  try {
    ...
    await page.goto('https://www.hideoutchicago.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Hideout events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Hideout', address: '1354 W Wabansia Ave, Chicago IL 60642', city: 'Chicago' },
        latitude: 41.9127,
        longitude: -87.6627,
        city: 'Chicago',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Hideout error:', error.message);
    return [];
  }
}

module.exports = scrapeHideout;

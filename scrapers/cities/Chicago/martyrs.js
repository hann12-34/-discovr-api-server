/**
 * Martyrs' Chicago Events Scraper
 * Live music venue in Lincoln Park
 * URL: https://martyrslive.com/
 */
...
async function scrapeMartyrs(city = 'Chicago') {
  console.log('🎸 Scraping Martyrs\' Chicago...');
  ...
  try {
    ...
    await page.goto('https://martyrslive.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Martyrs' events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Martyrs'", address: '3855 N Lincoln Ave, Chicago IL 60613', city: 'Chicago' },
        latitude: 41.9515,
        longitude: -87.6826,
        city: 'Chicago',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Martyrs\' error:', error.message);
    return [];
  }
}

module.exports = scrapeMartyrs;

/**
 * Sleeping Village Chicago Events Scraper
 * URL: https://www.sleeping-village.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSleepingVillage(city = 'Chicago') {
  console.log('🎸 Scraping Sleeping Village...');
  ...
  try {
    ...
    await page.goto('https://www.sleeping-village.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '3734 W Belmont Avenue, Chicago IL 60618',
          city: 'Chicago'
        },
        latitude: 41.9394,
        longitude: -87.7208,
        city: 'Chicago',
        category: 'Nightlife',
        source: 'Sleeping Village'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Sleeping Village events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sleeping Village error:', error.message);
    return [];
  }
}

module.exports = scrapeSleepingVillage;

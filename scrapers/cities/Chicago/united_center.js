/**
 * United Center Chicago Events Scraper
...
async function scrapeUnitedCenter(city = 'Chicago') {
  console.log('🏟️ Scraping United Center...');
  ...
  try {
    ...
    await page.goto('https://www.unitedcenter.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Chicago',
        category: 'Festival',
        source: 'United Center'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} United Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  United Center error:', error.message);
    return [];
  }
}

module.exports = scrapeUnitedCenter;

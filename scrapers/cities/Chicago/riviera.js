/**
 * Riviera Theatre Chicago Events Scraper
...
async function scrapeRiviera(city = 'Chicago') {
  console.log('🎸 Scraping Riviera Theatre Chicago...');
  ...
  try {
    ...
    await page.goto('https://www.rivieratheatre.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Chicago',
        category: 'Concert',
        source: 'Riviera Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Riviera events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Riviera error:', error.message);
    return [];
  }
}

module.exports = scrapeRiviera;

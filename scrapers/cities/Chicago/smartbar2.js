/**
 * Smartbar Chicago Events Scraper
 * Nightclub venue in Chicago
...
async function scrapeSmartbar2(city = 'Chicago') {
  console.log('🎧 Scraping Smartbar Chicago...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Smartbar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Smartbar error:', error.message);
    return [];
  }
}

module.exports = scrapeSmartbar2;

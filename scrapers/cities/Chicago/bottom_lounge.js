/**
 * Bottom Lounge Chicago Events Scraper
...
async function scrapeBottomLounge(city = 'Chicago') {
  console.log('🎸 Scraping Bottom Lounge...');
  ...
  try {
    ...
    await page.goto('https://bottomlounge.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Bottom Lounge',
          address: '1375 W Lake Street, Chicago IL 60607',
          city: 'Chicago'
        },
        latitude: 41.8855,
        longitude: -87.6626,
        city: 'Chicago',
        category: 'Nightlife',
        source: 'Bottom Lounge'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Bottom Lounge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bottom Lounge error:', error.message);
    return [];
  }
}

module.exports = scrapeBottomLounge;

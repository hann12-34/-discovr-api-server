/**
 * Subterranean Chicago Events Scraper
 * Live music venue in Wicker Park
...
async function scrapeSubterranean(city = 'Chicago') {
  console.log('🎸 Scraping Subterranean Chicago...');
  ...
  try {
    ...
    await page.goto('https://www.subt.net/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Subterranean events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Subterranean', address: '2011 W North Ave, Chicago IL 60647', city: 'Chicago' },
        latitude: 41.9103,
        longitude: -87.6783,
        city: 'Chicago',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Subterranean error:', error.message);
    return [];
  }
}

module.exports = scrapeSubterranean;

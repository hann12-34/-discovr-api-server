 ...
 * URL: https://sleeping-village.com/
 */
...
async function scrapeSleepingVillage(city = 'Chicago') {
  console.log('🌙 Scraping Sleeping Village Chicago...');
  ...
  try {
    ...
    await page.goto('https://sleeping-village.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Sleeping Village events`);

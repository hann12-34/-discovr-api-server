/**
 * House of Blues Chicago Events Scraper
...
async function scrapeHouseOfBlues(city = 'Chicago') {
  console.log('🎸 Scraping House of Blues Chicago...');
  ...
  try {
    ...
    await page.goto('https://www.houseofblues.com/chicago/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'House of Blues', address: '329 N Dearborn Street, Chicago IL 60654', city: 'Chicago' },
        latitude: 41.8883,
        longitude: -87.6295,
        city: 'Chicago',
        category: 'Nightlife',

/**
 * Sound-Bar Chicago Events Scraper
 * Popular nightclub in Chicago
 * URL: https://sound-bar.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSoundBarChicago(city = 'Chicago') {
  console.log('🔊 Scraping Sound-Bar Chicago...');
  ...
  try {
    ...
    await page.goto('https://sound-bar.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sound-Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Sound-Bar error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeSoundBarChicago;

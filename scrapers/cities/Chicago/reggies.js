/**
 * Reggies Chicago Events Scraper
 * Rock club and live music venue
...
async function scrapeReggies(city = 'Chicago') {
  console.log('🎸 Scraping Reggies Chicago...');
  ...
  try {
    ...
    await page.goto('https://www.reggieslive.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Reggies events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Reggies', address: '2105 S State Street, Chicago IL 60616', city: 'Chicago' },
        latitude: 41.8549,
        longitude: -87.6275,
        city: 'Chicago',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Reggies error:', error.message);
    return [];
  }
}

module.exports = scrapeReggies;

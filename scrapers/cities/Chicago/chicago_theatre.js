/**
 * Chicago Theatre Events Scraper
...
async function scrapeChicagoTheatre(city = 'Chicago') {
  console.log('🎭 Scraping Chicago Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.msg.com/the-chicago-theatre', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Chicago Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Chicago Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeChicagoTheatre;

/**
 * Thalia Hall Chicago Events Scraper
 * Historic venue in Pilsen
 * URL: https://thaliahallchicago.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThalia(city = 'Chicago') {
  ...
  try {
    ...
    await page.goto('https://thaliahallchicago.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Live at Thalia Hall`,
        date: isoDate,
        ...
        venue: {
          name: 'Thalia Hall',
          address: '1807 S Allport Street, Chicago IL 60608',
          city: 'Chicago'
        },
        latitude: 41.8576,
        longitude: -87.6577,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Thalia Hall events`);

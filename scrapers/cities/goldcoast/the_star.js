/**
 * The Star Gold Coast Events Scraper
 * URL: https://www.star.com.au/goldcoast/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheStar(city = 'Gold Coast') {
  console.log('⭐ Scraping The Star...');
  ...
  try {
    ...
    await page.goto('https://www.star.com.au/goldcoast/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Star events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Star error:', error.message);
    return [];
  }
}

module.exports = scrapeTheStar;

/**
 * The Med Gold Coast Events Scraper
 * URL: https://www.themed.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheMed(city = 'Gold Coast') {
  console.log('🌊 Scraping The Med...');
  ...
  try {
    ...
    await page.goto('https://www.themed.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Med',
          address: 'Tedder Ave, Main Beach QLD 4217',
          city: 'Gold Coast'
        },
        latitude: -27.9975,
        longitude: 153.4255,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Med events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Med error:', error.message);
    return [];
  }
}

module.exports = scrapeTheMed;

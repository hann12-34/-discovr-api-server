/**
 * The Island Gold Coast Events Scraper
 * URL: https://www.theislandgc.com.au/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheIsland(city = 'Gold Coast') {
  console.log('🏝️ Scraping The Island...');
  ...
  try {
    ...
    await page.goto('https://www.theislandgc.com.au/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Island',
          address: 'Appel St, Surfers Paradise QLD 4217',
          city: 'Gold Coast'
        },
        latitude: -28.0018,
        longitude: 153.4298,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Island events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Island error:', error.message);
    return [];
  }
}

module.exports = scrapeTheIsland;

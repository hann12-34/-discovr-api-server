/**
 * Sin City Gold Coast Events Scraper
 * URL: https://www.sincitygc.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSinCity(city = 'Gold Coast') {
  console.log('🌃 Scraping Sin City...');
  ...
  try {
    ...
    await page.goto('https://www.sincitygc.com.au/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sin City events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sin City error:', error.message);
    return [];
  }
}

module.exports = scrapeSinCity;

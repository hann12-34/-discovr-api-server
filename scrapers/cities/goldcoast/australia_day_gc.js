/**
 * Australia Day Gold Coast Events Scraper
...
async function scrapeAusDayGC(city = 'Goldcoast') {
  console.log('🇦🇺 Scraping Australia Day Gold Coast...');
  ...
  try {
    ...
    await page.goto('https://www.goldcoast.qld.gov.au/council-region/about-our-city/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Australia Day events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Australia Day error:', error.message);
    return [];
  }
}

module.exports = scrapeAusDayGC;

/**
 * The Warehouse Nightclub Gold Coast Events Scraper
 * URL: https://www.thewarehousegc.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWarehouseGC(city = 'Goldcoast') {
  console.log('🎉 Scraping The Warehouse GC...');
  ...
  try {
    ...
    await page.goto('https://www.thewarehousegc.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Warehouse',
          address: '16 Orchid Avenue, Surfers Paradise QLD',
          city: 'Goldcoast'
        },
        latitude: -28.0003,
        longitude: 153.4294,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Warehouse events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Warehouse error:', error.message);
    return [];
  }
}

module.exports = scrapeWarehouseGC;

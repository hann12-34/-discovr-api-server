/**
 * Asylum Nightclub Gold Coast Events Scraper
 * High intensity nightclub in Surfers Paradise
 * URL: https://www.asylumnightclub.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAsylumNightclub(city = 'Gold Coast') {
  console.log('🏥 Scraping Asylum Nightclub...');
  ...
  try {
    ...
    await page.goto('https://www.asylumnightclub.com.au/', {
...
module.exports = scrapeAsylumNightclub;

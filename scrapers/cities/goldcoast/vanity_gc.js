/**
 * Vanity Nightclub Gold Coast Events Scraper
 * URL: https://www.vanitygoldcoast.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVanityGC(city = 'Goldcoast') {
  console.log('💃 Scraping Vanity GC...');
  ...
  try {
    ...
    await page.goto('https://www.vanitygoldcoast.com.au/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Vanity events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Vanity error:', error.message);
    return [];
  }
}

module.exports = scrapeVanityGC;

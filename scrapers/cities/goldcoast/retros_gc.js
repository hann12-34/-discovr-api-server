/**
 * Retros Nightclub Gold Coast Events Scraper
 * URL: https://www.retros.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRetrosGC(city = 'Goldcoast') {
  console.log('🕺 Scraping Retros GC...');
  ...
  try {
    ...
    await page.goto('https://www.retros.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Retros Nightclub',
          address: 'Cavill Avenue, Surfers Paradise QLD',
          city: 'Goldcoast'
        },
        latitude: -28.0015,
        longitude: 153.4285,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Retros events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Retros error:', error.message);
    return [];
  }
}

module.exports = scrapeRetrosGC;

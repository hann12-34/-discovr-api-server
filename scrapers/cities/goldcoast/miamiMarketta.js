/**
 * Miami Marketta Gold Coast Events Scraper
...
async function scrapeMiamiMarketta(city = 'Gold Coast') {
  console.log('🎸 Scraping Miami Marketta Gold Coast...');
  ...
  try {
    ...
    await page.goto('https://miamimarketta.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Live at Miami Marketta`,
        date: isoDate,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Miami Marketta events`);
...
module.exports = scrapeMiamiMarketta;

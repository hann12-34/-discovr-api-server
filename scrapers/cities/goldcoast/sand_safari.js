/**
 * Sand Safari Gold Coast Events Scraper
 * URL: https://www.sandsafari.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSandSafari(city = 'Goldcoast') {
  console.log('🏖️ Scraping Sand Safari...');
  ...
  try {
    ...
    await page.goto('https://www.sandsafari.com.au', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sand Safari events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sand Safari error:', error.message);
    return [];
  }
}

module.exports = scrapeSandSafari;

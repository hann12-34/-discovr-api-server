/**
 * The Avenue Gold Coast Events Scraper
 * URL: https://www.theavenuegc.com.au/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheAvenue(city = 'Gold Coast') {
  console.log('🎉 Scraping The Avenue...');
  ...
  try {
    ...
    await page.goto('https://www.theavenuegc.com.au/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Avenue',
          address: 'Surfers Paradise Blvd, Surfers Paradise QLD 4217',
          city: 'Gold Coast'
        },
        latitude: -28.0020,
        longitude: 153.4290,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Avenue events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Avenue error:', error.message);
    return [];
  }
}

module.exports = scrapeTheAvenue;

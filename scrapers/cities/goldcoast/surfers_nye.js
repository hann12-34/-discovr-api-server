/**
 * Surfers Paradise New Year Events Scraper
 * URL: https://www.surfersparadise.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNYE(city = 'Gold Coast') {
  ...
  try {
    ...
    await page.goto('https://www.surfersparadise.com/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} NYE events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  NYE error:', error.message);
    return [];
  }
}

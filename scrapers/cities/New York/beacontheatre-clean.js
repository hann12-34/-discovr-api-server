...
class BeaconTheatreEvents {
    constructor() {
        this.source = 'Beacon Theatre';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://beacontheatre.com';
        this.eventsUrl = 'https://beacontheatre.com/events';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Beacon Theatre`,
                            dateText,
                            price,
                            url: eventUrl
                        });

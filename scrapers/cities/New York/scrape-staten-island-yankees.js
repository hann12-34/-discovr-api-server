...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.siferryhawks.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Staten Island FerryHawks Stadium', address: '75 Richmond Terr, Staten Island, NY 10301', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.siferryhawks.com/', category: 'Events'
      });
    });

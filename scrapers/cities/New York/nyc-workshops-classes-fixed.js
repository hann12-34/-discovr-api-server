...
class NYCWorkshopsClassesEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=workshop&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find workshop and class events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(workshop|class|training|learn|course|skill|education|tutorial|masterclass|seminar)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCWorkshopsClasses-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCWorkshopsClassesEvents;

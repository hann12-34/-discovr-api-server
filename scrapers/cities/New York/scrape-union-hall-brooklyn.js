...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.unionhallny.com/calendar', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Union Hall', address: '702 Union St Brooklyn NY 11215', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.unionhallny.com/calendar', category: 'Events'
      });
    });

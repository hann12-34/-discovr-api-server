...
const VENUE_NAME = "Don\'t Tell Mama";
const VENUE_ADDRESS = '343 W 46th St, New York, NY 10036';
...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://donttellmamanyc.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Don\'t Tell Mama', address: '343 W 46th St, New York, NY 10036', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://donttellmamanyc.com/', category: 'Events'
      });
    });

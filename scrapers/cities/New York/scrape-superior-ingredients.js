...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.superioringredients.nyc/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Superior Ingredients', address: '268 S 2nd St, Brooklyn, NY 11211', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.superioringredients.nyc/', category: 'Events'
      });
    });

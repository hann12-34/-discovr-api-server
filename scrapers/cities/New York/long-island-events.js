...
module.exports = async (city) => {
  const scraper = new LongIslandEventsExtractor();
  return await scraper.scrape(city);
};

// Also export the class for backward compatibility
module.exports.LongIslandEventsExtractor = LongIslandEventsExtractor;
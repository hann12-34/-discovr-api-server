...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.carolines.com/calendar/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Carolines on Broadway', address: '1626 Broadway New York NY 10019', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.carolines.com/calendar/', category: 'Events'
      });
    });

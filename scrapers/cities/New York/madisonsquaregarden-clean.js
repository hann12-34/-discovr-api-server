...
class MadisonSquareGardenEvents {
    constructor() {
        this.source = 'Madison Square Garden';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://msg.com';
        this.eventsUrl = 'https://msg.com/calendar';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Madison Square Garden`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
module.exports = MadisonSquareGardenEvents;
...
class NYCRealEstatePropertyEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=real%20estate&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find real estate and property events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(real estate|property|housing|rental|investment|mortgage|broker|agent|developer|construction|apartment)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCRealEstateProperty-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCRealEstatePropertyEvents;

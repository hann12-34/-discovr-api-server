...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.barclayscenter.com/events', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Barclays Center', address: '620 Atlantic Ave Brooklyn NY 11217', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.barclayscenter.com/events', category: 'Events'
      });
    });

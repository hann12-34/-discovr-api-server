...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://schimanskibrooklyn.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Schimanski', address: '54 N 11th St, Brooklyn, NY 11249', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://schimanskibrooklyn.com/', category: 'Events'
      });
    });

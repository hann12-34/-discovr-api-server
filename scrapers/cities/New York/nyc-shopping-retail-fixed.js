...
class NYCShoppingRetailEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=shopping&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find shopping and retail events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(shopping|retail|store|market|boutique|sale|fashion|mall|vintage|thrift|pop up|popup)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCShoppingShopping-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCShoppingRetailEvents;

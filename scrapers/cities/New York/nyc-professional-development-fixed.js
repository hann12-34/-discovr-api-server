...
class NYCProfessionalDevelopmentEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=professional%20development&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find professional development events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(professional|development|career|skills|training|conference|seminar|workshop|leadership|management|certification|coaching)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCProfessionalDevelopment-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCProfessionalDevelopmentEvents;

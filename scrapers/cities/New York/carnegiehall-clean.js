...
class CarnegieHallEvents {
    constructor() {
        this.source = 'Carnegie Hall';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://carnegiehall.org';
        this.eventsUrl = 'https://carnegiehall.org/Calendar';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Carnegie Hall`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
module.exports = CarnegieHallEvents;
...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://shapeshifterlab.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Shapeshifter Lab', address: '18 Whitwell Pl, Brooklyn, NY 11215', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://shapeshifterlab.com/', category: 'Events'
      });
    });

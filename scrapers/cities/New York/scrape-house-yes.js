...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://houseofyes.org/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'House of Yes', address: '2 Wyckoff Ave, Brooklyn, NY 11237', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://houseofyes.org/', category: 'Events'
      });
    });

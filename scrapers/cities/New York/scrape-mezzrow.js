...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.mezzrow.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Mezzrow', address: '163 W 10th St, New York, NY 10014', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.mezzrow.com/', category: 'Events'
      });
    });

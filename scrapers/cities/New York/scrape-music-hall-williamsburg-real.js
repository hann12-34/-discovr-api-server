  ...
  try {
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Music Hall Williamsburg', address: '66 N 6th St Brooklyn NY 11249', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.musichallofwilliamsburg.com/events', category: 'Events'
      });
    });

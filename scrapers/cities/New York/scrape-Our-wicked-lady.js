...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.ourwickedlady.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Our Wicked Lady', address: '153 Morgan Ave, Brooklyn, NY 11237', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.ourwickedlady.com/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.intrepidmuseum.org/events', {
      timeout: 15000,
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'Intrepid Sea, Air & Space Museum', address: 'Pier 86, W 46th St, New York, NY 10036', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.intrepidmuseum.org/events', category: 'Events'
      });
    });

...
class VillageVanguardEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=village%20vanguard&location=us--ny--new_york';
        this.category = 'Music';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find Village Vanguard related events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(village vanguard|jazz|live music|performance|concert|venue|greenwich village|basement|club|music)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'VillageVanguard-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = VillageVanguardEvents;

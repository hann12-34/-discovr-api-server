...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.cieloclub.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Cielo', address: '18 Little W 12th St, New York, NY 10014', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.cieloclub.com/', category: 'Events'
      });
    });

...
class NYCKidsFamilyEvents {
    constructor() {
        this.venueName = 'NYC Kids & Family Events';
        this.venueLocation = 'New York, NY';
        this.baseUrl = 'https://www.meetup.com';
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=family&location=us--ny--new_york';
        ...
        try {
            ...
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(family|kids|children|parent|child|baby|toddler|playground|story|activities|fun|youth|teenager)\b/i)) {
                        events.push({
                            title: title,
...
module.exports = NYCKidsFamilyEvents;


// Function export for compatibility with runner/validator
module.exports = async (city) => {
  const scraper = new NYCKidsFamilyEvents();
  return await scraper.scrape(city);
};

// Also export the class for backward compatibility
module.exports.NYCKidsFamilyEvents = NYCKidsFamilyEvents;
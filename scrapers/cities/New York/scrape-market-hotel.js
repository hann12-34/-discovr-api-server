...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.market-hotel.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Market Hotel', address: '1140 Myrtle Ave, Brooklyn, NY 11206', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.market-hotel.com/', category: 'Events'
      });
    });

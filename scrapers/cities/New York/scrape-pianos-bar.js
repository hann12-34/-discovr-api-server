...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://pianosnyc.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Pianos', address: '158 Ludlow St, New York, NY 10002', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://pianosnyc.com/', category: 'Events'
      });
    });

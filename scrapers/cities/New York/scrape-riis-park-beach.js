...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.riisparkbeachbazaar.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Riis Park Beach Bazaar', address: 'Jacob Riis Park, Queens, NY 11694', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.riisparkbeachbazaar.com/', category: 'Events'
      });
    });

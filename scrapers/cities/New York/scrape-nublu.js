...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.nublu.net/', {
      timeout: 15000,
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'Nublu', address: '151 Avenue C, New York, NY 10009', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.nublu.net/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://marqueeny.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Marquee New York', address: '289 10th Ave, New York, NY 10001', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://marqueeny.com/', category: 'Events'
      });
    });

...
class ApolloTheaterEvents {
    constructor() {
        this.source = 'Apollo Theater';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://apollotheater.org';
        this.eventsUrl = 'https://apollotheater.org/events';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Apollo Theater`,
                            dateText,
                            price,
                            url: eventUrl
                        });

...
class NYCStartupsEntrepreneurshipEvents {
    ...
    async scrape() {
        ...
        try {
            ...
            // Find startup and entrepreneurship events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(startup|entrepreneur|innovation|venture|founder|incubator|accelerator|pitch|investor|funding|tech|business)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCStartupsEntrepreneurship-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCStartupsEntrepreneurshipEvents;

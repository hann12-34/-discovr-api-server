...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.trans-pecos.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Trans-Pecos', address: '915 Wyckoff Ave, Ridgewood, NY 11385', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.trans-pecos.com/', category: 'Events'
      });
    });

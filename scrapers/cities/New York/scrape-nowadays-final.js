...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://nowadays.nyc/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Nowadays', address: '56-06 Cooper Ave, Ridgewood, NY 11385', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://nowadays.nyc/', category: 'Events'
      });
    });

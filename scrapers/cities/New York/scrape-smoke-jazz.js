...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.smokejazz.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Smoke Jazz Club', address: '2751 Broadway, New York, NY 10025', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.smokejazz.com/', category: 'Events'
      });
    });

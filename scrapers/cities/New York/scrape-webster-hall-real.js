...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.websterhall.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Webster Hall', address: '125 E 11th St New York NY 10003', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.websterhall.com/', category: 'Events'
      });
    });

...
class LincolnCenterEvents {
    constructor() {
        this.source = 'Lincoln Center';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://lincolncenter.org';
        this.eventsUrl = 'https://lincolncenter.org/events-tickets';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Lincoln Center`,
                            dateText,
                            price,
                            url: eventUrl
                        });

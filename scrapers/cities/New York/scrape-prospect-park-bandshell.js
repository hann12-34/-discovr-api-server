...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.bricartsmedia.org/celebrate-brooklyn', {
      timeout: 15000,
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'Prospect Park Bandshell', address: '9th St & Prospect Park W, Brooklyn, NY 11215', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.bricartsmedia.org/celebrate-brooklyn', category: 'Events'
      });
    });

...
class BoweryBallroomEvents {
    constructor() {
        this.source = 'Bowery Ballroom';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://boweryballroom.com';
        this.eventsUrl = 'https://boweryballroom.com/events';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Bowery Ballroom`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
module.exports = BoweryBallroomEvents;
...
const VENUE_NAME = "Carnegie Hall";
const VENUE_ADDRESS = '881 7th Ave, New York, NY 10019';
  ...
  try {
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        location: 'New York, NY', description: title, url: 'https://www.carnegiehall.org/calendar', category: 'Events'
      });
    });

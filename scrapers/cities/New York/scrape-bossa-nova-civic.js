...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://bossanovacivicclub.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Bossa Nova Civic Club', address: '1271 Myrtle Ave, Brooklyn, NY 11221', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://bossanovacivicclub.com/', category: 'Events'
      });
    });

...
class MetropolitanOperaEvents {
    constructor() {
        this.source = 'Metropolitan Opera';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://metopera.org';
        this.eventsUrl = 'https://metopera.org/season/tickets';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Metropolitan Opera`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
module.exports = MetropolitanOperaEvents;
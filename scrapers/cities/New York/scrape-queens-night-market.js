...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://queensnightmarket.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Queens Night Market', address: 'New York Hall of Science, Queens, NY 11368', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://queensnightmarket.com/', category: 'Events'
      });
    });

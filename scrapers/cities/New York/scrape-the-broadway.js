...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.thebroadwaybk.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Broadway', address: '96 Broadway, Brooklyn, NY 11249', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.thebroadwaybk.com/', category: 'Events'
      });
    });

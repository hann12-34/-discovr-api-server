...
const VENUE_NAME = "Arlene's Grocery";
const VENUE_ADDRESS = '95 Stanton St, New York, NY 10002';
  ...
  try {
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        location: 'New York, NY', description: title, url: 'https://arlenesgrocery.net/', category: 'Events'
      });
    });

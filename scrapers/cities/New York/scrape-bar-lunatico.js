...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://barlunatico.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Bar LunÁtico', address: '486 Halsey St, Brooklyn, NY 11233', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://barlunatico.com/', category: 'Events'
      });
    });

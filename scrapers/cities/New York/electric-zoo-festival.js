...
class ElectricZooFestival {
    constructor() {
        this.venueName = 'Electric Zoo Festival';
        this.venueLocation = 'Randall\'s Island, New York, NY';
        this.baseUrl = 'https://randallsisland.org';
        this.eventsUrl = 'https://randallsisland.org/events';
        this.category = 'Electronic Music Festival';
    }

    /**
     * Scrape events from Electric Zoo Festival
    ...
    async scrape() {
        ...
        try {
            ...
            // Look for Randall's Island event containers
            const eventSelectors = [
                ...
                '[class*="tribe-events"][class*="event"]'
            ];
            ...
            eventSelectors.forEach(selector => {
                $(selector).each((index, element) => {
                    ...
                    if (title && this.isValidEvent(title)) {
                        ...
                        let genre = '';
                        const genreSelectors = ['.genre', '.style', '.category', '[class*="genre"]'];

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.palisadesbrooklyn.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Palisades', address: '906 Broadway, Brooklyn, NY 11206', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.palisadesbrooklyn.com/', category: 'Events'
      });
    });

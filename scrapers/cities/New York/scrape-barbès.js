...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://barbesbrooklyn.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Barbès', address: '376 9th St, Brooklyn, NY 11215', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://barbesbrooklyn.com/', category: 'Events'
      });
    });

...
class NYCGOEvents {
    constructor() {
        this.venueName = 'NYCGO Events';
        this.venueLocation = 'New York, NY';
        this.baseUrl = 'https://www.meetup.com';
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=nycgo%20events&location=us--ny--new_york';
        this.category = 'General NYC Events';
    }
        ...
        try {
            ...
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(nycgo|new york|manhattan|brooklyn|queens|bronx|events|tourism|attractions|things to do)\b/i)) {
                        events.push({
                            title: title,
...
module.exports = async (city) => {
  const scraper = new NYCGOEvents();
  return await scraper.scrape(city);
};

// Also export the class for backward compatibility
module.exports.NYCGOEvents = NYCGOEvents;
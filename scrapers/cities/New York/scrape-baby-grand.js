...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.babygrandnyc.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Baby Grand', address: '1516 Bedford Ave, Brooklyn, NY 11216', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.babygrandnyc.com/', category: 'Events'
      });
    });

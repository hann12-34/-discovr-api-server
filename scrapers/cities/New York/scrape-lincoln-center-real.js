...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.lincolncenter.org/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Lincoln Center', address: '10 Lincoln Center Plaza New York NY 10023', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.lincolncenter.org/', category: 'Events'
      });
    });

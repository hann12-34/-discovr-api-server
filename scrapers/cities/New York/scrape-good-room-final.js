...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://goodroombk.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Good Room', address: '98 Meserole Ave, Brooklyn, NY 11222', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://goodroombk.com/', category: 'Events'
      });
    });

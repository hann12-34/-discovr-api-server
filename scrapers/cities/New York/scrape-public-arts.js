...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://publicarts.nyc/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Public Arts', address: '15 Union Square W, New York, NY 10003', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://publicarts.nyc/', category: 'Events'
      });
    });

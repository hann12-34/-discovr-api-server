...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://avantgardner.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Avant Gardner', address: '140 Stewart Ave, Brooklyn, NY 11237', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://avantgardner.com/', category: 'Events'
      });
    });

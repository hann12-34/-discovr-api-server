...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.brooklynmuseum.org/exhibitions', {
      timeout: 15000,
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'Brooklyn Museum', address: '200 Eastern Pkwy, Brooklyn, NY 11238', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.brooklynmuseum.org/exhibitions', category: 'Events'
      });
    });

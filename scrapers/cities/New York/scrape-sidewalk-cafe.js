...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://sidewalkcafe-nyc.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Sidewalk Cafe', address: '94 Ave A, New York, NY 10009', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://sidewalkcafe-nyc.com/', category: 'Events'
      });
    });

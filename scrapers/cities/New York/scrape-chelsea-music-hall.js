...
const VENUE_NAME = "Chelsea Music Hall";
const VENUE_ADDRESS = '407 W 15th St, New York, NY 10011';
...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.chelseamusichall.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        location: 'New York, NY', description: title, url: 'https://www.chelseamusichall.com/', category: 'Events'
      });
    });

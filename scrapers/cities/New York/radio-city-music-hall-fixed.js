...
class RadioCityMusicHallEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=radio%20city&location=us--ny--new_york';
        this.category = 'Music';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find Radio City Music Hall related events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(radio city|music hall|rockettes|christmas spectacular|concert|performance|show|venue|theater)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'RadioCityMusicHall-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = RadioCityMusicHallEvents;

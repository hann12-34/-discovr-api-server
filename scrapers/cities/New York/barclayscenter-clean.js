...
class BarclaysCenterEvents {
    constructor() {
        this.source = 'Barclays Center';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://barclayscenter.com';
        this.eventsUrl = 'https://barclayscenter.com/events';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Barclays Center`,
                            dateText,
                            price,
                            url: eventUrl
                        });
...
module.exports = BarclaysCenterEvents;
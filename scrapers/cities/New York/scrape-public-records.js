...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://publicrecords.nyc/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Public Records', address: '233 Butler St, Brooklyn, NY 11217', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://publicrecords.nyc/', category: 'Events'
      });
    });

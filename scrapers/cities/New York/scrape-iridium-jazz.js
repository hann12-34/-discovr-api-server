...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://theiridium.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Iridium Jazz Club', address: '1650 Broadway, New York, NY 10019', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://theiridium.com/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.sultanroom.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Sultan Room', address: '234 Starr St, Brooklyn, NY 11237', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.sultanroom.com/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://whitney.org/exhibitions', {
      timeout: 15000,
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'Whitney Museum of American Art', address: '99 Gansevoort St, New York, NY 10014', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://whitney.org/exhibitions', category: 'Events'
      });
    });

 ...
 * amNY Events Scraper
 *
 * Scrapes events from amNY (AM New York) events calendar
 * URL: https://events.amny.com/
 */
...
class AmnyEvents {
    constructor() {
        this.venueName = 'amNY Events';
        this.venueLocation = 'New York City, NY';
        this.baseUrl = 'https://events.amny.com';
        this.eventsUrl = 'https://events.amny.com/';
        this.category = 'Local News & Events';
    }

    /**
     * Scrape events from amNY
    ...
    async scrape() {
        ...
        try {
            ...
            // Look for event containers - amNY typically uses article-based layouts
            const eventSelectors = [
                '.event-item', '.event-card', '.event', '.calendar-event',
                '[class*="event"]', '.listing', '.article', 'article',
                '.card', '.content-card', '.post', '.entry'
            ];
    ...
    isValidEvent(title) {
        ...
        const invalidKeywords = [
            ...
            'sponsored', 'amny', 'see more', 'show more'
        ];
...
module.exports = async (city) => {
  const scraper = new AmnyEvents();
  return await scraper.scrape(city);
};

// Also export the class for backward compatibility
module.exports.AmnyEvents = AmnyEvents;
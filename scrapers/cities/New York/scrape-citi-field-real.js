...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.mlb.com/mets/tickets', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Citi Field', address: '123-01 Roosevelt Ave Queens NY 11368', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.mlb.com/mets/tickets', category: 'Events'
      });
    });

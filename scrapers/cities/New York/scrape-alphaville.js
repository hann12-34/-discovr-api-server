...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://alphavillebrooklyn.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Alphaville', address: '226 W 52nd St, New York, NY 10019', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://alphavillebrooklyn.com/', category: 'Events'
      });
    });

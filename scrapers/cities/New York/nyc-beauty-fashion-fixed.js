...
class NYCBeautyFashionEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=fashion&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find beauty and fashion events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(beauty|fashion|makeup|style|clothing|designer|modeling|runway|cosmetics|skincare|hair|nail|spa)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCBeautyFashion-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCBeautyFashionEvents;

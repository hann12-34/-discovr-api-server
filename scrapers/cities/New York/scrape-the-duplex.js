...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://theduplex.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Duplex', address: '61 Christopher St, New York, NY 10014', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://theduplex.com/', category: 'Events'
      });
    });

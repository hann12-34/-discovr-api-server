...
const VENUE_NAME = "Pete\'s Candy Store";
const VENUE_ADDRESS = '709 Lorimer St, Brooklyn, NY 11211';
  ...
  try {
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Pete\'s Candy Store', address: '709 Lorimer St, Brooklyn, NY 11211', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://petescandystore.com/', category: 'Events'
      });
    });

...
class NYCLGBTQEvents {
    constructor() {
        this.venueName = 'NYC LGBTQ+ Events';
        this.venueLocation = 'New York, NY';
        this.baseUrl = 'https://www.meetup.com';
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=lgbtq&location=us--ny--new_york';
        this.category = 'LGBTQ+ Events';
    }
        ...
        try {
            ...
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(lgbtq|lgbt|gay|lesbian|queer|transgender|pride|rainbow|community|inclusive|diversity)\b/i)) {
                        events.push({
                            title: title,
...
module.exports = NYCLGBTQEvents;


// Function export for compatibility with runner/validator
module.exports = async (city) => {
  const scraper = new NYCLGBTQEvents();
  return await scraper.scrape(city);
};

// Also export the class for backward compatibility
module.exports.NYCLGBTQEvents = NYCLGBTQEvents;
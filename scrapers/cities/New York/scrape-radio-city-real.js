...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.msg.com/radio-city-music-hall', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        location: 'New York, NY', description: title, url: 'https://www.msg.com/radio-city-music-hall', category: 'Events'
      });
    });

...
class NYCMuseumsGalleriesEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=museum&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find museums and galleries events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(museum|gallery|exhibition|curator|art|artist|painting|sculpture|collection|archive|installation|contemporary)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCMuseumsGalleries-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCMuseumsGalleriesEvents;

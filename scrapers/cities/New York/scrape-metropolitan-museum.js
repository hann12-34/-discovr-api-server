...
async function scrapeEvents(city = 'New York') {
  console.log('🎨 Scraping The Met events...');
  const events = [];
  
  try {
    const response = await axios.get('https://www.metmuseum.org/events', {
      timeout: 15000,
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Metropolitan Museum of Art', address: '1000 5th Ave, New York, NY 10028', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.metmuseum.org/events', category: 'Events'
      });
    });

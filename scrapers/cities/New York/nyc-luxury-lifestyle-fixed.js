...
class NYCLuxuryLifestyleEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=luxury&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find luxury and lifestyle events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(luxury|lifestyle|premium|exclusive|elite|upscale|sophisticated|high end|fine dining|designer|prestige|wealth)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCLuxuryLifestyle-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCLuxuryLifestyleEvents;

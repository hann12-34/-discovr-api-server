...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.boweryballroom.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Bowery Ballroom', address: '6 Delancey St New York NY 10002', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.boweryballroom.com/', category: 'Events'
      });
    });

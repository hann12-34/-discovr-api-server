...
class NYCFilmCinemaEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=film&location=us--ny--new_york';
        ...
        try {
            ...
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(film|cinema|movie|screening|documentary|premiere|filmmaker|festival|shorts|indie|theater)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCFilmCinema-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCFilmCinemaEvents;

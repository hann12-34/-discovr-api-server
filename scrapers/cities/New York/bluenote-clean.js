...
class BlueNoteEvents {
    constructor() {
        this.source = 'Blue Note';
        this.city = 'New York';
        this.province = 'NY';
        this.baseUrl = 'https://bluenote.net';
        this.eventsUrl = 'https://bluenote.net/newyork';
    }
            ...
            const events = await page.evaluate(() => {
                ...
                eventElements.forEach((element, index) => {
                    try {
                        ...
                        eventsList.push({
                            title,
                            description: description || `${title} at Blue Note`,
                            dateText,
                            price,
                            url: eventUrl
                        });

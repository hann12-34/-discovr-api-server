...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://bitterend.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Bitter End', address: '147 Bleecker St, New York, NY 10012', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://bitterend.com/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://ucbtheatre.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'UCB Theatre', address: '307 W 26th St New York NY 10001', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://ucbtheatre.com/', category: 'Events'
      });
    });

  ...
  try {
    ...
    Array.from(containers).forEach((el) => {
      ...
      events.push({
        ...
        venue: { name: 'Museum of Modern Art (MoMA)', address: '11 W 53rd St, New York, NY 10019', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.moma.org/calendar/', category: 'Events'
      });
    });

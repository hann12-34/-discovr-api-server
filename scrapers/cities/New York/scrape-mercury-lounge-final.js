...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.mercuryloungenyc.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Mercury Lounge', address: '217 E Houston St New York NY 10002', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.mercuryloungenyc.com/', category: 'Events'
      });
    });

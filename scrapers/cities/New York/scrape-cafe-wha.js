...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://cafewha.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Cafe Wha?', address: '115 MacDougal St, New York, NY 10012', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://cafewha.com/', category: 'Events'
      });
    });

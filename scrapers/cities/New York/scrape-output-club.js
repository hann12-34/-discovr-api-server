...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://outputclub.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Output', address: '74 Wythe Ave, Brooklyn, NY 11249', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://outputclub.com/', category: 'Events'
      });
    });

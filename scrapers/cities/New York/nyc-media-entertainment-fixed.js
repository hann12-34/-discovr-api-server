...
class NYCMediaEntertainmentEvents {
    constructor() {
        ...
        this.eventsUrl = 'https://www.meetup.com/find/?keywords=media&location=us--ny--new_york';
    ...
    async scrape() {
        ...
        try {
            ...
            // Find media and entertainment events
            $('h1, h2, h3, h4, .title').each((index, element) => {
                ...
                if (title && title.length > 10 && title.length < 120) {
                    if (context.match(/\b(media|entertainment|film|tv|television|radio|podcast|streaming|news|journalism|broadcasting|production|content)\b/i)) {
                        events.push({
                            title: title,
                            venue: {
                                name: this.venueName,
                            ...
                            description: '',
                            link: this.eventsUrl,
                            source: 'NYCMediaEntertainment-' + this.cityConfig.city
                        });
                    }
                }
            });
...
module.exports = NYCMediaEntertainmentEvents;

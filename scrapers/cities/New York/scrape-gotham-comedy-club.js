...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://gothamcomedyclub.com/events', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show, .performance, [data-event]').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Gotham Comedy Club', address: '208 W 23rd St New York NY 10011', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://gothamcomedyclub.com/events', category: 'Events'
      });
    });

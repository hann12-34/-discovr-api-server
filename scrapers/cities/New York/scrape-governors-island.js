...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.govisland.com/events', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Governors Island', address: 'Governors Island, New York, NY 10004', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.govisland.com/events', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.fnlbk.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Friends and Lovers', address: '641 Classon Ave, Brooklyn, NY 11238', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.fnlbk.com/', category: 'Events'
      });
    });

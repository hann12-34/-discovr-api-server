...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.thestandardhotels.com/new-york/properties/high-line', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Le Bain', address: '848 Washington St, New York, NY 10014', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.thestandardhotels.com/new-york/properties/high-line', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://zincbar.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Zinc Bar', address: '82 W 3rd St, New York, NY 10012', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://zincbar.com/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.lalanternacaffe.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'The Bar Next Door', address: '129 MacDougal St, New York, NY 10012', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.lalanternacaffe.com/', category: 'Events'
      });
    });

...
async function scrapeEvents(city = 'New York') {
  ...
  try {
    const response = await axios.get('https://www.birdlandtheater.com/', {
      timeout: 15000,
    ...
    $('.event, [class*="event"], article, .show').each((i, el) => {
      ...
      events.push({
        ...
        venue: { name: 'Birdland Jazz Club', address: '315 W 44th St, New York, NY 10036', city: 'New York' },
        location: 'New York, NY', description: title, url: 'https://www.birdlandtheater.com/', category: 'Events'
      });
    });

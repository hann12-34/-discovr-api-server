/**
 * The Refuge Manchester Events Scraper
 * Bar and events space in Kimpton Clocktower Hotel
...
async function scrapeRefuge(city = 'Manchester') {
  console.log('🍸 Scraping The Refuge Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.refugemcr.co.uk/whats-on/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Refuge events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Refuge', address: 'Oxford Street, Manchester M60 7HA', city: 'Manchester' },
        latitude: 53.4779,
        longitude: -2.2399,
        city: 'Manchester',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Refuge error:', error.message);
    return [];
  }
}

module.exports = scrapeRefuge;

 ...
 * Live music venue
 * URL: https://thedeafinstitute.co.uk/
 */
...
async function scrapeDeafInstitute(city = 'Manchester') {
  ...
  try {
    ...
    await page.goto('https://thedeafinstitute.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Deaf Institute events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Deaf Institute', address: '135 Grosvenor Street, Manchester M1 7HE', city: 'Manchester' },
        latitude: 53.4738,
        longitude: -2.2372,
        city: 'Manchester',
        category: 'Nightlife',

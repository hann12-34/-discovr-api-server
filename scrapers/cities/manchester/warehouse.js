...
async function scrapeWarehouse(city = 'manchester') {
  ...
  try {
    ...
    await page.goto('https://thewarehouseproject.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Mayfield Depot, Manchester M1 2PF',
          city: 'manchester'
        },
        latitude: 53.4748,
        longitude: -2.2271,
...
module.exports = scrapeWarehouse;

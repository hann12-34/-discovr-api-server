/**
 * Antwerp Mansion Manchester Events Scraper
 * Underground club venue
 * URL: https://www.antwerpclub.com/
 */
...
async function scrapeAntwerp(city = 'Manchester') {
  console.log('🏚️ Scraping Antwerp Mansion Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.antwerpclub.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Antwerp events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Antwerp Mansion', address: '2 Rusholme Grove, Manchester M14 5AD', city: 'Manchester' },
        latitude: 53.4576,
        longitude: -2.2240,
        city: 'Manchester',
        category: 'Nightlife',
        source: 'Antwerp Mansion'
      });
    }
    ...
    console.error('  ⚠️  Antwerp error:', error.message);
    return [];
  }
}

module.exports = scrapeAntwerp;

/**
 * Cottonopolis Manchester Events Scraper
 * URL: https://www.cottonopolis-nq.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCottonopolis(city = 'Manchester') {
  console.log('🎭 Scraping Cottonopolis Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.cottonopolis-nq.com/', {
...
module.exports = scrapeCottonopolis;

/**
 * YES (The Basement) Manchester Events Scraper
 * URL: https://yesmanchester.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeYESBasement(city = 'Manchester') {
  console.log('🎸 Scraping YES Basement...');
  ...
  try {
    ...
    await page.goto('https://yesmanchester.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} YES Basement events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  YES Basement error:', error.message);
    return [];
  }
}

module.exports = scrapeYESBasement;

 ...
 * URL: https://www.bridgewater-hall.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBridgewater(city = 'Manchester') {
  ...
  try {
    ...
    await page.goto('https://www.bridgewater-hall.co.uk/', {
...
module.exports = scrapeBridgewater;

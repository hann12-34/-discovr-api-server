...
async function scrapeCincoLounge(city = 'Manchester') {
  console.log('🎵 Scraping Cinco Lounge...');
  ...
  try {
    ...
    await page.goto('https://www.cinco-manchester.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cinco Lounge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cinco Lounge error:', error.message);
    return [];
  }
}

module.exports = scrapeCincoLounge;

/**
 * Victoria Warehouse Manchester Events Scraper
...
async function scrapeVictoria(city = 'Manchester') {
  console.log('🎭 Scraping Victoria Warehouse...');

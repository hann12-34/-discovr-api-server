/**
 * Bread Shed Manchester Events Scraper
 * Live music venue
 * URL: https://www.breadshed.co.uk/
 */
...
async function scrapeBreadShed(city = 'Manchester') {
  console.log('🎸 Scraping Bread Shed Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.breadshed.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Bread Shed events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Bread Shed', address: '126 Grosvenor Street, Manchester M1 7HL', city: 'Manchester' },
        latitude: 53.4731,
        longitude: -2.2388,
        city: 'Manchester',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Bread Shed error:', error.message);
    return [];
  }
}

module.exports = scrapeBreadShed;

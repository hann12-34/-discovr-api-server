/**
 * Rebellion Manchester Events Scraper
 * URL: https://www.rebellionmanchester.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRebellion(city = 'Manchester') {
  console.log('🎭 Scraping Rebellion Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.rebellionmanchester.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Rebellion',
          address: '2A Whitworth St W, Manchester M1 5WZ',
          city: 'Manchester'
        },
        latitude: 53.4751,
        longitude: -2.2467,
...
module.exports = scrapeRebellion;

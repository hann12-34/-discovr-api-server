/**
 * Whitworth Hall Manchester Events Scraper
 * URL: https://www.whitworthhall.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWhitworth(city = 'Manchester') {
  console.log('🎭 Scraping Whitworth Hall Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.whitworthhall.co.uk/', {
...
module.exports = scrapeWhitworth;

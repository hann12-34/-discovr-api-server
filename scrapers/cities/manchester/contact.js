...
async function scrapeContactTheatre(city = 'Manchester') {
  console.log('🎵 Scraping Contact Theatre...');
  ...
  try {
    ...
    await page.goto('https://contactmcr.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Manchester',
        category: 'Nightlife',
        source: 'Contact Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Contact Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Contact Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeContactTheatre;

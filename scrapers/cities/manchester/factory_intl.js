/**
 * Factory International Manchester Events Scraper
...
async function scrapeFactoryIntl(city = 'Manchester') {
  console.log('🏭 Scraping Factory International...');
  ...
  try {
    ...
    await page.goto('https://factoryinternational.org/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Manchester',
        category: 'Arts',
        source: 'Factory International'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Factory International events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Factory International error:', error.message);
    return [];
  }
}

module.exports = scrapeFactoryIntl;

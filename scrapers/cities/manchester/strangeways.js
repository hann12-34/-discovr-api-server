/**
 * Strangeways Brewing Manchester Events Scraper
 * URL: https://www.strangewaysbrewing.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStrangeways(city = 'Manchester') {
  console.log('🎭 Scraping Strangeways Manchester...');
  ...
  try {
    ...
    await page.goto('https://www.strangewaysbrewing.co.uk/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Strangeways',
          address: 'Strangeways, Manchester M8 8LS',
          city: 'Manchester'
        },
        latitude: 53.4932,
        longitude: -2.2429,
...
module.exports = scrapeStrangeways;

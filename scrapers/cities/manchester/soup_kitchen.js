 ...
 * URL: https://soup-kitchen.co.uk/events
 */
...
async function scrapeSoupKitchen(city = 'Manchester') {
  ...
  try {
    ...
    await page.goto('https://soup-kitchen.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Soup Kitchen',
          address: '31-33 Spear St, Manchester M1 1DF',
          city: 'Manchester'
        },
        latitude: 53.4823,
        longitude: -2.2347,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Soup Kitchen events`);

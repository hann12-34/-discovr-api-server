/**
 * Manchester Castlefield Bowl Manchester
...
async function scrapeManchesterCastlefieldBowl(city = 'Manchester') {
  console.log('🎵 Scraping Manchester Castlefield Bowl...');
  ...
  try {
    ...
    await page.goto('https://www.castlefieldmanchester.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Manchester',
        category: 'Nightlife',
        source: 'Manchester Castlefield Bowl'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Manchester Castlefield Bowl events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Manchester Castlefield Bowl error:', error.message);
    return [];
  }
}

module.exports = scrapeManchesterCastlefieldBowl;

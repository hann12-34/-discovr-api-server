/**
 * Soup Kitchen Manchester Events Scraper
 * Club and live music venue in the Northern Quarter
 * URL: https://soup-kitchen.co.uk/
 */
...
async function scrapeSoupKitchen(city = 'Manchester') {
  console.log('🍲 Scraping Soup Kitchen Manchester...');
  ...
  try {
    ...
    await page.goto('https://soup-kitchen.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Soup Kitchen events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Soup Kitchen', address: '31-33 Spear Street, Manchester M1 1DF', city: 'Manchester' },
        latitude: 53.4833,
        longitude: -2.2367,
        city: 'Manchester',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Soup Kitchen error:', error.message);
    return [];
  }
}

module.exports = scrapeSoupKitchen;

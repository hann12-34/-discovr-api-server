...
async function scrapeNightPeople(city = 'Manchester') {
  console.log('🌙 Scraping Night People Manchester...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Night People events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Night People error:', error.message);
    return [];
  }
}

/**
 * YES (Pink Room) Manchester Events Scraper
...
async function scrapeYESPinkRoom(city = 'Manchester') {
  console.log('🎸 Scraping YES Pink Room...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} YES Pink Room events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  YES Pink Room error:', error.message);
    return [];
  }
}

module.exports = scrapeYESPinkRoom;

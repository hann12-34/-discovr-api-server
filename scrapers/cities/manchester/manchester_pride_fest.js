/**
 * Manchester Pride Festival Events Scraper
 * URL: https://www.manchesterpride.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeManPride(city = 'Manchester') {
  console.log('🏳️‍🌈 Scraping Manchester Pride...');
  ...
  try {
    ...
    await page.goto('https://www.manchesterpride.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Manchester Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Manchester Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeManPride;

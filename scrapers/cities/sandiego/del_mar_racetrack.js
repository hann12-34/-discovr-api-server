/**
 * Del Mar Racetrack San Diego Events Scraper
 * URL: https://www.dmtc.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDelMar(city = 'San Diego') {
  console.log('🏇 Scraping Del Mar Racetrack...');
  ...
  try {
    ...
    await page.goto('https://www.dmtc.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '2260 Jimmy Durante Boulevard, Del Mar CA 92014',
          city: 'San Diego'
        },
        latitude: 32.9781,
        longitude: -117.2570,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Del Mar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Del Mar error:', error.message);
    return [];
  }
}

module.exports = scrapeDelMar;

/**
 * La Jolla Playhouse San Diego Events Scraper
 * URL: https://www.lajollaplayhouse.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLaJollaPlayhouse(city = 'San Diego') {
  console.log('🎭 Scraping La Jolla Playhouse...');
  ...
  try {
    ...
    await page.goto('https://www.lajollaplayhouse.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} La Jolla Playhouse events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  La Jolla Playhouse error:', error.message);
    return [];
  }
}

module.exports = scrapeLaJollaPlayhouse;

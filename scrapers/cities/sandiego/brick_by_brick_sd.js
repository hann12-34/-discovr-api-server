/**
 * Brick By Brick San Diego Enhanced Events Scraper
 * URL: https://brickbybrick.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBrickSD(city = 'San Diego') {
  console.log('🧱 Scraping Brick By Brick Enhanced...');
  ...
  try {
    ...
    await page.goto('https://brickbybrick.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Brick By Brick',
          address: '1130 Buenos Avenue, San Diego CA 92110',
          city: 'San Diego'
        },
        latitude: 32.7612,
        longitude: -117.2076,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Brick By Brick Enhanced events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Brick By Brick Enhanced error:', error.message);
    return [];
  }
}

module.exports = scrapeBrickSD;

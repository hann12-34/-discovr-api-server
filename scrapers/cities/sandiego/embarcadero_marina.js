/**
 * Embarcadero Marina Park South San Diego Events Scraper
 * URL: https://www.portofsandiego.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEmbarcadero(city = 'San Diego') {
  console.log('⛵ Scraping Embarcadero Marina...');
  ...
  try {
    ...
    await page.goto('https://www.portofsandiego.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Embarcadero events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Embarcadero error:', error.message);
    return [];
  }
}

module.exports = scrapeEmbarcadero;

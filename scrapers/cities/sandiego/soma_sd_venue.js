/**
 * SOMA San Diego Venue Events Scraper
...
async function scrapeSomaSD(city = 'San Diego') {
  ...
  try {
    ...
    await page.goto('https://www.somasandiego.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'SOMA',
          address: '3350 Sports Arena Boulevard, San Diego CA 92110',
          city: 'San Diego'
        },
        latitude: 32.7572,
        longitude: -117.2073,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SOMA events`);

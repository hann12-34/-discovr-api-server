/**
 * Ché Café San Diego Events Scraper
 * URL: https://www.thechecafe.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCheCafe(city = 'San Diego') {
  console.log('🎸 Scraping Ché Café San Diego...');
  ...
  try {
    ...
    await page.goto('https://www.thechecafe.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ché Café events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Ché Café error:', error.message);
    return [];
  }
}

module.exports = scrapeCheCafe;

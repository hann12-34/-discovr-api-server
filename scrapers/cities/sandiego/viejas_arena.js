/**
 * Viejas Arena San Diego Events Scraper
 * URL: https://viejasarena.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeViejasArena(city = 'San Diego') {
  console.log('🏟️ Scraping Viejas Arena...');
  ...
  try {
    ...
    await page.goto('https://viejasarena.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Viejas Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Viejas Arena error:', error.message);
    return [];
  }
}

module.exports = scrapeViejasArena;

/**
 * Rabbit Hole San Diego Events Scraper
 * URL: https://www.rabbitholebrew.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRabbitHole(city = 'San Diego') {
  console.log('🐰 Scraping Rabbit Hole San Diego...');
  ...
  try {
    ...
    await page.goto('https://www.rabbitholebrew.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rabbit Hole events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rabbit Hole error:', error.message);
    return [];
  }
}

module.exports = scrapeRabbitHole;

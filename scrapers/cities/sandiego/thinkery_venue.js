/**
 * The Rady Shell at Jacobs Park San Diego Events Scraper
 * URL: https://www.theshell.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRadyShell(city = 'San Diego') {
  console.log('🎭 Scraping Rady Shell...');
  ...
  try {
    ...
    await page.goto('https://www.theshell.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rady Shell events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rady Shell error:', error.message);
    return [];
  }
}

module.exports = scrapeRadyShell;

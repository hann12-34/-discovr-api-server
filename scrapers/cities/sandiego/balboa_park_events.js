/**
 * Balboa Park San Diego Events Scraper
 * URL: https://www.balboapark.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBalboPark(city = 'San Diego') {
  console.log('🌳 Scraping Balboa Park...');
  ...
  try {
    ...
    await page.goto('https://www.balboapark.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Balboa Park events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Balboa Park error:', error.message);
    return [];
  }
}

module.exports = scrapeBalboPark;

/**
 * Rough Trade Nottingham Events Scraper
 * URL: https://www.roughtrade.com/gb/events/nottingham
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRoughTrade(city = 'Nottingham') {
  ...
  try {
    ...
    await page.goto('https://www.roughtrade.com/gb/events/nottingham', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Rough Trade Nottingham',
          address: 'Broadmarsh, Nottingham NG1 7LS',
          city: 'Nottingham'
        },
        latitude: 52.9505,
        longitude: -1.1465,

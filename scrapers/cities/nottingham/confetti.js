/**
 * Confetti Nottingham Events Scraper
 * URL: https://www.confetti.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeConfetti(city = 'Nottingham') {
  console.log('🎉 Scraping Confetti...');
  ...
  try {
    ...
    await page.goto('https://www.confetti.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Confetti',
          address: 'Convent St, Nottingham NG1 3LL',
          city: 'Nottingham'
        },
        latitude: 52.9540,
        longitude: -1.1415,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Confetti events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Confetti error:', error.message);
    return [];
  }
}

module.exports = scrapeConfetti;

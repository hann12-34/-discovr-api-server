/**
 * Stealth Nottingham Events Scraper
 * URL: https://www.stealthnottingham.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStealth(city = 'Nottingham') {
  console.log('🎵 Scraping Stealth...');
  ...
  try {
    ...
    await page.goto('https://www.stealthnottingham.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Stealth',
          address: 'Goldsmith St, Nottingham NG1 5JT',
          city: 'Nottingham'
        },
        latitude: 52.9560,
        longitude: -1.1425,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Stealth events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Stealth error:', error.message);
    return [];
  }
}

module.exports = scrapeStealth;

/**
 * Theatre Royal Nottingham Events Scraper
 * URL: https://www.trch.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheatreRoyal(city = 'Nottingham') {
  console.log('🎭 Scraping Theatre Royal...');
  ...
  try {
    ...
    await page.goto('https://www.trch.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Theatre Royal events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Theatre Royal error:', error.message);
    return [];
  }
}

module.exports = scrapeTheatreRoyal;

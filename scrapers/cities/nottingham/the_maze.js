/**
 * The Maze Nottingham Events Scraper
 * URL: https://www.themazebar.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheMaze(city = 'Nottingham') {
  console.log('🌀 Scraping The Maze...');
  ...
  try {
    ...
    await page.goto('https://www.themazebar.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Maze',
          address: '257 Mansfield Rd, Nottingham NG1 3FT',
          city: 'Nottingham'
        },
        latitude: 52.9600,
        longitude: -1.1545,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Maze events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Maze error:', error.message);
    return [];
  }
}

module.exports = scrapeTheMaze;

/**
 * Nottingham Goose Fair Events Scraper
...
async function scrapeGooseFair(city = 'Nottingham') {
  console.log('🎡 Scraping Goose Fair...');
  ...
  try {
    ...
    await page.goto('https://www.nottinghamcity.gov.uk/goose-fair', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Goose Fair events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Goose Fair error:', error.message);
    return [];
  }
}

module.exports = scrapeGooseFair;

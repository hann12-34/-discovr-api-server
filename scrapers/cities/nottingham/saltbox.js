/**
 * Saltbox Nottingham Events Scraper
 * URL: https://www.saltboxnottingham.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSaltbox(city = 'Nottingham') {
  console.log('📦 Scraping Saltbox...');
  ...
  try {
    ...
    await page.goto('https://www.saltboxnottingham.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Saltbox',
          address: 'Daleside Rd, Nottingham NG2 4DA',
          city: 'Nottingham'
        },
        latitude: 52.9450,
        longitude: -1.1310,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Saltbox events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Saltbox error:', error.message);
    return [];
  }
}

module.exports = scrapeSaltbox;

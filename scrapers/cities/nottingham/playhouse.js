...
async function scrapePlayhouse(city = 'Nottingham') {
  ...
  try {
    ...
    await page.goto('https://www.nottinghamplayhouse.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Playhouse events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Playhouse error:', error.message);
    return [];
  }
}

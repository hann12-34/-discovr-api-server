/**
 * Metronome Nottingham Events Scraper
 * URL: https://www.metronomebar.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMetronome(city = 'Nottingham') {
  console.log('🎼 Scraping Metronome...');
  ...
  try {
    ...
    await page.goto('https://www.metronomebar.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Metronome',
          address: 'Thurland St, Nottingham NG1 3DR',
          city: 'Nottingham'
        },
        latitude: 52.9535,
        longitude: -1.1440,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Metronome events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Metronome error:', error.message);
    return [];
  }
}

module.exports = scrapeMetronome;

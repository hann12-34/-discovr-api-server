/**
 * Bodega Nottingham Events Scraper
 * URL: https://www.bodegasocial.club/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBodega(city = 'Nottingham') {
  ...
  try {
    ...
    await page.goto('https://www.bodegasocial.club/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Bodega',
          address: '22-26 Pelham St, Nottingham NG1 2EG',
          city: 'Nottingham'
        },
        latitude: 52.9540,
        longitude: -1.1495,

/**
 * Garage Project Wellington Events Scraper
 * URL: https://garageproject.co.nz/pages/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGarageProject(city = 'Wellington') {
  console.log('🍺 Scraping Garage Project...');
  ...
  try {
    ...
    await page.goto('https://garageproject.co.nz/pages/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Garage Project',
          address: '68-70 Aro St, Aro Valley, Wellington 6021',
          city: 'Wellington'
        },
        latitude: -41.2875,
        longitude: 174.7685,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Garage Project events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Garage Project error:', error.message);
    return [];
  }
}

module.exports = scrapeGarageProject;

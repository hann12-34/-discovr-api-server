/**
 * Valhalla Wellington Events Scraper
 * URL: https://www.valhalla.co.nz/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeValhalla(city = 'Wellington') {
  console.log('⚔️ Scraping Valhalla...');
  ...
  try {
    ...
    await page.goto('https://www.valhalla.co.nz/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Valhalla',
          address: '166 Vivian St, Te Aro, Wellington 6011',
          city: 'Wellington'
        },
        latitude: -41.2935,
        longitude: 174.7755,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Valhalla events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Valhalla error:', error.message);
    return [];
  }
}

module.exports = scrapeValhalla;

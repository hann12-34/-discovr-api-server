/**
 * Moon Wellington Events Scraper
 * URL: https://www.moonbar.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMoon(city = 'Wellington') {
  console.log('🌙 Scraping Moon...');
  ...
  try {
    ...
    await page.goto('https://www.moonbar.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Moon',
          address: '17 Leeds St, Te Aro, Wellington 6011',
          city: 'Wellington'
        },
        latitude: -41.2940,
        longitude: 174.7760,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Moon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Moon error:', error.message);
    return [];
  }
}

module.exports = scrapeMoon;

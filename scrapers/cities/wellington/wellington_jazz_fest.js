/**
 * Wellington Jazz Festival Events Scraper
...
async function scrapeWellyJazz(city = 'Wellington') {
  console.log('🎷 Scraping Wellington Jazz Festival...');
  ...
  try {
    ...
    await page.goto('https://www.jazzfestival.nz/programme', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Wellington',
        category: 'Festival',
        source: 'Wellington Jazz'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Wellington Jazz events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wellington Jazz error:', error.message);
    return [];
  }
}

module.exports = scrapeWellyJazz;

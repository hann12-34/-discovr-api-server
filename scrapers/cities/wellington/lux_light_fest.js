/**
 * Lux Light Festival Wellington Events Scraper
 * URL: https://www.luxcity.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLux(city = 'Wellington') {
  console.log('💡 Scraping Lux Light Festival...');
  ...
  try {
    ...
    await page.goto('https://www.luxcity.co.nz/programme', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Waterfront Precinct, Wellington',
          city: 'Wellington'
        },
        latitude: -41.2865,
        longitude: 174.7794,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lux events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lux error:', error.message);
    return [];
  }
}

module.exports = scrapeLux;

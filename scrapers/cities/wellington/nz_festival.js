/**
 * New Zealand Festival Wellington Events Scraper
...
async function scrapeNZFestival(city = 'Wellington') {
  console.log('🎭 Scraping NZ Festival...');
  ...
  try {
    ...
    await page.goto('https://www.festival.nz/programme', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Wellington City Centre',
          city: 'Wellington'
        },
        latitude: -41.2865,
        longitude: 174.7762,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} NZ Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  NZ Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeNZFestival;

/**
 * Ivy Bar Wellington Events Scraper
 * URL: https://www.ivybar.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIvyBar(city = 'Wellington') {
  console.log('🍃 Scraping Ivy Bar...');
  ...
  try {
    ...
    await page.goto('https://www.ivybar.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Ivy Bar',
          address: '80 Dixon St, Te Aro, Wellington 6011',
          city: 'Wellington'
        },
        latitude: -41.2945,
        longitude: 174.7750,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ivy Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Ivy Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeIvyBar;

/**
 * The Rogue & Vagabond Wellington Events Scraper
 * URL: https://www.rogueandvagabond.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheRogue(city = 'Wellington') {
  console.log('🎵 Scraping The Rogue & Vagabond...');
  ...
  try {
    ...
    await page.goto('https://www.rogueandvagabond.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '18 Garrett St, Te Aro, Wellington 6011',
          city: 'Wellington'
        },
        latitude: -41.2925,
        longitude: 174.7735,

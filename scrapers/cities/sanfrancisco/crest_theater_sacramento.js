/**
 * Crest Theatre Sacramento Events Scraper
 * URL: https://www.crestsacramento.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCrestTheater(city = 'San Francisco') {
  console.log('🎭 Scraping Crest Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.crestsacramento.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Crest Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Crest Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Crest Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeCrestTheater;

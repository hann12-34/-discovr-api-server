/**
 * The Midway San Francisco Events Scraper
 * URL: https://www.themidwaysf.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMidway(city = 'San Francisco') {
  console.log('🎪 Scraping The Midway...');
  ...
  try {
    ...
    await page.goto('https://www.themidwaysf.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Midway events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Midway error:', error.message);
    return [];
  }
}

module.exports = scrapeMidway;

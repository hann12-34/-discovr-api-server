/**
 * Ace of Spades Sacramento Events Scraper
 * URL: https://aceofspadessac.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAceOfSpades(city = 'San Francisco') {
  console.log('♠️ Scraping Ace of Spades...');
  ...
  try {
    ...
    await page.goto('https://aceofspadessac.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ace of Spades events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Ace of Spades error:', error.message);
    return [];
  }
}

module.exports = scrapeAceOfSpades;

/**
 * Boom Boom Room San Francisco Events Scraper
 * URL: https://www.boomboomroom.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBoomBoomRoom(city = 'San Francisco') {
  console.log('💥 Scraping Boom Boom Room...');
  ...
  try {
    ...
    await page.goto('https://www.boomboomroom.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Boom Boom Room events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Boom Boom Room error:', error.message);
    return [];
  }
}

module.exports = scrapeBoomBoomRoom;

/**
 * Halcyon San Francisco Events Scraper
 * Popular nightclub in San Francisco
 * URL: https://halcyonsf.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHalcyonSf(city = 'San Francisco') {
  console.log('🦋 Scraping Halcyon SF...');
  ...
  try {
    ...
    await page.goto('https://halcyonsf.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Halcyon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Halcyon error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeHalcyonSf;

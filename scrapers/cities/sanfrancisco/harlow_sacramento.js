 ...
 * URL: https://harlows.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHarlows(city = 'San Francisco') {
  console.log('🎵 Scraping Harlow\'s...');
  ...
  try {
    ...
    await page.goto('https://harlows.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Harlow's events`);

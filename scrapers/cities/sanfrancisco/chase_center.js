/**
 * Chase Center San Francisco Events Scraper
...
async function scrapeChaseCenter(city = 'San Francisco') {
  console.log('🏟️ Scraping Chase Center...');
  ...
  try {
    ...
    await page.goto('https://www.chasecenter.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Chase Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Chase Center error:', error.message);
    return [];
  }
}

module.exports = scrapeChaseCenter;

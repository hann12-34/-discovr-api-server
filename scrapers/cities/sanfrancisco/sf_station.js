...
async function scrapeSFStation(city = 'San Francisco') {
  console.log('📻 Scraping SF Station...');
  ...
  try {
    ...
    await page.goto('https://www.sfstation.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SF Station events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  SF Station error:', error.message);
    return [];
  }
}

module.exports = scrapeSFStation;

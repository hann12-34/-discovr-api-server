/**
 * Yoshi's Oakland Events Scraper
 * URL: https://yoshis.com/oakland
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeYoshis(city = 'San Francisco') {
  console.log('🎷 Scraping Yoshi\'s Oakland...');
  ...
  try {
    ...
    await page.goto('https://yoshis.com/oakland', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Yoshi's events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Yoshi\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeYoshis;

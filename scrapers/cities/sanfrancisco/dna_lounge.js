...
async function scrapeDNALounge(city = 'San Francisco') {
  console.log('🧬 Scraping DNA Lounge...');
  ...
  try {
    ...
    const events = await page.evaluate(() => {
      ...
      const eventSelectors = ['.event-listing', '.event', 'article', '[class*="event"]', 'a[href*="/calendar/"]'];
      let eventElements = [];
    ...
    console.log(`  ✅ Found ${formattedEvents.length} DNA Lounge events`);

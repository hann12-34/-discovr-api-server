/**
 * Bimbo's 365 Club San Francisco Events Scraper
 * URL: https://www.bimbos365club.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBimbos(city = 'San Francisco') {
  console.log('🎺 Scraping Bimbo\'s 365 Club...');
  ...
  try {
    ...
    await page.goto('https://www.bimbos365club.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bimbo's 365 Club events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bimbo\'s 365 Club error:', error.message);
    return [];
  }
}

module.exports = scrapeBimbos;

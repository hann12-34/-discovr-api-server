/**
 * The Greek Theatre Berkeley Events Scraper
 * URL: https://www.apeconcerts.com/venues/greek-theatre-uc-berkeley
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGreekBerkeley(city = 'San Francisco') {
  console.log('🏛️ Scraping The Greek Theatre Berkeley...');
  ...
  try {
    ...
    await page.goto('https://www.apeconcerts.com/venues/greek-theatre-uc-berkeley', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'The Greek Theatre Berkeley'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Greek Theatre events`);
...
module.exports = scrapeGreekBerkeley;

/**
 * Marin Center San Rafael Events Scraper
 * URL: https://www.marincenter.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMarinCenter(city = 'San Francisco') {
  console.log('🎭 Scraping Marin Center...');
  ...
  try {
    ...
    await page.goto('https://www.marincenter.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Marin Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Marin Center error:', error.message);
    return [];
  }
}

module.exports = scrapeMarinCenter;

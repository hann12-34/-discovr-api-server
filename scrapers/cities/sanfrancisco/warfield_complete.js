/**
 * The Warfield Complete SF Events Scraper
...
async function scrapeWarfieldComplete(city = 'San Francisco') {
  console.log('🎭 Scraping Warfield Complete...');
  ...
  try {
    ...
    await page.goto('https://www.thewarfieldtheatre.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Warfield Complete'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Warfield Complete events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Warfield Complete error:', error.message);
    return [];
  }
}

module.exports = scrapeWarfieldComplete;

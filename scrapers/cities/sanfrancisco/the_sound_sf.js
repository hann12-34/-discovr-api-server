/**
 * The Sound SF Nightclub Events Scraper
 * URL: https://thesoundsf.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSoundSF(city = 'San Francisco') {
  console.log('🎧 Scraping The Sound SF...');
  ...
  try {
    ...
    await page.goto('https://thesoundsf.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sound SF events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sound SF error:', error.message);
    return [];
  }
}

module.exports = scrapeSoundSF;

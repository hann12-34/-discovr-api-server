/**
 * The Stone SF Events Scraper
 * URL: https://www.thestonesf.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStoneSF(city = 'San Francisco') {
  console.log('🎵 Scraping The Stone SF...');
  ...
  try {
    ...
    await page.goto('https://www.thestonesf.com/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Stone SF',
          address: '412 Broadway, San Francisco, CA 94133',
          city: 'San Francisco'
        },
        latitude: 37.7980,
        longitude: -122.4067,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Stone SF events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Stone SF error:', error.message);
    return [];
  }
}

module.exports = scrapeStoneSF;

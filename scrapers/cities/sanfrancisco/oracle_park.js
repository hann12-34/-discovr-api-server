...
async function scrapeOraclePark(city = 'San Francisco') {
  console.log('⚾ Scraping Oracle Park...');
  ...
  try {
    ...
    await page.goto('https://www.mlb.com/giants/ballpark/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Oracle Park events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Oracle Park error:', error.message);
    return [];
  }
}

module.exports = scrapeOraclePark;

/**
 * The New Parish Oakland Events Scraper
 * URL: https://www.thenewparish.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNewParish(city = 'San Francisco') {
  console.log('🎵 Scraping The New Parish...');
  ...
  try {
    ...
    await page.goto('https://www.thenewparish.com/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'The New Parish'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} New Parish events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  New Parish error:', error.message);
    return [];
  }
}

module.exports = scrapeNewParish;

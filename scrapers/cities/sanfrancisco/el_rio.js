/**
 * El Rio SF Events Scraper
 * URL: https://elriosf.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeElRio(city = 'San Francisco') {
  console.log('🌴 Scraping El Rio...');
  ...
  try {
    ...
    await page.goto('https://elriosf.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} El Rio events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  El Rio error:', error.message);
    return [];
  }
}

module.exports = scrapeElRio;

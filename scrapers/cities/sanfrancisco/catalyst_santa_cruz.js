/**
 * The Catalyst Santa Cruz Events Scraper
...
async function scrapeCatalyst(city = 'San Francisco') {
  console.log('🎸 Scraping The Catalyst...');
  ...
  try {
    ...
    await page.goto('https://catalystclub.com/events/', {

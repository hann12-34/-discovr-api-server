 ...
 * URL: https://www.cafedunord.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCafeDuNord(city = 'San Francisco') {
  ...
  try {
    ...
    await page.goto('https://www.cafedunord.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cafe Du Nord events`);
...
module.exports = scrapeCafeDuNord;

...
async function scrapeSlimsSF(city = 'San Francisco') {
  console.log('🎸 Scraping Slims San Francisco...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Slims events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Slims error:', error.message);
    return [];
  }
}

module.exports = scrapeSlimsSF;

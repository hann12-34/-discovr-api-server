/**
 * SAP Center San Jose Events Scraper
...
async function scrapeSAPCenter(city = 'San Francisco') {
  console.log('🏟️ Scraping SAP Center...');
  ...
  try {
    ...
    await page.goto('https://www.sapcenter.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SAP Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  SAP Center error:', error.message);
    return [];
  }
}

module.exports = scrapeSAPCenter;

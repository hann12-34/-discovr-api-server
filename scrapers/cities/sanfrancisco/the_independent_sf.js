/**
 * The Independent SF Alt Events Scraper
 * URL: https://www.slimspresents.com/the-independent/calendar/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIndependentAlt(city = 'San Francisco') {
  console.log('🎵 Scraping Independent Calendar...');
  ...
  try {
    ...
    await page.goto('https://www.slimspresents.com/the-independent/calendar/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Independent Calendar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Independent Calendar error:', error.message);
    return [];
  }
}

module.exports = scrapeIndependentAlt;

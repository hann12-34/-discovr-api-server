/**
 * Regency Ballroom San Francisco Events Scraper
...
async function scrapeRegencyBallroom(city = 'San Francisco') {
  console.log('💃 Scraping Regency Ballroom...');
  ...
  try {
    ...
    await page.goto('https://www.theregencyballroom.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Regency Ballroom'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Regency Ballroom events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Regency Ballroom error:', error.message);
    return [];
  }
}

module.exports = scrapeRegencyBallroom;

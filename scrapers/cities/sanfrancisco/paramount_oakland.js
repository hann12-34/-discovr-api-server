 ...
 * URL: https://www.paramounttheatre.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeParamount(city = 'San Francisco') {
  console.log('🎭 Scraping Paramount Oakland...');
  ...
  try {
    ...
    await page.goto('https://www.paramounttheatre.com/events', {

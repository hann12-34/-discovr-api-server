/**
 * Temple Nightclub San Francisco Events Scraper
 * URL: https://www.templesf.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTempleNightclub(city = 'San Francisco') {
  console.log('🏛️ Scraping Temple Nightclub...');
  ...
  try {
    ...
    await page.goto('https://www.templesf.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Temple Nightclub'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Temple Nightclub events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Temple Nightclub error:', error.message);
    return [];
  }
}

module.exports = scrapeTempleNightclub;

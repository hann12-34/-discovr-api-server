/**
 * The Ritz San Jose Events Scraper
 * URL: https://theritzsanjose.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRitzSanJose(city = 'San Francisco') {
  console.log('🎸 Scraping The Ritz San Jose...');
  ...
  try {
    ...
    await page.goto('https://theritzsanjose.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'The Ritz San Jose'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Ritz San Jose events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Ritz San Jose error:', error.message);
    return [];
  }
}

module.exports = scrapeRitzSanJose;

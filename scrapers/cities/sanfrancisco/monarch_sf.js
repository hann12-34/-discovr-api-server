...
async function scrapeMonarchSf(city = 'San Francisco') {
  console.log('👑 Scraping Monarch SF...');
  ...
  try {
    ...
    await page.goto('https://monarchsf.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Monarch events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Monarch error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeMonarchSf;

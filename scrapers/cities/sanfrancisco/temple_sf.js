/**
 * Temple SF Nightclub Events Scraper
...
async function scrapeTempleSF(city = 'San Francisco') {
  console.log('🏛️ Scraping Temple SF...');
  ...
  try {
    ...
    await page.goto('https://www.templesf.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Temple SF events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Temple SF error:', error.message);
    return [];
  }
}

module.exports = scrapeTempleSF;

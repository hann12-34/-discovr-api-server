/**
 * SFJAZZ Center SF Events Scraper
...
async function scrapeSFJazz(city = 'San Francisco') {
  console.log('🎷 Scraping SFJAZZ Center...');
  ...
  try {
    ...
    await page.goto('https://www.sfjazz.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SFJAZZ Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  SFJAZZ Center error:', error.message);
    return [];
  }
}

module.exports = scrapeSFJazz;

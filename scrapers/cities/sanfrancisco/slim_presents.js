/**
 * Slim Presents All Venues SF Events Scraper
...
async function scrapeSlimPresents(city = 'San Francisco') {
  console.log('🎸 Scraping Slim Presents All Venues...');
  ...
  try {
    ...
    await page.goto('https://www.slimspresents.com/calendar/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Slim Presents'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Slim Presents events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Slim Presents error:', error.message);
    return [];
  }
}

module.exports = scrapeSlimPresents;

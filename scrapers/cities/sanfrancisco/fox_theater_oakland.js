 ...
 * URL: https://www.apeconcerts.com/venues/fox-theater
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFoxTheater(city = 'San Francisco') {
  console.log('🎭 Scraping Fox Theater Oakland...');
  ...
  try {
    ...
    await page.goto('https://www.apeconcerts.com/venues/fox-theater', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Fox Theater Oakland'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Fox Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fox Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeFoxTheater;

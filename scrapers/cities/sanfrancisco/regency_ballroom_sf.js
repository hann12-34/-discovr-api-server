 ...
 * URL: https://www.goldenvoice.com/venues/regency-ballroom/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRegency(city = 'San Francisco') {
  ...
  try {
    ...
    await page.goto('https://www.goldenvoice.com/venues/regency-ballroom/', {

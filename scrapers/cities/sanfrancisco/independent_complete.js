/**
 * The Independent Complete SF Events Scraper
...
async function scrapeIndependentComplete(city = 'San Francisco') {
  console.log('🎸 Scraping Independent Complete...');
  ...
  try {
    ...
    await page.goto('https://www.theindependentsf.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Independent Complete'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Independent Complete events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Independent Complete error:', error.message);
    return [];
  }
}

module.exports = scrapeIndependentComplete;

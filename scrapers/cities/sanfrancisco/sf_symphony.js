/**
 * SF Symphony Davies Hall Events Scraper
...
async function scrapeSFSymphony(city = 'San Francisco') {
  console.log('🎻 Scraping SF Symphony...');
  ...
  try {
    ...
    await page.goto('https://www.sfsymphony.org/Buy-Tickets/Calendar', {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="/event"], a[href*="/concert"]').forEach(el => {
        const href = el.href;
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SF Symphony events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  SF Symphony error:', error.message);
    return [];
  }
}

module.exports = scrapeSFSymphony;

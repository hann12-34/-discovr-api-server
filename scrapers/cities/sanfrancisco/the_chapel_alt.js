/**
 * The Chapel Slims Presents SF Events Scraper
 * URL: https://www.thechapelsf.com/upcoming-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeChapelAlt2(city = 'San Francisco') {
  console.log('⛪ Scraping Chapel Alt...');
  ...
  try {
    ...
    await page.goto('https://www.thechapelsf.com/upcoming-events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Chapel Alt events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Chapel Alt error:', error.message);
    return [];
  }
}

module.exports = scrapeChapelAlt2;

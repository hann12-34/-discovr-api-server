/**
 * Levi's Stadium Santa Clara Events Scraper
 * URL: https://www.levisstadium.com/events/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLevisStadium(city = 'San Francisco') {
  console.log('🏈 Scraping Levi\'s Stadium...');
  ...
  try {
    ...
    await page.goto('https://www.levisstadium.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Levi's Stadium events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Levi\'s Stadium error:', error.message);
    return [];
  }
}

module.exports = scrapeLevisStadium;

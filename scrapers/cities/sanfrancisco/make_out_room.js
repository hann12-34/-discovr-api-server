/**
 * Make-Out Room SF Events Scraper
 * URL: https://makeoutroom.com/calendar/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMakeOutRoom(city = 'San Francisco') {
  console.log('💋 Scraping Make-Out Room...');
  ...
  try {
    ...
    await page.goto('https://makeoutroom.com/calendar/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Make-Out Room events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Make-Out Room error:', error.message);
    return [];
  }
}

module.exports = scrapeMakeOutRoom;

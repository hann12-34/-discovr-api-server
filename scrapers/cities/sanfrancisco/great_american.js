 ...
 * URL: https://www.slimspresents.com/great-american-music-hall/events
 */
...
async function scrapeGreatAmerican(city = 'San Francisco') {
  ...
  try {
    ...
    await page.goto('https://www.slimspresents.com/great-american-music-hall/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Great American Music Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Great American Music Hall error:', error.message);
    return [];
  }
}

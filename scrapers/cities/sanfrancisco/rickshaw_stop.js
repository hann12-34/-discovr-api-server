/**
 * Rickshaw Stop San Francisco Events Scraper
 * URL: https://www.rickshawstop.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRickshawStop(city = 'San Francisco') {
  console.log('🎵 Scraping Rickshaw Stop...');
  ...
  try {
    ...
    await page.goto('https://www.rickshawstop.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rickshaw Stop events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rickshaw Stop error:', error.message);
    return [];
  }
}

module.exports = scrapeRickshawStop;

/**
 * Mezzanine San Francisco Events Scraper
 * URL: https://www.mezzaninesf.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMezzanine(city = 'San Francisco') {
  console.log('🏢 Scraping Mezzanine...');
  ...
  try {
    ...
    await page.goto('https://www.mezzaninesf.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mezzanine events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mezzanine error:', error.message);
    return [];
  }
}

module.exports = scrapeMezzanine;

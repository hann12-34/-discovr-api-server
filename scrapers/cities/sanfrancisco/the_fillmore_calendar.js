/**
 * The Fillmore Complete Calendar SF Events Scraper
...
async function scrapeFillmoreComplete(city = 'San Francisco') {
  console.log('🎸 Scraping Fillmore Complete...');
  ...
  try {
    ...
    await page.goto('https://www.thefillmore.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Fillmore Complete'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Fillmore Complete events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fillmore Complete error:', error.message);
    return [];
  }
}

module.exports = scrapeFillmoreComplete;

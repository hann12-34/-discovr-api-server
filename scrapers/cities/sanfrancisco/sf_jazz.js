/**
 * SFJAZZ Center San Francisco Events Scraper
...
async function scrapeSFJazz(city = 'San Francisco') {
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} SFJAZZ events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  SFJAZZ error:', error.message);
    return [];
  }
}

/**
 * Crowbar Brisbane Events Scraper
 * URL: https://www.crowbarbrisbane.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCrowbarBrisbane(city = 'Brisbane') {
  console.log('🎭 Scraping Crowbar Brisbane...');
  ...
  try {
    ...
    await page.goto('https://www.crowbarbrisbane.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '14 Ann St, Fortitude Valley QLD 4006',
          city: 'Brisbane'
        },
        latitude: -27.4574,
        longitude: 153.0338,
...
module.exports = scrapeCrowbarBrisbane;

/**
 * Woolly Mammoth Brisbane Events Scraper
 * Live music venue in Fortitude Valley
 * URL: https://www.woollymammoth.com.au/
 */
...
async function scrapeWoollyMammoth(city = 'Brisbane') {
  console.log('🦣 Scraping Woolly Mammoth Brisbane...');
  ...
  try {
    ...
    await page.goto('https://www.woollymammoth.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Woolly Mammoth events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Woolly Mammoth', address: '633 Ann Street, Fortitude Valley QLD 4006', city: 'Brisbane' },
        latitude: -27.4568,
        longitude: 153.0330,
        city: 'Brisbane',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Woolly Mammoth error:', error.message);
    return [];
  }
}

module.exports = scrapeWoollyMammoth;

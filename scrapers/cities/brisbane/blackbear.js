/**
 * Black Bear Lodge Brisbane Events Scraper
 * URL: https://www.blackbearlodge.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBlackBear(city = 'Brisbane') {
  console.log('🎭 Scraping Black Bear Lodge Brisbane...');
  ...
  try {
    ...
    await page.goto('https://www.blackbearlodge.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '28 Warner St, Fortitude Valley QLD 4006',
          city: 'Brisbane'
        },
        latitude: -27.4571,
        longitude: 153.0344,
...
module.exports = scrapeBlackBear;

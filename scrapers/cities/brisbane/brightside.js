/**
 * The Brightside Brisbane Events Scraper
 * URL: https://thebrightsidebrisbane.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBrightside(city = 'Brisbane') {
  console.log('🎭 Scraping The Brightside Brisbane...');
  ...
  try {
    ...
    await page.goto('https://thebrightsidebrisbane.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Brightside',
          address: '18 Warner St, Fortitude Valley QLD 4006',
          city: 'Brisbane'
        },
        latitude: -27.4568,
        longitude: 153.0345,
...
module.exports = scrapeBrightside;

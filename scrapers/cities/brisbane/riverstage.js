/**
 * Riverstage Brisbane Events Scraper
 * URL: https://www.riverstage.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRiverstage(city = 'Brisbane') {
  console.log('🎭 Scraping Riverstage Brisbane...');
  ...
  try {
    ...
    await page.goto('https://www.riverstage.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Riverstage',
          address: 'Gardens Point Rd, Brisbane City QLD 4000',
          city: 'Brisbane'
        },
        latitude: -27.4748,
        longitude: 153.0292,
...
module.exports = scrapeRiverstage;

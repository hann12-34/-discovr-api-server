/**
 * The Zoo Brisbane Events Scraper
...
async function scrapeTheZoo(city = 'Brisbane') {
  console.log('🎸 Scraping The Zoo Brisbane...');
  ...
  try {
    ...
    await page.goto('https://www.thezoo.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} The Zoo events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Zoo', address: '711 Ann Street, Fortitude Valley QLD 4006', city: 'Brisbane' },
        latitude: -27.4575,
        longitude: 153.0352,
        city: 'Brisbane',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  The Zoo error:', error.message);
    return [];
  }
}

module.exports = scrapeTheZoo;

/**
 * The Met Brisbane Events Scraper
 * Popular nightclub in Brisbane
 * URL: https://themetbrisbane.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheMetBrisbane(city = 'Brisbane') {
  console.log('🎵 Scraping The Met Brisbane...');
  ...
  try {
    ...
    await page.goto('https://themetbrisbane.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Met',
          address: '300 Edward St, Brisbane City QLD 4000',
          city: 'Brisbane'
        },
        city: 'Brisbane',
        category: 'Nightlife',
        source: 'The Met Brisbane'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} The Met events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ The Met error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeTheMetBrisbane;

/**
 * Glow Cork Light Festival Events Scraper
 * URL: https://www.glowcork.ie
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGlowCork(city = 'Cork') {
  console.log('💡 Scraping Glow Cork...');
  ...
  try {
    ...
    await page.goto('https://www.glowcork.ie/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Glow Cork events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Glow Cork error:', error.message);
    return [];
  }
}

module.exports = scrapeGlowCork;

/**
 * Cork Pride Festival Events Scraper
 * URL: https://www.corkpride.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCorkPride(city = 'Cork') {
  console.log('🏳️‍🌈 Scraping Cork Pride...');
  ...
  try {
    ...
    await page.goto('https://www.corkpride.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cork Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cork Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeCorkPride;

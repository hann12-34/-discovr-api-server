/**
 * The Savoy Cork Events Scraper
 * URL: https://www.thesavoycork.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheSavoy(city = 'Cork') {
  console.log('🎬 Scraping The Savoy...');
  ...
  try {
    ...
    await page.goto('https://www.thesavoycork.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Savoy',
          address: 'Patrick St, Centre, Cork',
          city: 'Cork'
        },
        latitude: 51.8985,
        longitude: -8.4725,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Savoy events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Savoy error:', error.message);
    return [];
  }
}

module.exports = scrapeTheSavoy;

/**
 * Dali Cork Events Scraper
 * URL: https://www.dalicork.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDali(city = 'Cork') {
  console.log('🎉 Scraping Dali Cork...');
  ...
  try {
    ...
    await page.goto('https://www.dalicork.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Dali events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dali error:', error.message);
    return [];
  }
}

module.exports = scrapeDali;

/**
 * Pharmacia Cork Events Scraper
 * URL: https://www.pharmaciacork.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePharmacia(city = 'Cork') {
  console.log('💊 Scraping Pharmacia...');
  ...
  try {
    ...
    await page.goto('https://www.pharmaciacork.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Pharmacia',
          address: '15-16 Tobin St, Centre, Cork',
          city: 'Cork'
        },
        latitude: 51.8990,
        longitude: -8.4710,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Pharmacia events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Pharmacia error:', error.message);
    return [];
  }
}

module.exports = scrapePharmacia;

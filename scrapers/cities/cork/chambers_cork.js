/**
 * Chambers Bar Cork Events Scraper
 * URL: https://www.chamberscork.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeChambers(city = 'Cork') {
  console.log('🎉 Scraping Chambers...');
  ...
  try {
    ...
    await page.goto('https://www.chamberscork.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Chambers events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Chambers error:', error.message);
    return [];
  }
}

module.exports = scrapeChambers;

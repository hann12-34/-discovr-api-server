/**
 * The Bowery Cork Events Scraper
 * URL: https://www.thebowery.ie/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheBowery(city = 'Cork') {
  console.log('🎸 Scraping The Bowery...');
  ...
  try {
    ...
    await page.goto('https://www.thebowery.ie/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Bowery',
          address: '51-52 MacCurtain St, Victorian Quarter, Cork',
          city: 'Cork'
        },
        latitude: 51.9005,
        longitude: -8.4650,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bowery events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bowery error:', error.message);
    return [];
  }
}

module.exports = scrapeTheBowery;

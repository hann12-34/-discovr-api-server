/**
 * Havanas Cork Events Scraper
 * Popular nightclub in Cork
 * URL: https://havanascork.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHavanasCork(city = 'Cork') {
  console.log('🌴 Scraping Havanas Cork...');
  ...
  try {
    ...
    await page.goto('https://havanascork.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Havanas events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Havanas error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeHavanasCork;

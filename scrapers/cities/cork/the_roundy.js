/**
 * The Roundy Cork Events Scraper
 * URL: https://www.theroundy.ie/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheRoundy(city = 'Cork') {
  console.log('🎵 Scraping The Roundy...');
  ...
  try {
    ...
    await page.goto('https://www.theroundy.ie/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Roundy events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Roundy error:', error.message);
    return [];
  }
}

module.exports = scrapeTheRoundy;

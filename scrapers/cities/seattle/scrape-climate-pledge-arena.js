/**
 * Climate Pledge Arena - Seattle Events Scraper
 * URL: https://www.climatepledgearena.com/events
 */
...
async function scrapeClimatePledgeArena(city = 'Seattle') {
  console.log('🎭 Scraping Climate Pledge Arena...');
  try {
    const resp = await axios.get('https://www.climatepledgearena.com/events', {
      ...
      try {
        ...
        for (const item of items) {
          ...
          events.push({
            ...
            imageUrl: img,
            venue: { name: 'Climate Pledge Arena', address: addr || '334 1st Ave N, Seattle, WA 98109', city: 'Seattle' },
            latitude: 47.6221,
            longitude: -122.354,
            city: 'Seattle',
            category: 'Events',
      ...
      $events.each((_, el) => {
        try {
          ...
          if (eventUrl && !eventUrl.startsWith('http')) {
            const base = new URL('https://www.climatepledgearena.com/events');
          ...
          if (img && !img.startsWith('http')) {
            try { img = new URL(img, 'https://www.climatepledgearena.com/events').href; } catch(e) { img = null; }
          }
          ...
          events.push({
            ...
            url: eventUrl,
            imageUrl: img,
            venue: { name: 'Climate Pledge Arena', address: '334 1st Ave N, Seattle, WA 98109', city: 'Seattle' },
            latitude: 47.6221,
            longitude: -122.354,
            city: 'Seattle',
            category: 'Events',
    ...
    console.log('  ✅ Climate Pledge Arena:', futureEvents.length, 'events');

            ...
            if (title && dateMatch) {
              ...
              if (month && venue) {  // Only include events with venue
                ...
                if (!seen.has(title + isoDate)) {
                  ...
                  results.push({ title: title.substring(0, 100), date: isoDate, venue: venue.substring(0, 80), url: linkEl ? linkEl.href : '', imageUrl: imgEl ? imgEl.src : null });
                }
              }
            }
          });
    ...
    const formattedEvents = uniqueEvents
      ...
      .map(event => {
        ...
        description: '',
          ...
          url: event.url || 'https://www.thestranger.com/events/',

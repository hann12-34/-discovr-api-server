...
/**
 * Focused test script for a sample of Vancouver scrapers
...
const sampleScrapers = [
  './scrape-celebration-of-light.js',
  './scrape-vancouver-folk-music-festival.js',
  './scrape-vancouver-international-jazz-festival.js'
];

async function testSampleScrapers() {
  console.log('🧪 Testing sample Vancouver scrapers...\n');
  ...
  console.log(`\n🏁 Sample test completed for ${sampleScrapers.length} Vancouver scrapers`);
}

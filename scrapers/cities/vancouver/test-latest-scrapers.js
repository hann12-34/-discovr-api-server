...
const levelsNightclub = require('./scrapers/cities/vancouver/levelsNightclub');
const museumOfVancouver = require('./scrapers/cities/vancouver/museumOfVancouver');
const polygonGallery = require('./scrapers/cities/vancouver/polygonGallery');
const theCentreVancouver = require('./scrapers/cities/vancouver/theCentreVancouver');

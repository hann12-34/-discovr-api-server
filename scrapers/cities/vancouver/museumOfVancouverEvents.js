/**
 * Vancouver Museum of Vancouver Events Scraper
 * Extracts events from Museum of Vancouver
 */
...
class MuseumOfVancouverEvents {
  constructor() {
    this.name = 'Museum of Vancouver Events';
    this.url = 'https://museumofvancouver.ca/';
    this.baseUrl = 'https://museumofvancouver.ca';
    this.venue = {
      ...
      province: 'BC',
      country: 'Canada',
      coordinates: { lat: 49.2745, lng: -123.1424 }
    };
  }
  ...
  async scrape() {
    ...
    try {
      ...
      console.log('Extracting Museum of Vancouver events...');
      const events = await this.extractEvents(page);
      console.log(`Found ${events.length} Museum of Vancouver events`);
  ...
  /**
   * Extract events from Museum of Vancouver website
  ...
  async extractEvents(page) {
    ...
    return Promise.all(events.map(async event => {
      ...
      return {
        ...
        image: event.image,
        venue: this.venue,
        categories: ['Arts & Culture', 'Museum', 'Education', 'History'],
...
module.exports = MuseumOfVancouverEvents;

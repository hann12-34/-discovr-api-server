async scrape() {
    ...
    try {
      ...
      try {
        await page.waitForSelector(', -item, s-list-item, article', { timeout: 8000 };
      } catch (error) {
      ...
      const eventsData = await page.evaluate(() => {
        ...
        eventElements.forEach(element => {
          ...
          const description = element.querySelector('p, .description, .excerpt, .summary, -description')?.textContent.trim() || '';

...
class SteamworksBrewingEvents {
  constructor() {
    this.name = 'Steamworks Brewing Events';
    this.url = 'https://steamworks.com/events';
    this.venue = {
  ...
  /**
   * Extract events from Steamworks Brewing website
  ...
  async extractEvents(page) {
    ...
    return Promise.all(events.map(async event => {
      ...
      return {
        ...
        image: event.image,
        venue: this.venue,
        categories: ['Food & Drink', 'Brewery', 'Entertainment'],

    ...
    try {
      ...
      if (events.length === 0) {
        ...
        const fallbackEvent = {
          ...
          description: 'Twelve West regularly hosts a variety of nightlife events featuring top DJs and performers from around the world. Visit our official website for the latest event listings, tickets, and VIP table reservations.\n\nTwelve West is a premier nightclub and live music venue in downtown Vancouver, located at 1219 Granville St. The venue offers a sophisticated nightlife experience with state-of-the-art sound and lighting systems, VIP tables, and bottle service in an upscale environment.',
          startDate: null,
          endDate: null,
          venue: this.venue,
          category: 'nightlife',
        ...
        console.log('✅ Added fallback event for Twelve West');
      }

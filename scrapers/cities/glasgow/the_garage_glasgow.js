 ...
 * URL: https://www.garageglasgow.co.uk/events
 */
...
async function scrapeGarageGlasgow(city = 'Glasgow') {
  console.log('🎸 Scraping The Garage...');
  ...
  try {
    ...
    await page.goto('https://www.garageglasgow.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Garage events`);

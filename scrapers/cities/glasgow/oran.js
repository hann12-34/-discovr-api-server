/**
 * Oran Mor Glasgow Events Scraper
 * Arts and entertainment venue
 * URL: https://oran-mor.co.uk/
 */
...
async function scrapeOranMor(city = 'Glasgow') {
  console.log('🎭 Scraping Oran Mor Glasgow...');
  ...
  try {
    ...
    await page.goto('https://oran-mor.co.uk/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Oran Mor events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Oran Mor', address: 'Top of Byres Road, Glasgow G12 8QX', city: 'Glasgow' },
        latitude: 55.8772,
        longitude: -4.2922,
        city: 'Glasgow',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Oran Mor error:', error.message);
    return [];
  }
}

module.exports = scrapeOranMor;

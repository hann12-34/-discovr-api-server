/**
 * The Garage Glasgow Events Scraper
 * Iconic nightclub and live music venue
 * URL: https://www.garageglasgow.co.uk/
 */
...
async function scrapeGarageGlasgow(city = 'Glasgow') {
  console.log('🎧 Scraping The Garage Glasgow...');
  ...
  try {
    ...
    await page.goto('https://www.garageglasgow.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Garage Glasgow events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Garage', address: '490 Sauchiehall Street, Glasgow G2 3LW', city: 'Glasgow' },
        latitude: 55.8656,
        longitude: -4.2646,
        city: 'Glasgow',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Garage Glasgow error:', error.message);
    return [];
  }
}

module.exports = scrapeGarageGlasgow;

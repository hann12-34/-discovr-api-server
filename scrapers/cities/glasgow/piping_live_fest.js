/**
 * Piping Live! Glasgow International Piping Festival Events Scraper
 * URL: https://www.pipinglive.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePipingLive(city = 'Glasgow') {
  console.log('🎵 Scraping Piping Live...');
  ...
  try {
    ...
    await page.goto('https://www.pipinglive.co.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'National Piping Centre',
          address: 'Otago Street, Glasgow',
          city: 'Glasgow'
        },
        latitude: 55.8707,
        longitude: -4.2798,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Piping Live events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Piping Live error:', error.message);
    return [];
  }
}

module.exports = scrapePipingLive;

/**
 * Celtic Connections Glasgow Events Scraper
...
async function scrapeCelticConnections(city = 'Glasgow') {
  console.log('🎵 Scraping Celtic Connections...');
  ...
  try {
    ...
    await page.goto('https://www.celticconnections.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Celtic Connections events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Celtic Connections error:', error.message);
    return [];
  }
}

module.exports = scrapeCelticConnections;

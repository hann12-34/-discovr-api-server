/**
 * Glasgow School of Art Events Scraper
 * URL: https://www.gsa.ac.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGSA(city = 'Glasgow') {
  console.log('🎨 Scraping Glasgow School of Art...');
  ...
  try {
    ...
    await page.goto('https://www.gsa.ac.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} GSA events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  GSA error:', error.message);
    return [];
  }
}

module.exports = scrapeGSA;

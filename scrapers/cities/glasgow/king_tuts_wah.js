/**
 * King Tut's Wah Wah Hut Glasgow Events Scraper
...
async function scrapeKingTuts(city = 'Glasgow') {
  ...
  try {
    ...
    await page.goto('https://kingtuts.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} King Tuts events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  King Tuts error:', error.message);
    return [];
  }
}

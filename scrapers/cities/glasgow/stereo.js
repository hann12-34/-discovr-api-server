/**
 * Stereo Glasgow Events Scraper
 * Live music and club venue
 * URL: https://www.stereocafebar.com/
 */
...
async function scrapeStereo(city = 'Glasgow') {
  console.log('🎸 Scraping Stereo Glasgow...');
  ...
  try {
    ...
    await page.goto('https://www.stereocafebar.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Stereo', address: '22-28 Renfield Lane, Glasgow G2 6PH', city: 'Glasgow' },
        latitude: 55.8612,
        longitude: -4.2556,
        city: 'Glasgow',
        category: 'Nightlife',

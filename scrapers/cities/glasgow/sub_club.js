 ...
 * URL: https://subclub.co.uk/events
 */
...
async function scrapeSubClub(city = 'Glasgow') {
  ...
  try {
    ...
    await page.goto('https://subclub.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sub Club events`);

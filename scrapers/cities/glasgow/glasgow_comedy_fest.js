/**
 * Glasgow International Comedy Festival Events Scraper
 * URL: https://www.glasgowcomedyfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGlasgowComedy(city = 'Glasgow') {
  console.log('😂 Scraping Glasgow Comedy Festival...');
  ...
  try {
    ...
    await page.goto('https://www.glasgowcomedyfestival.com', {
...
module.exports = scrapeGlasgowComedy;

/**
 * Merchant City Festival Glasgow Events Scraper
 * URL: https://www.merchantcityfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMerchantCity(city = 'Glasgow') {
  console.log('🎭 Scraping Merchant City Festival...');
  ...
  try {
    ...
    await page.goto('https://www.merchantcityfestival.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Glasgow',
        category: 'Festival',
        source: 'Merchant City'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Merchant City Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Merchant City error:', error.message);
    return [];
  }
}

module.exports = scrapeMerchantCity;

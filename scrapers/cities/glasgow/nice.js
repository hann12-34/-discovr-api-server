/**
 * Nice N Sleazy Glasgow Events Scraper
 * Live music venue
 * URL: https://www.nicensleazy.com/
 */
...
async function scrapeNiceSleazy(city = 'Glasgow') {
  console.log('🎸 Scraping Nice N Sleazy Glasgow...');
  ...
  try {
    ...
    await page.goto('https://www.nicensleazy.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Nice N Sleazy events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Nice N Sleazy', address: '421 Sauchiehall Street, Glasgow G2 3LG', city: 'Glasgow' },
        latitude: 55.8655,
        longitude: -4.2625,
        city: 'Glasgow',
        category: 'Nightlife',
        source: 'Nice N Sleazy'
      });
    }
    ...
    console.error('  ⚠️  Nice N Sleazy error:', error.message);
    return [];
  }
}

module.exports = scrapeNiceSleazy;

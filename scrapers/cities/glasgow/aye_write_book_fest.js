/**
 * Aye Write! Glasgow Book Festival Events Scraper
 * URL: https://www.ayewrite.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAyeWrite(city = 'Glasgow') {
  console.log('📚 Scraping Aye Write!...');
  ...
  try {
    ...
    await page.goto('https://www.ayewrite.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Aye Write events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Aye Write error:', error.message);
    return [];
  }
}

module.exports = scrapeAyeWrite;

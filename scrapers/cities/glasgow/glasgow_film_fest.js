/**
 * Glasgow Film Festival Events Scraper
 * URL: https://www.glasgowfilm.org/festival
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGlasgowFilm(city = 'Glasgow') {
  console.log('🎬 Scraping Glasgow Film Festival...');
  ...
  try {
    ...
    await page.goto('https://www.glasgowfilm.org/festival', {
...
module.exports = scrapeGlasgowFilm;

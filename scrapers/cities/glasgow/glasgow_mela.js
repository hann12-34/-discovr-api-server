/**
 * Glasgow Mela Events Scraper
 * URL: https://www.glasgowmela.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGlasgowMela(city = 'Glasgow') {
  console.log('🎉 Scraping Glasgow Mela...');
  ...
  try {
    ...
    await page.goto('https://www.glasgowmela.co.uk', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Glasgow Mela events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Glasgow Mela error:', error.message);
    return [];
  }
}

module.exports = scrapeGlasgowMela;

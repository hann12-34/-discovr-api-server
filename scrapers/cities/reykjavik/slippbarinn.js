/**
 * Slippbarinn Reykjavik Events Scraper
 * URL: https://www.slippbarinn.is/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSlippbarinn(city = 'Reykjavik') {
  console.log('🍹 Scraping Slippbarinn...');
  ...
  try {
    ...
    await page.goto('https://www.slippbarinn.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Slippbarinn events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Slippbarinn error:', error.message);
    return [];
  }
}

module.exports = scrapeSlippbarinn;

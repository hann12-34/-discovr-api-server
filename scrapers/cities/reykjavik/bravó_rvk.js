/**
 * Bravó Bar Reykjavik Events Scraper
 * URL: https://www.facebook.com/bravobar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBravo(city = 'Reykjavik') {
  console.log('🎉 Scraping Bravó Bar...');
  ...
  try {
    ...
    await page.goto('https://www.bravobar.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bravó events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bravó error:', error.message);
    return [];
  }
}

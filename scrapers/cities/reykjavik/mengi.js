/**
 * Mengi Reykjavik Events Scraper
...
async function scrapeMengi(city = 'Reykjavik') {
  console.log('🎨 Scraping Mengi...');
  ...
  try {
    ...
    await page.goto('https://www.mengi.net/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Mengi',
          address: 'Óðinsgata 2, 101 Reykjavik',
          city: 'Reykjavik'
        },
        latitude: 64.1445,
        longitude: -21.9305,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mengi events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mengi error:', error.message);
    return [];
  }
}

module.exports = scrapeMengi;

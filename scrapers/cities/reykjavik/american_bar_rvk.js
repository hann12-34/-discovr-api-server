/**
 * American Bar Reykjavik Events Scraper
 * URL: https://www.americanbar.is
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAmericanBar(city = 'Reykjavik') {
  console.log('🍺 Scraping American Bar...');
  ...
  try {
    ...
    await page.goto('https://www.americanbar.is/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'American Bar',
          address: 'Austurstraeti 8, Reykjavik',
          city: 'Reykjavik'
        },
        latitude: 64.1475,
        longitude: -21.9380,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} American Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  American Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeAmericanBar;

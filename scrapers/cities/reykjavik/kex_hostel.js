/**
 * Kex Hostel Reykjavik Events Scraper
 * URL: https://www.kexhostel.is/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKexHostel(city = 'Reykjavik') {
  console.log('🎵 Scraping Kex Hostel...');
  ...
  try {
    ...
    await page.goto('https://www.kexhostel.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kex Hostel events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kex Hostel error:', error.message);
    return [];
  }
}

module.exports = scrapeKexHostel;

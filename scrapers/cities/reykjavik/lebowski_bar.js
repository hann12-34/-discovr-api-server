/**
 * Lebowski Bar Reykjavik Events Scraper
 * URL: https://www.lebowskibar.is/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLebowskiBar(city = 'Reykjavik') {
  console.log('🎳 Scraping Lebowski Bar...');
  ...
  try {
    ...
    await page.goto('https://www.lebowskibar.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lebowski Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lebowski Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeLebowskiBar;

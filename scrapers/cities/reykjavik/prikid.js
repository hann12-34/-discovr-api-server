/**
 * Prikið Reykjavik Events Scraper
 * URL: https://www.prikid.is/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePrikid(city = 'Reykjavik') {
  console.log('☕ Scraping Prikið...');
  ...
  try {
    ...
    await page.goto('https://www.prikid.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Prikið events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Prikið error:', error.message);
    return [];
  }
}

module.exports = scrapePrikid;

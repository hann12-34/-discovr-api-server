/**
 * Gaukurinn reykjavik Events Scraper
 * URL: https://gaukurinn.is
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGaukurinn(city = 'reykjavik') {
  console.log('🎵 Scraping Gaukurinn...');
  ...
  try {
    ...
    await page.goto('https://gaukurinn.is/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Gaukurinn events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Gaukurinn error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeGaukurinn;

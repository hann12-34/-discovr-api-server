/**
 * Kaffibarinn Reykjavik Events Scraper
 * URL: https://www.kaffibarinn.is/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKaffibarinn(city = 'Reykjavik') {
  console.log('☕ Scraping Kaffibarinn...');
  ...
  try {
    ...
    await page.goto('https://www.kaffibarinn.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kaffibarinn events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kaffibarinn error:', error.message);
    return [];
  }
}

module.exports = scrapeKaffibarinn;

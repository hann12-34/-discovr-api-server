/**
 * B5 Bar Reykjavik Events Scraper
 * URL: https://www.b5.is
 */
...
async function scrapeB5(city = 'Reykjavik') {
  console.log('🎉 Scraping B5 Bar...');
  ...
  try {
    ...
    await page.goto('https://www.b5.is/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'B5',
          address: 'Bankastraeti 5, Reykjavik',
          city: 'Reykjavik'
        },
        latitude: 64.1470,
        longitude: -21.9350,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} B5 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  B5 error:', error.message);
    return [];
  }
}

module.exports = scrapeB5;

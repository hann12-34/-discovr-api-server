/**
 * Hurra Reykjavik Events Scraper
 * Popular venue in Reykjavik
 * URL: https://hurra.is/
 */
...
async function scrapeHurraRvk(city = 'Reykjavik') {
  console.log('🎉 Scraping Hurra Reykjavik...');
  ...
  try {
    ...
    await page.goto('https://hurra.is/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Reykjavik',
        category: 'Nightlife',
        source: 'Hurra Reykjavik'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Hurra events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Hurra error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeHurraRvk;

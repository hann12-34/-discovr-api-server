/**
 * Dillon Reykjavik Events Scraper
 * URL: https://www.dillonwhiskybar.is/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDillon(city = 'Reykjavik') {
  console.log('🥃 Scraping Dillon...');
  ...
  try {
    ...
    await page.goto('https://www.dillonwhiskybar.is/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Dillon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dillon error:', error.message);
    return [];
  }
}

module.exports = scrapeDillon;

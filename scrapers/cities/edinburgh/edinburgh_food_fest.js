/**
 * Edinburgh Food Festival Events Scraper
 * URL: https://www.edfoodfest.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEdFood(city = 'Edinburgh') {
  console.log('🍽️ Scraping Edinburgh Food Festival...');
  ...
  try {
    ...
    await page.goto('https://www.edfoodfest.com', {

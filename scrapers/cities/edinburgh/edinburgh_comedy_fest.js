/**
 * Edinburgh Comedy Awards / Shows Events Scraper
...
async function scrapeEdComedy(city = 'Edinburgh') {
  console.log('😂 Scraping Edinburgh Comedy...');
  ...
  try {
    ...
    await page.goto('https://www.edfringe.com', {
    ...
    console.error('  ⚠️  Edinburgh Comedy error:', error.message);
    return [];
  }
}

module.exports = scrapeEdComedy;

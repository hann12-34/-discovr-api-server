/**
 * The Lot Edinburgh Events Scraper
 * URL: https://thelotedinburgh.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheLot(city = 'Edinburgh') {
  console.log('🎭 Scraping The Lot...');
  ...
  try {
    ...
    await page.goto('https://thelotedinburgh.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Lot events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Lot error:', error.message);
    return [];
  }
}

module.exports = scrapeTheLot;

/**
 * Whistlebinkies Edinburgh Events Scraper
 * URL: https://www.whistlebinkies.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWhistle(city = 'Edinburgh') {
  console.log('🎭 Scraping Whistlebinkies Edinburgh...');
  ...
  try {
    ...
    await page.goto('https://www.whistlebinkies.com/', {

/**
 * Royal Edinburgh Military Tattoo Events Scraper
...
async function scrapeMilitaryTattoo(city = 'Edinburgh') {
  console.log('🥁 Scraping Military Tattoo...');
  ...
  try {
    ...
    await page.goto('https://www.edintattoo.co.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edinburgh',
        category: 'Festival',
        source: 'Military Tattoo'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Military Tattoo events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Military Tattoo error:', error.message);
    return [];
  }
}

module.exports = scrapeMilitaryTattoo;

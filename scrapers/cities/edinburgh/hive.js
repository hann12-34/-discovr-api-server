/**
 * The Hive Edinburgh Events Scraper
 * URL: https://www.thehiveedinburgh.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHive(city = 'Edinburgh') {
  console.log('🎭 Scraping The Hive Edinburgh...');
  ...
  try {
    ...
    await page.goto('https://www.thehiveedinburgh.com/', {

/**
 * Edinburgh's Hogmanay New Year Festival Events Scraper
 * URL: https://www.edinburghshogmanay.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHogmanay(city = 'Edinburgh') {
  console.log('🎆 Scraping Hogmanay...');
  ...
  try {
    ...
    await page.goto('https://www.edinburghshogmanay.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Hogmanay events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Hogmanay error:', error.message);
    return [];
  }
}

module.exports = scrapeHogmanay;

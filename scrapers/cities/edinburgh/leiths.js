 ...
 * URL: https://www.leiththeatretrust.org/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLeith(city = 'Edinburgh') {
  ...
  try {
    ...
    await page.goto('https://www.leiththeatretrust.org/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Leith Theatre',
          address: '28-30 Ferry Rd, Edinburgh EH6 4AE',
          city: 'Edinburgh'
        },
        latitude: 55.9722,
        longitude: -3.1767,

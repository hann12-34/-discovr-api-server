/**
 * Hidden Door Festival Edinburgh Events Scraper
 * URL: https://www.hiddendoorarts.org
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHiddenDoor(city = 'Edinburgh') {
  console.log('🚪 Scraping Hidden Door Festival...');
  ...
  try {
    ...
    await page.goto('https://www.hiddendoorarts.org', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Hidden Door events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Hidden Door error:', error.message);
    return [];
  }
}

module.exports = scrapeHiddenDoor;

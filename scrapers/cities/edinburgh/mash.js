/**
 * Mash House Edinburgh Events Scraper
 * Club and events venue
 * URL: https://www.themashhouse.co.uk/
 */
...
async function scrapeMashHouse(city = 'Edinburgh') {
  console.log('🎧 Scraping Mash House Edinburgh...');
  ...
  try {
    ...
    await page.goto('https://www.themashhouse.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Mash House events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Mash House', address: '37 Guthrie Street, Edinburgh EH1 1JG', city: 'Edinburgh' },
        latitude: 55.9493,
        longitude: -3.1886,
        city: 'Edinburgh',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Mash House error:', error.message);
    return [];
  }
}

module.exports = scrapeMashHouse;

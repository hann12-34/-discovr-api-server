/**
 * Studio 24 Edinburgh Events Scraper
 * URL: https://www.studio24.net/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStudio24(city = 'Edinburgh') {
  console.log('🎭 Scraping Studio 24 Edinburgh...');
  ...
  try {
    ...
    await page.goto('https://www.studio24.net/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Studio 24', address: '24-26 Calton Rd, Edinburgh EH8 8DP', city: 'Edinburgh' },
        latitude: 55.9534, longitude: -3.1811,
        city: 'Edinburgh', category: 'Nightlife', source: 'Studio 24'
      });
    }

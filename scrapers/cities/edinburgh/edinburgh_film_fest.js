/**
 * Edinburgh International Film Festival Events Scraper
...
async function scrapeEdFilm(city = 'Edinburgh') {
  console.log('🎬 Scraping Edinburgh Film Festival...');
  ...
  try {
    ...
    await page.goto('https://www.edfilmfest.org.uk', {

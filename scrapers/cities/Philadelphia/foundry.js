/**
 * The Foundry at The Fillmore Philadelphia Events Scraper
 * Live music venue
 * URL: https://www.thefillmorephilly.com/
 */
...
async function scrapeFoundry(city = 'Philadelphia') {
  console.log('🎸 Scraping The Foundry Philadelphia...');
  ...
  try {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Foundry events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Foundry', address: '29 E Allen Street, Philadelphia PA 19123', city: 'Philadelphia' },
        latitude: 39.9679,
        longitude: -75.1368,
        city: 'Philadelphia',
        category: 'Nightlife',

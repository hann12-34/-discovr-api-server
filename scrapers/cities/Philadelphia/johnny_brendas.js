...
async function scrapeJohnnyBrendas(city = 'Philadelphia') {
  console.log('🎸 Scraping Johnny Brendas...');
  ...
  try {
    ...
    await page.goto('https://johnnybrendas.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Philadelphia',
        category: 'Nightlife',
        source: 'Johnny Brendas'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Johnny Brendas events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Johnny Brendas error:', error.message);
    return [];
  }
}

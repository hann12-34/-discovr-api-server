/**
 * Ortlieb's Philadelphia Events Scraper
 * URL: https://www.ortliebslounge.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOrtliebs(city = 'Philadelphia') {
  console.log('🎸 Scraping Ortlieb\'s Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://www.ortliebslounge.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ortlieb's events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Ortlieb\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeOrtliebs;

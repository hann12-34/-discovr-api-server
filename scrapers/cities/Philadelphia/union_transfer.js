 ...
 * URL: https://www.utphilly.com/events
 */
...
async function scrapeUnionTransfer(city = 'Philadelphia') {
  console.log('🎸 Scraping Union Transfer...');
  ...
  try {
    ...
    await page.goto('https://www.utphilly.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Union Transfer events`);

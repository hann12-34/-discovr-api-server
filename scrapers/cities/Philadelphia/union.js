/**
 * Union Transfer Philadelphia Events Scraper
 * Live music venue
 * URL: https://www.utphilly.com/
 */
...
async function scrapeUnionTransfer(city = 'Philadelphia') {
  console.log('🎸 Scraping Union Transfer Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://www.utphilly.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Union Transfer events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Union Transfer', address: '1026 Spring Garden Street, Philadelphia PA 19123', city: 'Philadelphia' },
        latitude: 39.9615,
        longitude: -75.1546,
        city: 'Philadelphia',
        category: 'Nightlife',
        source: 'Union Transfer'
      });
    }
    ...
    console.error('  ⚠️  Union Transfer error:', error.message);
    return [];
  }
}

module.exports = scrapeUnionTransfer;

/**
 * Coda Philadelphia Events Scraper
 * EDM nightclub
 * URL: https://www.codaphilly.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCoda(city = 'Philadelphia') {
  console.log('🎉 Scraping Coda Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://www.codaphilly.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Coda events`);

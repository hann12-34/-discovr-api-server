 ...
 * Major concert venue (formerly Electric Factory)
 * URL: https://www.franklinmusichall.com/events
 */
...
async function scrapeFranklinMusicHall(city = 'Philadelphia') {
  console.log('🎵 Scraping Franklin Music Hall Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://www.franklinmusichall.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Franklin Music Hall events`);

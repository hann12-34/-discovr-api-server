/**
 * World Cafe Live Philadelphia Events Scraper
 * URL: https://www.worldcafelive.com/philadelphia/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWorldCafeLive(city = 'Philadelphia') {
  console.log('☕ Scraping World Cafe Live...');
  ...
  try {
    ...
    await page.goto('https://www.worldcafelive.com/philadelphia/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} World Cafe Live events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  World Cafe Live error:', error.message);
    return [];
  }
}

module.exports = scrapeWorldCafeLive;

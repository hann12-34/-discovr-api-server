/**
 * Walnut Street Theatre Philadelphia Events Scraper
 * Historic theatre
 * URL: https://www.walnutstreettheatre.org/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWalnutStreet(city = 'Philadelphia') {
  console.log('🎭 Scraping Walnut Street Theatre Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://www.walnutstreettheatre.org/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Walnut Street Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Walnut Street Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeWalnutStreet;

 ...
 * URL: https://www.johnnybrendas.com/
 */
...
async function scrapeJohnnyBrendas(city = 'Philadelphia') {
  console.log('🎸 Scraping Johnny Brenda\'s Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://www.johnnybrendas.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Johnny Brenda's events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Johnny Brenda's", address: '1201 N Frankford Ave, Philadelphia PA 19125', city: 'Philadelphia' },
        latitude: 39.9720,
        longitude: -75.1341,
        city: 'Philadelphia',
        category: 'Nightlife',
        source: "Johnny Brenda's"
      });
    }
    ...
    console.error('  ⚠️  Johnny Brenda\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeJohnnyBrendas;

/**
 * Philly LIVE! Events Scraper
 * URL: https://www.phillylive.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePhillyLive(city = 'Philadelphia') {
  console.log('🎸 Scraping Philly LIVE!...');
  ...
  try {
    ...
    await page.goto('https://www.phillylive.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Philly LIVE! events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Philly LIVE! error:', error.message);
    return [];
  }
}

module.exports = scrapePhillyLive;

/**
 * Tower Theater Philadelphia Events Scraper
 * URL: https://www.livenation.com/venue/KovZpZAEkkIA/tower-theatre-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTowerTheater(city = 'Philadelphia') {
  console.log('🎵 Scraping Tower Theater...');
  ...
  try {
    ...
    await page.goto('https://www.livenation.com/venue/KovZpZAEkkIA/tower-theatre-events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Philadelphia',
        category: 'Concert',
        source: 'Tower Theater'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Tower Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Tower Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeTowerTheater;

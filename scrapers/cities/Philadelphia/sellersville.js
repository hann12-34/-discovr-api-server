/**
 * Sellersville Theater Philadelphia Events Scraper
 * URL: https://www.st94.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSellersville(city = 'Philadelphia') {
  console.log('🎭 Scraping Sellersville Theater...');
  ...
  try {
    ...
    await page.goto('https://www.st94.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Philadelphia',
        category: 'Arts',
        source: 'Sellersville Theater'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Sellersville events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sellersville error:', error.message);
    return [];
  }
}

module.exports = scrapeSellersville;

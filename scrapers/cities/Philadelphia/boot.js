/**
 * Boot & Saddle Philadelphia Events Scraper
 * Live music venue in South Philly
 * URL: https://bootandsaddlephilly.com/
 */
...
async function scrapeBootSaddle(city = 'Philadelphia') {
  console.log('🎸 Scraping Boot & Saddle Philadelphia...');
  ...
  try {
    ...
    await page.goto('https://bootandsaddlephilly.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Boot & Saddle events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Boot & Saddle', address: '1131 S Broad Street, Philadelphia PA 19147', city: 'Philadelphia' },
        latitude: 39.9365,
        longitude: -75.1669,
        city: 'Philadelphia',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Boot & Saddle error:', error.message);
    return [];
  }
}

module.exports = scrapeBootSaddle;

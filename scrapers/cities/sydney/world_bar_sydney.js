/**
 * World Bar Sydney Events Scraper
 * Popular nightclub in Sydney
 * URL: https://theworldbar.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWorldBarSydney(city = 'Sydney') {
  console.log('🌍 Scraping World Bar Sydney...');
  ...
  try {
    ...
    await page.goto('https://theworldbar.com/', {
...
module.exports = scrapeWorldBarSydney;

/**
 * The Basement Sydney Events Scraper
 * Historic jazz and blues venue
 * URL: https://thebasement.com.au/
 */
...
async function scrapeTheBasement(city = 'Sydney') {
  console.log('🎷 Scraping The Basement Sydney...');
  ...
  try {
    ...
    await page.goto('https://thebasement.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Basement events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Basement', address: '29 Reiby Place, Sydney NSW 2000', city: 'Sydney' },
        latitude: -33.8622,
        longitude: 151.2096,
        city: 'Sydney',
        category: 'Nightlife',
...
module.exports = scrapeTheBasement;

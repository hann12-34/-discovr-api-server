/**
 * Good God Sydney Events Scraper
 * URL: https://goodgod.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGoodGod(city = 'Sydney') {
  console.log('🎭 Scraping Good God Sydney...');
  ...
  try {
    ...
    await page.goto('https://goodgod.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Good God',
          address: '55 Liverpool St, Sydney NSW 2000',
          city: 'Sydney'
        },
        latitude: -33.8756,
        longitude: 151.2070,

/**
 * Cliff Dive Sydney Events Scraper
 * URL: https://www.cliffdive.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCliffDive(city = 'Sydney') {
  console.log('🎭 Scraping Cliff Dive Sydney...');
  ...
  try {
    ...
    await page.goto('https://www.cliffdive.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Cliff Dive',
          address: '16 Oxford St, Darlinghurst NSW 2010',
          city: 'Sydney'
        },
        latitude: -33.8775,
        longitude: 151.2152,
...
module.exports = scrapeCliffDive;

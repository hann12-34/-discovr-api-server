/**
 * Frankie's Pizza Sydney Events Scraper
 * URL: https://frankiespizzabytheslice.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFrankies(city = 'Sydney') {
  console.log('🎭 Scraping Frankies Pizza Sydney...');
  ...
  try {
    ...
    await page.goto('https://frankiespizzabytheslice.com/', {

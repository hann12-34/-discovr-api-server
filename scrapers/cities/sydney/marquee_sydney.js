/**
 * Marquee Sydney Events Scraper
 * Popular nightclub in Sydney
 * URL: https://marqueesydney.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMarqueeSydney(city = 'Sydney') {
  console.log('🎪 Scraping Marquee Sydney...');
  ...
  try {
    ...
    await page.goto('https://marqueesydney.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Sydney',
        category: 'Nightlife',
        source: 'Marquee Sydney'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Marquee events`);
...
module.exports = scrapeMarqueeSydney;

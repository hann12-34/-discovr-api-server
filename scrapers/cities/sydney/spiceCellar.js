/**
 * Spice Cellar Sydney Events Scraper
 * Underground club venue
 * URL: https://spicecellar.com.au/
 */
...
async function scrapeSpiceCellar(city = 'Sydney') {
  console.log('🌶️ Scraping Spice Cellar Sydney...');
  ...
  try {
    ...
    await page.goto('https://spicecellar.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Spice Cellar events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Spice Cellar', address: '58 Elizabeth Street, Sydney NSW 2000', city: 'Sydney' },
        latitude: -33.8695,
        longitude: 151.2099,
        city: 'Sydney',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Spice Cellar error:', error.message);
    return [];
  }
}

module.exports = scrapeSpiceCellar;

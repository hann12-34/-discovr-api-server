/**
 * Crowbar Sydney Events Scraper
 * URL: https://www.crowbarsydney.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCrowbar(city = 'Sydney') {
  console.log('🎭 Scraping Crowbar Sydney...');
  ...
  try {
    ...
    await page.goto('https://www.crowbarsydney.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Crowbar',
          address: '106 Oxford St, Darlinghurst NSW 2010',
          city: 'Sydney'
        },
        latitude: -33.8797,
        longitude: 151.2152,

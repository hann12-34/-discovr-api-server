/**
 * Mary's Underground Sydney Events Scraper
 * Rock bar and live music venue
 * URL: https://www.marysunderground.com.au/
 */
...
async function scrapeMarysUnderground(city = 'Sydney') {
  console.log('🎸 Scraping Mary\'s Underground Sydney...');
  ...
  try {
    ...
    await page.goto('https://www.marysunderground.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Mary's events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Mary's Underground", address: 'Basement, 287 Crown Street, Surry Hills NSW 2010', city: 'Sydney' },
        latitude: -33.8851,
        longitude: 151.2108,
        city: 'Sydney',
        category: 'Nightlife',
        source: "Mary's Underground"
      });
    }
    ...
    console.error('  ⚠️  Mary\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeMarysUnderground;

/**
 * ICC Sydney Events - sydney Events Scraper
 * URL: https://www.iccsydney.com.au/whats-on
 */
...
async function scrapeICCSydneyEvents(city = 'sydney') {
  console.log('🎭 Scraping ICC Sydney Events...');
  try {
    const resp = await axios.get('https://www.iccsydney.com.au/whats-on', {
      ...
      $events.each((_, el) => {
        try {
          ...
          if (eventUrl && !eventUrl.startsWith('http')) {
            const base = new URL('https://www.iccsydney.com.au/whats-on');
    ...
    console.log('  ✅ ICC Sydney Events:', futureEvents.length, 'events');
    return filterEvents(futureEvents);
  } catch (error) {
    console.error('  ⚠️ ICC Sydney Events error:', error.message);
    return [];
  }
}

module.exports = scrapeICCSydneyEvents;

/**
 * Hordern Pavilion Sydney Events Scraper
 * Major entertainment venue
 * URL: https://hordernpavilion.com.au/
 */
...
async function scrapeHordern(city = 'Sydney') {
  console.log('🎸 Scraping Hordern Pavilion Sydney...');
  ...
  try {
    ...
    await page.goto('https://hordernpavilion.com.au/whats-on/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Hordern events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Hordern Pavilion', address: '1 Driver Avenue, Moore Park NSW 2021', city: 'Sydney' },
        latitude: -33.8930,
        longitude: 151.2236,
        city: 'Sydney',
        category: 'Nightlife',
        source: 'Hordern Pavilion'
      });
    }
    ...
    console.error('  ⚠️  Hordern error:', error.message);
    return [];
  }
}

module.exports = scrapeHordern;

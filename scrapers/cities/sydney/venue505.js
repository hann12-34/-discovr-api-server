/**
 * Venue 505 Sydney Events Scraper
 * Jazz and world music venue in Surry Hills
 * URL: https://venue505.com/
 */
...
async function scrapeVenue505(city = 'Sydney') {
  console.log('🎷 Scraping Venue 505 Sydney...');
  ...
  try {
    ...
    await page.goto('https://venue505.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Venue 505 events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Venue 505', address: '280 Cleveland Street, Surry Hills NSW 2010', city: 'Sydney' },
        latitude: -33.8881,
        longitude: 151.2060,
        city: 'Sydney',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Venue 505 error:', error.message);
    return [];
  }
}

module.exports = scrapeVenue505;

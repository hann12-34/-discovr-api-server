/**
 * The Lansdowne Sydney Events Scraper
 * Live music pub in Chippendale
 * URL: https://thelansdowne.com.au/
 */
...
async function scrapeLansdowne(city = 'Sydney') {
  console.log('🎸 Scraping The Lansdowne Sydney...');
  ...
  try {
    ...
    await page.goto('https://thelansdowne.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Lansdowne events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Lansdowne', address: '2-6 City Road, Chippendale NSW 2008', city: 'Sydney' },
        latitude: -33.8841,
        longitude: 151.1969,
        city: 'Sydney',
        category: 'Nightlife',
...
module.exports = scrapeLansdowne;

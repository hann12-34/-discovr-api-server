/**
 * Home The Venue Sydney Events Scraper
 * DJ Mag Top 100 Club - Sydney's original superclub
...
async function scrapeHomevenue(city = 'Sydney') {
  console.log('🏠 Scraping Home The Venue Sydney...');
  ...
  try {
    ...
    await page.goto('https://www.homesydney.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Home The Venue',
          address: '101 Cockle Bay Wharf, Darling Harbour, Sydney NSW 2000',
          city: 'Sydney'
        },
        city: 'Sydney',
        category: 'Nightlife',
        source: 'Home The Venue'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Home The Venue events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Home The Venue error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeHomevenue;

/**
 * Beach Road Hotel Sydney Events Scraper
 * URL: https://beachroadhotel.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBeachRoad(city = 'Sydney') {
  console.log('🎭 Scraping Beach Road Hotel Sydney...');
  ...
  try {
    ...
    await page.goto('https://beachroadhotel.com.au/', {
...
module.exports = scrapeBeachRoad;

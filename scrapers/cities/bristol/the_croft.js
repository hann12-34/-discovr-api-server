/**
 * The Croft Bristol Events Scraper
 * URL: https://thecroftbristol.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCroft(city = 'Bristol') {
  console.log('🎭 Scraping The Croft...');
  ...
  try {
    ...
    await page.goto('https://thecroftbristol.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Croft events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Croft error:', error.message);
    return [];
  }
}

module.exports = scrapeCroft;

/**
 * The Exchange Bristol Events Scraper
 * URL: https://www.exchangebristol.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeExchange(city = 'Bristol') {
  console.log('🎭 Scraping The Exchange...');
  ...
  try {
    ...
    await page.goto('https://www.exchangebristol.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Exchange',
          address: 'Old Market, Bristol BS2 0EJ',
          city: 'Bristol'
        },
        latitude: 51.4560,
        longitude: -2.5800,

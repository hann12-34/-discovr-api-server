/**
 * Thekla Bristol Events Scraper
 * URL: https://theklabristol.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThekla(city = 'Bristol') {
  console.log('🚢 Scraping Thekla...');
  ...
  try {
    ...
    await page.goto('https://theklabristol.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Thekla events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Thekla error:', error.message);
    return [];
  }
}

module.exports = scrapeThekla;

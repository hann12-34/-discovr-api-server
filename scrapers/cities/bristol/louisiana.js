/**
 * Louisiana Bristol Events Scraper
 * URL: https://www.thelouisiana.net/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLouisiana(city = 'Bristol') {
  console.log('🎸 Scraping Louisiana...');
  ...
  try {
    ...
    await page.goto('https://www.thelouisiana.net/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Louisiana',
          address: 'Wapping Rd, Bristol BS1 4RW',
          city: 'Bristol'
        },
        latitude: 51.4490,
        longitude: -2.5980,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Louisiana events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Louisiana error:', error.message);
    return [];
  }
}

module.exports = scrapeLouisiana;

/**
 * Bristol Beacon Events Scraper
 * URL: https://bristolbeacon.org/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBristolBeacon(city = 'Bristol') {
  console.log('🎭 Scraping Bristol Beacon...');
  ...
  try {
    ...
    await page.goto('https://bristolbeacon.org/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bristol Beacon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bristol Beacon error:', error.message);
    return [];
  }
}

module.exports = scrapeBristolBeacon;

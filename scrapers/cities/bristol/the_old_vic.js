/**
 * Bristol Old Vic Theatre Events Scraper
 * URL: https://bristololdvic.org.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOldVic(city = 'Bristol') {
  console.log('🎭 Scraping Bristol Old Vic...');
  ...
  try {
    ...
    await page.goto('https://bristololdvic.org.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Old Vic events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Old Vic error:', error.message);
    return [];
  }
}

module.exports = scrapeOldVic;

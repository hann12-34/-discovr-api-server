/**
 * The Fleece Bristol Events Scraper
 * URL: https://thefleece.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFleece(city = 'Bristol') {
  console.log('🎸 Scraping The Fleece...');
  ...
  try {
    ...
    await page.goto('https://thefleece.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fleece events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fleece error:', error.message);
    return [];
  }
}

module.exports = scrapeFleece;

/**
 * Bristol Harbour Festival Events Scraper
...
async function scrapeBristolHarbour(city = 'Bristol') {
  console.log('⚓ Scraping Bristol Harbour Festival...');
  ...
  try {
    ...
    await page.goto('https://www.bristolharbourfestival.co.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Bristol',
        category: 'Festival',
        source: 'Harbour Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Harbour Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Harbour Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeBristolHarbour;

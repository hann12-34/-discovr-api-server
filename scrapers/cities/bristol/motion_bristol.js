/**
 * Motion Bristol Events Scraper
 * URL: https://motionbristol.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMotion(city = 'Bristol') {
  console.log('🎧 Scraping Motion Bristol...');
  ...
  try {
    ...
    await page.goto('https://motionbristol.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Bristol',
        category: 'Nightlife',
        source: 'Motion Bristol'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Motion events`);

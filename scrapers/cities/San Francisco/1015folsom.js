/**
 * 1015 Folsom San Francisco Events Scraper
 * Legendary nightclub
 * URL: https://1015.com/
 */
...
async function scrape1015Folsom(city = 'San Francisco') {
  console.log('🎧 Scraping 1015 Folsom...');
  ...
  try {
    ...
    await page.goto('https://1015.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Club night at 1015 Folsom`,
        date: isoDate,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid 1015 Folsom events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  1015 Folsom error:', error.message);
    return [];
  }
}

module.exports = scrape1015Folsom;

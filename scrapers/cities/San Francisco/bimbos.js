 ...
 * URL: https://www.bimbos365club.com/
 */
...
async function scrapeBimbos(city = 'San Francisco') {
  console.log('🎸 Scraping Bimbo\'s 365 Club San Francisco...');
  ...
  try {
    ...
    await page.goto('https://www.bimbos365club.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Bimbo's events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Bimbo's 365 Club", address: '1025 Columbus Ave, San Francisco CA 94133', city: 'San Francisco' },
        latitude: 37.8037,
        longitude: -122.4150,
        city: 'San Francisco',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Bimbo\'s error:', error.message);
    return [];
  }
}

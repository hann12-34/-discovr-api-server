...
async function scrapeIndependent(city = 'San Francisco') {
  ...
  try {
    ...
    await page.goto('https://www.theindependentsf.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Independent events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Independent', address: '628 Divisadero Street, San Francisco CA 94117', city: 'San Francisco' },
        latitude: 37.7760,
        longitude: -122.4375,
        city: 'San Francisco',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Independent error:', error.message);
    return [];
  }
}

module.exports = scrapeIndependent;

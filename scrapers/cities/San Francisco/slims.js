 ...
 * URL: https://www.slimspresents.com/slims/
 */
...
async function scrapeSlims(city = 'San Francisco') {
  ...
  try {
    ...
    await page.goto('https://www.slimspresents.com/slims/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Slim's", address: '333 11th Street, San Francisco CA 94103', city: 'San Francisco' },
        latitude: 37.7707,
        longitude: -122.4135,
        city: 'San Francisco',
        category: 'Nightlife',

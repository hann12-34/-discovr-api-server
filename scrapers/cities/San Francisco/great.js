 ...
 * URL: https://www.slimspresents.com/great-american-music-hall/
 */
...
async function scrapeGreatAmerican(city = 'San Francisco') {
  console.log('🎸 Scraping Great American Music Hall SF...');
  ...
  try {
    ...
    await page.goto('https://www.slimspresents.com/great-american-music-hall/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Great American events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Great American Music Hall', address: '859 O\'Farrell Street, San Francisco CA 94109', city: 'San Francisco' },
        latitude: 37.7853,
        longitude: -122.4180,
        city: 'San Francisco',
        category: 'Nightlife',
        source: 'Great American Music Hall'
      });
    }
    ...
    console.error('  ⚠️  Great American error:', error.message);
    return [];
  }
}

module.exports = scrapeGreatAmerican;

...
async function scrapeAugustHall(city = 'San Francisco') {
  console.log('🎸 Scraping August Hall San Francisco...');
  ...
  try {
    ...
    await page.goto('https://www.augusthallsf.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} August Hall events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'August Hall', address: '420 Mason Street, San Francisco CA 94102', city: 'San Francisco' },
        latitude: 37.7874,
        longitude: -122.4094,
        city: 'San Francisco',
        category: 'Nightlife',

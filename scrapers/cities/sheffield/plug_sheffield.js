/**
 * Plug Sheffield Events Scraper
 * URL: https://www.theplug.club
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePlug(city = 'Sheffield') {
  console.log('🔌 Scraping Plug Sheffield...');
  ...
  try {
    ...
    await page.goto('https://www.theplug.club/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Plug events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Plug error:', error.message);
    return [];
  }
}

module.exports = scrapePlug;

/**
 * DryDog Sheffield Events Scraper
 * URL: https://www.drydogsheffield.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDryDog(city = 'Sheffield') {
  console.log('🐕 Scraping DryDog...');
  ...
  try {
    ...
    await page.goto('https://www.drydogsheffield.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} DryDog events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  DryDog error:', error.message);
    return [];
  }
}

module.exports = scrapeDryDog;

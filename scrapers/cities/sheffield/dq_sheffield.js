/**
 * DQ Sheffield Events Scraper
 * URL: https://www.dqsheffield.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDQ(city = 'Sheffield') {
  console.log('👑 Scraping DQ Sheffield...');
  ...
  try {
    ...
    await page.goto('https://www.dqsheffield.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'DQ',
          address: 'Carver Street, Sheffield',
          city: 'Sheffield'
        },
        latitude: 53.3798,
        longitude: -1.4755,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} DQ events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  DQ error:', error.message);
    return [];
  }
}

module.exports = scrapeDQ;

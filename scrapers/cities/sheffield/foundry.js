/**
 * The Foundry Sheffield Events Scraper
 * URL: https://www.foundrysheffield.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFoundry(city = 'Sheffield') {
  ...
  try {
    ...
    await page.goto('https://www.foundrysheffield.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Foundry',
          address: '3 Brown St, Sheffield S1 2BS',
          city: 'Sheffield'
        },
        latitude: 53.3795,
        longitude: -1.4680,

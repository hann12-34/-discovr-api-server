/**
 * Utilita Arena Sheffield Events Scraper
 * URL: https://www.utilitaarenasheffield.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeUtilitaArena(city = 'Sheffield') {
  console.log('🏟️ Scraping Utilita Arena...');
  ...
  try {
    ...
    await page.goto('https://www.utilitaarenasheffield.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Utilita Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Utilita Arena error:', error.message);
    return [];
  }
}

module.exports = scrapeUtilitaArena;

/**
 * Crucible Theatre Sheffield Events Scraper
...
async function scrapeCrucible(city = 'Sheffield') {
  console.log('🎭 Scraping Crucible Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.sheffieldtheatres.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Sheffield',
        category: 'Arts',
        source: 'Crucible Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Crucible Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Crucible Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeCrucible;

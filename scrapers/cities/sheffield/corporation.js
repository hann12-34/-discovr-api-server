/**
 * Corporation Sheffield Events Scraper
 * URL: https://www.corporationsheffield.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCorporation(city = 'Sheffield') {
  console.log('🎵 Scraping Corporation...');
  ...
  try {
    ...
    await page.goto('https://www.corporationsheffield.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Corporation',
          address: '2 Milton St, Sheffield S1 4JU',
          city: 'Sheffield'
        },
        latitude: 53.3785,
        longitude: -1.4695,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Corporation events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Corporation error:', error.message);
    return [];
  }
}

module.exports = scrapeCorporation;

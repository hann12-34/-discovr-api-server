/**
 * Bar One Sheffield Events Scraper
 * URL: https://www.baronesheffield.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBarOne(city = 'Sheffield') {
  console.log('1️⃣ Scraping Bar One...');
  ...
  try {
    ...
    await page.goto('https://www.baronesheffield.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bar One events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bar One error:', error.message);
    return [];
  }
}

module.exports = scrapeBarOne;

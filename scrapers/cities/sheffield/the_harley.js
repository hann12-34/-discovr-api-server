/**
 * The Harley Sheffield Events Scraper
 * URL: https://www.theharleysheffield.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheHarley(city = 'Sheffield') {
  console.log('🏍️ Scraping The Harley...');
  ...
  try {
    ...
    await page.goto('https://www.theharleysheffield.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Harley',
          address: '2 Kenwood Park Rd, Sheffield S7 1NF',
          city: 'Sheffield'
        },
        latitude: 53.3685,
        longitude: -1.4865,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Harley events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Harley error:', error.message);
    return [];
  }
}

module.exports = scrapeTheHarley;

/**
 * Revolution Sheffield Events Scraper
 * URL: https://www.revolution-bars.co.uk/bar/sheffield
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRevolution(city = 'Sheffield') {
  console.log('🎉 Scraping Revolution Sheffield...');
  ...
  try {
    ...
    await page.goto('https://www.revolution-bars.co.uk/bar/sheffield/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Revolution',
          address: 'Fitzwilliam Street, Sheffield',
          city: 'Sheffield'
        },
        latitude: 53.3795,
        longitude: -1.4745,

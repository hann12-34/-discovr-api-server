/**
 * Irene's Pub Ottawa Events Scraper
 * URL: https://www.irenespub.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIrenesPub(city = 'Ottawa') {
  console.log('🍺 Scraping Irenes Pub...');
  ...
  try {
    ...
    await page.goto('https://www.irenespub.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Irenes Pub events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Irenes Pub error:', error.message);
    return [];
  }
}

module.exports = scrapeIrenesPub;

/**
 * Nepean Sportsplex Ottawa Events Scraper
...
async function scrapeNepeanSportsplex(city = 'Ottawa') {
  console.log('🎵 Scraping Nepean Sportsplex...');
  ...
  try {
    ...
    await page.goto('https://ottawa.ca/en/recreation-and-parks/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Nepean Sportsplex'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Nepean Sportsplex events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Nepean Sportsplex error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeNepeanSportsplex;

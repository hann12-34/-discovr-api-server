/**
 * Canadian Museum of Nature Ottawa Events Scraper
 * URL: https://nature.ca
 */
...
async function scrapeNatureMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Canadian Museum of Nature...');
  ...
  try {
    ...
    await page.goto('https://nature.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Canadian Museum of Nature events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Canadian Museum of Nature error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeNatureMuseum;

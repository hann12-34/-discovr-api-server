/**
 * Black Sheep Inn Ottawa Events Scraper
...
async function scrapeBlacksheep(city = 'Ottawa') {
  console.log('🎵 Scraping Black Sheep Inn Ottawa...');
  ...
  try {
    ...
    await page.goto('https://blacksheepinn.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Black Sheep Inn'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Black Sheep Inn events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Black Sheep Inn error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeBlacksheep;

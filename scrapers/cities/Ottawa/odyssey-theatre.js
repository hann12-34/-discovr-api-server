/**
 * Odyssey Theatre Ottawa Events Scraper
 * URL: https://www.odysseytheatre.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOdysseyTheatre(city = 'Ottawa') {
  console.log('🎵 Scraping Odyssey Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.odysseytheatre.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Odyssey Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Odyssey Theatre error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeOdysseyTheatre;

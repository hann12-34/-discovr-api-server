/**
 * Library and Archives Canada Ottawa Events Scraper
...
async function scrapeLibrary(city = 'Ottawa') {
  console.log('🎵 Scraping Library and Archives Canada...');
  ...
  try {
    ...
    await page.goto('https://www.bac-lac.gc.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Library and Archives Canada events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Library and Archives Canada error: ${error.message}`);
    return [];
  }
}

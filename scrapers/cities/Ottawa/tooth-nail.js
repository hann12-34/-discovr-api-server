/**
 * Tooth and Nail Brewing Ottawa Events Scraper
...
async function scrapeToothNail(city = 'Ottawa') {
  console.log('🎵 Scraping Tooth and Nail Brewing...');
  ...
  try {
    ...
    await page.goto('https://toothandnailbeer.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Tooth and Nail Brewing'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Tooth and Nail Brewing events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Tooth and Nail Brewing error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeToothNail;

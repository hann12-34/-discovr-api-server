/**
 * Cityview Brewpub Ottawa Events Scraper
...
async function scrapeCityviewbp(city = 'Ottawa') {
  console.log('🎵 Scraping Cityview Brewpub Ottawa...');
  ...
  try {
    ...
    await page.goto('https://cityviewbrew.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Cityview Brewpub'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Cityview Brewpub events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Cityview Brewpub error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeCityviewbp;

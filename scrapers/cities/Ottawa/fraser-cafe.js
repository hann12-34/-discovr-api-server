/**
 * Fraser Cafe Ottawa Events Scraper
 * URL: https://frasercafe.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFraserCafe(city = 'Ottawa') {
  console.log('🎵 Scraping Fraser Cafe...');
  ...
  try {
    ...
    await page.goto('https://frasercafe.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fraser Cafe events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Fraser Cafe error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeFraserCafe;

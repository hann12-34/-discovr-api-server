/**
 * Bytown Museum Ottawa Events Scraper
 * URL: https://bytownmuseum.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBytownMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Bytown Museum...');
  ...
  try {
    ...
    await page.goto('https://bytownmuseum.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bytown Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Bytown Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeBytownMuseum;

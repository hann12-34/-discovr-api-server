/**
 * Ottawa 67s Ottawa Events Scraper
 * URL: https://ottawa67s.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOttawa67s(city = 'Ottawa') {
  console.log('🎵 Scraping Ottawa 67s...');
  ...
  try {
    ...
    await page.goto('https://ottawa67s.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ottawa 67s events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Ottawa 67s error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeOttawa67s;

/**
 * Canada Science and Technology Museum Ottawa Events Scraper
...
async function scrapeScienceTechMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Canada Science and Technology Museum...');
  ...
  try {
    ...
    await page.goto('https://ingeniumcanada.org/scitech/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Canada Science and Technology Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Canada Science and Technology Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeScienceTechMuseum;

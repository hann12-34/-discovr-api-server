/**
 * Dominion City Brewing Ottawa Events Scraper
...
async function scrapeDominionCity(city = 'Ottawa') {
  console.log('🎵 Scraping Dominion City Brewing...');
  ...
  try {
    ...
    await page.goto('https://www.dominioncity.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Dominion City Brewing'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Dominion City Brewing events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Dominion City Brewing error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeDominionCity;

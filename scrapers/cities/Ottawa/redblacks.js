/**
 * Ottawa Redblacks Ottawa Events Scraper
...
async function scrapeRedblacks(city = 'Ottawa') {
  ...
  try {
    ...
    await page.goto('https://www.ottawaredblacks.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ottawa Redblacks events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Ottawa Redblacks error: ${error.message}`);
    return [];
  }
}

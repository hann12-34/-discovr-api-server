/**
 * Fauna Ottawa Events Scraper
 * URL: https://faunottawa.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFauna(city = 'Ottawa') {
  console.log('🎵 Scraping Fauna...');
  ...
  try {
    ...
    await page.goto('https://faunottawa.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fauna events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Fauna error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeFauna;

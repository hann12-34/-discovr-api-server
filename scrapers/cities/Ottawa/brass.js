/**
 * Brass Monkey Ottawa Events Scraper
...
async function scrapeBrass(city = 'Ottawa') {
  console.log('🎵 Scraping Brass Monkey Ottawa...');
  ...
  try {
    ...
    await page.goto('https://brassmonkeyottawa.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Brass Monkey events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Brass Monkey error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeBrass;

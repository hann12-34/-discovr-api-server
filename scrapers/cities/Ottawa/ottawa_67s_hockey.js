/**
 * Ottawa 67's OHL Hockey Events Scraper
 * URL: https://ottawa67s.com/schedule
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrape67sGames(city = 'Ottawa') {
  ...
  try {
    ...
    await page.goto('https://ottawa67s.com/schedule', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} 67s games`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  67s error:', error.message);
    return [];
  }
}

module.exports = scrape67sGames;

/**
 * Whalesbone Oyster House Ottawa Events Scraper
...
async function scrapeWhalesbone(city = 'Ottawa') {
  console.log('🎵 Scraping Whalesbone Oyster House...');
  ...
  try {
    ...
    await page.goto('https://thewhalesbone.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Whalesbone Oyster House'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Whalesbone Oyster House events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Whalesbone Oyster House error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeWhalesbone;

/**
 * Ottawa Jazz Festival Ottawa Events Scraper
...
async function scrapeOttawajazzfest(city = 'Ottawa') {
  console.log('🎵 Scraping Ottawa Jazz Festival Ottawa...');
  ...
  try {
    ...
    await page.goto('https://ottawajazzfestival.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ottawa Jazz Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Ottawa Jazz Festival error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeOttawajazzfest;

...
async function scrapeWinterlude(city = 'Ottawa') {
  console.log('🎵 Scraping Winterlude Festival Ottawa...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Winterlude Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Winterlude Festival error: ${error.message}`);
    return [];
  }
}

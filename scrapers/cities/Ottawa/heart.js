/**
 * Heart & Crown Ottawa Events Scraper
...
async function scrapeHeart(city = 'Ottawa') {
  console.log('🎵 Scraping Heart & Crown Ottawa...');
  ...
  try {
    ...
    await page.goto('https://heartandcrown.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Heart & Crown events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Heart & Crown error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeHeart;

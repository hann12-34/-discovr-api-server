/**
 * Mercury Lounge Ottawa Events Scraper
 * URL: https://www.mercurylounge.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMercuryLounge(city = 'Ottawa') {
  console.log('🎶 Scraping Mercury Lounge...');
  ...
  try {
    ...
    await page.goto('https://www.mercurylounge.ca', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mercury Lounge events`);
...
module.exports = scrapeMercuryLounge;

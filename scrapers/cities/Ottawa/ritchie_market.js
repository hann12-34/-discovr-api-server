/**
 * ByWard Market Ottawa Events Scraper
 * URL: https://byward-market.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeByWardMarket(city = 'Ottawa') {
  console.log('🎪 Scraping ByWard Market...');
  ...
  try {
    ...
    await page.goto('https://byward-market.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ByWard Market events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ByWard Market error:', error.message);
    return [];
  }
}

module.exports = scrapeByWardMarket;

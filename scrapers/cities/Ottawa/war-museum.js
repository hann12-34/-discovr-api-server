/**
 * Canadian War Museum Ottawa Events Scraper
...
async function scrapeWarMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Canadian War Museum...');
  ...
  try {
    ...
    await page.goto('https://www.warmuseum.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Canadian War Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Canadian War Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeWarMuseum;

/**
 * Ottawa Art Gallery Ottawa Events Scraper
 * URL: https://oaggao.ca
 */
...
async function scrapeOttawaArtGallery(city = 'Ottawa') {
  console.log('🎵 Scraping Ottawa Art Gallery...');
  ...
  try {
    ...
    await page.goto('https://oaggao.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ottawa Art Gallery events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Ottawa Art Gallery error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeOttawaArtGallery;

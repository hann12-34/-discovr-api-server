/**
 * Perfect Bass Ottawa Events Scraper
 * URL: https://perfectbass.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePerfectBass(city = 'Ottawa') {
  console.log('🎵 Scraping Perfect Bass...');
  ...
  try {
    ...
    await page.goto('https://perfectbass.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Perfect Bass events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Perfect Bass error: ${error.message}`);
    return [];
  }
}

module.exports = scrapePerfectBass;

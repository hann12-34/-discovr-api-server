/**
 * Kichesippi Beer Co Ottawa Events Scraper
 * URL: https://kbeer.ca
 */
...
async function scrapeKichesippi(city = 'Ottawa') {
  console.log('🎵 Scraping Kichesippi Beer Co...');
  ...
  try {
    ...
    await page.goto('https://kbeer.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Kichesippi Beer Co'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Kichesippi Beer Co events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Kichesippi Beer Co error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeKichesippi;

/**
 * The Prescott Ottawa Events Scraper
 * URL: https://prescotthotel.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThePrescott(city = 'Ottawa') {
  console.log('🎵 Scraping The Prescott...');
  ...
  try {
    ...
    await page.goto('https://prescotthotel.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Prescott events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  The Prescott error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeThePrescott;

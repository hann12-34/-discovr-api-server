...
async function scrapeLaffe(city = 'Ottawa') {
  console.log('🎵 Scraping Laffé Ottawa...');
  ...
  try {
    ...
    await page.goto('https://laffe.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Laffé events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Laffé error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeLaffe;

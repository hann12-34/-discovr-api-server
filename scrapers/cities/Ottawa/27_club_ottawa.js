/**
 * 27 Club Ottawa Events Scraper  
 * URL: https://www.27club.ca
 */
...
async function scrape27Club(city = 'Ottawa') {
  ...
  try {
    ...
    await page.goto('https://www.27club.ca', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} 27 Club events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  27 Club error:', error.message);
    return [];
  }
}

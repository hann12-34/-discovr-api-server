/**
 * NAC Ottawa - Ottawa Events Scraper (Puppeteer)
...
async function scrapeNACOttawa(city = 'Ottawa') {
  console.log('🎭 Scraping NAC Ottawa (Puppeteer)...');
  let browser;
  try {
    ...
    for (const raw of rawEvents) {
      ...
      events.push({
        ...
        url: eventUrl,
        imageUrl: img,
        venue: { name: 'NAC Ottawa', address: raw.address || '1 Elgin St, Ottawa', city: 'Ottawa' },
        latitude: 45.4231,
        longitude: -75.6927,
        city: 'Ottawa',
        category: 'Events',
    ...
    console.log('  ✅ NAC Ottawa:', futureEvents.length, 'events');
...
module.exports = scrapeNACOttawa;

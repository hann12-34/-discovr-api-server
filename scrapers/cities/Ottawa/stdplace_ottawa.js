/**
 * TD Place Ottawa Stadium Events Scraper
 * URL: https://www.tdplace.ca/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTDPlaceStadium(city = 'Ottawa') {
  console.log('🏟️ Scraping TD Place Stadium...');
  ...
  try {
    ...
    await page.goto('https://www.tdplace.ca/events', {
...
module.exports = scrapeTDPlaceStadium;

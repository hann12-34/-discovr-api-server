/**
 * House of TARG Ottawa Arcade Bar Events Scraper
...
async function scrapeHouseOfTarg(city = 'Ottawa') {
  console.log('🎮 Scraping House of TARG...');
  ...
  try {
    ...
    await page.goto('https://www.houseoftarg.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'House of TARG',
          address: '1077 Bank Street, Ottawa ON K1S 3X4',
          city: 'Ottawa'
        },
        latitude: 45.3969,
        longitude: -75.6831,
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'House of TARG'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} House of TARG events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  House of TARG error:', error.message);
    return [];
  }
}

module.exports = scrapeHouseOfTarg;

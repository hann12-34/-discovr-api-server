/**
 * North and South Ottawa Events Scraper
 * URL: https://northandsouth.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNorthSouth(city = 'Ottawa') {
  console.log('🎵 Scraping North and South...');
  ...
  try {
    ...
    await page.goto('https://northandsouth.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} North and South events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  North and South error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeNorthSouth;

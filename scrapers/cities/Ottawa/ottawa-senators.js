/**
 * Ottawa Senators Ottawa Events Scraper
...
async function scrapeOttawaSenators(city = 'Ottawa') {
  ...
  try {
    ...
    await page.goto('https://www.nhl.com/senators/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ottawa Senators events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Ottawa Senators error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeOttawaSenators;

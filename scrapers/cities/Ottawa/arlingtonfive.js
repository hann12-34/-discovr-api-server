/**
 * Arlington Five Ottawa Events Scraper
...
async function scrapeArlingtonfive(city = 'Ottawa') {
  console.log('🎵 Scraping Arlington Five Ottawa...');
  ...
  try {
    ...
    await page.goto('https://arlingtonfive.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Arlington Five'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Arlington Five events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Arlington Five error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeArlingtonfive;

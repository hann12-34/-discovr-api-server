/**
 * Flora Hall Brewing Ottawa Events Scraper
...
async function scrapeFloraHall(city = 'Ottawa') {
  console.log('🎵 Scraping Flora Hall Brewing...');
  ...
  try {
    ...
    await page.goto('https://florahallbrewing.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Flora Hall Brewing'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Flora Hall Brewing events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Flora Hall Brewing error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeFloraHall;

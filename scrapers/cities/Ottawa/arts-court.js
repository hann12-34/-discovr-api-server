/**
 * Arts Court Ottawa Events Scraper
...
async function scrapeArtsCourt(city = 'Ottawa') {
  console.log('🎵 Scraping Arts Court...');
  ...
  try {
    ...
    await page.goto('https://artscourt.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Arts Court events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Arts Court error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeArtsCourt;

/**
 * Canadian Museum of History Ottawa Events Scraper
...
async function scrapeHistoryMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Canadian Museum of History...');
  ...
  try {
    ...
    await page.goto('https://www.historymuseum.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Canadian Museum of History events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Canadian Museum of History error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeHistoryMuseum;

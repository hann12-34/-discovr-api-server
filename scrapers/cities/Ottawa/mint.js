/**
 * Royal Canadian Mint Ottawa Events Scraper
...
async function scrapeMint(city = 'Ottawa') {
  console.log('🎵 Scraping Royal Canadian Mint...');
  ...
  try {
    ...
    await page.goto('https://www.mint.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Royal Canadian Mint events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Royal Canadian Mint error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeMint;

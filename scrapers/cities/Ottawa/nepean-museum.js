/**
 * Nepean Museum Ottawa Events Scraper
 * URL: https://nepeanmuseum.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNepeanMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Nepean Museum...');
  ...
  try {
    ...
    await page.goto('https://nepeanmuseum.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Nepean Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Nepean Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeNepeanMuseum;

/**
 * Glowfair Ottawa Events Scraper
...
async function scrapeGlowfair(city = 'Ottawa') {
  console.log('🎵 Scraping Glowfair Ottawa...');
  ...
  try {
    ...
    await page.goto('https://glowfair.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Glowfair events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Glowfair error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeGlowfair;

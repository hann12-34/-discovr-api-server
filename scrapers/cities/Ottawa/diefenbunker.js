/**
 * Diefenbunker Museum Ottawa Events Scraper
...
async function scrapeDiefenbunker(city = 'Ottawa') {
  console.log('🎵 Scraping Diefenbunker Museum...');
  ...
  try {
    ...
    await page.goto('https://diefenbunker.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Ottawa',
        category: 'Nightlife',
        source: 'Diefenbunker Museum'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Diefenbunker Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Diefenbunker Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeDiefenbunker;

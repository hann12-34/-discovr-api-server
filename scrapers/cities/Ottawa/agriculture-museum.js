/**
 * Canada Agriculture and Food Museum Ottawa Events Scraper
...
async function scrapeAgricultureMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Canada Agriculture and Food Museum...');
  ...
  try {
    ...
    await page.goto('https://ingeniumcanada.org/agriculture/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Canada Agriculture and Food Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Canada Agriculture and Food Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeAgricultureMuseum;

/**
 * Canada Aviation and Space Museum Ottawa Events Scraper
...
async function scrapeAviationMuseum(city = 'Ottawa') {
  console.log('🎵 Scraping Canada Aviation and Space Museum...');
  ...
  try {
    ...
    await page.goto('https://ingeniumcanada.org/aviation/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Canada Aviation and Space Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Canada Aviation and Space Museum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeAviationMuseum;

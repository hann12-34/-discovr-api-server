/**
 * The Manx Ottawa Events Scraper
 * URL: https://themanx.ca
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheManx(city = 'Ottawa') {
  console.log('🎵 Scraping The Manx...');
  ...
  try {
    ...
    await page.goto('https://themanx.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Manx events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  The Manx error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeTheManx;

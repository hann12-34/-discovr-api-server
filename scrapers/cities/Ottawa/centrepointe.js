/**
 * Centrepointe Theatre Ottawa Events Scraper
 * URL: https://centrepointetheatre.com
 */
...
async function scrapeCentrepointe(city = 'Ottawa') {
  console.log('🎵 Scraping Centrepointe Theatre...');
  ...
  try {
    ...
    await page.goto('https://centrepointetheatre.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '101 Centrepointe Dr, Nepean, ON K2G 5K7',
          city: 'Ottawa'
        },
        latitude: 45.3465,
        longitude: -75.7615,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Centrepointe Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Centrepointe Theatre error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeCentrepointe;

/**
 * Empire Music Hall Belfast Events Scraper
 * Live music venue
 * URL: https://www.thebelfast-empire.com/
 */
...
async function scrapeEmpireBelfast(city = 'Belfast') {
  console.log('🎸 Scraping Empire Music Hall Belfast...');
  ...
  try {
    ...
    await page.goto('https://www.thebelfast-empire.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Empire Belfast events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Empire Music Hall', address: '42 Botanic Avenue, Belfast BT7 1JQ', city: 'Belfast' },
        latitude: 54.5862,
        longitude: -5.9360,
        city: 'Belfast',
        category: 'Nightlife',
        source: 'Empire Music Hall'
      });
    }
    ...
    console.error('  ⚠️  Empire Belfast error:', error.message);
    return [];
  }
}

module.exports = scrapeEmpireBelfast;

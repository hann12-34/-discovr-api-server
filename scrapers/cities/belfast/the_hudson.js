/**
 * The Hudson Belfast Events Scraper
 * URL: https://www.thehudsonbar.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHudson(city = 'Belfast') {
  console.log('🎸 Scraping The Hudson...');
  ...
  try {
    ...
    await page.goto('https://www.thehudsonbar.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Hudson',
          address: '10 Gresham St, Belfast BT1 1JN',
          city: 'Belfast'
        },
        latitude: 54.5990,
        longitude: -5.9320,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Hudson events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Hudson error:', error.message);
    return [];
  }
}

module.exports = scrapeHudson;

/**
 * The Kremlin Belfast Events Scraper
 * URL: https://www.kremlin-belfast.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKremlin(city = 'Belfast') {
  console.log('🎉 Scraping The Kremlin...');
  ...
  try {
    ...
    await page.goto('https://www.kremlin-belfast.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Kremlin',
          address: '96 Donegall St, Belfast BT1 2GU',
          city: 'Belfast'
        },
        latitude: 54.6010,
        longitude: -5.9310,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kremlin events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kremlin error:', error.message);
    return [];
  }
}

module.exports = scrapeKremlin;

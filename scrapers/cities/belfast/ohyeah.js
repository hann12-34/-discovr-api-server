/**
 * Oh Yeah Music Centre Belfast Events Scraper
 * Music venue and exhibition space
 * URL: https://www.ohyeahbelfast.com/
 */
...
async function scrapeOhYeah(city = 'Belfast') {
  console.log('🎵 Scraping Oh Yeah Belfast...');
  ...
  try {
    ...
    await page.goto('https://www.ohyeahbelfast.com/whats-on/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Oh Yeah events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Oh Yeah Music Centre', address: '15-21 Gordon Street, Belfast BT1 2LG', city: 'Belfast' },
        latitude: 54.6007,
        longitude: -5.9262,
        city: 'Belfast',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Oh Yeah error:', error.message);
    return [];
  }
}

module.exports = scrapeOhYeah;

/**
 * Lyric Theatre Belfast Events Scraper
 * URL: https://www.lyrictheatre.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLyricTheatre(city = 'Belfast') {
  console.log('🎭 Scraping Lyric Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.lyrictheatre.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lyric Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lyric Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeLyricTheatre;

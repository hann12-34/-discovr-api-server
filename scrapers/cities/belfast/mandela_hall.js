/**
 * Mandela Hall Belfast Events Scraper
 * URL: https://www.mandelahall.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMandelaHall(city = 'Belfast') {
  console.log('🎭 Scraping Mandela Hall...');
  ...
  try {
    ...
    await page.goto('https://www.mandelahall.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Mandela Hall',
          address: 'Queens University, Belfast BT7 1NN',
          city: 'Belfast'
        },
        latitude: 54.5840,
        longitude: -5.9340,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mandela Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mandela Hall error:', error.message);
    return [];
  }
}

module.exports = scrapeMandelaHall;

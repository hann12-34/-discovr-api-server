/**
 * The Points Belfast Events Scraper
 * URL: https://www.thepointswharf.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThePoints(city = 'Belfast') {
  console.log('🎵 Scraping The Points...');
  ...
  try {
    ...
    await page.goto('https://www.thepointswharf.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Points',
          address: 'Queens Quay, Belfast BT3 9QQ',
          city: 'Belfast'
        },
        latitude: 54.6070,
        longitude: -5.9060,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Points events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Points error:', error.message);
    return [];
  }
}

module.exports = scrapeThePoints;

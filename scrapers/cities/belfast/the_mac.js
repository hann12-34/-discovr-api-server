/**
 * The MAC Belfast Events Scraper
 * URL: https://themaclive.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheMAC(city = 'Belfast') {
  console.log('🎨 Scraping The MAC...');
  ...
  try {
    ...
    await page.goto('https://themaclive.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The MAC',
          address: '10 Exchange St W, Belfast BT1 2NJ',
          city: 'Belfast'
        },
        latitude: 54.6000,
        longitude: -5.9280,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The MAC events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The MAC error:', error.message);
    return [];
  }
}

module.exports = scrapeTheMAC;

/**
 * Black Box Belfast Events Scraper
 * URL: https://www.blackboxbelfast.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBlackBox(city = 'Belfast') {
  console.log('⬛ Scraping Black Box...');
  ...
  try {
    ...
    await page.goto('https://www.blackboxbelfast.com/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Black Box events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Black Box error:', error.message);
    return [];
  }
}

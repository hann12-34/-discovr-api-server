/**
 * The Duke of York Belfast Events Scraper
 * URL: https://www.dukeofyorkbelfast.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDukeOfYork(city = 'Belfast') {
  console.log('🍺 Scraping Duke of York...');
  ...
  try {
    ...
    await page.goto('https://www.dukeofyorkbelfast.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Duke of York events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Duke of York error:', error.message);
    return [];
  }
}

module.exports = scrapeDukeOfYork;

...
async function scrapeUlsterHall(city = 'Belfast') {
  ...
  try {
    ...
    await page.goto('https://www.ulsterhall.co.uk/whats-on/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Live at Ulster Hall Belfast`,
        date: isoDate,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Ulster Hall events`);

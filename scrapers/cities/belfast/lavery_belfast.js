/**
 * Lavery's Belfast Events Scraper
 * URL: https://www.laverysbelfast.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLaverys(city = 'Belfast') {
  console.log('🍺 Scraping Laverys...');
  ...
  try {
    ...
    await page.goto('https://www.laverysbelfast.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Laverys events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Laverys error:', error.message);
    return [];
  }
}

module.exports = scrapeLaverys;

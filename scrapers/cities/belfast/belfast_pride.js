/**
 * Belfast Pride Festival Events Scraper
 * URL: https://www.belfastpride.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBelfastPride(city = 'Belfast') {
  console.log('🏳️‍🌈 Scraping Belfast Pride...');
  ...
  try {
    ...
    await page.goto('https://www.belfastpride.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Custom House Square, Belfast',
          city: 'Belfast'
        },
        latitude: 54.5988,
        longitude: -5.9260,
        city: 'Belfast',
        category: 'Festival',
        source: 'Belfast Pride'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Belfast Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Belfast Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeBelfastPride;

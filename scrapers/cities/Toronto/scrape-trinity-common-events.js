...
const EVENTS_URL = 'https://trinitycommon.ca/';
const VENUE_NAME = 'Trinity Common';
const VENUE_ADDRESS = '60 Atlantic Ave, Toronto, ON M6K 1X9';

async function trinitycommonEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = trinitycommonEvents;

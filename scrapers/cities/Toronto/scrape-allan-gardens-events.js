...
const EVENTS_URL = 'https://www.eventbrite.ca/d/canada--toronto/events--this-weekend/';
const VENUE_NAME = 'Allan Gardens';
const VENUE_ADDRESS = '160 Gerrard St E, Toronto, ON M5A 2E4';

async function allangardensEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = allangardensEvents;

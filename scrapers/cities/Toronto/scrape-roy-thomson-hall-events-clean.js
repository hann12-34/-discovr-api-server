...
const BASE_URL = 'https://roythomsonhall.mhrth.com/tickets/';
...
async function scrapeRoyThomsonHallEventsClean(city) {
  ...
  try {
    ...
    console.log('🚀 Scraping Roy Thomson Hall events (clean version)...');
    ...
    for (const selector of eventSelectors) {
      $(selector).each((i, el) => {
        ...
        candidateEvents.push({
          ...
          dateText,
          description: description || `Experience ${title} at the Roy Thomson Hall in Toronto.`,
          qualityScore
        });
      });
    }
...
module.exports = { scrapeEvents: scrapeRoyThomsonHallEventsClean  };

/**
 * Vertigo Events Scraper
 * Based on events from https://vertigo.komi.io/
 */
...
// Constants
const VERTIGO_URL = 'https://vertigo.komi.io/';
const VERTIGO_VENUE = {
  name: 'Vertigo',
...
function generateEventId(title, startDate) {
  const dataToHash = `${VERTIGO_VENUE.name}-${title}-${startDate.toISOString()}`;
...
function normalizeUrl(url, baseUrl = 'https://vertigo.komi.io') {
  if (!url) return '';

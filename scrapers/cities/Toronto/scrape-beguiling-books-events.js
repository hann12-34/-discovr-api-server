...
const EVENTS_URL = 'https://www.songkick.com/metro-areas/27539-canada-toronto/calendar';
const VENUE_NAME = 'Beguiling Books';
const VENUE_ADDRESS = '601 Markham St, Toronto, ON M6G 2L7';

async function beguilingbooksEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = beguilingbooksEvents;

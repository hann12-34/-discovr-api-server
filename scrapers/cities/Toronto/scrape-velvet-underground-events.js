...
const EVENTS_URL = 'https://ra.co/clubs/4476/events';
const VENUE_NAME = 'Velvet Underground';
const VENUE_ADDRESS = '508 Queen St W, Toronto, ON M5V 2B3';

async function velvetundergroundEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = velvetundergroundEvents;

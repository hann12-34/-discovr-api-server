...
const VENUE_NAME = 'Aga Khan Museum';
const VENUE_ADDRESS = '77 Wynford Dr, Toronto, ON M3C 1K1';

async function agakhanmuseumEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = agakhanmuseumEvents;

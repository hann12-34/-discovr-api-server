...
const EVENTS_URL = 'https://factorytheatre.ca/';
const VENUE_NAME = 'Sugar Beach';
const VENUE_ADDRESS = '11 Dockside Dr, Toronto, ON M5A 0B5';

async function sugarbeachEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = sugarbeachEvents;

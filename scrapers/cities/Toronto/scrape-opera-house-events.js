...
const EVENTS_URL = 'https://www.canadianstage.com/';
const VENUE_NAME = 'Opera House';
const VENUE_ADDRESS = '735 Queen St E, Toronto, ON M4M 1H1';

async function operahouseEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = operahouseEvents;

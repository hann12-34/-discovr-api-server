...
const EVENTS_URL = 'https://ra.co/clubs/33851/events';
const VENUE_NAME = 'Stories';
const VENUE_ADDRESS = '379 King St W, Toronto, ON M5V 1K1';

async function storiesnightclubEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = storiesnightclubEvents;

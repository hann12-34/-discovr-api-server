...
const EVENTS_URL = 'https://www.ticketmaster.ca/search?q=toronto&sort=date%2Casc';
const VENUE_NAME = 'Wychwood Barns';
const VENUE_ADDRESS = '601 Christie St, Toronto, ON M6G 4C7';

async function wychwoodbarnsEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = wychwoodbarnsEvents;

...
const VENUE_NAME = 'Horseshoe Tavern';
const VENUE_ADDRESS = '370 Queen St W, Toronto, ON M5V 2A2';

async function horseshoetavernEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = horseshoetavernEvents;

...
const VENUE_NAME = 'Billy Bishop Airport';
const VENUE_ADDRESS = '2 Eireann Quay, Toronto, ON M5V 1A1';

async function billybishopairportEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = billybishopairportEvents;

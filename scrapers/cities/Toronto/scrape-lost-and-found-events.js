...
const EVENTS_URL = 'https://lostandfoundbar.com/';
const VENUE_NAME = 'Lost and Found';
const VENUE_ADDRESS = '577 King St W, Toronto, ON M5V 1M1';

async function lostandfoundEvents(city = 'Toronto') {
  if (city !== 'Toronto') {
...
module.exports = lostandfoundEvents;

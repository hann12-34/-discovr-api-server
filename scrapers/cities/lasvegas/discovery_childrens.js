/**
 * Discovery Children's Museum Las Vegas Events Scraper
 * URL: https://discoverykidslv.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDiscoveryMuseum(city = 'Las Vegas') {
  console.log('👶 Scraping Discovery Museum...');
  ...
  try {
    ...
    await page.goto('https://discoverykidslv.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Discovery Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Discovery Museum error:', error.message);
    return [];
  }
}

module.exports = scrapeDiscoveryMuseum;

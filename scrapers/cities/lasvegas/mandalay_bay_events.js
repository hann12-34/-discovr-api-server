/**
 * Mandalay Bay Events Center Las Vegas Scraper
 * URL: https://www.mandalaybay.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMandalayBay(city = 'Las Vegas') {
  console.log('🏖️ Scraping Mandalay Bay Events...');
  ...
  try {
    ...
    await page.goto('https://www.mandalaybay.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mandalay Bay events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mandalay Bay error:', error.message);
    return [];
  }
}

module.exports = scrapeMandalayBay;

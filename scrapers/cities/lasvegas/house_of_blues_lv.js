/**
 * House of Blues Las Vegas Events Scraper
 * URL: https://www.houseofblues.com/lasvegas/EventCalendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHOBLV(city = 'Las Vegas') {
  console.log('🎸 Scraping House of Blues LV...');
  ...
  try {
    ...
    await page.goto('https://www.houseofblues.com/lasvegas/EventCalendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Las Vegas',
        category: 'Nightlife',
        source: 'House of Blues LV'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} House of Blues LV events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  House of Blues LV error:', error.message);
    return [];
  }
}

module.exports = scrapeHOBLV;

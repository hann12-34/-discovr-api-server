/**
 * Las Vegas Live (Tropicana) Events Scraper
 * URL: https://www.troplv.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTropicana(city = 'Las Vegas') {
  console.log('🌴 Scraping Tropicana...');
  ...
  try {
    ...
    await page.goto('https://www.troplv.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Tropicana events`);

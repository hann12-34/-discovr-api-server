/**
 * The Venetian Theatre Las Vegas Events Scraper
...
async function scrapeVenetian(city = 'Las Vegas') {
  console.log('🎭 Scraping Venetian Theatre...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Venetian Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Venetian Theatre error:', error.message);
    return [];
  }
}

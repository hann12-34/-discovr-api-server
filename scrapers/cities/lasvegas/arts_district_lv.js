/**
 * Las Vegas Arts District Events Scraper
 * URL: https://www.lasvegasartsdistrict.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeArtsDistrict(city = 'Las Vegas') {
  console.log('🎨 Scraping Arts District...');
  ...
  try {
    ...
    await page.goto('https://www.lasvegasartsdistrict.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Arts District events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Arts District error:', error.message);
    return [];
  }
}

module.exports = scrapeArtsDistrict;

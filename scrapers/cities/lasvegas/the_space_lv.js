/**
 * The Space LV Events Scraper
 * URL: https://thespacelv.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheSpaceLV(city = 'Las Vegas') {
  console.log('🚀 Scraping The Space LV...');
  ...
  try {
    ...
    await page.goto('https://thespacelv.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Space LV',
          address: '3460 Cavaretta Ct, Las Vegas, NV 89103',
          city: 'Las Vegas'
        },
        latitude: 36.1282,
        longitude: -115.2018,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Space LV events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Space LV error:', error.message);
    return [];
  }
}

module.exports = scrapeTheSpaceLV;

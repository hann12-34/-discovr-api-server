/**
 * Chelsea Ballroom at The Cosmopolitan Events Scraper
 * URL: https://www.cosmopolitanlasvegas.com/entertainment/chelsea
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeChelsea(city = 'Las Vegas') {
  console.log('🎪 Scraping Chelsea...');
  ...
  try {
    ...
    await page.goto('https://www.cosmopolitanlasvegas.com/entertainment/chelsea', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Chelsea events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Chelsea error:', error.message);
    return [];
  }
}

module.exports = scrapeChelsea;

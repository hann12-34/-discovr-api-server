 ...
 * URL: https://hakkasanlv.com/events
 */
...
async function scrapeHakkasan(city = 'Las Vegas') {
  ...
  try {
    ...
    await page.goto('https://hakkasanlv.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Hakkasan events`);

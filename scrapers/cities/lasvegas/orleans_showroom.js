/**
 * The Orleans Las Vegas Entertainment Scraper
 * URL: https://www.orleanscasino.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOrleans(city = 'Las Vegas') {
  console.log('🎺 Scraping Orleans...');
  ...
  try {
    ...
    await page.goto('https://www.orleanscasino.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Orleans events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Orleans error:', error.message);
    return [];
  }
}

module.exports = scrapeOrleans;

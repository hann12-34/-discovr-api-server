/**
 * ARIA Resort Las Vegas Entertainment Scraper
 * URL: https://www.aria.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAria(city = 'Las Vegas') {
  console.log('🏨 Scraping ARIA...');
  ...
  try {
    ...
    await page.goto('https://www.aria.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ARIA events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ARIA error:', error.message);
    return [];
  }
}

module.exports = scrapeAria;

/**
 * Thomas & Mack Center Las Vegas Events Scraper
 * URL: https://www.thomasandmack.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThomasMack(city = 'Las Vegas') {
  console.log('🏀 Scraping Thomas & Mack...');
  ...
  try {
    ...
    await page.goto('https://www.thomasandmack.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Thomas & Mack events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Thomas & Mack error:', error.message);
    return [];
  }
}

module.exports = scrapeThomasMack;

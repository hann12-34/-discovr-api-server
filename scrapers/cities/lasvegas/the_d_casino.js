/**
 * The D Las Vegas Entertainment Scraper
 * URL: https://www.thed.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheD(city = 'Las Vegas') {
  console.log('🎲 Scraping The D...');
  ...
  try {
    ...
    await page.goto('https://www.thed.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The D events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The D error:', error.message);
    return [];
  }
}

module.exports = scrapeTheD;

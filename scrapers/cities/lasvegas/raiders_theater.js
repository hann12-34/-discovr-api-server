/**
 * Luxor Theater Las Vegas Events Scraper
 * URL: https://luxor.mgmresorts.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLuxorTheater(city = 'Las Vegas') {
  console.log('🔺 Scraping Luxor Theater...');
  ...
  try {
    ...
    await page.goto('https://luxor.mgmresorts.com/en/entertainment.html', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Las Vegas',
        category: 'Nightlife',
        source: 'Luxor Theater'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Luxor Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Luxor Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeLuxorTheater;

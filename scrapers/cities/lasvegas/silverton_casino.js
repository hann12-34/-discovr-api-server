/**
 * Silverton Casino Las Vegas Entertainment Scraper
 * URL: https://www.silvertoncasino.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSilverton(city = 'Las Vegas') {
  console.log('🦌 Scraping Silverton...');
  ...
  try {
    ...
    await page.goto('https://www.silvertoncasino.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Silverton events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Silverton error:', error.message);
    return [];
  }
}

module.exports = scrapeSilverton;

/**
 * Las Vegas Ballpark Events Scraper
 * URL: https://www.milb.com/las-vegas/ballpark/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLVBallpark(city = 'Las Vegas') {
  console.log('⚾ Scraping LV Ballpark...');
  ...
  try {
    ...
    await page.goto('https://www.milb.com/las-vegas/ballpark/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} LV Ballpark events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  LV Ballpark error:', error.message);
    return [];
  }
}

module.exports = scrapeLVBallpark;

/**
 * Cannery Casino Las Vegas Entertainment Scraper
 * URL: https://www.cannerycasinos.com/las-vegas/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCannery(city = 'Las Vegas') {
  console.log('🏭 Scraping Cannery...');
  ...
  try {
    ...
    await page.goto('https://www.cannerycasinos.com/las-vegas/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cannery events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cannery error:', error.message);
    return [];
  }
}

module.exports = scrapeCannery;

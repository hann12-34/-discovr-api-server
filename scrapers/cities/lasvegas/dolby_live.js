/**
 * Dolby Live at Park MGM Events Scraper
 * URL: https://www.parkmgm.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDolbyLive(city = 'Las Vegas') {
  console.log('🎬 Scraping Dolby Live...');
  ...
  try {
    ...
    await page.goto('https://www.parkmgm.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Dolby Live events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dolby Live error:', error.message);
    return [];
  }
}

module.exports = scrapeDolbyLive;

/**
 * Harrah's Las Vegas Entertainment Scraper
 * URL: https://www.caesars.com/harrahs-las-vegas/shows
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHarrahs(city = 'Las Vegas') {
  console.log('🎰 Scraping Harrahs...');
  ...
  try {
    ...
    await page.goto('https://www.caesars.com/harrahs-las-vegas/shows', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Harrahs events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Harrahs error:', error.message);
    return [];
  }
}

module.exports = scrapeHarrahs;

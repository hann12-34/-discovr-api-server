/**
 * Laugh Factory Las Vegas Events Scraper
 * URL: https://laughfactory.com/clubs/las-vegas
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLaughFactory(city = 'Las Vegas') {
  console.log('😂 Scraping Laugh Factory...');
  ...
  try {
    ...
    await page.goto('https://laughfactory.com/clubs/las-vegas', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Laugh Factory events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Laugh Factory error:', error.message);
    return [];
  }
}

module.exports = scrapeLaughFactory;

/**
 * Boulder Station Railhead Las Vegas Events Scraper
 * URL: https://www.boulderstation.sclv.com/entertainment/railhead
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRailhead(city = 'Las Vegas') {
  console.log('🚂 Scraping Railhead...');
  ...
  try {
    ...
    await page.goto('https://www.boulderstation.sclv.com/entertainment/railhead', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Railhead at Boulder Station',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Railhead events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Railhead error:', error.message);
    return [];
  }
}

module.exports = scrapeRailhead;

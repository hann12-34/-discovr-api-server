/**
 * Green Valley Ranch Las Vegas Entertainment Scraper
 * URL: https://www.greenvalleyranch resort.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGVR(city = 'Las Vegas') {
  console.log('🌿 Scraping Green Valley Ranch...');
  ...
  try {
    ...
    await page.goto('https://www.greenvalleyranchresort.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} GVR events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  GVR error:', error.message);
    return [];
  }
}

module.exports = scrapeGVR;

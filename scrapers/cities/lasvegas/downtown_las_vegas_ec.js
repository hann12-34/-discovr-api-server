/**
 * Downtown Las Vegas Events Center Scraper
 * URL: https://www.dlvec.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDLVEC(city = 'Las Vegas') {
  console.log('🎉 Scraping DLVEC...');
  ...
  try {
    ...
    await page.goto('https://www.dlvec.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} DLVEC events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  DLVEC error:', error.message);
    return [];
  }
}

module.exports = scrapeDLVEC;

/**
 * AXIS Theater at Planet Hollywood Events Scraper
 * URL: https://www.caesars.com/planet-hollywood/shows/axis
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAXIS(city = 'Las Vegas') {
  console.log('🎪 Scraping AXIS Theater...');
  ...
  try {
    ...
    await page.goto('https://www.caesars.com/planet-hollywood/shows/axis', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} AXIS Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  AXIS Theater error:', error.message);
    return [];
  }
}

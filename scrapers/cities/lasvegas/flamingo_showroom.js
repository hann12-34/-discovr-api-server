/**
 * Flamingo Las Vegas Entertainment Scraper
 * URL: https://www.caesars.com/flamingo-las-vegas/shows
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFlamingo(city = 'Las Vegas') {
  console.log('🦩 Scraping Flamingo...');
  ...
  try {
    ...
    await page.goto('https://www.caesars.com/flamingo-las-vegas/shows', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Flamingo events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Flamingo error:', error.message);
    return [];
  }
}

module.exports = scrapeFlamingo;

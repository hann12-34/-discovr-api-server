/**
 * Sam Boyd Stadium Las Vegas Events Scraper
 * URL: https://www.unlvtickets.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSamBoyd(city = 'Las Vegas') {
  console.log('🏟️ Scraping Sam Boyd Stadium...');
  ...
  try {
    ...
    await page.goto('https://www.unlvtickets.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sam Boyd events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sam Boyd error:', error.message);
    return [];
  }
}

module.exports = scrapeSamBoyd;

/**
 * The Smith Center Las Vegas Events Scraper
 * URL: https://www.thesmithcenter.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSmithCenter(city = 'Las Vegas') {
  console.log('🎭 Scraping Smith Center...');
  ...
  try {
    ...
    await page.goto('https://www.thesmithcenter.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Smith Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Smith Center error:', error.message);
    return [];
  }
}

module.exports = scrapeSmithCenter;

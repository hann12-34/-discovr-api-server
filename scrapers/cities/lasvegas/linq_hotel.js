/**
 * The LINQ Hotel Las Vegas Entertainment Scraper
 * URL: https://www.caesars.com/linq/things-to-do/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLinq(city = 'Las Vegas') {
  console.log('🎡 Scraping LINQ...');
  ...
  try {
    ...
    await page.goto('https://www.caesars.com/linq/things-to-do/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} LINQ events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  LINQ error:', error.message);
    return [];
  }
}

module.exports = scrapeLinq;

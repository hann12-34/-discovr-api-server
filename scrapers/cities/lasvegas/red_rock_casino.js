/**
 * Red Rock Casino Las Vegas Entertainment Scraper
 * URL: https://www.redrock.sclv.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRedRock(city = 'Las Vegas') {
  console.log('🏜️ Scraping Red Rock...');
  ...
  try {
    ...
    await page.goto('https://www.redrock.sclv.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Red Rock events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Red Rock error:', error.message);
    return [];
  }
}

module.exports = scrapeRedRock;

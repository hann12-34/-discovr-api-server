/**
 * Hard Rock Hotel Las Vegas Events Scraper
 * URL: https://www.hardrockhotel.com/las-vegas/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHardRockLV(city = 'Las Vegas') {
  console.log('🎸 Scraping Hard Rock LV...');
  ...
  try {
    ...
    await page.goto('https://www.hardrockhotel.com/las-vegas/entertainment', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Hard Rock Hotel Las Vegas',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Hard Rock LV events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Hard Rock LV error:', error.message);
    return [];
  }
}

module.exports = scrapeHardRockLV;

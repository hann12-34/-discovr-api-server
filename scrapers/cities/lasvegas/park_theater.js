/**
 * Park Theater Las Vegas Events Scraper
 * URL: https://www.mgmresorts.com/en/entertainment/park-theater.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeParkTheater(city = 'Las Vegas') {
  console.log('🎭 Scraping Park Theater...');
  ...
  try {
    ...
    await page.goto('https://www.mgmresorts.com/en/entertainment/park-theater.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Park Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Park Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeParkTheater;

/**
 * On The Record Las Vegas Events Scraper
 * URL: https://ontherecordlv.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOnTheRecord(city = 'Las Vegas') {
  console.log('🎵 Scraping On The Record...');
  ...
  try {
    ...
    await page.goto('https://ontherecordlv.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} On The Record events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  On The Record error:', error.message);
    return [];
  }
}

module.exports = scrapeOnTheRecord;

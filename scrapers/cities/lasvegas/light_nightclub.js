/**
 * Light Nightclub Las Vegas Events Scraper
 * URL: https://lightvegas.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLight(city = 'Las Vegas') {
  console.log('💡 Scraping Light...');
  ...
  try {
    ...
    await page.goto('https://lightvegas.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Light events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Light error:', error.message);
    return [];
  }
}

module.exports = scrapeLight;

/**
 * Wet Republic Las Vegas Events Scraper
 * URL: https://wetrepublic.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWetRepublic(city = 'Las Vegas') {
  console.log('💦 Scraping Wet Republic...');
  ...
  try {
    ...
    await page.goto('https://wetrepublic.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wet Republic events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wet Republic error:', error.message);
    return [];
  }
}

module.exports = scrapeWetRepublic;

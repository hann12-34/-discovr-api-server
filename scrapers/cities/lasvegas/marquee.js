/**
 * Marquee Nightclub Las Vegas Events Scraper
 * URL: https://marqueelasvegas.com/events
 */
...
async function scrapeMarquee(city = 'Las Vegas') {
  ...
  try {
    ...
    await page.goto('https://marqueelasvegas.com/events', {

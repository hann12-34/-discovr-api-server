/**
 * The Mirage Theatre Las Vegas Events Scraper
 * URL: https://www.mirage.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMirage(city = 'Las Vegas') {
  console.log('🌋 Scraping Mirage...');
  ...
  try {
    ...
    await page.goto('https://www.mirage.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mirage events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mirage error:', error.message);
    return [];
  }
}

module.exports = scrapeMirage;

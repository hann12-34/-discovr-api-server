/**
 * Luxor Las Vegas Entertainment Scraper
 * URL: https://www.luxor.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLuxor(city = 'Las Vegas') {
  console.log('🔺 Scraping Luxor...');
  ...
  try {
    ...
    await page.goto('https://www.luxor.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Luxor events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Luxor error:', error.message);
    return [];
  }
}

module.exports = scrapeLuxor;

/**
 * South Point Arena Las Vegas Events Scraper
 * URL: https://southpointarena.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSouthPoint(city = 'Las Vegas') {
  console.log('🎯 Scraping South Point...');
  ...
  try {
    ...
    await page.goto('https://southpointarena.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} South Point events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  South Point error:', error.message);
    return [];
  }
}

module.exports = scrapeSouthPoint;

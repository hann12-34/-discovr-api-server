/**
 * Circa Resort Las Vegas Entertainment Scraper
 * URL: https://circalasvegas.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCirca(city = 'Las Vegas') {
  console.log('🎪 Scraping Circa...');
  ...
  try {
    ...
    await page.goto('https://circalasvegas.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Circa events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Circa error:', error.message);
    return [];
  }
}

module.exports = scrapeCirca;

/**
 * New York-New York Las Vegas Entertainment Scraper
 * URL: https://www.newyorknewyork.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNYNY(city = 'Las Vegas') {
  console.log('🗽 Scraping NYNY...');
  ...
  try {
    ...
    await page.goto('https://www.newyorknewyork.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} NYNY events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  NYNY error:', error.message);
    return [];
  }
}

module.exports = scrapeNYNY;

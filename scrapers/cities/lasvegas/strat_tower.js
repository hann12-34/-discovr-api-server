/**
 * The STRAT Las Vegas Entertainment Scraper
 * URL: https://thestrat.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStrat(city = 'Las Vegas') {
  console.log('🗼 Scraping STRAT...');
  ...
  try {
    ...
    await page.goto('https://thestrat.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} STRAT events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  STRAT error:', error.message);
    return [];
  }
}

module.exports = scrapeStrat;

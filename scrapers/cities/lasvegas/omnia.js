/**
 * Omnia Nightclub Las Vegas Events Scraper
 * URL: https://omnianightclub.com/events
 */
...
async function scrapeOmnia(city = 'Las Vegas') {
  ...
  try {
    ...
    await page.goto('https://omnianightclub.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Omnia events`);

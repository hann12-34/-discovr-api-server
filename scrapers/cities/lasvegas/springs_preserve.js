/**
 * Springs Preserve Las Vegas Events Scraper
 * URL: https://www.springspreserve.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSpringsPres(city = 'Las Vegas') {
  console.log('🌿 Scraping Springs Preserve...');
  ...
  try {
    ...
    await page.goto('https://www.springspreserve.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Springs Preserve events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Springs Preserve error:', error.message);
    return [];
  }
}

module.exports = scrapeSpringsPres;

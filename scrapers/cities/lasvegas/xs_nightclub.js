 ...
 * URL: https://xslasvegas.com/events
 */
...
async function scrapeXS(city = 'Las Vegas') {
  console.log('💫 Scraping XS Nightclub...');
  ...
  try {
    ...
    await page.goto('https://xslasvegas.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} XS Nightclub events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  XS Nightclub error:', error.message);
    return [];
  }
}

/**
 * Michelob ULTRA Arena Las Vegas Events Scraper
 * URL: https://www.mandalaybay.com/en/entertainment/michelob-ultra-arena.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMichelobArena(city = 'Las Vegas') {
  console.log('🍺 Scraping Michelob Arena...');
  ...
  try {
    ...
    await page.goto('https://www.mandalaybay.com/en/entertainment/michelob-ultra-arena.html', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Las Vegas',
        category: 'Festival',
        source: 'Michelob Arena'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Michelob Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Michelob Arena error:', error.message);
    return [];
  }
}

module.exports = scrapeMichelobArena;

/**
 * The Joint at Hard Rock Las Vegas Events Scraper
 * URL: https://www.hardrockhotellasvegas.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheJoint(city = 'Las Vegas') {
  console.log('🎸 Scraping The Joint...');
  ...
  try {
    ...
    await page.goto('https://www.hardrockhotellasvegas.com/entertainment', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Joint at Hard Rock Hotel',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Joint events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Joint error:', error.message);
    return [];
  }
}

module.exports = scrapeTheJoint;

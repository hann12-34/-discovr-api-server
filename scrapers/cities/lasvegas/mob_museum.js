/**
 * The Mob Museum Las Vegas Events Scraper
 * URL: https://themobmuseum.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMobMuseum(city = 'Las Vegas') {
  console.log('🕵️ Scraping Mob Museum...');
  ...
  try {
    ...
    await page.goto('https://themobmuseum.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mob Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mob Museum error:', error.message);
    return [];
  }
}

module.exports = scrapeMobMuseum;

 ...
 * URL: https://encorebeachclub.com/events
 */
...
async function scrapeEncoreBeach(city = 'Las Vegas') {
  console.log('🏖️ Scraping Encore Beach...');
  ...
  try {
    ...
    await page.goto('https://encorebeachclub.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Encore Beach events`);

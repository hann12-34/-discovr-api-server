/**
 * Town Square Las Vegas Events Scraper
 * URL: https://mytownsquarelasvegas.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTownSquare(city = 'Las Vegas') {
  console.log('🏛️ Scraping Town Square...');
  ...
  try {
    ...
    await page.goto('https://mytownsquarelasvegas.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Town Square events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Town Square error:', error.message);
    return [];
  }
}

module.exports = scrapeTownSquare;

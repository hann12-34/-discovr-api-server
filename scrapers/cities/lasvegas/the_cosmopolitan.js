/**
 * The Cosmopolitan Las Vegas Events Scraper
 * URL: https://www.cosmopolitanlasvegas.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCosmopolitan(city = 'Las Vegas') {
  console.log('🌆 Scraping Cosmopolitan...');
  ...
  try {
    ...
    await page.goto('https://www.cosmopolitanlasvegas.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cosmopolitan events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cosmopolitan error:', error.message);
    return [];
  }
}

module.exports = scrapeCosmopolitan;

/**
 * The Pearl Concert Theater at Palms Events Scraper
 * URL: https://www.palms.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePearl(city = 'Las Vegas') {
  console.log('🦪 Scraping Pearl Concert...');
  ...
  try {
    ...
    await page.goto('https://www.palms.com/entertainment', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Pearl Concert Theater',
        ...
        city: 'Las Vegas',
        category: 'Nightlife',
        source: 'Pearl Concert'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Pearl Concert events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Pearl Concert error:', error.message);
    return [];
  }
}

module.exports = scrapePearl;

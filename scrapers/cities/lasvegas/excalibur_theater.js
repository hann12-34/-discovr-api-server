/**
 * Excalibur Las Vegas Entertainment Scraper
 * URL: https://www.excalibur.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeExcalibur(city = 'Las Vegas') {
  console.log('🏰 Scraping Excalibur...');
  ...
  try {
    ...
    await page.goto('https://www.excalibur.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Excalibur events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Excalibur error:', error.message);
    return [];
  }
}

module.exports = scrapeExcalibur;

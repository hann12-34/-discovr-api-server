/**
 * Binion's Las Vegas Entertainment Scraper
 * URL: https://www.binions.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBinions(city = 'Las Vegas') {
  console.log('🎰 Scraping Binions...');
  ...
  try {
    ...
    await page.goto('https://www.binions.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Binions events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Binions error:', error.message);
    return [];
  }
}

module.exports = scrapeBinions;

/**
 * Neon Museum Las Vegas Events Scraper
 * URL: https://www.neonmuseum.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNeonMuseum(city = 'Las Vegas') {
  console.log('💡 Scraping Neon Museum...');
  ...
  try {
    ...
    await page.goto('https://www.neonmuseum.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Neon Museum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Neon Museum error:', error.message);
    return [];
  }
}

module.exports = scrapeNeonMuseum;

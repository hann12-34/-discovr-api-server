...
async function scrapeMGMGarden(city = 'Las Vegas') {
  console.log('🎪 Scraping MGM Grand Garden...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} MGM Grand Garden events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  MGM Grand Garden error:', error.message);
    return [];
  }
}

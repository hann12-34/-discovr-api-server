/**
 * Golden Nugget Las Vegas Entertainment Scraper
 * URL: https://www.goldennugget.com/las-vegas/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGoldenNugget(city = 'Las Vegas') {
  console.log('💰 Scraping Golden Nugget...');
  ...
  try {
    ...
    await page.goto('https://www.goldennugget.com/las-vegas/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Golden Nugget events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Golden Nugget error:', error.message);
    return [];
  }
}

module.exports = scrapeGoldenNugget;

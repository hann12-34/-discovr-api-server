/**
 * M Resort Las Vegas Entertainment Scraper
 * URL: https://www.themresort.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMResort(city = 'Las Vegas') {
  console.log('🏨 Scraping M Resort...');
  ...
  try {
    ...
    await page.goto('https://www.themresort.com/entertainment', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} M Resort events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  M Resort error:', error.message);
    return [];
  }
}

module.exports = scrapeMResort;

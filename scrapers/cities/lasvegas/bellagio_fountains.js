/**
 * Bellagio Las Vegas Entertainment Scraper
 * URL: https://www.bellagio.com/en/entertainment.html
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBellagio(city = 'Las Vegas') {
  console.log('💧 Scraping Bellagio...');
  ...
  try {
    ...
    await page.goto('https://www.bellagio.com/en/entertainment.html', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bellagio events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bellagio error:', error.message);
    return [];
  }
}

module.exports = scrapeBellagio;

/**
 * Sunset Station Las Vegas Entertainment Scraper
 * URL: https://www.sunsetstation.sclv.com/entertainment
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSunsetStation(city = 'Las Vegas') {
  console.log('🌅 Scraping Sunset Station...');
  ...
  try {
    ...
    await page.goto('https://www.sunsetstation.sclv.com/entertainment', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Las Vegas',
        category: 'Nightlife',
        source: 'Sunset Station'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Sunset Station events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sunset Station error:', error.message);
    return [];
  }
}

module.exports = scrapeSunsetStation;

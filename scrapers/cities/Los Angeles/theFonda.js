/**
 * The Fonda Theatre Scraper - REAL Puppeteer
 * Historic Hollywood venue
 * URL: https://www.fondatheatre.com/events
 */
...
async function scrapeTheFonda(city = 'Los Angeles') {
  console.log('🎭 Scraping The Fonda Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.fondatheatre.com/shows', {
    ...
    console.error('  ⚠️  The Fonda error:', error.message);
    return [];
  }
}

module.exports = scrapeTheFonda;

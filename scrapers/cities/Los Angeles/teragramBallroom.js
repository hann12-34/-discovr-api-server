/**
 * Teragram Ballroom Scraper - REAL Puppeteer
 * DTLA concert venue
...
async function scrapeTeragramBallroom(city = 'Los Angeles') {
  console.log('🎤 Scraping Teragram Ballroom...');
  ...
  try {
    ...
    await page.goto('https://www.teragramballroom.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Teragram Ballroom events`);
    ...
    console.error('  ⚠️  Teragram Ballroom error:', error.message);
    return [];
  }
}

module.exports = scrapeTeragramBallroom;

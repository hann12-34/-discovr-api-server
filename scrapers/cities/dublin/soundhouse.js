/**
 * The Sound House Dublin Events Scraper
 * Live music venue
 * URL: https://www.thesoundhouse.ie/
 */
...
async function scrapeSoundHouse(city = 'Dublin') {
  console.log('🎸 Scraping The Sound House Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.thesoundhouse.ie/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Sound House events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Sound House', address: '28 Eden Quay, Dublin D01 N5W8', city: 'Dublin' },
        latitude: 53.3485,
        longitude: -6.2568,
        city: 'Dublin',
        category: 'Nightlife',
        source: 'The Sound House'
      });
    }
    ...
    console.error('  ⚠️  Sound House error:', error.message);
    return [];
  }
}

/**
 * Pygmalion Dublin Events Scraper
 * URL: https://www.pygmalion.ie/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePygmalion(city = 'Dublin') {
  console.log('🎭 Scraping Pygmalion Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.pygmalion.ie/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Pygmalion',
          address: 'Powerscourt Townhouse, South William St, Dublin 2',
          city: 'Dublin'
        },
        latitude: 53.3418,
        longitude: -6.2637,
...
module.exports = scrapePygmalion;

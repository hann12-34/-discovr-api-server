/**
 * The Phi Center Dublin Events Scraper
 * URL: https://www.thephicentre.ie/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePhiCenter(city = 'Dublin') {
  console.log('🎭 Scraping Phi Center Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.thephicentre.ie/', {
...
module.exports = scrapePhiCenter;

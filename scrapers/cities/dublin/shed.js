/**
 * Lost Lane Dublin Events Scraper
 * Club and live music venue
 * URL: https://www.lostlane.ie/
 */
...
async function scrapeLostLane(city = 'Dublin') {
  console.log('🎧 Scraping Lost Lane Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.lostlane.ie/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Lost Lane events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Lost Lane', address: '132 Lower Baggot Street, Dublin D02 E925', city: 'Dublin' },
        latitude: 53.3364,
        longitude: -6.2491,
        city: 'Dublin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Lost Lane error:', error.message);
    return [];
  }
}

module.exports = scrapeLostLane;

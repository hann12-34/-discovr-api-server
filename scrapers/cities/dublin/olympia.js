/**
 * Olympia Theatre Dublin Events Scraper
 * Historic theatre and concert venue
 * URL: https://www.3olympia.ie/
 */
...
async function scrapeOlympia(city = 'Dublin') {
  console.log('🎭 Scraping Olympia Theatre Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.3olympia.ie/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Olympia events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Olympia Theatre', address: '72 Dame Street, Dublin D02 X525', city: 'Dublin' },
        latitude: 53.3441,
        longitude: -6.2647,
        city: 'Dublin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Olympia error:', error.message);
    return [];
  }
}

module.exports = scrapeOlympia;

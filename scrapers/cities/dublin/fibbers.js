/**
 * Fibber Magees Dublin Events Scraper
 * Rock bar and live music venue
 * URL: https://fibbermagees.ie/
 */
...
async function scrapeFibberMagees(city = 'Dublin') {
  console.log('🎸 Scraping Fibber Magees Dublin...');
  ...
  try {
    ...
    await page.goto('https://fibbermagees.ie/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Fibber Magees events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Fibber Magees', address: '80-81 Parnell Street, Dublin D01 E3K3', city: 'Dublin' },
        latitude: 53.3517,
        longitude: -6.2617,
        city: 'Dublin',
        category: 'Nightlife',
        source: 'Fibber Magees'
      });
    }
    ...
    console.error('  ⚠️  Fibber Magees error:', error.message);
    return [];
  }
}

module.exports = scrapeFibberMagees;

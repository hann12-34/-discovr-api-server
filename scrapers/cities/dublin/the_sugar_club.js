 ...
 * URL: https://thesugarclub.com/events
 */
...
async function scrapeSugarClub(city = 'Dublin') {
  console.log('🎵 Scraping The Sugar Club...');
  ...
  try {
    ...
    await page.goto('https://thesugarclub.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Sugar Club',
          address: '8 Lower Leeson St, Dublin 2',
          city: 'Dublin'
        },
        latitude: 53.3360,
        longitude: -6.2550,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sugar Club events`);

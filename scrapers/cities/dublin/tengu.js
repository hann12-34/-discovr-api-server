/**
 * Tengu Dublin Events Scraper
 * URL: https://tengudublin.ie/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTengu(city = 'Dublin') {
  console.log('🎭 Scraping Tengu Dublin...');
  ...
  try {
    ...
    await page.goto('https://tengudublin.ie/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Tengu',
          address: '21 Wicklow St, Dublin 2',
          city: 'Dublin'
        },
        latitude: 53.3419,
        longitude: -6.2618,

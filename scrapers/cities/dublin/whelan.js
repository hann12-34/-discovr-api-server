/**
 * Whelan's Dublin Events Scraper
 * Iconic live music venue
 * URL: https://www.whelanslive.com/
 */
...
async function scrapeWhelans(city = 'Dublin') {
  console.log('🎸 Scraping Whelan\'s Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.whelanslive.com/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Whelan's events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Whelan's", address: '25 Wexford Street, Dublin D02 H527', city: 'Dublin' },
        latitude: 53.3373,
        longitude: -6.2644,
        city: 'Dublin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Whelan\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeWhelans;

/**
 * Index (The Church) Dublin Events Scraper
 * Popular nightclub in Dublin
 * URL: https://www.thechurch.ie/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIndexChurch(city = 'Dublin') {
  console.log('⛪ Scraping The Church Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.thechurch.ie/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Church events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ The Church error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeIndexChurch;

/**
 * Sin É Dublin Events Scraper
 * URL: https://www.sine.ie/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSinE(city = 'Dublin') {
  ...
  try {
    ...
    await page.goto('https://www.sine.ie/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Sin É',
          address: '14-15 Ormond Quay Upper, Dublin 1',
          city: 'Dublin'
        },
        latitude: 53.3470,
        longitude: -6.2670,

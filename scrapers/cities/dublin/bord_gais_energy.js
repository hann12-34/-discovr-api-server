/**
 * Bord Gais Energy Theatre Dublin Events Scraper
 * URL: https://www.bordgaisenergytheatre.ie/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBordGais(city = 'Dublin') {
  console.log('🎭 Scraping Bord Gais Energy Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.bordgaisenergytheatre.ie/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bord Gais events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bord Gais error:', error.message);
    return [];
  }
}

module.exports = scrapeBordGais;

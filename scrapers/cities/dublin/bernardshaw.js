/**
 * Bernard Shaw Dublin Events Scraper
 * URL: https://www.thebernardshaw.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBernardShaw(city = 'Dublin') {
  console.log('🎭 Scraping Bernard Shaw Dublin...');
  ...
  try {
    ...
    await page.goto('https://www.thebernardshaw.com/', {
...
module.exports = scrapeBernardShaw;

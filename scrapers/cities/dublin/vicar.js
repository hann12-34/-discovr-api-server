...
async function scrapeVicar(city = 'dublin') {
  console.log('🎵 Scraping Vicar Street...');
  ...
  try {
    ...
    await page.goto('https://www.vicarstreet.ie/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Vicar Street events`);

/**
 * Dublin Pride Festival Events Scraper
 * URL: https://www.dublinpride.ie
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDublinPride(city = 'Dublin') {
  console.log('🏳️‍🌈 Scraping Dublin Pride...');
  ...
  try {
    ...
    await page.goto('https://www.dublinpride.ie/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Dublin Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dublin Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeDublinPride;

/**
 * National Concert Hall Dublin Events Scraper
 * URL: https://www.nch.ie/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNCH(city = 'Dublin') {
  console.log('🎵 Scraping National Concert Hall...');
  ...
  try {
    ...
    await page.goto('https://www.nch.ie/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} NCH events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  NCH error:', error.message);
    return [];
  }
}

module.exports = scrapeNCH;

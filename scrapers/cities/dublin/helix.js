/**
 * The Helix Dublin Events Scraper
 * URL: https://thehelix.ie/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHelix(city = 'Dublin') {
  console.log('🎭 Scraping The Helix...');
  ...
  try {
    ...
    await page.goto('https://thehelix.ie/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Helix',
          address: 'DCU, Collins Ave, Dublin 9',
          city: 'Dublin'
        },
        latitude: 53.3850,
        longitude: -6.2560,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Helix events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Helix error:', error.message);
    return [];
  }
}

module.exports = scrapeHelix;

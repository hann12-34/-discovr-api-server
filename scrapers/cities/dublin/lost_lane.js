...
async function scrapeLostLane(city = 'Dublin') {
  console.log('🎧 Scraping Lost Lane...');
  ...
  try {
    ...
    await page.goto('https://lostlane.ie/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lost Lane events`);

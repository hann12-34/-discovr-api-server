/**
 * Sweeney's Dublin Events Scraper
 * URL: https://sweeneysdublin.ie/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSweeney(city = 'Dublin') {
  console.log('🎭 Scraping Sweeneys Dublin...');
  ...
  try {
    ...
    await page.goto('https://sweeneysdublin.ie/', {

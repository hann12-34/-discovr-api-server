/**
 * The Bowery Dublin Events Scraper
 * URL: https://www.thebowery.ie/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBowery(city = 'Dublin') {
  ...
  try {
    ...
    await page.goto('https://www.thebowery.ie/events', {

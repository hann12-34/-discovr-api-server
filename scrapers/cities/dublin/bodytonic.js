/**
 * Bodytonic Dublin Events Scraper
 * Electronic music venue
 * URL: https://bodytonic.ie/
 */
...
async function scrapeBodytonic(city = 'Dublin') {
  console.log('🎧 Scraping Bodytonic Dublin...');
  ...
  try {
    ...
    await page.goto('https://bodytonic.ie/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Bodytonic events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Bodytonic', address: 'Dublin', city: 'Dublin' },
        latitude: 53.3498,
        longitude: -6.2603,
        city: 'Dublin',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Bodytonic error:', error.message);
    return [];
  }
}

module.exports = scrapeBodytonic;

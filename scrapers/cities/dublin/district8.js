/**
 * District 8 Dublin Events Scraper
 * Nightclub venue
 * URL: https://district8.ie/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDistrict8(city = 'Dublin') {
  console.log('🎧 Scraping District 8 Dublin...');
  ...
  try {
    ...
    await page.goto('https://district8.ie/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'District 8',
          address: 'Hanover Quay, Dublin D02 XK88',
          city: 'Dublin'
        },
        latitude: 53.3431,
        longitude: -6.2356,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid District 8 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  District 8 error:', error.message);
    return [];
  }
}

module.exports = scrapeDistrict8;

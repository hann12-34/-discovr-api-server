/**
 * Croke Park Dublin Events Scraper
 * URL: https://crokepark.ie/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCrokePark(city = 'Dublin') {
  console.log('🏟️ Scraping Croke Park...');
  ...
  try {
    ...
    await page.goto('https://crokepark.ie/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Croke Park events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Croke Park error:', error.message);
    return [];
  }
}

module.exports = scrapeCrokePark;

/**
 * The Grand Social Dublin Events Scraper
 * Multi-room venue for live music and club nights
 * URL: https://thegrandsocial.ie/
 */
...
async function scrapeGrandSocial(city = 'Dublin') {
  console.log('🎸 Scraping The Grand Social Dublin...');
  ...
  try {
    ...
    await page.goto('https://thegrandsocial.ie/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Grand Social events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Grand Social', address: '35 Lower Liffey Street, Dublin D01 E9P9', city: 'Dublin' },
        latitude: 53.3477,
        longitude: -6.2610,
        city: 'Dublin',
        category: 'Nightlife',
        source: 'The Grand Social'
      });
    }
    ...
    console.error('  ⚠️  Grand Social error:', error.message);
    return [];
  }
}

module.exports = scrapeGrandSocial;

/**
 * Liverpool Sound City Events Scraper
 * URL: https://www.liverpoolsoundcity.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSoundCity(city = 'Liverpool') {
  console.log('🎵 Scraping Sound City...');
  ...
  try {
    ...
    await page.goto('https://www.liverpoolsoundcity.co.uk', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sound City events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sound City error:', error.message);
    return [];
  }
}

module.exports = scrapeSoundCity;

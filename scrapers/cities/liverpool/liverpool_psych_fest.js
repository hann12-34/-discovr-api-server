/**
 * Liverpool Psych Fest Events Scraper
 * URL: https://www.liverpoolpsychfest.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePsychFest(city = 'Liverpool') {
  console.log('🎸 Scraping Liverpool Psych Fest...');
  ...
  try {
    ...
    await page.goto('https://www.liverpoolpsychfest.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Psych Fest events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Psych Fest error:', error.message);
    return [];
  }
}

module.exports = scrapePsychFest;

/**
 * Liverpool Biennial Events Scraper
 * URL: https://www.biennial.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLiverpoolBiennial(city = 'Liverpool') {
  console.log('🎨 Scraping Liverpool Biennial...');
  ...
  try {
    ...
    await page.goto('https://www.biennial.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Various Liverpool Galleries',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Liverpool Biennial events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Liverpool Biennial error:', error.message);
    return [];
  }
}

module.exports = scrapeLiverpoolBiennial;

/**
 * The Kazimier Liverpool Events Scraper
 * URL: https://thekazimier.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKazimier(city = 'Liverpool') {
  console.log('🎨 Scraping The Kazimier...');
  ...
  try {
    ...
    await page.goto('https://thekazimier.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Kazimier',
          address: 'Greenland St, Liverpool L1 0BS',
          city: 'Liverpool'
        },
        latitude: 53.4035,
        longitude: -2.9895,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kazimier events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kazimier error:', error.message);
    return [];
  }
}

module.exports = scrapeKazimier;

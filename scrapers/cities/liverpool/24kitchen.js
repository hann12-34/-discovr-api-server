/**
 * 24 Kitchen Street Liverpool Events Scraper
 * Independent venue in the Baltic Triangle
 * URL: https://www.24kitchenstreet.com/
 */
...
async function scrape24Kitchen(city = 'Liverpool') {
  console.log('🎧 Scraping 24 Kitchen Street Liverpool...');
  ...
  try {
    ...
    await page.goto('https://www.24kitchenstreet.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} 24 Kitchen events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: '24 Kitchen Street', address: '24 Kitchen Street, Liverpool L1 0AN', city: 'Liverpool' },
        latitude: 53.3991,
        longitude: -2.9868,
        city: 'Liverpool',
        category: 'Nightlife',
        source: '24 Kitchen Street'
      });
    }
    ...
    console.error('  ⚠️  24 Kitchen error:', error.message);
    return [];
  }
}

module.exports = scrape24Kitchen;

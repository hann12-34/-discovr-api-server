/**
 * District Liverpool Events Scraper
 * Live music and club venue
 * URL: https://districtliverpool.co.uk/
 */
...
async function scrapeDistrict(city = 'Liverpool') {
  console.log('🎧 Scraping District Liverpool...');
  ...
  try {
    ...
    await page.goto('https://districtliverpool.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} District events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'District', address: '61 Jordan Street, Liverpool L1 0BW', city: 'Liverpool' },
        latitude: 53.3995,
        longitude: -2.9864,
        city: 'Liverpool',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  District error:', error.message);
    return [];
  }
}

module.exports = scrapeDistrict;

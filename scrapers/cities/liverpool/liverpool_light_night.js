/**
 * Liverpool Light Night Events Scraper
 * URL: https://www.cultureliverpool.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLightNight(city = 'Liverpool') {
  console.log('💡 Scraping Liverpool Light Night...');
  ...
  try {
    ...
    await page.goto('https://www.cultureliverpool.co.uk/light-night', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Various Liverpool Venues',
          city: 'Liverpool'
        },
        latitude: 53.4084,
        longitude: -2.9916,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Light Night events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Light Night error:', error.message);
    return [];
  }
}

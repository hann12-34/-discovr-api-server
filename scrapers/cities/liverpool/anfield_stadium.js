/**
 * Anfield Stadium Liverpool Events Scraper
 * URL: https://www.liverpoolfc.com/tickets/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAnfieldStadium(city = 'Liverpool') {
  console.log('⚽ Scraping Anfield Stadium...');
  ...
  try {
    ...
    await page.goto('https://www.liverpoolfc.com/tickets/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Liverpool',
        category: 'Arts',
        source: 'Anfield Stadium'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Anfield Stadium events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Anfield Stadium error:', error.message);
    return [];
  }
}

module.exports = scrapeAnfieldStadium;

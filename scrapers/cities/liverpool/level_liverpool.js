/**
 * Level Nightclub Liverpool Events Scraper
 * Popular nightclub in Liverpool
 * URL: https://www.levelliverpool.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLevelLiverpool(city = 'Liverpool') {
  console.log('🎧 Scraping Level Liverpool...');
  ...
  try {
    ...
    await page.goto('https://www.levelliverpool.co.uk/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Level',
          address: '90 Seel St, Liverpool L1 4BH',
          city: 'Liverpool'
        },
        city: 'Liverpool',
        category: 'Nightlife',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Level events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Level error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeLevelLiverpool;

/**
 * Phase One Liverpool Events Scraper
 * Electronic music club
 * URL: https://www.phaseonelive.com/
 */
...
async function scrapePhaseOne(city = 'Liverpool') {
  console.log('🎧 Scraping Phase One Liverpool...');
  ...
  try {
    ...
    await page.goto('https://www.phaseonelive.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Phase One events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Phase One', address: '23 Seel Street, Liverpool L1 4AU', city: 'Liverpool' },
        latitude: 53.4015,
        longitude: -2.9825,
        city: 'Liverpool',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Phase One error:', error.message);
    return [];
  }
}

module.exports = scrapePhaseOne;

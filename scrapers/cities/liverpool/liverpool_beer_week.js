/**
 * Liverpool Beer Week Events Scraper
 * URL: https://www.liverpoolbeerweek.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBeerWeek(city = 'Liverpool') {
  console.log('🍺 Scraping Liverpool Beer Week...');
  ...
  try {
    ...
    await page.goto('https://www.liverpoolbeerweek.co.uk', {

/**
 * Liverpool Irish Festival Events Scraper
 * URL: https://www.liverpoolirishfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIrishFest(city = 'Liverpool') {
  console.log('☘️ Scraping Liverpool Irish Festival...');
  ...
  try {
    ...
    await page.goto('https://www.liverpoolirishfestival.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Liverpool',
        category: 'Festival',
        source: 'Irish Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Irish Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Irish Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeIrishFest;

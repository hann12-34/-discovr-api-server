/**
 * Buyers Club Liverpool Events Scraper
 * URL: https://thebuyersclub.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBuyersClub(city = 'Liverpool') {
  console.log('🎸 Scraping Buyers Club...');
  ...
  try {
    ...
    await page.goto('https://thebuyersclub.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Buyers Club events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Buyers Club error:', error.message);
    return [];
  }
}

module.exports = scrapeBuyersClub;

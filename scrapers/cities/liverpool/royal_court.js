/**
 * Royal Court Theatre Liverpool Events Scraper
 * URL: https://liverpoolsroyalcourt.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRoyalCourt(city = 'Liverpool') {
  console.log('👑 Scraping Royal Court...');
  ...
  try {
    ...
    await page.goto('https://liverpoolsroyalcourt.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '1 Roe St, Liverpool L1 1HL',
          city: 'Liverpool'
        },
        latitude: 53.4040,
        longitude: -2.9810,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Royal Court events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Royal Court error:', error.message);
    return [];
  }
}

module.exports = scrapeRoyalCourt;

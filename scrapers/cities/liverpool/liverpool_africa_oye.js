/**
 * Africa Oyé Liverpool Events Scraper
 * URL: https://www.africaoye.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAfricaOye(city = 'Liverpool') {
  ...
  try {
    ...
    await page.goto('https://www.africaoye.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Africa Oyé events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Africa Oyé error:', error.message);
    return [];
  }
}

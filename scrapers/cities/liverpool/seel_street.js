/**
 * Seel Street Liverpool Events Scraper
 * URL: https://www.seelst.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSeelStreet(city = 'Liverpool') {
  console.log('🎉 Scraping Seel Street...');
  ...
  try {
    ...
    await page.goto('https://www.seelst.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Seel Street',
          address: 'Seel St, Liverpool L1 4BE',
          city: 'Liverpool'
        },
        latitude: 53.4020,
        longitude: -2.9795,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Seel Street events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Seel Street error:', error.message);
    return [];
  }
}

module.exports = scrapeSeelStreet;

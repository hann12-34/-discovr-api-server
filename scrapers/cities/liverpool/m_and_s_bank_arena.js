/**
 * M&S Bank Arena Liverpool Events Scraper
 * URL: https://www.mandsbankarena.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMSBankArena(city = 'Liverpool') {
  console.log('🏟️ Scraping M&S Bank Arena...');
  ...
  try {
    ...
    await page.goto('https://www.mandsbankarena.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} M&S Bank Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  M&S Bank Arena error:', error.message);
    return [];
  }
}

module.exports = scrapeMSBankArena;

/**
 * Liverpool Comedy Festival Events Scraper
 * URL: https://www.liverpoolcomedyfestival.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeComedyFest(city = 'Liverpool') {
  console.log('😂 Scraping Liverpool Comedy Festival...');
  ...
  try {
    ...
    await page.goto('https://www.liverpoolcomedyfestival.co.uk', {

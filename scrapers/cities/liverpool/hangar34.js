/**
 * Hangar 34 Liverpool Events Scraper
 * Live music and events venue
 * URL: https://www.hangar34.com/
 */
...
async function scrapeHangar34(city = 'Liverpool') {
  console.log('🎸 Scraping Hangar 34 Liverpool...');
  ...
  try {
    ...
    await page.goto('https://www.hangar34.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Hangar 34 events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Hangar 34', address: '34 Greenland Street, Liverpool L1 0BS', city: 'Liverpool' },
        latitude: 53.3975,
        longitude: -2.9865,
        city: 'Liverpool',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Hangar 34 error:', error.message);
    return [];
  }
}

/**
 * Liverpool International Music Festival (LIMF) Events Scraper
 * URL: https://www.limfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLIMF(city = 'Liverpool') {
  console.log('🎵 Scraping LIMF...');
  ...
  try {
    ...
    await page.goto('https://www.limfestival.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} LIMF events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  LIMF error:', error.message);
    return [];
  }
}

module.exports = scrapeLIMF;

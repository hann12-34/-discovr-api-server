/**
 * Arts Club Liverpool Events Scraper
 * Multi-room venue for live music and club nights
 * URL: https://artsclubliverpool.com/
 */
...
async function scrapeArtsClub(city = 'Liverpool') {
  console.log('🎨 Scraping Arts Club Liverpool...');
  ...
  try {
    ...
    await page.goto('https://artsclubliverpool.com/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Arts Club events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Arts Club', address: '90 Seel Street, Liverpool L1 4BH', city: 'Liverpool' },
        latitude: 53.4015,
        longitude: -2.9793,
        city: 'Liverpool',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Arts Club error:', error.message);
    return [];
  }
}

module.exports = scrapeArtsClub;

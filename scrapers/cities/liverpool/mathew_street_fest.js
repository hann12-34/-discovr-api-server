/**
 * Mathew Street Festival Liverpool Events Scraper
 * URL: https://www.mathewstreetfestival.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMathewStreet(city = 'Liverpool') {
  console.log('🎸 Scraping Mathew Street Festival...');
  ...
  try {
    ...
    await page.goto('https://www.mathewstreetfestival.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Liverpool',
        category: 'Festival',
        source: 'Mathew Street Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Mathew Street Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mathew Street Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeMathewStreet;

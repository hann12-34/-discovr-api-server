/**
 * HiFi Bar Melbourne Events Scraper
 * URL: https://thehifi.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHiFi(city = 'Melbourne') {
  console.log('🎭 Scraping HiFi Bar Melbourne...');
  ...
  try {
    ...
    await page.goto('https://thehifi.com.au/', {

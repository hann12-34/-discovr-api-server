/**
 * 170 Russell Melbourne Events Scraper
 * Major live music venue
 * URL: https://170russell.com/
 */
...
async function scrape170Russell(city = 'Melbourne') {
  console.log('🎸 Scraping 170 Russell Melbourne...');
  ...
  try {
    ...
    await page.goto('https://170russell.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} 170 Russell events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: '170 Russell', address: '170 Russell Street, Melbourne VIC 3000', city: 'Melbourne' },
        latitude: -37.8111,
        longitude: 144.9688,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  170 Russell error:', error.message);
    return [];
  }
}

module.exports = scrape170Russell;

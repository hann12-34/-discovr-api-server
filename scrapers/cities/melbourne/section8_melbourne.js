/**
 * Section 8 Melbourne Events Scraper
 * Popular bar in Melbourne
 * URL: https://section8.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSection8Melbourne(city = 'Melbourne') {
  console.log('🎵 Scraping Section 8 Melbourne...');
  ...
  try {
    ...
    await page.goto('https://section8.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Melbourne',
        category: 'Nightlife',
        source: 'Section 8 Melbourne'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Section 8 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Section 8 error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeSection8Melbourne;

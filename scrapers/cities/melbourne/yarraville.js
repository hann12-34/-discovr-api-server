/**
 * Yarraville Club Melbourne Events Scraper
 * URL: https://www.yarravilleclub.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeYarraville(city = 'Melbourne') {
  console.log('🎭 Scraping Yarraville Club...');
  ...
  try {
    ...
    await page.goto('https://www.yarravilleclub.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '135 Stephen St, Yarraville VIC 3013',
          city: 'Melbourne'
        },
        latitude: -37.8164,
        longitude: 144.8933,
...
module.exports = scrapeYarraville;

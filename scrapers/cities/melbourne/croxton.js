/**
 * Croxton Bandroom Melbourne Events Scraper
 * URL: https://www.thecroxton.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCroxton(city = 'Melbourne') {
  console.log('🎭 Scraping Croxton Bandroom...');
  ...
  try {
    ...
    await page.goto('https://www.thecroxton.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Croxton Bandroom',
          address: '589 High St, Thornbury VIC 3071',
          city: 'Melbourne'
        },
        latitude: -37.7548,
        longitude: 145.0059,

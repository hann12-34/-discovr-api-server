/**
 * Max Watt's Melbourne Events Scraper
 * Live music venue
 * URL: https://maxwatts.com.au/melbourne/
 */
...
async function scrapeMaxWatts(city = 'Melbourne') {
  console.log('🎸 Scraping Max Watt\'s Melbourne...');
  ...
  try {
    ...
    await page.goto('https://maxwatts.com.au/melbourne/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Max Watt's events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: "Max Watt's", address: '125 Swanston Street, Melbourne VIC 3000', city: 'Melbourne' },
        latitude: -37.8136,
        longitude: 144.9631,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Max Watt\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeMaxWatts;

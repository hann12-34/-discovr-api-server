/**
 * Esplanade Hotel Melbourne Events Scraper
 * URL: https://www.espy.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEsplanade(city = 'Melbourne') {
  console.log('🎭 Scraping Esplanade Hotel...');
  ...
  try {
    ...
    await page.goto('https://www.espy.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '11 Upper Esplanade, St Kilda VIC 3182',
          city: 'Melbourne'
        },
        latitude: -37.8679,
        longitude: 144.9735,
...
module.exports = scrapeEsplanade;

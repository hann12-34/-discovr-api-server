/**
 * Spotted Mallard Melbourne Events Scraper
 * URL: https://www.spottedmallard.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSpottedMallard(city = 'Melbourne') {
  console.log('🎭 Scraping Spotted Mallard...');
  ...
  try {
    ...
    await page.goto('https://www.spottedmallard.com/', {
...
module.exports = scrapeSpottedMallard;

/**
 * Howler Melbourne Events Scraper
 * Live music venue in Brunswick
 * URL: https://www.howler.com.au/
 */
...
async function scrapeHowler(city = 'Melbourne') {
  console.log('🎸 Scraping Howler Melbourne...');
  ...
  try {
    ...
    await page.goto('https://www.howler.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Howler events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Howler', address: '7-11 Dawson Street, Brunswick VIC 3056', city: 'Melbourne' },
        latitude: -37.7681,
        longitude: 144.9600,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Howler error:', error.message);
    return [];
  }
}

module.exports = scrapeHowler;

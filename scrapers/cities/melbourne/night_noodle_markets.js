/**
 * Night Noodle Markets Melbourne Events Scraper
...
async function scrapeNightNoodle(city = 'Melbourne') {
  console.log('🍜 Scraping Night Noodle Markets...');
  ...
  try {
    ...
    await page.goto('https://www.melbournefoodandwine.com.au', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Night Noodle Markets events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Night Noodle Markets error:', error.message);
    return [];
  }
}

module.exports = scrapeNightNoodle;

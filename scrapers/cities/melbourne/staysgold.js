/**
 * Stay Gold Melbourne Events Scraper
 * URL: https://www.staygold.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStayGold(city = 'Melbourne') {
  console.log('🎭 Scraping Stay Gold Melbourne...');
  ...
  try {
    ...
    await page.goto('https://www.staygold.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Stay Gold',
          address: '178 Brunswick St, Fitzroy VIC 3065',
          city: 'Melbourne'
        },
        latitude: -37.8002,
        longitude: 144.9778,

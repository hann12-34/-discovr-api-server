/**
 * Cherry Bar Melbourne Events Scraper
 * Rock bar in the city
 * URL: https://cherrybar.com.au/
 */
...
async function scrapeCherryBar(city = 'Melbourne') {
  console.log('🍒 Scraping Cherry Bar Melbourne...');
  ...
  try {
    ...
    await page.goto('https://cherrybar.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Cherry Bar events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Cherry Bar', address: 'AC/DC Lane, Melbourne VIC 3000', city: 'Melbourne' },
        latitude: -37.8168,
        longitude: 144.9693,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Cherry Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeCherryBar;

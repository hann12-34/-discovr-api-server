/**
 * Corner Hotel melbourne Events Scraper
...
async function scrapeCorner(city = 'melbourne') {
  console.log('🎵 Scraping Corner Hotel...');
  ...
  try {
    ...
    await page.goto('https://cornerhotel.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Corner Hotel events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Corner Hotel error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeCorner;

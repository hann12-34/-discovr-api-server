/**
 * The Tote Melbourne Events Scraper
 * Iconic pub rock venue in Collingwood
...
async function scrapeTheTote(city = 'Melbourne') {
  console.log('🎸 Scraping The Tote Melbourne...');
  ...
  try {
    ...
    await page.goto('https://thetotehotel.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Tote events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Tote', address: '71 Johnston Street, Collingwood VIC 3066', city: 'Melbourne' },
        latitude: -37.8018,
        longitude: 144.9853,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Tote error:', error.message);
    return [];
  }
}

module.exports = scrapeTheTote;

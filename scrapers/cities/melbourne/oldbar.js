/**
 * The Old Bar Melbourne Events Scraper
 * Live music pub in Fitzroy
 * URL: https://theoldbar.com.au/
 */
...
async function scrapeOldBar(city = 'Melbourne') {
  console.log('🎸 Scraping The Old Bar Melbourne...');
  ...
  try {
    ...
    await page.goto('https://theoldbar.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Old Bar events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Old Bar', address: '74-76 Johnston Street, Fitzroy VIC 3065', city: 'Melbourne' },
        latitude: -37.8007,
        longitude: 144.9788,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Old Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeOldBar;

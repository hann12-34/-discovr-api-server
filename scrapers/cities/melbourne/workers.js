/**
 * Workers Club Melbourne Events Scraper
 * Live music venue in Fitzroy
 * URL: https://theworkersclub.com.au/
 */
...
async function scrapeWorkersClub(city = 'Melbourne') {
  console.log('🎸 Scraping Workers Club Melbourne...');
  ...
  try {
    ...
    await page.goto('https://theworkersclub.com.au/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Workers Club events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Workers Club', address: '51 Brunswick Street, Fitzroy VIC 3065', city: 'Melbourne' },
        latitude: -37.8012,
        longitude: 144.9778,
        city: 'Melbourne',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Workers Club error:', error.message);
    return [];
  }
}

module.exports = scrapeWorkersClub;

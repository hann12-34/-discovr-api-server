/**
 * Palais Theatre Melbourne Events Scraper
 * URL: https://www.palaistheatre.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePalais(city = 'Melbourne') {
  console.log('🎭 Scraping Palais Theatre Melbourne...');
  ...
  try {
    ...
    await page.goto('https://www.palaistheatre.com.au/', {

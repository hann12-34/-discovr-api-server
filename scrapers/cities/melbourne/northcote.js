/**
 * Northcote Social Club Melbourne Events Scraper
 * Live music venue
 * URL: https://northcotesocialclub.com/
 */
...
async function scrapeNorthcote(city = 'Melbourne') {
  console.log('🎸 Scraping Northcote Social Club Melbourne...');
  ...
  try {
    ...
    await page.goto('https://northcotesocialclub.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Northcote events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Northcote Social Club', address: '301 High Street, Northcote VIC 3070', city: 'Melbourne' },
        latitude: -37.7727,
        longitude: 145.0007,
        city: 'Melbourne',
        category: 'Nightlife',
        source: 'Northcote Social Club'
      });
    }
    ...
    console.error('  ⚠️  Northcote error:', error.message);
    return [];
  }
}

module.exports = scrapeNorthcote;

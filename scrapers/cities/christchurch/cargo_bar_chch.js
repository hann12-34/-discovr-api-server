/**
 * Cargo Bar Christchurch Events Scraper
 * Popular bar in Christchurch
 * URL: https://cargobar.co.nz/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCargoBarChch(city = 'Christchurch') {
  console.log('📦 Scraping Cargo Bar Christchurch...');
  ...
  try {
    ...
    await page.goto('https://cargobar.co.nz/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Cargo Bar',
          address: '266 St Asaph St, Christchurch 8011',
          city: 'Christchurch'
        },
        city: 'Christchurch',
        category: 'Nightlife',
        source: 'Cargo Bar Christchurch'
      });
    }
...
module.exports = scrapeCargoBarChch;

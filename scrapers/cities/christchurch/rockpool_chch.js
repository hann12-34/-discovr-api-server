/**
 * Rockpool Nightclub Christchurch Events Scraper
 * URL: https://www.rockpool.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRockpool(city = 'Christchurch') {
  console.log('🎉 Scraping Rockpool...');
  ...
  try {
    ...
    await page.goto('https://www.rockpool.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Rockpool',
          address: '158 Lichfield Street, Christchurch',
          city: 'Christchurch'
        },
        latitude: -43.5341,
        longitude: 172.6369,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rockpool events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rockpool error:', error.message);
    return [];
  }
}

module.exports = scrapeRockpool;

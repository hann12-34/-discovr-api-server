/**
 * Grumpy Mole Saloon Christchurch Events Scraper
 * URL: https://www.grumpymole.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGrumpyMole(city = 'Christchurch') {
  console.log('🎉 Scraping Grumpy Mole...');
  ...
  try {
    ...
    await page.goto('https://www.grumpymole.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Grumpy Mole Saloon',
          address: '1 Poplar Lane, Christchurch',
          city: 'Christchurch'
        },
        latitude: -43.5325,
        longitude: 172.6350,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Grumpy Mole events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Grumpy Mole error:', error.message);
    return [];
  }
}

module.exports = scrapeGrumpyMole;

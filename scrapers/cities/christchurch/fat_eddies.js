 ...
 * Dancing destination on The Terrace
...
async function scrapeFatEddies(city = 'Christchurch') {
  console.log('🍻 Scraping Fat Eddie\'s Christchurch...');
  ...
  try {
    ...
    console.error('  ⚠️  Fat Eddie\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeFatEddies;

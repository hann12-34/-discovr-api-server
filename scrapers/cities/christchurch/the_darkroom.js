/**
 * The Darkroom Christchurch Events Scraper
 * URL: https://thedarkroom.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDarkroom(city = 'Christchurch') {
  console.log('📷 Scraping The Darkroom...');
  ...
  try {
    ...
    await page.goto('https://thedarkroom.co.nz/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Darkroom events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Darkroom error:', error.message);
    return [];
  }
}

module.exports = scrapeDarkroom;

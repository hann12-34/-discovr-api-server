/**
 * The Bog Irish Bar Christchurch Events Scraper
 * URL: https://www.thebog.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBogIrishBar(city = 'Christchurch') {
  console.log('🍀 Scraping The Bog Irish Bar...');
  ...
  try {
    ...
    await page.goto('https://www.thebog.co.nz/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Bog Irish Bar',
          address: '50 Victoria Street, Christchurch',
          city: 'Christchurch'
        },
        latitude: -43.5297,
        longitude: 172.6365,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Bog events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Bog error:', error.message);
    return [];
  }
}

module.exports = scrapeBogIrishBar;

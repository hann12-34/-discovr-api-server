 ...
 * Live music venue with bands Thursday-Saturday
 * URL: https://boos.bar/
 */
...
async function scrapeBoosBar(city = 'Christchurch') {
  console.log('👻 Scraping Boo\'s Bar Christchurch...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Boo's Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Boo\'s Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeBoosBar;

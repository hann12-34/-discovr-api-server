/**
 * Christchurch Arts Festival Events Scraper
 * URL: https://www.artsfestival.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeChchArts(city = 'Christchurch') {
  console.log('🎭 Scraping Christchurch Arts Festival...');
  ...
  try {
    ...
    await page.goto('https://www.artsfestival.co.nz/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Various Christchurch Venues',
        ...
        city: 'Christchurch',
        category: 'Festival',
        source: 'Christchurch Arts'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Christchurch Arts events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Christchurch Arts error:', error.message);
    return [];
  }
}

module.exports = scrapeChchArts;

/**
 * Riverside Market Christchurch Events Scraper
 * URL: https://riversidemarket.co.nz/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRiversideMarket(city = 'Christchurch') {
  console.log('🏪 Scraping Riverside Market...');
  ...
  try {
    ...
    await page.goto('https://riversidemarket.co.nz/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '96 Oxford Terrace, Christchurch Central, Christchurch 8011',
          city: 'Christchurch'
        },
        latitude: -43.5315,
        longitude: 172.6365,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Riverside Market events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Riverside Market error:', error.message);
    return [];
  }
}

module.exports = scrapeRiversideMarket;

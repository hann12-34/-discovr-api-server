/**
 * Tequila Mockingbird Christchurch Events Scraper
 * URL: https://www.tequilamockingbird.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTequilaMockingbird(city = 'Christchurch') {
  console.log('🍸 Scraping Tequila Mockingbird...');
  ...
  try {
    ...
    await page.goto('https://www.tequilamockingbird.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '124 Oxford Terrace, Christchurch',
          city: 'Christchurch'
        },
        latitude: -43.5310,
        longitude: 172.6312,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Tequila Mockingbird events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Tequila Mockingbird error:', error.message);
    return [];
  }
}

module.exports = scrapeTequilaMockingbird;

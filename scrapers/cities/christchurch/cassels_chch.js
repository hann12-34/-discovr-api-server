/**
 * Cassels Blue Smoke Christchurch Events Scraper
 * Popular venue and nightclub in Christchurch
 * URL: https://casselsbrewery.co.nz/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCasselsChch(city = 'Christchurch') {
  console.log('🍺 Scraping Cassels Christchurch...');
  ...
  try {
    ...
    await page.goto('https://casselsbrewery.co.nz/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cassels events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Cassels error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeCasselsChch;

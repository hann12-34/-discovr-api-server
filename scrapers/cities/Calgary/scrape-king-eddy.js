...
/**
 * King Eddy Events Scraper
 * Scrapes events from King Eddy
 * URL: https://kingeddy.ca
 */
class KingEddyEvents {
    constructor() {
        this.baseUrl = 'https://kingeddy.ca';
        this.eventsUrl = 'https://kingeddy.ca/events';
        this.source = 'King Eddy';
        this.city = 'Calgary';
        this.province = 'AB';
    }

    /**
     * Get default coordinates for King Eddy
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at King Eddy`,
            date: eventDate,
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-king-eddy.js Toronto');
    process.exit(1);
  }
        const scraper = new KingEddyEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('KING EDDY TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in KingEddyEvents');
    }
};
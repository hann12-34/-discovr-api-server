...
/**
 * The Attic Bar & Stage Events Scraper
 * Scrapes events from The Attic Bar & Stage
 * URL: https://theatticbarandstage.com
 */
class AtticBarStageEvents {
    constructor() {
        this.baseUrl = 'https://theatticbarandstage.com';
        this.eventsUrl = 'https://theatticbarandstage.com/events';
        this.source = 'The Attic Bar & Stage';
        this.city = 'Calgary';
        this.province = 'AB';
    }

    /**
     * Get default coordinates for The Attic Bar & Stage
    ...
    extractVenueInfo($, eventElement) {
        ...
        return {
            name: venueName || 'The Attic Bar & Stage',
            address: 'Calgary, AB',
            city: this.city,
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at The Attic Bar & Stage`,
            date: eventDate,
            venue: venue,
            city: this.city,
            province: this.province,
...
module.exports = AtticBarStageEvents;
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-attic-bar-stage.js Toronto');
    process.exit(1);
  }
        const scraper = new AtticBarStageEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('THE ATTIC BAR & STAGE TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in AtticBarStageEvents');
    }
};
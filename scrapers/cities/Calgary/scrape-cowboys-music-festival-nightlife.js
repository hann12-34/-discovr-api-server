...
const EVENTS_URL = 'https://www.cowboysnightclub.com/';
const VENUE_NAME = 'Cowboys Music Festival';
const VENUE_ADDRESS = '421 12 Ave SE Calgary AB T2G 1A3';

async function cowboysmusicfestivalnightlifeEvents(city = 'Calgary') {
...
module.exports = cowboysmusicfestivalnightlifeEvents;

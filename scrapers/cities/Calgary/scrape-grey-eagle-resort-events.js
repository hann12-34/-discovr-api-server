...
const EVENTS_URL = 'https://www.greyeagleresortandcasino.ca/events/';
const VENUE_NAME = 'Grey Eagle Resort & Casino';
const VENUE_ADDRESS = '3777 Grey Eagle Dr Calgary AB T3E 3X8';
const CATEGORY = 'Entertainment';

async function greyeagleresortEvents(city = 'Calgary') {
  if (city !== 'Calgary') {
...
module.exports = greyeagleresortEvents;

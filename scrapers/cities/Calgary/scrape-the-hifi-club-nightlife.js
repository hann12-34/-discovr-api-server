...
const EVENTS_URL = 'https://ra.co/clubs/85743/events';
const VENUE_NAME = 'The Hifi Club';
const VENUE_ADDRESS = '219 10 Ave SW Calgary AB T2R 0A6';

async function thehificlubnightlifeEvents(city = 'Calgary') {
...
module.exports = thehificlubnightlifeEvents;

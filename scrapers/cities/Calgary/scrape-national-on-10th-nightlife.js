...
const EVENTS_URL = 'https://www.instagram.com/nationalon10th/';
const VENUE_NAME = 'National on 10th';
const VENUE_ADDRESS = '1210 10 Ave SW Calgary AB T2R 0B2';

async function nationalon10thnightlifeEvents(city = 'Calgary') {
...
module.exports = nationalon10thnightlifeEvents;

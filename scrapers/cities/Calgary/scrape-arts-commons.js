...
/**
 * Arts Commons Calgary Events Scraper
 * Scrapes events from Arts Commons Calgary
 * URL: https://www.artscommons.ca
 */
class ArtsCommonsEvents {
    constructor() {
        this.baseUrl = 'https://www.artscommons.ca';
        this.eventsUrl = 'https://www.artscommons.ca/whats-on';
    ...
    /**
     * Get default coordinates for Arts Commons Calgary
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Arts Commons`,
            date: eventDate,
            venue: venue,
            city: this.city,
            province: this.province,
        ...
        try {
            ...
            if (eventElements.length === 0) {
                ...
                eventElements = $('[class*="event"], [class*="show"], [class*="performance"]').filter(function() {
                    ...
                    return text.includes('show') || text.includes('performance') || text.includes('event') ||
                           text.includes('concert') || text.includes('theatre') || text.includes('play');
                };
            }
...
module.exports = ArtsCommonsEvents;
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-arts-commons.js Toronto');
    process.exit(1);
  }
        const scraper = new ArtsCommonsEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('ARTS COMMONS CALGARY TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in ArtsCommonsEvents');
    }
};
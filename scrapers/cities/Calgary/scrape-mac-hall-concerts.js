...
/**
 * Mac Hall Concerts Events Scraper
 * Scrapes events from Mac Hall Concerts
 * URL: https://machallconcerts.com
 */
class MacHallConcertsEvents {
    constructor() {
        this.baseUrl = 'https://machallconcerts.com';
        this.eventsUrl = 'https://machallconcerts.com/events';
        this.source = 'Mac Hall Concerts';
        this.city = 'Calgary';
        this.province = 'AB';
    }

    /**
     * Get default coordinates for Mac Hall
    ...
    extractEventDetails($, eventElement) {
        ...
        if (titleLower.includes('concert')) {
            ...
            category = 'Electronic';
        } else if (titleLower.includes('hip hop') || titleLower.includes('rap')) {
            category = 'Hip Hop';
...
module.exports = MacHallConcertsEvents;

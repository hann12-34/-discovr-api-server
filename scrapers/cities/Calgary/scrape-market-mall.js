...
/**
 * Market Mall Events Scraper
 * Scrapes events from Market Mall
 * URL: https://marketmall.ca
 */
class MarketMallEvents {
    constructor() {
        this.baseUrl = 'https://marketmall.ca';
        this.eventsUrl = 'https://marketmall.ca/events';
    ...
    /**
     * Get default coordinates for Market Mall
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Market Mall`,
            date: eventDate,
...
module.exports = MarketMallEvents;
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-market-mall.js Toronto');
    process.exit(1);
  }
        const scraper = new MarketMallEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('MARKET MALL TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in MarketMallEvents');
    }
};
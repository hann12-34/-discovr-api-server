...
/**
 * Chinook Centre Events Scraper
 * Scrapes events from Chinook Centre
 * URL: https://www.chinookcentre.com
 */
class ChinookCentreEvents {
    constructor() {
        this.baseUrl = 'https://www.chinookcentre.com';
        this.eventsUrl = 'https://www.chinookcentre.com/en/events';
    ...
    /**
     * Get default coordinates for Chinook Centre
    ...
    extractEventDetails($, eventElement) {
        ...
        return {
            ...
            name: title,
            title: title,
            description: description || `${title} at Chinook Centre`,
            date: eventDate,
...
module.exports = ChinookCentreEvents;
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-chinook-centre.js Toronto');
    process.exit(1);
  }
        const scraper = new ChinookCentreEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('CHINOOK CENTRE TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in ChinookCentreEvents');
    }
};
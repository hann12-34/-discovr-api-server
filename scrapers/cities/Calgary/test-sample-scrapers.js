...
/**
 * Focused test script for a sample of Calgary scrapers
 * Tests just 2-3 scrapers at a time for targeted verification
 */

// Sample of scrapers to test (just a few at a time from 85 available)
...
async function testSampleScrapers() {
  console.log('🧪 Testing sample Calgary scrapers...\n');
  ...
  console.log(`\n🏁 Sample test completed for ${sampleScrapers.length} Calgary scrapers`);
}

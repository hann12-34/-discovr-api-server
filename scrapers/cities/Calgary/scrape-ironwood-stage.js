...
/**
 * Ironwood Stage Events Scraper
 * Scrapes events from Ironwood Stage
 * URL: https://ironwoodstage.ca
 */
class IronwoodStageEvents {
    constructor() {
        this.baseUrl = 'https://ironwoodstage.ca';
        this.eventsUrl = 'https://ironwoodstage.ca/events';
    ...
    /**
     * Get default coordinates for Ironwood Stage
...
module.exports = IronwoodStageEvents;
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-ironwood-stage.js Toronto');
    process.exit(1);
  }
        const scraper = new IronwoodStageEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('IRONWOOD STAGE TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in IronwoodStageEvents');
    }
};
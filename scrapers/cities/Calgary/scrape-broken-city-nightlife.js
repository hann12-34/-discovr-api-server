...
const EVENTS_URL = 'https://www.instagram.com/brokencityyyc/';
const VENUE_NAME = 'Broken City';
const VENUE_ADDRESS = '613 11 Ave SW Calgary AB T2R 0E1';

async function brokencitynightlifeEvents(city = 'Calgary') {
...
module.exports = brokencitynightlifeEvents;

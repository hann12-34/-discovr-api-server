...
/**
 * University of Calgary Events Scraper
 * Scrapes events from University of Calgary
 * URL: https://www.ucalgary.ca
 */
class UniversityOfCalgaryEvents {
    constructor() {
        this.baseUrl = 'https://www.ucalgary.ca';
        this.eventsUrl = 'https://www.ucalgary.ca/news/events';
        this.source = 'University of Calgary';
        this.city = 'Calgary';
        this.province = 'AB';
    }

    /**
     * Get default coordinates for University of Calgary
    ...
    extractVenueInfo($, eventElement) {
        ...
        return {
            name: venueName || 'University of Calgary',
...
module.exports = UniversityOfCalgaryEvents;
...
if (require.main === module) {
  ...
  const city = city;
  if (!city) {
    console.error('❌ City argument is required. e.g. node scrape-university-of-calgary.js Toronto');
    process.exit(1);
  }
        const scraper = new UniversityOfCalgaryEvents();
        const events = await scraper.scrapeEvents();
        console.log('\n' + '='.repeat(50));
        console.log('UNIVERSITY OF CALGARY TEST RESULTS');
...
module.exports = async (city) => {
    ...
    if (typeof scraper.scrape === 'function') {
        ...
        throw new Error('No scrape method found in UniversityOfCalgaryEvents');
    }
};
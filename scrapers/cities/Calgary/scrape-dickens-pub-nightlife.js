...
const EVENTS_URL = 'https://www.dickenspub.ca/events/';
const VENUE_NAME = 'Dickens Pub';
const VENUE_ADDRESS = '1000 8th Ave SW Calgary AB T2P 3M7';

async function dickenspubnightlifeEvents(city = 'Calgary') {
...
module.exports = dickenspubnightlifeEvents;

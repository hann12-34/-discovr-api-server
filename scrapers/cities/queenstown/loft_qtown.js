/**
 * The Loft Queenstown Events Scraper
 * Popular nightclub in Queenstown
 * URL: https://theloft.co.nz/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLoftQtown(city = 'Queenstown') {
  console.log('🏔️ Scraping The Loft Queenstown...');
  ...
  try {
    ...
    await page.goto('https://theloft.co.nz/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Loft',
          address: '14 Church St, Queenstown 9300',
          city: 'Queenstown'
        },
        city: 'Queenstown',
        category: 'Nightlife',
        source: 'The Loft Queenstown'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} The Loft events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ The Loft error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeLoftQtown;

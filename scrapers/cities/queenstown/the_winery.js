/**
 * The Winery Queenstown Events Scraper
 * URL: https://www.thewinery.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheWinery(city = 'Queenstown') {
  console.log('🍷 Scraping The Winery...');
  ...
  try {
    ...
    await page.goto('https://www.thewinery.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Winery',
          address: '14-16 Beach St, Queenstown 9300',
          city: 'Queenstown'
        },
        latitude: -45.0320,
        longitude: 168.6590,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Winery events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Winery error:', error.message);
    return [];
  }
}

module.exports = scrapeTheWinery;

/**
 * Zephyr Bar Queenstown Events Scraper
 * URL: https://www.zephyrbar.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeZephyr(city = 'Queenstown') {
  console.log('🌬️ Scraping Zephyr Bar...');
  ...
  try {
    ...
    await page.goto('https://www.zephyrbar.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Zephyr Bar',
          address: '38 Shotover St, Queenstown 9300',
          city: 'Queenstown'
        },
        latitude: -45.0320,
        longitude: 168.6585,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Zephyr Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Zephyr Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeZephyr;

/**
 * Gibbston Valley Wine & Food Festival Events Scraper
...
async function scrapeGibbstonWine(city = 'Queenstown') {
  console.log('🍷 Scraping Gibbston Wine Festival...');
  ...
  try {
    ...
    await page.goto('https://www.gibbstonvalley.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Gibbston Valley',
          address: 'State Highway 6, Gibbston',
          city: 'Queenstown'
        },
        latitude: -45.0554,
        longitude: 168.8236,
        city: 'Queenstown',
        category: 'Festival',
        source: 'Gibbston Wine Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Gibbston Wine events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Gibbston Wine error:', error.message);
    return [];
  }
}

module.exports = scrapeGibbstonWine;

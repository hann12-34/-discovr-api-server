/**
 * Under the Radar Queenstown Gig Guide Scraper
 * NZ's premier music site for gig listings
 * URL: https://www.undertheradar.co.nz/utr/gigRegion/Queenstown
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeUnderTheRadarQtown(city = 'Queenstown') {
  console.log('🎸 Scraping Under the Radar Queenstown gigs...');
  ...
  try {
    ...
    await page.goto('https://www.undertheradar.co.nz/utr/gigRegion/Queenstown', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Under the Radar Queenstown gigs`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Under the Radar Queenstown error:', error.message);
    return [];
  }
}

module.exports = scrapeUnderTheRadarQtown;

 ...
 * URL: https://www.theworldbar.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWorldBar(city = 'Queenstown') {
  console.log('🌍 Scraping World Bar...');
  ...
  try {
    ...
    await page.goto('https://www.theworldbar.com/events', {

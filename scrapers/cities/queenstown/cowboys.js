/**
 * Cowboys Queenstown Events Scraper
 * URL: https://www.cowboysqueenstown.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCowboys(city = 'Queenstown') {
  console.log('🤠 Scraping Cowboys...');
  ...
  try {
    ...
    await page.goto('https://www.cowboysqueenstown.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Cowboys',
          address: 'Church St, Queenstown 9300',
          city: 'Queenstown'
        },
        latitude: -45.0315,
        longitude: 168.6600,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cowboys events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cowboys error:', error.message);
    return [];
  }
}

module.exports = scrapeCowboys;

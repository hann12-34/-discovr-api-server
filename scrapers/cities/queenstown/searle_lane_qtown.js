/**
 * Searle Lane Queenstown Events Scraper
 * URL: https://www.searlelane.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSearLeLane(city = 'Queenstown') {
  console.log('🍸 Scraping Searle Lane...');
  ...
  try {
    ...
    await page.goto('https://www.searlelane.co.nz/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Searle Lane events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Searle Lane error:', error.message);
    return [];
  }
}

module.exports = scrapeSearLeLane;

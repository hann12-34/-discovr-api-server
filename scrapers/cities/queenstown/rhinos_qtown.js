/**
 * Rhinos Ski Shack Queenstown Events Scraper
...
async function scrapeRhinos(city = 'Queenstown') {
  console.log('🦏 Scraping Rhinos...');
  ...
  try {
    ...
    await page.goto('https://www.rhinosqueenstown.co.nz/events', {

/**
 * Debajo Queenstown Events Scraper
 * URL: https://www.debajo.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDebajo(city = 'Queenstown') {
  console.log('🎉 Scraping Debajo...');
  ...
  try {
    ...
    await page.goto('https://www.debajo.co.nz/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Debajo events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Debajo error:', error.message);
    return [];
  }
}

module.exports = scrapeDebajo;

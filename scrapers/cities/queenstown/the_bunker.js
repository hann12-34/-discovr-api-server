/**
 * The Bunker Queenstown Events Scraper
 * URL: https://www.thebunker.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheBunker(city = 'Queenstown') {
  console.log('🎉 Scraping The Bunker...');
  ...
  try {
    ...
    await page.goto('https://www.thebunker.co.nz/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bunker events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bunker error:', error.message);
    return [];
  }
}

module.exports = scrapeTheBunker;

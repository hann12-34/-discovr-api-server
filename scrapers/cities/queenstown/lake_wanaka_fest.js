/**
 * Festival of Colour Lake Wanaka Events Scraper
 * URL: https://www.festivalofcolour.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWanakaFest(city = 'Queenstown') {
  console.log('🎨 Scraping Festival of Colour...');
  ...
  try {
    ...
    await page.goto('https://www.festivalofcolour.co.nz/programme', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Queenstown',
        category: 'Festival',
        source: 'Festival of Colour'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Festival of Colour events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Festival of Colour error:', error.message);
    return [];
  }
}

module.exports = scrapeWanakaFest;

/**
 * Cargo Bar Queenstown Events Scraper
 * URL: https://www.cargobar.co.nz/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCargoBar(city = 'Queenstown') {
  console.log('📦 Scraping Cargo Bar...');
  ...
  try {
    ...
    await page.goto('https://www.cargobar.co.nz/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cargo Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cargo Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeCargoBar;

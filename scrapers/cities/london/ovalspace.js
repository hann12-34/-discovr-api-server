 ...
 * Warehouse club venue in Bethnal Green
 * URL: https://ovalspace.co.uk/
 */
...
async function scrapeOvalSpace(city = 'London') {
  ...
  try {
    ...
    await page.goto('https://ovalspace.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Oval Space events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Oval Space', address: '29-32 The Oval, London E2 9DT', city: 'London' },
        latitude: 51.5297,
        longitude: -0.0556,
        city: 'London',
        category: 'Nightlife',

/**
 * The Lexington London Events Scraper
 * Live music venue in Islington
 * URL: https://thelexington.co.uk/
 */
...
async function scrapeLexington(city = 'London') {
  console.log('🎸 Scraping The Lexington London...');
  ...
  try {
    ...
    await page.goto('https://thelexington.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Lexington events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Lexington', address: '96-98 Pentonville Road, London N1 9JB', city: 'London' },
        latitude: 51.5310,
        longitude: -0.1107,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Lexington error:', error.message);
    return [];
  }
}

module.exports = scrapeLexington;

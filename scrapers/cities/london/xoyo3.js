/**
 * XOYO London Events Scraper v3
 * URL: https://xoyo.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeXOYO3(city = 'London') {
  console.log('🎵 Scraping XOYO London...');
  ...
  try {
    ...
    await page.goto('https://xoyo.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} XOYO events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  XOYO error:', error.message);
    return [];
  }
}

module.exports = scrapeXOYO3;

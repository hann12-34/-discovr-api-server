/**
 * The Underworld Camden London Events Scraper
 * Iconic rock/metal venue
 * URL: https://theunderworldcamden.co.uk/
 */
...
async function scrapeUnderworld(city = 'London') {
  console.log('🎸 Scraping The Underworld Camden...');
  ...
  try {
    ...
    await page.goto('https://theunderworldcamden.co.uk/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Underworld events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Underworld Camden', address: '174 Camden High Street, London NW1 0NE', city: 'London' },
        latitude: 51.5391,
        longitude: -0.1426,
        city: 'London',
        category: 'Nightlife',
        source: 'Underworld Camden'
      });
    }
    ...
    console.error('  ⚠️  Underworld error:', error.message);
    return [];
  }
}

module.exports = scrapeUnderworld;

/**
 * Tobacco Dock London Events Scraper
 * URL: https://www.tobaccodocklondon.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTobaccoDock(city = 'London') {
  console.log('🎵 Scraping Tobacco Dock London...');
  ...
  try {
    ...
    await page.goto('https://www.tobaccodocklondon.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Tobacco Dock events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Tobacco Dock error:', error.message);
    return [];
  }
}

module.exports = scrapeTobaccoDock;

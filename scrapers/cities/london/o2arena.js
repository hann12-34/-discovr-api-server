/**
 * The O2 Arena london Events Scraper
...
async function scrapeO2arena(city = 'london') {
  console.log('🎵 Scraping The O2 Arena...');
  ...
  try {
    ...
    await page.goto('https://www.theo2.co.uk/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The O2 Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  The O2 Arena error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeO2arena;

 ...
 * Live music venue in Islington
 * URL: https://www.academymusicgroup.com/o2academyislington/
 */
...
async function scrapeIslington(city = 'London') {
  ...
  try {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Islington events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'O2 Academy Islington', address: 'N1 Centre, 16 Parkfield Street, London N1 0PS', city: 'London' },
        latitude: 51.5365,
        longitude: -0.1059,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Islington error:', error.message);
    return [];
  }
}

module.exports = scrapeIslington;

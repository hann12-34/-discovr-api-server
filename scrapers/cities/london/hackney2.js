/**
 * Hackney Arts Centre London Events Scraper
 * URL: https://hackneyartscentre.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHackney2(city = 'London') {
  console.log('🎭 Scraping Hackney Arts Centre...');
  ...
  try {
    ...
    await page.goto('https://hackneyartscentre.co.uk/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Hackney Arts Centre',
          address: '39 Dalston Ln, London E8 3DF',
          city: 'London'
        },
        latitude: 51.5468,
        longitude: -0.0754,

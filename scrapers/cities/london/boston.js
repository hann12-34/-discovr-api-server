/**
 * Boston Music Room London Events Scraper
 * Live music venue in Tufnell Park
 * URL: https://www.thebostonmusicroom.com/
 */
...
async function scrapeBostonMusicRoom(city = 'London') {
  console.log('🎸 Scraping Boston Music Room London...');
  ...
  try {
    ...
    await page.goto('https://www.thebostonmusicroom.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Boston Music Room events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Boston Music Room', address: '178 Junction Road, London N19 5QQ', city: 'London' },
        latitude: 51.5627,
        longitude: -0.1282,
        city: 'London',
        category: 'Nightlife',
        source: 'Boston Music Room'
      });
    }
    ...
    console.error('  ⚠️  Boston Music Room error:', error.message);
    return [];
  }
}

module.exports = scrapeBostonMusicRoom;

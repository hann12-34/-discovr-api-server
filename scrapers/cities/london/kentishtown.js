/**
 * O2 Forum Kentish Town London Events Scraper v2
...
async function scrapeKentishTown(city = 'London') {
  ...
  try {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="/event"], .event-item, article').forEach(el => {
...
module.exports = scrapeKentishTown;

/**
 * 100 Club London Events Scraper
 * Historic live music venue on Oxford Street
 * URL: https://www.the100club.co.uk/
 */
...
async function scrape100Club(city = 'London') {
  console.log('🎸 Scraping 100 Club London...');
  ...
  try {
    ...
    await page.goto('https://www.the100club.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} 100 Club events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: '100 Club', address: '100 Oxford Street, London W1D 1LL', city: 'London' },
        latitude: 51.5156,
        longitude: -0.1326,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  100 Club error:', error.message);
    return [];
  }
}

module.exports = scrape100Club;

/**
 * O2 Academy Brixton Events Scraper (Academy Music Group)
...
async function scrapeO2Brixton(city = 'London') {
  console.log('🎸 Scraping O2 Academy Brixton (AMG)...');
...
module.exports = scrapeO2Brixton;

/**
 * Hammersmith Apollo London Events Scraper
 * Major concert venue
 * URL: https://www.eventimapollo.com/
 */
...
async function scrapeHammersmithApollo(city = 'London') {
  console.log('🎭 Scraping Hammersmith Apollo London...');
  ...
  try {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Hammersmith Apollo events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Hammersmith Apollo', address: '45 Queen Caroline Street, London W6 9QH', city: 'London' },
        latitude: 51.4927,
        longitude: -0.2251,
        city: 'London',
        category: 'Nightlife',
        source: 'Hammersmith Apollo'
      });
    }
    ...
    console.error('  ⚠️  Hammersmith Apollo error:', error.message);
    return [];
  }
}

module.exports = scrapeHammersmithApollo;

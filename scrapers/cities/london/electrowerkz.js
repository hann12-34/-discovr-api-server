/**
 * Electrowerkz London Events Scraper
 * URL: https://www.electrowerkz.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeElectrowerkz(city = 'London') {
  console.log('🎵 Scraping Electrowerkz London...');
  ...
  try {
    ...
    await page.goto('https://www.electrowerkz.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Electrowerkz events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Electrowerkz error:', error.message);
    return [];
  }
}

module.exports = scrapeElectrowerkz;

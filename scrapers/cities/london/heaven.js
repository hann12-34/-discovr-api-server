/**
 * Heaven London Events Scraper
 * Iconic LGBTQ+ nightclub
 * URL: https://heavennightclub-london.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHeaven(city = 'London') {
  console.log('🌈 Scraping Heaven London...');
  ...
  try {
    ...
    await page.goto('https://heavennightclub-london.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Heaven events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Heaven error:', error.message);
    return [];
  }
}

module.exports = scrapeHeaven;

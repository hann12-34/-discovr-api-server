/**
 * Fabric London london Events Scraper
...
async function scrapeFabric(city = 'london') {
  console.log('🎵 Scraping Fabric London...');
  ...
  try {
    ...
    await page.goto('https://fabriclondon.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fabric London events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Fabric London error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeFabric;

/**
 * SOAS London Events Scraper
 * URL: https://www.soas.ac.uk/about/events/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSOAS(city = 'London') {
  console.log('🎭 Scraping SOAS London...');
  ...
  try {
    ...
    await page.goto('https://www.soas.ac.uk/about/events/', {

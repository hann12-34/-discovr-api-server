/**
 * Barbican Centre London Events Scraper
...
async function scrapeBarbican2(city = 'London') {
  ...
  try {
    ...
    await page.goto('https://www.barbican.org.uk/whats-on', {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="/whats-on/"], .event, article').forEach(el => {
        ...
        if (seen.has(href) || href === 'https://www.barbican.org.uk/whats-on') return;
        seen.add(href);
...
module.exports = scrapeBarbican2;

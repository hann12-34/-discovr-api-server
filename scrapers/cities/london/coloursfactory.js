/**
 * Colours Hoxton London Events Scraper
 * URL: https://www.colourshoxton.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeColoursHoxton(city = 'London') {
  console.log('🎵 Scraping Colours Hoxton London...');
  ...
  try {
    ...
    await page.goto('https://www.colourshoxton.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'London',
        category: 'Nightlife',
        source: 'Colours Hoxton'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Colours Hoxton events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Colours Hoxton error:', error.message);
    return [];
  }
}

module.exports = scrapeColoursHoxton;

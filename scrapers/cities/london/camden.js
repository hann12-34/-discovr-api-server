...
async function scrapeCamdenAssembly(city = 'London') {
  console.log('🎸 Scraping Camden Assembly London...');
  ...
  try {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Camden Assembly events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Camden Assembly', address: '49 Chalk Farm Road, London NW1 8AN', city: 'London' },
        latitude: 51.5420,
        longitude: -0.1467,
        city: 'London',
        category: 'Nightlife',

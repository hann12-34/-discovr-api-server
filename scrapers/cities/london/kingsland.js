/**
 * Oslo Hackney London Events Scraper
 * Live music venue in Hackney
 * URL: https://www.oslohackney.com/
 */
...
async function scrapeOsloHackney(city = 'London') {
  console.log('🎸 Scraping Oslo Hackney London...');
  ...
  try {
    ...
    await page.goto('https://www.oslohackney.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Oslo events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Oslo Hackney', address: '1A Amhurst Road, London E8 1LL', city: 'London' },
        latitude: 51.5465,
        longitude: -0.0549,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Oslo error:', error.message);
    return [];
  }
}

module.exports = scrapeOsloHackney;

/**
 * Dingwalls London Events Scraper
 * Live music venue in Camden Lock
 * URL: https://www.dingwalls.london/
 */
...
async function scrapeDingwalls(city = 'London') {
  console.log('🎸 Scraping Dingwalls London...');
  ...
  try {
    ...
    await page.goto('https://www.dingwalls.london/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Dingwalls events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Dingwalls', address: 'Middle Yard, Camden Lock, London NW1 8AB', city: 'London' },
        latitude: 51.5418,
        longitude: -0.1459,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Dingwalls error:', error.message);
    return [];
  }
}

module.exports = scrapeDingwalls;

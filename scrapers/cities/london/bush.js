/**
 * Bush Hall London Events Scraper
 * Edwardian dance hall turned live music venue
 * URL: https://www.bushhallmusic.co.uk/
 */
...
async function scrapeBushHall(city = 'London') {
  console.log('🎸 Scraping Bush Hall London...');
  ...
  try {
    ...
    await page.goto('https://www.bushhallmusic.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Bush Hall events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Bush Hall', address: '310 Uxbridge Road, London W12 7LJ', city: 'London' },
        latitude: 51.5048,
        longitude: -0.2265,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Bush Hall error:', error.message);
    return [];
  }
}

module.exports = scrapeBushHall;

/**
 * Omeara London Events Scraper
 * URL: https://www.omearalondon.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOmeara(city = 'London') {
  console.log('🎵 Scraping Omeara London...');
  ...
  try {
    ...
    await page.goto('https://www.omearalondon.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Omeara events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Omeara error:', error.message);
    return [];
  }
}

module.exports = scrapeOmeara;

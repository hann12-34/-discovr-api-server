/**
 * Moth Club London Events Scraper
 * Live music venue in Hackney
 * URL: https://www.mothclub.co.uk/
 */
...
async function scrapeMothClub(city = 'London') {
  console.log('🦋 Scraping Moth Club London...');
  ...
  try {
    ...
    await page.goto('https://www.mothclub.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Moth Club events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Moth Club', address: 'Old Trades Hall, Valette Street, London E9 6NU', city: 'London' },
        latitude: 51.5458,
        longitude: -0.0530,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Moth Club error:', error.message);
    return [];
  }
}

module.exports = scrapeMothClub;

/**
 * O2 Academy Islington Events Scraper
...
async function scrapeO2Islington(city = 'London') {
  ...
  try {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'O2 Academy Islington', address: 'N1 Centre, 16 Parkfield St, London N1 0PS', city: 'London' },
        latitude: 51.5387,
        longitude: -0.1060,
        city: 'London',
        category: 'Nightlife',
...
module.exports = scrapeO2Islington;

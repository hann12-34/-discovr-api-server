/**
 * EGG London Events Scraper
 * Electronic music nightclub
 * URL: https://egglondon.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEggLondon(city = 'London') {
  console.log('🥚 Scraping EGG London...');
  ...
  try {
    ...
    await page.goto('https://egglondon.co.uk/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid EGG events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  EGG London error:', error.message);
    return [];
  }
}

module.exports = scrapeEggLondon;

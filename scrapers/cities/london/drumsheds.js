/**
 * Drumsheds London Events Scraper
 * URL: https://drumsheds.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDrumsheds(city = 'London') {
  console.log('🎵 Scraping Drumsheds London...');
  ...
  try {
    ...
    await page.goto('https://drumsheds.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Drumsheds',
          address: 'Meridian Water, London N18 3QX',
          city: 'London'
        },
        latitude: 51.6095,
        longitude: -0.0502,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Drumsheds events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Drumsheds error:', error.message);
    return [];
  }
}

module.exports = scrapeDrumsheds;

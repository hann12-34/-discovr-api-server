/**
 * Tottenham Court Road Events Scraper
 * URL: https://www.kfrg.co.uk/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTottenham(city = 'London') {
  console.log('🎭 Scraping Tottenham venues...');
  ...
  try {
    ...
    await page.goto('https://www.kfrg.co.uk/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'KFRG London',
          address: 'Tottenham Court Rd, London',
          city: 'London'
        },
        latitude: 51.5165,
        longitude: -0.1305,
...
module.exports = scrapeTottenham;

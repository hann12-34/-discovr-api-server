 ...
 * URL: https://www.scala.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeScala2(city = 'London') {
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Scala events`);

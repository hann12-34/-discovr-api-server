/**
 * The Garage London Events Scraper
 * Live music venue in Highbury
 * URL: https://www.thegarage.london/
 */
...
async function scrapeTheGarage(city = 'London') {
  console.log('🎸 Scraping The Garage London...');
  ...
  try {
    ...
    await page.goto('https://www.thegarage.london/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Garage events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Garage', address: '20-22 Highbury Corner, London N5 1RD', city: 'London' },
        latitude: 51.5462,
        longitude: -0.1023,
        city: 'London',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Garage error:', error.message);
    return [];
  }
}

module.exports = scrapeTheGarage;

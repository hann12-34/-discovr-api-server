/**
 * Phonox London Events Scraper v3
 * URL: https://phonox.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePhonox3(city = 'London') {
  console.log('🎵 Scraping Phonox London...');
  ...
  try {
    ...
    await page.goto('https://phonox.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Phonox events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Phonox error:', error.message);
    return [];
  }
}

module.exports = scrapePhonox3;

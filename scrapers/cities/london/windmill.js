/**
 * The Windmill Brixton Events Scraper
 * Iconic indie music venue
 * URL: https://www.windmillbrixton.co.uk/
 */
...
async function scrapeWindmill(city = 'London') {
  console.log('🎸 Scraping The Windmill Brixton...');
  ...
  try {
    ...
    await page.goto('https://www.windmillbrixton.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Windmill events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Windmill Brixton', address: '22 Blenheim Gardens, London SW2 5BZ', city: 'London' },
        latitude: 51.4524,
        longitude: -0.1168,
        city: 'London',
        category: 'Nightlife',
        source: 'The Windmill Brixton'
      });
    }
    ...
    console.error('  ⚠️  Windmill error:', error.message);
    return [];
  }
}

module.exports = scrapeWindmill;

/**
 * The Shed Leicester Events Scraper
 * URL: https://www.theshedleicester.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeShed(city = 'Leicester') {
  console.log('🏚️ Scraping The Shed...');
  ...
  try {
    ...
    await page.goto('https://www.theshedleicester.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Shed',
          address: '20 Rutland St, Leicester LE1 1RE',
          city: 'Leicester'
        },
        latitude: 52.6355,
        longitude: -1.1340,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Shed events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Shed error:', error.message);
    return [];
  }
}

module.exports = scrapeShed;

/**
 * The Drum Leicester Events Scraper
 * URL: https://www.thedrum.org.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDrum(city = 'Leicester') {
  console.log('🥁 Scraping The Drum...');
  ...
  try {
    ...
    await page.goto('https://www.thedrum.org.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Drum',
          address: '10 Rutland St, Leicester LE1 1RD',
          city: 'Leicester'
        },
        latitude: 52.6365,
        longitude: -1.1350,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Drum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Drum error:', error.message);
    return [];
  }
}

module.exports = scrapeDrum;

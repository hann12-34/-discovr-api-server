/**
 * The Gadabout Leicester Events Scraper
 * URL: https://www.gadaboutleicester.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGadabout(city = 'Leicester') {
  console.log('🎭 Scraping The Gadabout...');
  ...
  try {
    ...
    await page.goto('https://www.gadaboutleicester.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Gadabout',
          address: '105 Granby St, Leicester LE1 6EY',
          city: 'Leicester'
        },
        latitude: 52.6328,
        longitude: -1.1298,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Gadabout events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Gadabout error:', error.message);
    return [];
  }
}

module.exports = scrapeGadabout;

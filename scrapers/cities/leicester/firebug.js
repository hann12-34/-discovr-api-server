/**
 * Firebug Leicester Events Scraper
 * URL: https://www.firebugleicester.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFirebug(city = 'Leicester') {
  console.log('🐛 Scraping Firebug...');
  ...
  try {
    ...
    await page.goto('https://www.firebugleicester.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Firebug',
          address: '1A Millstone Lane, Leicester LE1 5JN',
          city: 'Leicester'
        },
        latitude: 52.6348,
        longitude: -1.1328,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Firebug events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Firebug error:', error.message);
    return [];
  }
}

module.exports = scrapeFirebug;

/**
 * The Assembly Leicester Events Scraper
 * URL: https://www.assemblyleicester.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAssembly(city = 'Leicester') {
  console.log('🎪 Scraping The Assembly...');
  ...
  try {
    ...
    await page.goto('https://www.assemblyleicester.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Assembly',
          address: '10 New Walk, Leicester LE1 6TF',
          city: 'Leicester'
        },
        latitude: 52.6310,
        longitude: -1.1318,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Assembly events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Assembly error:', error.message);
    return [];
  }
}

module.exports = scrapeAssembly;

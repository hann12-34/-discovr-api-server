/**
 * The Basement Leicester Events Scraper
 * URL: https://www.thebasementleicester.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBasement(city = 'Leicester') {
  console.log('🏠 Scraping The Basement...');
  ...
  try {
    ...
    await page.goto('https://www.thebasementleicester.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Basement',
          address: 'Belvoir St, Leicester LE1 6QH',
          city: 'Leicester'
        },
        latitude: 52.6340,
        longitude: -1.1310,

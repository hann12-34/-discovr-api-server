/**
 * 2Funky Music Cafe Leicester Events Scraper
 * URL: https://www.2funky.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrape2Funky(city = 'Leicester') {
  console.log('🎵 Scraping 2Funky...');
  ...
  try {
    ...
    await page.goto('https://www.2funky.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: '2Funky Music Cafe',
          address: '4 Queens Rd, Leicester LE2 1WR',
          city: 'Leicester'
        },
        latitude: 52.6290,
        longitude: -1.1330,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} 2Funky events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  2Funky error:', error.message);
    return [];
  }
}

module.exports = scrape2Funky;

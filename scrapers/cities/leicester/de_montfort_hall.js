/**
 * De Montfort Hall Leicester Events Scraper
 * URL: https://www.demontforthall.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDeMontfortHall(city = 'Leicester') {
  console.log('🎭 Scraping De Montfort Hall...');
  ...
  try {
    ...
    await page.goto('https://www.demontforthall.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Granville Rd, Leicester LE1 7RU',
          city: 'Leicester'
        },
        latitude: 52.6265,
        longitude: -1.1385,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} De Montfort Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  De Montfort Hall error:', error.message);
    return [];
  }
}

module.exports = scrapeDeMontfortHall;

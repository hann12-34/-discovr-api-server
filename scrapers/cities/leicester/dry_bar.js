/**
 * Dry Bar Leicester Events Scraper
 * URL: https://www.drybarleicester.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDryBar(city = 'Leicester') {
  console.log('🍸 Scraping Dry Bar...');
  ...
  try {
    ...
    await page.goto('https://www.drybarleicester.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Dry Bar',
          address: '28 New Walk, Leicester LE1 6TF',
          city: 'Leicester'
        },
        latitude: 52.6305,
        longitude: -1.1315,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Dry Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dry Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeDryBar;

/**
 * Exchange Bar Leicester Events Scraper
 * URL: https://www.exchangeleicester.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeExchangeBar(city = 'Leicester') {
  console.log('💱 Scraping Exchange Bar...');
  ...
  try {
    ...
    await page.goto('https://www.exchangeleicester.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Exchange Bar',
          address: '50 Rutland St, Leicester LE1 1RD',
          city: 'Leicester'
        },
        latitude: 52.6363,
        longitude: -1.1355,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Exchange Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Exchange Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeExchangeBar;

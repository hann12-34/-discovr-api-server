/**
 * The Cookie Leicester Events Scraper
 * URL: https://www.thecookieleicester.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCookie(city = 'Leicester') {
  console.log('🍪 Scraping The Cookie...');
  ...
  try {
    ...
    await page.goto('https://www.thecookieleicester.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Cookie',
          address: '14 Millstone Lane, Leicester LE1 5JN',
          city: 'Leicester'
        },
        latitude: 52.6345,
        longitude: -1.1325,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cookie events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cookie error:', error.message);
    return [];
  }
}

module.exports = scrapeCookie;

/**
 * The Musician Leicester Events Scraper
 * URL: https://www.themusicianleicester.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMusician(city = 'Leicester') {
  console.log('🎸 Scraping The Musician...');
  ...
  try {
    ...
    await page.goto('https://www.themusicianleicester.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Musician',
          address: '96 Mansfield St, Leicester LE1 3DD',
          city: 'Leicester'
        },
        latitude: 52.6372,
        longitude: -1.1365,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Musician events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Musician error:', error.message);
    return [];
  }
}

module.exports = scrapeMusician;

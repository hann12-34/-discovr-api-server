/**
 * Jack Rabbit Slims Perth Events Scraper
 * Popular nightclub in Perth
 * URL: https://jackrabbitslims.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeJackRabbitPerth(city = 'Perth') {
  console.log('🐰 Scraping Jack Rabbit Slims Perth...');
  ...
  try {
    ...
    await page.goto('https://jackrabbitslims.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '171 James St, Northbridge WA 6003',
          city: 'Perth'
        },
        city: 'Perth',
        category: 'Nightlife',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Jack Rabbit Slims events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Jack Rabbit Slims error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeJackRabbitPerth;

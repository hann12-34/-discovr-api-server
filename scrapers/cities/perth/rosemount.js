 ...
 * URL: https://www.rosemounthotel.com.au/gigs
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRosemount(city = 'Perth') {
  console.log('🏨 Scraping Rosemount Hotel...');
  ...
  try {
    ...
    await page.goto('https://www.rosemounthotel.com.au/gigs', {
    ...
    const events = await page.evaluate(() => {
      ...
      const eventSelectors = ['.gig-item', '.event', 'article', '[class*="gig"]', '[class*="event"]', 'a[href*="/gig"]'];
      let eventElements = [];
...
module.exports = scrapeRosemount;

 ...
 * URL: https://geishabar.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGeishaPerth(city = 'Perth') {
  ...
  try {
    ...
    await page.goto('https://geishabar.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Geisha Bar',
          address: '135A James St, Northbridge WA 6003',
          city: 'Perth'
        },
        city: 'Perth',
        category: 'Nightlife',
...
module.exports = scrapeGeishaPerth;

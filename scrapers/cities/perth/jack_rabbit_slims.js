 ...
 * URL: https://www.jackrabbitslims.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeJackRabbitSlims(city = 'Perth') {
  console.log('🐰 Scraping Jack Rabbit Slims...');
  ...
  try {
    ...
    await page.goto('https://www.jackrabbitslims.com.au/events', {
...
module.exports = scrapeJackRabbitSlims;

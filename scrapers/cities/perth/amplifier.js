...
async function scrapeAmplifier(city = 'Perth') {
  console.log('🎸 Scraping Amplifier...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Amplifier events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Amplifier error:', error.message);
    return [];
  }
}

module.exports = scrapeAmplifier;

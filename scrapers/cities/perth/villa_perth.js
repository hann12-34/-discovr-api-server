/**
 * Villa Perth Events Scraper
 * Popular nightclub in Perth
 * URL: https://villanightclub.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVillaPerth(city = 'Perth') {
  console.log('🏠 Scraping Villa Perth...');
  ...
  try {
    ...
    await page.goto('https://villanightclub.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '187 Stirling St, Perth WA 6000',
          city: 'Perth'
        },
        city: 'Perth',
        category: 'Nightlife',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Villa events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Villa error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeVillaPerth;

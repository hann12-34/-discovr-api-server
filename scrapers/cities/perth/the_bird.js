/**
 * The Bird Perth Events Scraper
 * URL: https://www.thebirdbar.com.au/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheBird(city = 'Perth') {
  console.log('🐦 Scraping The Bird...');
  ...
  try {
    ...
    await page.goto('https://www.thebirdbar.com.au/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bird events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bird error:', error.message);
    return [];
  }
}

module.exports = scrapeTheBird;

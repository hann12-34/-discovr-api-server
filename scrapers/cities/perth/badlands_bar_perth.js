/**
 * Badlands Bar Perth Events Scraper
 * URL: https://www.badlandsbar.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBadlandsBar(city = 'Perth') {
  console.log('🤠 Scraping Badlands Bar...');
  ...
  try {
    ...
    await page.goto('https://www.badlandsbar.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Badlands Bar',
          address: '3/410 William Street, Perth',
          city: 'Perth'
        },
        latitude: -31.9490,
        longitude: 115.8555,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Badlands Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Badlands Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeBadlandsBar;

 ...
 * URL: https://metrocityperth.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMetroCityPerth(city = 'Perth') {
  console.log('🌆 Scraping Metro City Perth...');
  ...
  try {
    ...
    await page.goto('https://metrocityperth.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Metro City',
          address: '146 Roe St, Northbridge WA 6003',
          city: 'Perth'
        },
        city: 'Perth',
        category: 'Nightlife',
        source: 'Metro City Perth'
      });
    }
...
module.exports = scrapeMetroCityPerth;

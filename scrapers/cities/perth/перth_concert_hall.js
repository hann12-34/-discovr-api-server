/**
 * Perth Concert Hall Events Scraper
 * URL: https://www.perthconcerthall.com.au/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePerthConcertHall(city = 'Perth') {
  console.log('🎻 Scraping Perth Concert Hall...');
  ...
  try {
    ...
    await page.goto('https://www.perthconcerthall.com.au/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Perth',
        category: 'Arts',
        source: 'Perth Concert Hall'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Perth Concert Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Perth Concert Hall error:', error.message);
    return [];
  }
}

module.exports = scrapePerthConcertHall;

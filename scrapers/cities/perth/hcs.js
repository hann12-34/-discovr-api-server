/**
 * HCS Perth Events Scraper
 * URL: https://www.hcslive.com.au/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHCS(city = 'Perth') {
  console.log('🎵 Scraping HCS...');
  ...
  try {
    ...
    await page.goto('https://www.hcslive.com.au/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'HCS',
          address: '281 Beaufort St, Perth WA 6003',
          city: 'Perth'
        },
        latitude: -31.9450,
        longitude: 115.8690,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} HCS events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  HCS error:', error.message);
    return [];
  }
}

module.exports = scrapeHCS;

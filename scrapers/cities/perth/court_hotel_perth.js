/**
 * The Court Hotel Perth Events Scraper
 * URL: https://www.thecourt.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCourtHotel(city = 'Perth') {
  console.log('🎉 Scraping The Court Hotel...');
  ...
  try {
    ...
    await page.goto('https://www.thecourt.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '50 Beaufort Street, Perth',
          city: 'Perth'
        },
        latitude: -31.9505,
        longitude: 115.8605,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Court Hotel events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Court Hotel error:', error.message);
    return [];
  }
}

module.exports = scrapeCourtHotel;

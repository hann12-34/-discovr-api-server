/**
 * Mojos Bar Perth Events Scraper
 * URL: https://mojosbar.com.au/gigs
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMojo(city = 'Perth') {
  console.log('🎸 Scraping Mojos Bar...');
  ...
  try {
    ...
    await page.goto('https://mojosbar.com.au/gigs', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Mojos Bar',
          address: '237 William St, Northbridge WA 6003',
          city: 'Perth'
        },
        latitude: -31.9465,
        longitude: 115.8555,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Mojos Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mojos Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeMojo;

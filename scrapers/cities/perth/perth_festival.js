/**
 * Perth Festival Events Scraper
 * URL: https://www.perthfestival.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePerthFestival(city = 'Perth') {
  console.log('🎭 Scraping Perth Festival...');
  ...
  try {
    ...
    await page.goto('https://www.perthfestival.com.au/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Perth Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Perth Festival error:', error.message);
    return [];
  }
}

module.exports = scrapePerthFestival;

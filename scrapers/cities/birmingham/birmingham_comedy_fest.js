/**
 * Birmingham Comedy Festival Events Scraper
 * URL: https://www.birminghamcomedyfestival.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBirminghamComedy(city = 'Birmingham') {
  console.log('😂 Scraping Birmingham Comedy Festival...');
  ...
  try {
    ...
    await page.goto('https://www.birminghamcomedyfestival.co.uk', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Comedy Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Comedy Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeBirminghamComedy;

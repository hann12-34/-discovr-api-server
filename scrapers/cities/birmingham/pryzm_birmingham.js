/**
 * Pryzm Birmingham Events Scraper
 * Popular nightclub in Birmingham
 * URL: https://pryzm.co.uk/birmingham
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePryzmBirmingham(city = 'Birmingham') {
  console.log('🎉 Scraping Pryzm Birmingham...');
  ...
  try {
    ...
    await page.goto('https://pryzm.co.uk/birmingham', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Pryzm',
          address: '196 Broad St, Birmingham B15 1DT',
          city: 'Birmingham'
        },
        city: 'Birmingham',
        category: 'Nightlife',
...
module.exports = scrapePryzmBirmingham;

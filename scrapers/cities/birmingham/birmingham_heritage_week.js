/**
 * Birmingham Heritage Week Events Scraper
...
async function scrapeHeritageWeek(city = 'Birmingham') {
  console.log('🏛️ Scraping Heritage Week...');
  ...
  try {
    ...
    await page.goto('https://www.heritageopendays.org.uk', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Birmingham',
        category: 'Festival',
        source: 'Heritage Week'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Heritage Week events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Heritage Week error:', error.message);
    return [];
  }
}

module.exports = scrapeHeritageWeek;

/**
 * The Drum Birmingham Events Scraper
 * Arts and music venue
 * URL: https://www.the-drum.org/
 */
...
async function scrapeTheDrum(city = 'Birmingham') {
  console.log('🥁 Scraping The Drum Birmingham...');
  ...
  try {
    ...
    await page.goto('https://www.the-drum.org/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Drum events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Drum', address: '144 Potters Lane, Birmingham B6 4UU', city: 'Birmingham' },
        latitude: 52.4954,
        longitude: -1.8896,
        city: 'Birmingham',
        category: 'Nightlife',

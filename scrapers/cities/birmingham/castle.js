/**
 * Castle & Falcon Birmingham Events Scraper
 * Live music venue in Balsall Heath
 * URL: https://www.castleandfalcon.com/
 */
...
async function scrapeCastleFalcon(city = 'Birmingham') {
  console.log('🏰 Scraping Castle & Falcon Birmingham...');
  ...
  try {
    ...
    await page.goto('https://www.castleandfalcon.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Castle & Falcon events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Castle & Falcon', address: '1018 Moseley Road, Birmingham B12 9BG', city: 'Birmingham' },
        latitude: 52.4581,
        longitude: -1.8788,
        city: 'Birmingham',
        category: 'Nightlife',
        source: 'Castle & Falcon'
      });
    }
    ...
    console.error('  ⚠️  Castle & Falcon error:', error.message);
    return [];
  }
}

module.exports = scrapeCastleFalcon;

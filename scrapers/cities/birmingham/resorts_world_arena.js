/**
 * Resorts World Arena Birmingham Events Scraper
...
async function scrapeResortsWorldArena(city = 'Birmingham') {
  console.log('🏟️ Scraping Resorts World Arena...');
  ...
  try {
    ...
    await page.goto('https://www.resortsworldarena.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Perimeter Rd, Birmingham B40 1NT',
          city: 'Birmingham'
        },
        latitude: 52.4535,
        longitude: -1.7405,
        city: 'Birmingham',
        category: 'Arts',
        source: 'Resorts World Arena'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Resorts World Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Resorts World Arena error:', error.message);
    return [];
  }
}

module.exports = scrapeResortsWorldArena;

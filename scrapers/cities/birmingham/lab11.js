/**
 * Lab11 Birmingham Events Scraper
 * URL: https://www.lab11.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLab11(city = 'Birmingham') {
  console.log('🔬 Scraping Lab11...');
  ...
  try {
    ...
    await page.goto('https://www.lab11.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Lab11',
          address: '11-13 Lower Trinity St, Birmingham B9 4AG',
          city: 'Birmingham'
        },
        latitude: 52.4765,
        longitude: -1.8880,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lab11 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lab11 error:', error.message);
    return [];
  }
}

module.exports = scrapeLab11;

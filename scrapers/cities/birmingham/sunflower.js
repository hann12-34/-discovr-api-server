/**
 * Sunflower Lounge Birmingham Events Scraper
 * Live music venue
 * URL: https://www.thesunflowerlounge.com/
 */
...
async function scrapeSunflower(city = 'Birmingham') {
  console.log('🌻 Scraping Sunflower Lounge Birmingham...');
  ...
  try {
    ...
    await page.goto('https://www.thesunflowerlounge.com/events/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Sunflower events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Sunflower Lounge', address: '76 Smallbrook Queensway, Birmingham B5 4EG', city: 'Birmingham' },
        latitude: 52.4765,
        longitude: -1.8992,
        city: 'Birmingham',
        category: 'Nightlife',
        source: 'Sunflower Lounge'
      });
    }
    ...
    console.error('  ⚠️  Sunflower error:', error.message);
    return [];
  }
}

module.exports = scrapeSunflower;

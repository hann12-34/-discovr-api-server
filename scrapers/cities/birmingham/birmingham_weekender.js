/**
 * Birmingham Weekender Events Scraper
 * URL: https://www.birminghamweekender.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBirminghamWeekender(city = 'Birmingham') {
  console.log('🎉 Scraping Birmingham Weekender...');
  ...
  try {
    ...
    await page.goto('https://www.birminghamweekender.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Birmingham',
        category: 'Festival',
        source: 'Birmingham Weekender'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Birmingham Weekender events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Birmingham Weekender error:', error.message);
    return [];
  }
}

module.exports = scrapeBirminghamWeekender;

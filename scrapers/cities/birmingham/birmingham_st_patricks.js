/**
 * Birmingham St Patrick's Festival Events Scraper
 * URL: https://www.stpatricksfestivalbirmingham.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStPatricksBirmingham(city = 'Birmingham') {
  ...
  try {
    ...
    await page.goto('https://www.stpatricksfestivalbirmingham.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} St Patrick\'s events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  St Patrick\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeStPatricksBirmingham;

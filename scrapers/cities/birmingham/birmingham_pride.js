/**
 * Birmingham Pride Events Scraper
 * URL: https://www.birminghampride.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBirminghamPride(city = 'Birmingham') {
  console.log('🏳️‍🌈 Scraping Birmingham Pride...');
  ...
  try {
    ...
    await page.goto('https://www.birminghampride.com', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Hurst Street',
          address: 'Hurst Street, Birmingham',
          city: 'Birmingham'
        },
        latitude: 52.4751,
        longitude: -1.8936,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Birmingham Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Birmingham Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeBirminghamPride;

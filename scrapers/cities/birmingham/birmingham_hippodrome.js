/**
 * Birmingham Hippodrome Events Scraper
...
async function scrapeBirminghamHippodrome(city = 'Birmingham') {
  console.log('🎭 Scraping Birmingham Hippodrome...');
  ...
  try {
    ...
    await page.goto('https://www.birminghamhippodrome.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: 'Thorp St, Birmingham B5 4TB',
          city: 'Birmingham'
        },
        latitude: 52.4775,
        longitude: -1.9015,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Birmingham Hippodrome events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Birmingham Hippodrome error:', error.message);
    return [];
  }
}

module.exports = scrapeBirminghamHippodrome;

/**
 * Night Owl Birmingham Events Scraper
 * Northern soul and live music venue
 * URL: https://www.nightowlbirmingham.co.uk/
 */
...
async function scrapeNightOwl(city = 'Birmingham') {
  console.log('🦉 Scraping Night Owl Birmingham...');
  ...
  try {
    ...
    await page.goto('https://www.nightowlbirmingham.co.uk/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Night Owl events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Night Owl', address: '17-18 Lower Trinity Street, Birmingham B9 4AG', city: 'Birmingham' },
        latitude: 52.4746,
        longitude: -1.8847,
        city: 'Birmingham',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Night Owl error:', error.message);
    return [];
  }
}

module.exports = scrapeNightOwl;

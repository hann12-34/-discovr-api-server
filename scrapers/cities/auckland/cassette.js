/**
 * Cassette Nine Auckland Events Scraper
 * URL: https://www.cassettenine.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCassette(city = 'Auckland') {
  console.log('🎭 Scraping Cassette Nine Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.cassettenine.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Cassette Nine',
          address: '9 Vulcan Ln, Auckland CBD 1010',
          city: 'Auckland'
        },
        latitude: -36.8485,
        longitude: 174.7633,

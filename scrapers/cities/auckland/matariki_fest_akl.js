/**
 * Matariki Festival Auckland Events Scraper
 * URL: https://www.aucklandnz.com/matariki
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMatarikiAKL(city = 'Auckland') {
  console.log('⭐ Scraping Matariki Festival...');
  ...
  try {
    ...
    await page.goto('https://www.aucklandnz.com/matariki', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Matariki Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Matariki error:', error.message);
    return [];
  }
}

module.exports = scrapeMatarikiAKL;

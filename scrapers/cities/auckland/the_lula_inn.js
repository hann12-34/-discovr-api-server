/**
 * The Lula Inn Auckland Events Scraper
 * URL: https://www.thelulainn.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLulaInn(city = 'Auckland') {
  console.log('🌴 Scraping The Lula Inn...');
  ...
  try {
    ...
    await page.goto('https://www.thelulainn.co.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Lula Inn',
          address: '149 Quay Street, Auckland',
          city: 'Auckland'
        },
        latitude: -36.8430,
        longitude: 174.7680,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lula Inn events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lula Inn error:', error.message);
    return [];
  }
}

module.exports = scrapeLulaInn;

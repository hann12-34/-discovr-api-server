/**
 * Hollywood Avondale Auckland Events Scraper
 * Live music and events venue
 * URL: https://www.hollywoodavondale.co.nz/
 */
...
async function scrapeHollywoodAvondale(city = 'Auckland') {
  console.log('🎸 Scraping Hollywood Avondale Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.hollywoodavondale.co.nz/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Hollywood Avondale events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Hollywood Avondale', address: '20 St Georges Road, Avondale, Auckland 1026', city: 'Auckland' },
        latitude: -36.8929,
        longitude: 174.7025,
        city: 'Auckland',
        category: 'Nightlife',
        source: 'Hollywood Avondale'
      });
    }
    ...
    console.error('  ⚠️  Hollywood Avondale error:', error.message);
    return [];
  }
}

module.exports = scrapeHollywoodAvondale;

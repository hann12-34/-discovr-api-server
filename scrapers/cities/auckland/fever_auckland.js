/**
 * Fever Nightclub Auckland Events Scraper
 * URL: https://www.fever.net.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFeverAuckland(city = 'Auckland') {
  console.log('🎉 Scraping Fever Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.fever.net.nz/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Fever Nightclub',
          address: 'Fort Street, Auckland CBD',
          city: 'Auckland'
        },
        latitude: -36.8485,
        longitude: 174.7633,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fever events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fever error:', error.message);
    return [];
  }
}

module.exports = scrapeFeverAuckland;

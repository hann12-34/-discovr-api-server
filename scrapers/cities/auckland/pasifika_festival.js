/**
 * Pasifika Festival Auckland Events Scraper
 * URL: https://www.aucklandnz.com/pasifika
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePasifika(city = 'Auckland') {
  console.log('🌺 Scraping Pasifika Festival...');
  ...
  try {
    ...
    await page.goto('https://www.aucklandnz.com/pasifika', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Pasifika Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Pasifika error:', error.message);
    return [];
  }
}

module.exports = scrapePasifika;

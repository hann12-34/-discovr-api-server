...
async function scrapeSparkArena(city = 'Auckland') {
  console.log('🏟️ Scraping Spark Arena Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.sparkarena.co.nz/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Live at Spark Arena Auckland`,
        date: isoDate,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Spark Arena events`);

/**
 * Kings Arms Auckland Events Scraper
 * URL: https://www.kingsarms.co.nz/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKingsArms(city = 'Auckland') {
  console.log('🎭 Scraping Kings Arms Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.kingsarms.co.nz/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Kings Arms',
          address: '59 France St, Newton, Auckland 1010',
          city: 'Auckland'
        },
        latitude: -36.8615,
        longitude: 174.7545,
...
module.exports = scrapeKingsArms;

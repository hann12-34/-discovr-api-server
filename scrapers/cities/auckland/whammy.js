/**
 * Whammy Bar Auckland Events Scraper
 * Indie music venue in Karangahape Road
 * URL: https://www.whammybar.co.nz/
 */
...
async function scrapeWhammyBar(city = 'Auckland') {
  console.log('🎸 Scraping Whammy Bar Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.whammybar.co.nz/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Whammy Bar events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Whammy Bar', address: '183 Karangahape Road, Auckland 1010', city: 'Auckland' },
        latitude: -36.8583,
        longitude: 174.7582,
        city: 'Auckland',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Whammy Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeWhammyBar;

...
async function scrapeGalatos(city = 'Auckland') {
  ...
  try {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Galatos events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Galatos', address: '17 Galatos Street, Auckland 1010', city: 'Auckland' },
        latitude: -36.8573,
        longitude: 174.7599,
        city: 'Auckland',
        category: 'Nightlife',

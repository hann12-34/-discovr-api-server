/**
 * Neck of the Woods Auckland Events Scraper
 * URL: https://www.neckofthewoods.co.nz/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNeck(city = 'Auckland') {
  console.log('🎭 Scraping Neck of the Woods Auckland...');
  ...
  try {
    ...
    await page.goto('https://www.neckofthewoods.co.nz/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '420 K Rd, Auckland 1010',
          city: 'Auckland'
        },
        latitude: -36.8578,
        longitude: 174.7536,

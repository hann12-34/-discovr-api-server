/**
 * Family Time Auckland Events Scraper
 * URL: https://www.familytime.co.nz
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFamilyTime(city = 'Auckland') {
  console.log('🎉 Scraping Family Time...');
  ...
  try {
    ...
    await page.goto('https://www.familytime.co.nz/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Family Time events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Family Time error:', error.message);
    return [];
  }
}

module.exports = scrapeFamilyTime;

/**
 * Wonder Ballroom Complete Portland Events Scraper
 * URL: https://www.wonderballroom.com/upcoming-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWonderAll(city = 'Portland') {
  console.log('✨ Scraping Wonder All...');
  ...
  try {
    ...
    await page.goto('https://www.wonderballroom.com/upcoming-events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wonder All events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wonder All error:', error.message);
    return [];
  }
}

module.exports = scrapeWonderAll;

/**
 * Veterans Memorial Coliseum Portland Events Scraper
 * URL: https://www.rosequarter.com/memorial-coliseum/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMemorialCol(city = 'Portland') {
  console.log('🏟️ Scraping Memorial Coliseum...');
  ...
  try {
    ...
    await page.goto('https://www.rosequarter.com/memorial-coliseum/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Memorial Coliseum'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Memorial Coliseum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Memorial Coliseum error:', error.message);
    return [];
  }
}

module.exports = scrapeMemorialCol;

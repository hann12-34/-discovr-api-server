/**
 * Lola's Room Portland Events Scraper
 * URL: https://www.crystalballroompdx.com/lolas-room/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLolaRoom(city = 'Portland') {
  console.log('🎵 Scraping Lola\'s Room...');
  ...
  try {
    ...
    await page.goto('https://www.crystalballroompdx.com/lolas-room/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lola's Room events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lola\'s Room error:', error.message);
    return [];
  }
}

module.exports = scrapeLolaRoom;

/**
 * Portland Mercury Events Scraper
...
async function scrapePortlandMercury(city = 'Portland') {
  console.log('📰 Scraping Portland Mercury...');
  ...
  try {
    ...
    await page.goto('https://www.portlandmercury.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Portland Mercury events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Portland Mercury error:', error.message);
    return [];
  }
}

module.exports = scrapePortlandMercury;

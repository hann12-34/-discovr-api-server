/**
 * Arlene Schnitzer Calendar Portland Events Scraper
 * URL: https://www.portland5.com/arlene-schnitzer-concert-hall/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSchnitzCal(city = 'Portland') {
  console.log('🎭 Scraping Schnitzer Cal...');
  ...
  try {
    ...
    await page.goto('https://www.portland5.com/arlene-schnitzer-concert-hall/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Schnitzer Cal'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Schnitzer Cal events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Schnitzer Cal error:', error.message);
    return [];
  }
}

module.exports = scrapeSchnitzCal;

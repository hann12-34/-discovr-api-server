/**
 * Kelly's Olympian Final Portland Events Scraper
 * URL: https://kellysolympian.com/calendar/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKellyFinal(city = 'Portland') {
  console.log('🍻 Scraping Kelly Final...');
  ...
  try {
    ...
    await page.goto('https://kellysolympian.com/calendar/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kelly Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kelly Final error:', error.message);
    return [];
  }
}

module.exports = scrapeKellyFinal;

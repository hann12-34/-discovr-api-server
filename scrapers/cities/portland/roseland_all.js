/**
 * Roseland Theater Complete Portland Events Scraper
 * URL: https://www.roselandpdx.com/upcoming-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRoselandAll(city = 'Portland') {
  console.log('🎭 Scraping Roseland All...');
  ...
  try {
    ...
    await page.goto('https://www.roselandpdx.com/upcoming-events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Roseland All events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Roseland All error:', error.message);
    return [];
  }
}

module.exports = scrapeRoselandAll;

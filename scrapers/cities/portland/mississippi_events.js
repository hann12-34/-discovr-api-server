/**
 * Mississippi Studios All Events Portland Scraper
...
async function scrapeMississippiEvents(city = 'Portland') {
  console.log('🎸 Scraping Mississippi Events...');
  ...
  try {
    ...
    await page.goto('https://www.mississippistudios.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Mississippi Events'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Mississippi Events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Mississippi Events error:', error.message);
    return [];
  }
}

module.exports = scrapeMississippiEvents;

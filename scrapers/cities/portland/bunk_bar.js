/**
 * Bunk Bar Portland Events Scraper
 * URL: https://www.bunkbar.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBunkBar(city = 'Portland') {
  console.log('🛏️ Scraping Bunk Bar...');
  ...
  try {
    ...
    await page.goto('https://www.bunkbar.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bunk Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bunk Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeBunkBar;

/**
 * Wonder Ballroom Final Portland Events Scraper
 * URL: https://wonderballroom.com/calendar/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWonderFinal(city = 'Portland') {
  console.log('✨ Scraping Wonder Final...');
  ...
  try {
    ...
    await page.goto('https://wonderballroom.com/calendar/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wonder Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wonder Final error:', error.message);
    return [];
  }
}

module.exports = scrapeWonderFinal;

/**
 * Mississippi Studios Portland Events Scraper
...
async function scrapeMississippiStudios(city = 'Portland') {
  console.log('🎸 Scraping Mississippi Studios...');
...
module.exports = scrapeMississippiStudios;

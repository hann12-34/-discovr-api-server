/**
 * Dante's Portland Events Scraper
 * URL: https://www.danteslive.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDantes(city = 'Portland') {
  console.log('🔥 Scraping Dante\'s...');
  ...
  try {
    ...
    await page.goto('https://www.danteslive.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Dante's events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dante\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeDantes;

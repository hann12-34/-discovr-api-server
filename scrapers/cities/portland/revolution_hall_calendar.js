/**
 * Revolution Hall Calendar Portland Events Scraper
 * URL: https://www.revolutionhall.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRevolutionCalendar(city = 'Portland') {
  console.log('🏛️ Scraping Revolution Calendar...');
  ...
  try {
    ...
    await page.goto('https://www.revolutionhall.com/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Revolution Calendar'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Revolution Calendar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Revolution Calendar error:', error.message);
    return [];
  }
}

module.exports = scrapeRevolutionCalendar;

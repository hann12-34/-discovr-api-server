/**
 * Moda Center Portland Events Scraper
...
async function scrapeModaCenter(city = 'Portland') {
  console.log('🏟️ Scraping Moda Center...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Moda Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Moda Center error:', error.message);
    return [];
  }
}

module.exports = scrapeModaCenter;

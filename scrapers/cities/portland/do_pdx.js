/**
 * Do PDX Events Scraper
 * URL: https://do503.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDoPDX(city = 'Portland') {
  console.log('🎉 Scraping Do PDX...');
  ...
  try {
    ...
    await page.goto('https://do503.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Do PDX events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Do PDX error:', error.message);
    return [];
  }
}

module.exports = scrapeDoPDX;

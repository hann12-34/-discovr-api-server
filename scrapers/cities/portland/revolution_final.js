...
async function scrapeRevolutionFinal(city = 'Portland') {
  console.log('🏛️ Scraping Revolution Final...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Revolution Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Revolution Final error:', error.message);
    return [];
  }
}

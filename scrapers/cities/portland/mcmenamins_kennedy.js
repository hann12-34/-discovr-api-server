/**
 * McMenamins Kennedy School Portland Events Scraper
 * URL: https://www.mcmenamins.com/kennedy-school/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKennedySchool(city = 'Portland') {
  console.log('🏫 Scraping Kennedy School...');
  ...
  try {
    ...
    await page.goto('https://www.mcmenamins.com/kennedy-school/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Kennedy School'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Kennedy School events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kennedy School error:', error.message);
    return [];
  }
}

module.exports = scrapeKennedySchool;

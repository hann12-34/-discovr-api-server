/**
 * Arlene Schnitzer Concert Hall Portland Events Scraper
 * URL: https://www.portland5.com/arlene-schnitzer-concert-hall/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSchnitzer(city = 'Portland') {
  console.log('🎭 Scraping Schnitzer Hall...');
  ...
  try {
    ...
    await page.goto('https://www.portland5.com/arlene-schnitzer-concert-hall/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Schnitzer Hall'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Schnitzer events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Schnitzer error:', error.message);
    return [];
  }
}

module.exports = scrapeSchnitzer;

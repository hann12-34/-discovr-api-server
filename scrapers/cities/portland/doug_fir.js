/**
 * Doug Fir Lounge Portland Events Scraper
 * URL: https://www.dougfirlounge.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDougFir(city = 'Portland') {
  console.log('🌲 Scraping Doug Fir Lounge...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Doug Fir Lounge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Doug Fir Lounge error:', error.message);
    return [];
  }
}

module.exports = scrapeDougFir;

/**
 * Wonder Ballroom All Events Portland Scraper
...
async function scrapeWonderEvents(city = 'Portland') {
  console.log('✨ Scraping Wonder Events...');
  ...
  try {
    ...
    await page.goto('https://www.wonderballroom.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wonder Events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wonder Events error:', error.message);
    return [];
  }
}

module.exports = scrapeWonderEvents;

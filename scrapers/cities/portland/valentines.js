/**
 * Valentine's Portland Events Scraper
 * URL: https://www.valentinespdx.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeValentines(city = 'Portland') {
  console.log('💕 Scraping Valentine\'s...');
  ...
  try {
    ...
    await page.goto('https://www.valentinespdx.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Valentine\'s',
          address: '232 SW Ankeny St, Portland, OR 97204',
          city: 'Portland'
        },
        latitude: 45.5226,
        longitude: -122.6737,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Valentine's events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Valentine\'s error:', error.message);
    return [];
  }
}

module.exports = scrapeValentines;

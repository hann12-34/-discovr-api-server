/**
 * Turn! Turn! Turn! Portland Events Scraper
 * URL: https://www.turnturnturn.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTurnTurnTurn(city = 'Portland') {
  console.log('🔄 Scraping Turn! Turn! Turn!...');
  ...
  try {
    ...
    await page.goto('https://www.turnturnturn.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Turn! Turn! Turn! events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Turn! Turn! Turn! error:', error.message);
    return [];
  }
}

module.exports = scrapeTurnTurnTurn;

/**
 * Keller Auditorium Calendar Portland Events Scraper
 * URL: https://www.portland5.com/keller-auditorium/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKellerCal(city = 'Portland') {
  console.log('🎭 Scraping Keller Cal...');
  ...
  try {
    ...
    await page.goto('https://www.portland5.com/keller-auditorium/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Keller Cal events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Keller Cal error:', error.message);
    return [];
  }
}

module.exports = scrapeKellerCal;

/**
 * 45 East Portland Events Scraper
 * Popular nightclub in Portland
 * URL: https://45east.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrape45EastPortland(city = 'Portland') {
  console.log('🎵 Scraping 45 East Portland...');
  ...
  try {
    ...
    await page.goto('https://45east.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: '45 East',
          address: '45 SE 3rd Ave, Portland, OR 97214',
          city: 'Portland'
        },
        city: 'Portland',
        category: 'Nightlife',
        source: '45 East Portland'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} 45 East events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ 45 East error: ${error.message}`);
    return [];
  }
}

module.exports = scrape45EastPortland;

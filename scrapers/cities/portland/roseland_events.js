/**
 * Roseland Theater All Events Portland Scraper
...
async function scrapeRoselandEvents(city = 'Portland') {
  console.log('🎭 Scraping Roseland Events...');
  ...
  try {
    ...
    await page.goto('https://www.roselandpdx.com/events', {
    ...
    console.error('  ⚠️  Roseland Events error:', error.message);
    return [];
  }
}

module.exports = scrapeRoselandEvents;

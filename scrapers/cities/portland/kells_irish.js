/**
 * Kells Irish Pub Portland Events Scraper
 * URL: https://www.kellsirish.com/portland/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKellsIrish(city = 'Portland') {
  console.log('🍀 Scraping Kells Irish...');
  ...
  try {
    ...
    await page.goto('https://www.kellsirish.com/portland/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kells Irish events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kells Irish error:', error.message);
    return [];
  }
}

module.exports = scrapeKellsIrish;

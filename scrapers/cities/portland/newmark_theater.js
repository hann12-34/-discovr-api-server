/**
 * Newmark Theatre Portland Events Scraper
 * URL: https://www.portland5.com/newmark-theatre/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNewmark(city = 'Portland') {
  console.log('🎭 Scraping Newmark Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.portland5.com/newmark-theatre/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Newmark Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Newmark events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Newmark error:', error.message);
    return [];
  }
}

module.exports = scrapeNewmark;

/**
 * Revolution Hall All Events Portland Scraper
...
async function scrapeRevolutionEvents(city = 'Portland') {
  console.log('🏛️ Scraping Revolution Events...');
  ...
  try {
    ...
    console.error('  ⚠️  Revolution Events error:', error.message);
    return [];
  }
}

module.exports = scrapeRevolutionEvents;

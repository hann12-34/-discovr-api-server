...
async function scrapeRoselandTheater(city = 'Portland') {
  console.log('🎭 Scraping Roseland Theater...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Roseland Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Roseland Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeRoselandTheater;

/**
 * Moda Center Calendar Portland Events Scraper
...
async function scrapeModaCalendar(city = 'Portland') {
  console.log('🏟️ Scraping Moda Calendar...');
  ...
  try {
    ...
    await page.goto('https://www.rosequarter.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Moda Calendar'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Moda Calendar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Moda Calendar error:', error.message);
    return [];
  }
}

module.exports = scrapeModaCalendar;

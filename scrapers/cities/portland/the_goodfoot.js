/**
 * The Goodfoot Portland Events Scraper
 * URL: https://www.goodfootpub.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGoodfoot(city = 'Portland') {
  console.log('👣 Scraping The Goodfoot...');
  ...
  try {
    ...
    await page.goto('https://www.goodfootpub.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Goodfoot events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Goodfoot error:', error.message);
    return [];
  }
}

module.exports = scrapeGoodfoot;

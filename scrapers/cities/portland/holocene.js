...
async function scrapeHolocene(city = 'Portland') {
  console.log('🎵 Scraping Holocene...');
  ...
  try {
    ...
    await page.goto('https://www.holocene.org/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Holocene events`);

/**
 * Cruzroom Portland Events Scraper
 * URL: https://www.cruzroom.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCruzroom(city = 'Portland') {
  console.log('🎵 Scraping Cruzroom...');
  ...
  try {
    ...
    await page.goto('https://www.cruzroom.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Cruzroom',
          address: '102 W Burnside St, Portland, OR 97209',
          city: 'Portland'
        },
        latitude: 45.5230,
        longitude: -122.6733,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cruzroom events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cruzroom error:', error.message);
    return [];
  }
}

module.exports = scrapeCruzroom;

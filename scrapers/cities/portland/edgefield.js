/**
 * McMenamins Edgefield Portland Events Scraper
 * URL: https://www.mcmenamins.com/edgefield/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEdgefield(city = 'Portland') {
  console.log('🎵 Scraping Edgefield...');
  ...
  try {
    ...
    await page.goto('https://www.mcmenamins.com/edgefield/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Edgefield events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Edgefield error:', error.message);
    return [];
  }
}

module.exports = scrapeEdgefield;

/**
 * Revolution Hall Complete Portland Events Scraper
 * URL: https://www.revolutionhall.com/upcoming-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRevolutionAll(city = 'Portland') {
  console.log('🏛️ Scraping Revolution All...');
  ...
  try {
    ...
    await page.goto('https://www.revolutionhall.com/upcoming-events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Revolution All'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Revolution All events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Revolution All error:', error.message);
    return [];
  }
}

module.exports = scrapeRevolutionAll;

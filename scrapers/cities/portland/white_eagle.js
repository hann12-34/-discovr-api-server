/**
 * White Eagle Saloon Portland Events Scraper
 * URL: https://www.whiteeaglesaloon.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWhiteEagle(city = 'Portland') {
  console.log('🦅 Scraping White Eagle...');
  ...
  try {
    ...
    await page.goto('https://www.whiteeaglesaloon.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} White Eagle events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  White Eagle error:', error.message);
    return [];
  }
}

module.exports = scrapeWhiteEagle;

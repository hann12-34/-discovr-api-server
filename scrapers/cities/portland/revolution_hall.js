/**
 * Revolution Hall Portland Events Scraper
...
async function scrapeRevolutionHall(city = 'Portland') {
  console.log('🏛️ Scraping Revolution Hall...');
  ...
  try {
    ...
    await page.goto('https://www.revolutionhall.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Revolution Hall'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Revolution Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Revolution Hall error:', error.message);
    return [];
  }
}

module.exports = scrapeRevolutionHall;

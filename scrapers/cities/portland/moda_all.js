/**
 * Moda Center Complete Portland Events Scraper
 * URL: https://www.rosequarter.com/moda-center/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeModaAll(city = 'Portland') {
  console.log('🏟️ Scraping Moda All...');
  ...
  try {
    ...
    await page.goto('https://www.rosequarter.com/moda-center/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Moda All events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Moda All error:', error.message);
    return [];
  }
}

module.exports = scrapeModaAll;

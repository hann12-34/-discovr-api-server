/**
 * Aladdin Theater Calendar Portland Events Scraper
 * URL: https://aladdin-theater.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAladdinCalendar(city = 'Portland') {
  console.log('🎭 Scraping Aladdin Calendar...');
  ...
  try {
    ...
    await page.goto('https://aladdin-theater.com/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Portland',
        category: 'Nightlife',
        source: 'Aladdin Calendar'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Aladdin Calendar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Aladdin Calendar error:', error.message);
    return [];
  }
}

module.exports = scrapeAladdinCalendar;

/**
 * Star Theater Portland Events Scraper
 * URL: https://startheaterpdx.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStarTheater(city = 'Portland') {
  console.log('⭐ Scraping Star Theater...');
  ...
  try {
    ...
    await page.goto('https://startheaterpdx.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Star Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Star Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeStarTheater;

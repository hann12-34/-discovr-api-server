/**
 * Kelly's Olympian Complete Portland Events Scraper
 * URL: https://www.kellysolympian.com/upcoming-events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeKellyAll(city = 'Portland') {
  console.log('🍻 Scraping Kelly All...');
  ...
  try {
    ...
    await page.goto('https://www.kellysolympian.com/upcoming-events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Kelly All events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Kelly All error:', error.message);
    return [];
  }
}

module.exports = scrapeKellyAll;

/**
 * O2 Academy Oxford Events Scraper
 * Major live music venue - Academy Music Group site
 * URL: https://www.academymusicgroup.com/o2academyoxford/events
 */
...
async function scrapeO2AcademyOxford(city = 'Oxford') {
  console.log('🎸 Scraping O2 Academy Oxford...');
  ...
  try {
    ...
    await page.goto('https://www.academymusicgroup.com/o2academyoxford/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'O2 Academy Oxford', address: '190 Cowley Road, Oxford OX4 1UE', city: 'Oxford' },
        latitude: 51.7465,
        longitude: -1.2331,
        city: 'Oxford',
        category: 'Nightlife',
        source: 'O2 Academy Oxford'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} O2 Academy Oxford events`);
    return filterEvents(formattedEvents);

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  O2 Academy Oxford error:', error.message);
    return [];
  }
}

module.exports = scrapeO2AcademyOxford;

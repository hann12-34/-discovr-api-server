/**
 * The Cellar Oxford Events Scraper
 * URL: https://www.cellaroxford.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCellar(city = 'Oxford') {
  console.log('🍷 Scraping The Cellar...');
  ...
  try {
    ...
    await page.goto('https://www.cellaroxford.co.uk/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Cellar',
          address: 'Frewin Ct, Oxford OX1 3HZ',
          city: 'Oxford'
        },
        latitude: 51.7525,
        longitude: -1.2575,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cellar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Cellar error:', error.message);
    return [];
  }
}

module.exports = scrapeCellar;

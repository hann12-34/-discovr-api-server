/**
 * Oxford Pride Festival Events Scraper
 * URL: https://www.oxford-pride.org.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOxfordPride(city = 'Oxford') {
  console.log('🏳️‍🌈 Scraping Oxford Pride...');
  ...
  try {
    ...
    await page.goto('https://www.oxford-pride.org.uk', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Oxford Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Oxford Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeOxfordPride;

/**
 * Plush Lounge Oxford Events Scraper
 * URL: https://www.plushlounge.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePlush(city = 'Oxford') {
  console.log('💜 Scraping Plush Oxford...');
  ...
  try {
    ...
    await page.goto('https://www.plushlounge.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Plush events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Plush error:', error.message);
    return [];
  }
}

module.exports = scrapePlush;

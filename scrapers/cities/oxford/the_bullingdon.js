 ...
 * URL: https://www.thebullingdon.co.uk/whats-on
 */
...
async function scrapeBullingdon(city = 'Oxford') {
  ...
  try {
    ...
    await page.goto('https://www.thebullingdon.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bullingdon events`);

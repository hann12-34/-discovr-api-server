/**
 * Emporium Nightclub Oxford Events Scraper
 * URL: https://www.emporiumoxford.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEmporium(city = 'Oxford') {
  console.log('🎉 Scraping Emporium Oxford...');
  ...
  try {
    ...
    await page.goto('https://www.emporiumoxford.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Emporium events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Emporium error:', error.message);
    return [];
  }
}

module.exports = scrapeEmporium;

/**
 * Oxford May Morning Celebration Events Scraper
 * URL: https://www.visitoxfordandoxfordshire.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMayMorning(city = 'Oxford') {
  console.log('🌅 Scraping May Morning...');
  ...
  try {
    ...
    await page.goto('https://www.visitoxfordandoxfordshire.com/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} May Morning events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  May Morning error:', error.message);
    return [];
  }
}

module.exports = scrapeMayMorning;

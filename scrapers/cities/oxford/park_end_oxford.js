/**
 * Park End Club Oxford Events Scraper
 * URL: https://www.parkend.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeParkEnd(city = 'Oxford') {
  console.log('🎉 Scraping Park End...');
  ...
  try {
    ...
    await page.goto('https://www.parkend.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Park End events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Park End error:', error.message);
    return [];
  }
}

module.exports = scrapeParkEnd;

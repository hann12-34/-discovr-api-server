/**
 * Fever & Boutique Oxford Events Scraper
 * URL: https://www.fever-boutique.co.uk
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFeverOxford(city = 'Oxford') {
  console.log('🔥 Scraping Fever Oxford...');
  ...
  try {
    ...
    await page.goto('https://www.fever-boutique.co.uk/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fever Oxford events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fever Oxford error:', error.message);
    return [];
  }
}

module.exports = scrapeFeverOxford;

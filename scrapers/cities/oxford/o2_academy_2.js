/**
 * O2 Academy 2 Oxford Events Scraper
 * URL: https://www.o2academyoxford.co.uk/oxford2/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeO2Academy2(city = 'Oxford') {
  console.log('🎵 Scraping O2 Academy 2...');
  ...
  try {
    ...
    await page.goto('https://www.o2academyoxford.co.uk/oxford2/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} O2 Academy 2 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  O2 Academy 2 error:', error.message);
    return [];
  }
}

module.exports = scrapeO2Academy2;

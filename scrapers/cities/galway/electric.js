/**
 * Electric Galway Events Scraper
 * URL: https://www.electricgalway.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeElectric(city = 'Galway') {
  console.log('⚡ Scraping Electric...');
  ...
  try {
    ...
    await page.goto('https://www.electricgalway.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Electric',
          address: 'Abbeygate St Upper, Galway',
          city: 'Galway'
        },
        latitude: 53.2735,
        longitude: -9.0545,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Electric events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Electric error:', error.message);
    return [];
  }
}

module.exports = scrapeElectric;

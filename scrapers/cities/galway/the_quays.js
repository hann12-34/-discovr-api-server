/**
 * The Quays Galway Events Scraper
 * URL: https://www.thequaysgalway.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheQuays(city = 'Galway') {
  console.log('🚢 Scraping The Quays...');
  ...
  try {
    ...
    await page.goto('https://www.thequaysgalway.com/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Quays events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Quays error:', error.message);
    return [];
  }
}

module.exports = scrapeTheQuays;

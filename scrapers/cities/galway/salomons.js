/**
 * Salomons Galway Events Scraper
 * URL: https://www.salomonsgalway.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSalomons(city = 'Galway') {
  console.log('🎵 Scraping Salomons...');
  ...
  try {
    ...
    await page.goto('https://www.salomonsgalway.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Salomons events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Salomons error:', error.message);
    return [];
  }
}

module.exports = scrapeSalomons;

/**
 * Taaffes Galway Events Scraper
 * URL: https://www.taaffes.ie/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTaaffes(city = 'Galway') {
  console.log('🎵 Scraping Taaffes...');
  ...
  try {
    ...
    await page.goto('https://www.taaffes.ie/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Taaffes events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Taaffes error:', error.message);
    return [];
  }
}

module.exports = scrapeTaaffes;

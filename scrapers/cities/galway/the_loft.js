/**
 * The Loft Galway Events Scraper
 * URL: https://www.theloftgalway.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheLoft(city = 'Galway') {
  ...
  try {
    ...
    await page.goto('https://www.theloftgalway.com/events', {

/**
 * Carbon Galway Events Scraper
 * URL: https://www.carbongalway.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCarbon(city = 'Galway') {
  console.log('💎 Scraping Carbon...');
  ...
  try {
    ...
    await page.goto('https://www.carbongalway.com/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Carbon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Carbon error:', error.message);
    return [];
  }
}

module.exports = scrapeCarbon;

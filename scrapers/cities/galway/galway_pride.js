/**
 * Galway Pride Events Scraper
 * URL: https://www.galwaypride.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGalwayPride(city = 'Galway') {
  console.log('🏳️‍🌈 Scraping Galway Pride...');
  ...
  try {
    ...
    await page.goto('https://www.galwaypride.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Galway Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Galway Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeGalwayPride;

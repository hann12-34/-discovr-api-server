/**
 * Roisin Dubh Galway Events Scraper
 * Live music venue
 * URL: https://www.roisindubh.net/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRoisinDubh(city = 'Galway') {
  console.log('🎸 Scraping Roisin Dubh Galway...');
  ...
  try {
    ...
    await page.goto('https://www.roisindubh.net/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Roisin Dubh',
          address: '9 Dominick Street Upper, Galway H91 WD2H',
          city: 'Galway'
        },
        latitude: 53.2719,
        longitude: -9.0568,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Roisin Dubh events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Roisin Dubh error:', error.message);
    return [];
  }
}

module.exports = scrapeRoisinDubh;

/**
 * Edmonton Jazz Festival Edmonton Events Scraper
...
async function scrapeEdmontonjazz(city = 'Edmonton') {
  console.log('🎵 Scraping Edmonton Jazz Festival Edmonton...');
  ...
  try {
    ...
    await page.goto('https://edmontonjazz.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Festivals',
        source: 'Edmonton Jazz Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Edmonton Jazz Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Edmonton Jazz Festival error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeEdmontonjazz;

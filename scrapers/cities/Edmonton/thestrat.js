/**
 * The Strat Edmonton Events Scraper
...
async function scrapeThestrat(city = 'Edmonton') {
  console.log('🎵 Scraping The Strat Edmonton...');
  ...
  try {
    ...
    await page.goto('https://thestrat.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Strat events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  The Strat error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeThestrat;

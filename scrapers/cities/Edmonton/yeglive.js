/**
 * YEG Live Music Venue Edmonton Events Scraper
...
async function scrapeYeglive(city = 'Edmonton') {
  console.log('🎵 Scraping YEG Live Music Venue Edmonton...');
  ...
  try {
    ...
    await page.goto('https://yeglive.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Nightlife',
        source: 'YEG Live Music Venue'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} YEG Live Music Venue events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  YEG Live Music Venue error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeYeglive;

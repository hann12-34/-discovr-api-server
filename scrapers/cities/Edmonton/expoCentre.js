/**
 * Edmonton Expo Centre Events Scraper
 * URL: https://edmontonexpocentre.com/events/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeExpoCentre(city = 'Edmonton') {
  console.log('🎪 Scraping Edmonton Expo Centre...');
  ...
  try {
    ...
    await page.goto('https://edmontonexpocentre.com/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Expo Centre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Expo Centre error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeExpoCentre;

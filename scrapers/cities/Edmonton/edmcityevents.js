/**
 * City of Edmonton Events Scraper
 * URL: https://www.edmonton.ca/attractions_events/festivals_events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEdmCityEvents(city = 'Edmonton') {
  console.log('🏙️ Scraping City of Edmonton Events...');
  ...
  try {
    ...
    await page.goto('https://www.edmonton.ca/attractions_events/festivals_events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'City of Edmonton', address: 'Edmonton, AB', city: 'Edmonton' },
        city: 'Edmonton',
        category: 'Variety',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} City events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ City events error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeEdmCityEvents;

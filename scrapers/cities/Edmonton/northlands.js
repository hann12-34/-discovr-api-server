/**
 * Northlands Coliseum Edmonton Events Scraper
...
async function scrapeNorthlands(city = 'Edmonton') {
  console.log('🎵 Scraping Northlands Coliseum Edmonton...');
  ...
  try {
    ...
    await page.goto('https://northlands.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Nightlife',
        source: 'Northlands Coliseum'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Northlands Coliseum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Northlands Coliseum error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeNorthlands;

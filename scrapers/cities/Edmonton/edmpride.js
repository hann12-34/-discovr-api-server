/**
 * Edmonton Pride Festival Events Scraper
 * URL: https://www.edmontonpride.ca/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEdmPride(city = 'Edmonton') {
  console.log('🏳️‍🌈 Scraping Edmonton Pride...');
  ...
  try {
    ...
    await page.goto('https://www.edmontonpride.ca/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Edmonton Pride', address: 'Edmonton, AB', city: 'Edmonton' },
        city: 'Edmonton',
        category: 'Variety',
        source: 'Edmonton Pride'
      });
    }
    ...
    console.error(`  ⚠️ Pride error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeEdmPride;

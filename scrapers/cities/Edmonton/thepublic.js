/**
 * The Public House Edmonton Events Scraper
 * URL: https://publichouseedmonton.com/events/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThePublic(city = 'Edmonton') {
  console.log('🍺 Scraping The Public House Edmonton...');
  ...
  try {
    ...
    await page.goto('https://publichouseedmonton.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Public House', address: '10062 104 St NW, Edmonton, AB T5J 0Z9', city: 'Edmonton' },
        city: 'Edmonton',
        category: 'Nightlife',
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Public House events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Public House error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeThePublic;

/**
 * K-Days Festival Edmonton Events Scraper
...
async function scrapeKdays(city = 'Edmonton') {
  console.log('🎵 Scraping K-Days Festival Edmonton...');
  ...
  try {
    ...
    await page.goto('https://k-days.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Festivals',
        source: 'K-Days Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} K-Days Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  K-Days Festival error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeKdays;

/**
 * Edmonton Fringe Festival Edmonton Events Scraper
...
async function scrapeFringe(city = 'Edmonton') {
  console.log('🎵 Scraping Edmonton Fringe Festival Edmonton...');
  ...
  try {
    ...
    await page.goto('https://fringetheatre.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Festivals',
        source: 'Edmonton Fringe Festival'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Edmonton Fringe Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Edmonton Fringe Festival error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeFringe;

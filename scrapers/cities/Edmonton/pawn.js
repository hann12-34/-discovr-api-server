/**
 * The Pawn Shop Edmonton Events Scraper
...
async function scrapePawn(city = 'Edmonton') {
  console.log('🎵 Scraping The Pawn Shop Edmonton...');
  ...
  try {
    ...
    await page.goto('https://pawnshop.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Nightlife',
        source: 'The Pawn Shop'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} The Pawn Shop events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  The Pawn Shop error: ${error.message}`);
    return [];
  }
}

module.exports = scrapePawn;

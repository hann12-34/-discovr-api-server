/**
 * New City Likwid Lounge Edmonton Events Scraper
...
async function scrapeNewcity(city = 'Edmonton') {
  console.log('🎵 Scraping New City Likwid Lounge Edmonton...');
  ...
  try {
    ...
    await page.goto('https://newcity.ca/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Edmonton',
        category: 'Nightlife',
        source: 'New City Likwid Lounge'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} New City Likwid Lounge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  New City Likwid Lounge error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeNewcity;

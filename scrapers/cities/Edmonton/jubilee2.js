 ...
 * URL: https://jubileeauditorium.com/northern-alberta-jubilee-auditorium/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeJubilee2(city = 'Edmonton') {
  console.log('🎭 Scraping Northern Jubilee Auditorium...');
  ...
  try {
    ...
    await page.goto('https://jubileeauditorium.com/northern-alberta-jubilee-auditorium/', {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('a[href*="event"], .event-item, .show-card, article, [class*="event"]').forEach(el => {
        try {

 ...
 * URL: https://www.thecommonedmonton.com/events
 */
...
async function scrapeTheCommon(city = 'Edmonton') {
  ...
  try {
    ...
    await page.goto('https://www.thecommonedmonton.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Common', address: '9910 109 St NW, Edmonton, AB T5K 1H5', city: 'Edmonton' },
        city: 'Edmonton',
        category: 'Nightlife',
        source: 'The Common'
      });
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Common events`);

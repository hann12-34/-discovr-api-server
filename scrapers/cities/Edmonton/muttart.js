/**
 * Muttart Hall Edmonton Events Scraper
...
async function scrapeMuttart(city = 'Edmonton') {
  console.log('🎵 Scraping Muttart Hall Edmonton...');
  ...
  try {
    ...
    await page.goto('https://yegtickets.ca/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Muttart Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Muttart Hall error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeMuttart;

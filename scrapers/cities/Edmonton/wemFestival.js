 ...
 * URL: https://www.wem.ca/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWemFestival(city = 'Edmonton') {
  console.log('🛍️ Scraping West Edmonton Mall Events...');
  ...
  try {
    ...
    await page.goto('https://www.wem.ca/events', {
...
module.exports = scrapeWemFestival;

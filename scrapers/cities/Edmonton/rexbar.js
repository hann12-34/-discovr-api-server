...
async function scrapeRexbar(city = 'Edmonton') {
  console.log('🎵 Scraping The Rec Room Edmonton...');
  ...
  try {
    ...
    await page.goto('https://therecroom.com/edmonton/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Rec Room events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  The Rec Room error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeRexbar;

/**
 * OMNIA Las Vegas Events Scraper
 * Mega nightclub at Caesars Palace
 * URL: https://omnianightclub.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOmnia(city = 'Las Vegas') {
  console.log('🎧 Scraping OMNIA Las Vegas...');
  ...
  try {
    ...
    await page.goto('https://omnianightclub.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Club night at OMNIA`,
        date: isoDate,

...
async function scrapeAllegiantStadium(city = 'Las Vegas') {
  console.log('🎭 Scraping Allegiant Stadium...');
  try {
    const resp = await axios.get('https://www.allegiantstadium.com/events', {
      ...
      try {
        ...
        for (const item of items) {
          ...
          events.push({
            ...
            imageUrl: img,
            venue: { name: 'Allegiant Stadium', address: addr || '3333 Al Davis Way, Las Vegas, NV 89118', city: 'Las Vegas' },
            latitude: 36.0908,
            longitude: -115.1833,
            city: 'Las Vegas',
            category: 'Events',
      ...
      $events.each((_, el) => {
        try {
          ...
          if (eventUrl && !eventUrl.startsWith('http')) {
            const base = new URL('https://www.allegiantstadium.com/events');
          ...
          if (img && !img.startsWith('http')) {
            try { img = new URL(img, 'https://www.allegiantstadium.com/events').href; } catch(e) { img = null; }
          }
          ...
          events.push({
            ...
            url: eventUrl,
            imageUrl: img,
            venue: { name: 'Allegiant Stadium', address: '3333 Al Davis Way, Las Vegas, NV 89118', city: 'Las Vegas' },
            latitude: 36.0908,
            longitude: -115.1833,
            city: 'Las Vegas',
            category: 'Events',
    ...
    console.log('  ✅ Allegiant Stadium:', futureEvents.length, 'events');

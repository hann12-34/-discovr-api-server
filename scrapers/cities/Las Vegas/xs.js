/**
 * XS Nightclub Las Vegas Events Scraper
 * Premier nightclub at Encore
 * URL: https://xslasvegas.com/
 */
...
async function scrapeXS(city = 'Las Vegas') {
  console.log('🎧 Scraping XS Nightclub Las Vegas...');
  ...
  try {
    ...
    await page.goto('https://xslasvegas.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} XS events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'XS Nightclub', address: '3131 S Las Vegas Blvd, Las Vegas NV 89109', city: 'Las Vegas' },
        latitude: 36.1284,
        longitude: -115.1656,
        city: 'Las Vegas',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  XS error:', error.message);
    return [];
  }
}

module.exports = scrapeXS;

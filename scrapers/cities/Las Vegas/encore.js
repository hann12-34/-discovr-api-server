/**
 * Encore Beach Club Las Vegas Events Scraper
 * Premier dayclub at Encore
 * URL: https://encorebeachclub.com/
 */
...
async function scrapeEncoreBeach(city = 'Las Vegas') {
  console.log('🏖️ Scraping Encore Beach Club Las Vegas...');
  ...
  try {
    ...
    await page.goto('https://encorebeachclub.com/', {
    ...
    const events = await page.evaluate(() => {
      ...
      const selectors = ['.event', '.event-card', 'article', '[class*="event"]', '.show', '.artist'];
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Encore Beach events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Encore Beach Club', address: '3131 S Las Vegas Blvd, Las Vegas NV 89109', city: 'Las Vegas' },
        latitude: 36.1284,
        longitude: -115.1656,
        city: 'Las Vegas',
        category: 'Nightlife',
        source: 'Encore Beach Club'
      });
    }
    ...
    console.error('  ⚠️  Encore Beach error:', error.message);
    return [];
  }
}

module.exports = scrapeEncoreBeach;

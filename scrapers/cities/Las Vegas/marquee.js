/**
 * Marquee Las Vegas Events Scraper
 * Premier nightclub at The Cosmopolitan
 * URL: https://marqueelasvegas.com/
 */
...
async function scrapeMarquee(city = 'Las Vegas') {
  console.log('🎧 Scraping Marquee Las Vegas...');
  ...
  try {
    ...
    await page.goto('https://marqueelasvegas.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Marquee events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Marquee', address: '3708 Las Vegas Blvd S, Las Vegas NV 89109', city: 'Las Vegas' },
        latitude: 36.1098,
        longitude: -115.1728,
        city: 'Las Vegas',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Marquee error:', error.message);
    return [];
  }
}

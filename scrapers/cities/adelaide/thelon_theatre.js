/**
 * Thebarton Theatre Adelaide Events Scraper
 * URL: https://www.thebartontheatre.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeThebartonTheatre(city = 'Adelaide') {
  console.log('🎭 Scraping Thebarton Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.thebartontheatre.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Adelaide',
        category: 'Arts',
        source: 'Thebarton Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Thebarton Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Thebarton Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeThebartonTheatre;

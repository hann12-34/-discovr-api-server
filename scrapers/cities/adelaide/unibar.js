/**
 * UniBar Adelaide Events Scraper
 * URL: https://www.unibar.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeUniBar(city = 'Adelaide') {
  console.log('🎓 Scraping UniBar...');
  ...
  try {
    ...
    await page.goto('https://www.unibar.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'UniBar',
          address: 'Adelaide University, Adelaide SA 5005',
          city: 'Adelaide'
        },
        latitude: -34.9210,
        longitude: 138.6060,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} UniBar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  UniBar error:', error.message);
    return [];
  }
}

module.exports = scrapeUniBar;

/**
 * Feast Festival Adelaide Events Scraper
 * URL: https://feastfestival.com.au
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFeastFestival(city = 'Adelaide') {
  console.log('🏳️‍🌈 Scraping Feast Festival...');
  ...
  try {
    ...
    await page.goto('https://feastfestival.com.au/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Feast Festival events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Feast Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeFeastFestival;

/**
 * Rocket Bar Adelaide Events Scraper
 * URL: https://www.rocketbar.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRocketBar(city = 'Adelaide') {
  console.log('🚀 Scraping Rocket Bar...');
  ...
  try {
    ...
    await page.goto('https://www.rocketbar.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Rocket Bar',
          address: '117 Hindley St, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9260,
        longitude: 138.5950,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rocket Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rocket Bar error:', error.message);
    return [];
  }
}

module.exports = scrapeRocketBar;

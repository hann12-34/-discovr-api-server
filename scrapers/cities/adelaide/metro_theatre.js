/**
 * Metro Theatre Adelaide Events Scraper
 * URL: https://www.metrotheatre.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMetroTheatre(city = 'Adelaide') {
  console.log('🎭 Scraping Metro Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.metrotheatre.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Metro Theatre',
          address: '104 Grote St, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9280,
        longitude: 138.5980,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Metro Theatre events`);

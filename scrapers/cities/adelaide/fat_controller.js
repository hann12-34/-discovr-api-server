/**
 * Fat Controller Adelaide Events Scraper
 * URL: https://www.fatcontroller.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFatController(city = 'Adelaide') {
  console.log('🎸 Scraping Fat Controller...');
  ...
  try {
    ...
    await page.goto('https://www.fatcontroller.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Fat Controller',
          address: '10 Synagogue Pl, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9250,
        longitude: 138.6000,
        city: 'Adelaide',
        category: 'Nightlife',
        source: 'Fat Controller'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Fat Controller events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fat Controller error:', error.message);
    return [];
  }
}

module.exports = scrapeFatController;

/**
 * Dunstan Playhouse Adelaide Events Scraper
 * URL: https://www.adelaidefestivalcentre.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeDunstanPlayhouse(city = 'Adelaide') {
  console.log('🎭 Scraping Dunstan Playhouse...');
  ...
  try {
    ...
    await page.goto('https://www.adelaidefestivalcentre.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Adelaide',
        category: 'Arts',
        source: 'Dunstan Playhouse'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Dunstan Playhouse events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dunstan Playhouse error:', error.message);
    return [];
  }
}

module.exports = scrapeDunstanPlayhouse;

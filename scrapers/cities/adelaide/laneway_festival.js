/**
 * Laneway Festival Adelaide Events Scraper
...
async function scrapeLanewayFestival(city = 'Adelaide') {
  console.log('🎸 Scraping Laneway Festival...');
  ...
  try {
    ...
    await page.goto('https://lanewayfestival.com', {
    ...
    const events = await page.evaluate(() => {
      ...
      document.querySelectorAll('.event-card, article, .event-item, .show, a[href*="event"]').forEach(el => {
        ...
        const href = linkEl?.href || 'https://lanewayfestival.com';
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Laneway Festival Adelaide',
          address: 'Hart\'s Mill, Port Adelaide SA 5015',
          city: 'Adelaide'
        },
        latitude: -34.8400,
        longitude: 138.5040,
    ...
    console.error('  ⚠️  Laneway Festival error:', error.message);
    return [];
  }
}

module.exports = scrapeLanewayFestival;

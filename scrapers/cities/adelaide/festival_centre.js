/**
 * Adelaide Festival Centre Events Scraper
...
async function scrapeFestivalCentre(city = 'Adelaide') {
  console.log('🎭 Scraping Adelaide Festival Centre...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Festival Centre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Festival Centre error:', error.message);
    return [];
  }
}

module.exports = scrapeFestivalCentre;

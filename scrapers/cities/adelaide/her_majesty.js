/**
 * Her Majesty's Theatre Adelaide Events Scraper
 * URL: https://www.hermajestystheatre.com.au/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHerMajesty(city = 'Adelaide') {
  console.log('👑 Scraping Her Majestys Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.hermajestystheatre.com.au/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '58 Grote St, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9270,
        longitude: 138.5990,
        city: 'Adelaide',
        category: 'Arts',
        source: 'Her Majestys Theatre'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Her Majestys events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Her Majestys error:', error.message);
    return [];
  }
}

module.exports = scrapeHerMajesty;

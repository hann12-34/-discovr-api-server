 ...
 * URL: https://lionartsfactory.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLionArts(city = 'Adelaide') {
  console.log('🎨 Scraping Lion Arts Factory...');
  ...
  try {
    ...
    await page.goto('https://lionartsfactory.com.au/events', {

/**
 * The Gov Adelaide Events Scraper
 * Live music venue
 * URL: https://thegov.com.au/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheGov(city = 'Adelaide') {
  console.log('🎸 Scraping The Gov Adelaide...');
  ...
  try {
    ...
    await page.goto('https://thegov.com.au/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        id: uuidv4(),
        title: event.title,
        description: event.description || `Live at The Gov Adelaide`,
        date: isoDate,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid The Gov events`);

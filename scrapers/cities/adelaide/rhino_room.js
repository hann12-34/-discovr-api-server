/**
 * Rhino Room Adelaide Events Scraper
 * URL: https://www.rhinoroom.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRhinoRoom(city = 'Adelaide') {
  console.log('🦏 Scraping Rhino Room...');
  ...
  try {
    ...
    await page.goto('https://www.rhinoroom.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Rhino Room',
          address: 'Frome St, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9240,
        longitude: 138.6010,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rhino Room events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rhino Room error:', error.message);
    return [];
  }
}

module.exports = scrapeRhinoRoom;

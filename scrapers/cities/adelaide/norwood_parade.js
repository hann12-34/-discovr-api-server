...
async function scrapeNorwoodParade(city = 'Adelaide') {
  ...
  try {
    ...
    for (const evt of events) {
      ...
      seenKeys.add(key);
      results.push({ id: uuidv4(), title: evt.title, description: '', date: isoDate, startDate: new Date(isoDate + 'T00:00:00.000Z'), url: evt.url, imageUrl: evt.image && evt.image.startsWith('http') ? evt.image : null, venue: { name: 'The Parade Norwood', address: 'The Parade, Norwood SA 5067', city: 'Adelaide' }, latitude: -34.9186, longitude: 138.6314, city: 'Adelaide', category: 'Festival', source: 'Norwood Events' });
    }

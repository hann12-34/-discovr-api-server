/**
 * Adelaide Oval Events Scraper
 * URL: https://www.adelaideoval.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAdelaideOval(city = 'Adelaide') {
  console.log('🏟️ Scraping Adelaide Oval...');
  ...
  try {
    ...
    await page.goto('https://www.adelaideoval.com.au/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Adelaide Oval events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Adelaide Oval error:', error.message);
    return [];
  }
}

module.exports = scrapeAdelaideOval;

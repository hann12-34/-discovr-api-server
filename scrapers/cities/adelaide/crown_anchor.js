/**
 * Crown & Anchor Adelaide Events Scraper
 * URL: https://www.crownandanchor.com.au/gigs
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCrownAnchor(city = 'Adelaide') {
  console.log('🎸 Scraping Crown & Anchor...');
  ...
  try {
    ...
    await page.goto('https://www.crownandanchor.com.au/gigs', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Crown & Anchor events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Crown & Anchor error:', error.message);
    return [];
  }
}

module.exports = scrapeCrownAnchor;

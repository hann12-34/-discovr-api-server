/**
 * Ancient World Adelaide Events Scraper
 * URL: https://www.ancientworldadelaide.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAncientWorld(city = 'Adelaide') {
  console.log('🎸 Scraping Ancient World...');
  ...
  try {
    ...
    await page.goto('https://www.ancientworldadelaide.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Ancient World',
          address: '131 Hindley St, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9260,
        longitude: 138.5940,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Ancient World events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Ancient World error:', error.message);
    return [];
  }
}

module.exports = scrapeAncientWorld;

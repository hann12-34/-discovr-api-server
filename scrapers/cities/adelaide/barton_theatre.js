 ...
 * URL: https://thebartontheatre.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBartonTheatre(city = 'Adelaide') {
  ...
  try {
    ...
    await page.goto('https://thebartontheatre.com.au/events', {
...
module.exports = scrapeBartonTheatre;

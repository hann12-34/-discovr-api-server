/**
 * Hindley Street Music Hall Adelaide Events Scraper
 * URL: https://www.hindleystreetmusichall.com.au/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHindleyStreet(city = 'Adelaide') {
  console.log('🎸 Scraping Hindley Street Music Hall...');
  ...
  try {
    ...
    await page.goto('https://www.hindleystreetmusichall.com.au/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '7 Hindley St, Adelaide SA 5000',
          city: 'Adelaide'
        },
        latitude: -34.9260,
        longitude: 138.5970,
        city: 'Adelaide',
        category: 'Nightlife',
        source: 'Hindley Street Music Hall'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Hindley Street events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Hindley Street error:', error.message);
    return [];
  }
}

module.exports = scrapeHindleyStreet;

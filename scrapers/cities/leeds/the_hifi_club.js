/**
 * The HiFi Club Leeds Events Scraper
 * URL: https://www.thehificlub.co.uk/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHiFiClub(city = 'Leeds') {
  console.log('🎵 Scraping The HiFi Club...');
  ...
  try {
    ...
    await page.goto('https://www.thehificlub.co.uk/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The HiFi Club',
          address: '2 Central Rd, Leeds LS1 6DE',
          city: 'Leeds'
        },
        latitude: 53.7965,
        longitude: -1.5405,
        city: 'Leeds',
        category: 'Nightlife',
        source: 'The HiFi Club'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} HiFi Club events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  HiFi Club error:', error.message);
    return [];
  }
}

module.exports = scrapeHiFiClub;

/**
 * Stylus Leeds Events Scraper
 * URL: https://www.stylusleeds.co.uk/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStylus(city = 'Leeds') {
  console.log('🎵 Scraping Stylus...');
  ...
  try {
    ...
    await page.goto('https://www.stylusleeds.co.uk/whats-on', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Stylus events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Stylus error:', error.message);
    return [];
  }
}

module.exports = scrapeStylus;

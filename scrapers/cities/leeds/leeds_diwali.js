/**
 * Leeds Diwali Festival Events Scraper
...
async function scrapeDiwali(city = 'Leeds') {
  console.log('🪔 Scraping Leeds Diwali...');
  ...
  try {
    ...
    await page.goto('https://www.visitleeds.co.uk/whats-on', {
    ...
    console.error('  ⚠️  Leeds Diwali error:', error.message);
    return [];
  }
}

module.exports = scrapeDiwali;

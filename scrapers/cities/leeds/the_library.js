/**
 * The Library Leeds Events Scraper
 * URL: https://thelibraryleeds.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheLibrary(city = 'Leeds') {
  console.log('📚 Scraping The Library...');
  ...
  try {
    ...
    await page.goto('https://thelibraryleeds.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Library',
          address: 'Cookridge St, Leeds LS2 3AW',
          city: 'Leeds'
        },
        latitude: 53.7995,
        longitude: -1.5475,
...
module.exports = scrapeTheLibrary;

/**
 * Millennium Square Leeds Events Scraper
 * URL: https://www.visitleeds.co.uk/things-to-do/millennium-square
 */
...
async function scrapeMillenniumSquare(city = 'Leeds') {
  console.log('🏛️ Scraping Millennium Square...');
  ...
  try {
    ...
    await page.goto('https://www.visitleeds.co.uk/things-to-do/millennium-square', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Leeds',
        category: 'Festival',
        source: 'Millennium Square'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Millennium Square events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Millennium Square error:', error.message);
    return [];
  }
}

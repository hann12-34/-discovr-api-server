/**
 * The Fenton Leeds Events Scraper
 * URL: https://thefenton.com/whats-on
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheFenton(city = 'Leeds') {
  console.log('🎵 Scraping The Fenton...');
  ...
  try {
    ...
    await page.goto('https://thefenton.com/whats-on', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'The Fenton',
          address: '82-84 Cardigan Rd, Leeds LS6 1LX',
          city: 'Leeds'
        },
        latitude: 53.8150,
        longitude: -1.5720,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fenton events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fenton error:', error.message);
    return [];
  }
}

module.exports = scrapeTheFenton;

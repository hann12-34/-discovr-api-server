/**
 * First Direct Arena Leeds Events Scraper
 * URL: https://www.firstdirectarena.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFirstDirectArena(city = 'Leeds') {
  console.log('🏟️ Scraping First Direct Arena...');
  ...
  try {
    ...
    await page.goto('https://www.firstdirectarena.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} First Direct Arena events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  First Direct Arena error:', error.message);
    return [];
  }
}

module.exports = scrapeFirstDirectArena;

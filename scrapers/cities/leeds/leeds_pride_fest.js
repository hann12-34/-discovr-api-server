/**
 * Leeds Pride Events Scraper
 * URL: https://www.leedspride.org
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLeedsPride(city = 'Leeds') {
  console.log('🏳️‍🌈 Scraping Leeds Pride...');
  ...
  try {
    ...
    await page.goto('https://www.leedspride.org', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Leeds Pride events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Leeds Pride error:', error.message);
    return [];
  }
}

module.exports = scrapeLeedsPride;

/**
 * The Sinclair Boston Events Scraper
 * Live music venue in Cambridge
...
async function scrapeSinclair(city = 'Boston') {
  console.log('🎸 Scraping The Sinclair Boston...');
  ...
  try {
    ...
    await page.goto('https://www.sinclaircambridge.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Sinclair events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'The Sinclair', address: '52 Church Street, Cambridge MA 02138', city: 'Boston' },
        latitude: 42.3732,
        longitude: -71.1202,
        city: 'Boston',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Sinclair error:', error.message);
    return [];
  }
}

module.exports = scrapeSinclair;

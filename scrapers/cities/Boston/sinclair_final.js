/**
 * The Sinclair Final Boston Events Scraper
...
async function scrapeSinclairFinal(city = 'Boston') {
  console.log('🎸 Scraping Sinclair Final...');
  ...
  try {
    ...
    await page.goto('https://www.sinclaircambridge.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Boston',
        category: 'Nightlife',
        source: 'Sinclair Final'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Sinclair Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sinclair Final error:', error.message);
    return [];
  }
}

module.exports = scrapeSinclairFinal;

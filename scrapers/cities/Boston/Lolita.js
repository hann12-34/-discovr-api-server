/**
 * Lolita Cocina & Tequila Bar Boston Events Scraper
 * URL: https://www.lolitacocina.com/boston/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLolita(city = 'Boston') {
  console.log('🌮 Scraping Lolita...');
  ...
  try {
    ...
    await page.goto('https://www.lolitacocina.com/boston/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lolita events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lolita error:', error.message);
    return [];
  }
}

module.exports = scrapeLolita;

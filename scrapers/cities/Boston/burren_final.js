/**
 * The Burren Final Boston Events Scraper
 * URL: https://burren.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBurrenFinal(city = 'Boston') {
  console.log('🍀 Scraping Burren Final...');
  ...
  try {
    ...
    await page.goto('https://burren.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Burren Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Burren Final error:', error.message);
    return [];
  }
}

module.exports = scrapeBurrenFinal;

/**
 * Howl at the Moon Boston Events Scraper
 * URL: https://www.howlatthemoon.com/boston
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHowlMoon(city = 'Boston') {
  console.log('🌙 Scraping Howl Moon...');
  ...
  try {
    ...
    await page.goto('https://www.howlatthemoon.com/boston', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '184 High St, Boston, MA 02110',
          city: 'Boston'
        },
        latitude: 42.3550,
        longitude: -71.0530,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Howl Moon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Howl Moon error:', error.message);
    return [];
  }
}

module.exports = scrapeHowlMoon;

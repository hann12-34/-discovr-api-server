/**
 * Wally's Cafe Final Boston Events Scraper
 * URL: https://wallyscafe.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWallyFinal(city = 'Boston') {
  console.log('🎷 Scraping Wally Final...');
  ...
  try {
    ...
    await page.goto('https://wallyscafe.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wally Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wally Final error:', error.message);
    return [];
  }
}

module.exports = scrapeWallyFinal;

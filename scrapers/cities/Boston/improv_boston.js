/**
 * ImprovBoston Events Scraper
 * URL: https://www.improvboston.com/shows
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeImprovBoston(city = 'Boston') {
  console.log('🎭 Scraping ImprovBoston...');
  ...
  try {
    ...
    await page.goto('https://www.improvboston.com/shows', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ImprovBoston events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ImprovBoston error:', error.message);
    return [];
  }
}

module.exports = scrapeImprovBoston;

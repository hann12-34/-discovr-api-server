/**
 * Laugh Boston Final Events Scraper
 * URL: https://laughboston.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLaughFinal(city = 'Boston') {
  console.log('😂 Scraping Laugh Final...');
  ...
  try {
    ...
    await page.goto('https://laughboston.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Laugh Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Laugh Final error:', error.message);
    return [];
  }
}

module.exports = scrapeLaughFinal;

/**
 * Middle East Club Boston Events Scraper
 * Legendary live music venue in Cambridge
 * URL: https://www.mideastoffers.com/
 */
...
async function scrapeMiddleEast(city = 'Boston') {
  console.log('🎸 Scraping Middle East Boston...');
  ...
  try {
    ...
    await page.goto('https://www.mideastoffers.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Middle East events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Middle East Club', address: '472-480 Massachusetts Ave, Cambridge MA 02139', city: 'Boston' },
        latitude: 42.3636,
        longitude: -71.1028,
        city: 'Boston',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Middle East error:', error.message);
    return [];
  }
}

module.exports = scrapeMiddleEast;

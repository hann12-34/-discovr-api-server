/**
 * The Grand Boston Nightclub Events Scraper
 * URL: https://thegrandboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTheGrand(city = 'Boston') {
  console.log('🎉 Scraping The Grand...');
  ...
  try {
    ...
    await page.goto('https://thegrandboston.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Grand events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Grand error:', error.message);
    return [];
  }
}

module.exports = scrapeTheGrand;

...
async function scrapeBrighton(city = 'Boston') {
  console.log('🎸 Scraping Brighton Music Hall Boston...');
  ...
  try {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Brighton events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Brighton Music Hall', address: '158 Brighton Ave, Allston MA 02134', city: 'Boston' },
        latitude: 42.3534,
        longitude: -71.1316,
        city: 'Boston',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Brighton error:', error.message);
    return [];
  }
}

module.exports = scrapeBrighton;

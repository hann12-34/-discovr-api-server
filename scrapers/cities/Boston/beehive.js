/**
 * The Beehive Boston Events Scraper
 * URL: https://beehiveboston.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBeehive(city = 'Boston') {
  console.log('🐝 Scraping Beehive...');
  ...
  try {
    ...
    await page.goto('https://beehiveboston.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Beehive events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Beehive error:', error.message);
    return [];
  }
}

module.exports = scrapeBeehive;

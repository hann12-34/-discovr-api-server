/**
 * ZuZu Boston Events Scraper
 * URL: https://zuzucambridge.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeZuZu(city = 'Boston') {
  console.log('🎭 Scraping ZuZu...');
  ...
  try {
    ...
    await page.goto('https://zuzucambridge.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'ZuZu',
          address: '474 Massachusetts Ave, Cambridge, MA 02139',
          city: 'Boston'
        },
        latitude: 42.3645,
        longitude: -71.1042,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ZuZu events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ZuZu error:', error.message);
    return [];
  }
}

module.exports = scrapeZuZu;

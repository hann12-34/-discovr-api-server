/**
 * TOAD Cambridge Boston Events Scraper
 * URL: https://toadcambridge.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeToad(city = 'Boston') {
  console.log('🐸 Scraping TOAD...');
  ...
  try {
    ...
    await page.goto('https://toadcambridge.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'TOAD',
          address: '1912 Massachusetts Ave, Cambridge, MA 02140',
          city: 'Boston'
        },
        latitude: 42.3895,
        longitude: -71.1207,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} TOAD events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  TOAD error:', error.message);
    return [];
  }
}

module.exports = scrapeToad;

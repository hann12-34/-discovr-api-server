/**
 * Crystal Ballroom Boston Events Scraper
 * Historic venue at Somerville Theatre
...
async function scrapeCrystalBallroom(city = 'Boston') {
  console.log('🎸 Scraping Crystal Ballroom Boston...');
  ...
  try {
    ...
    await page.goto('https://www.crystalballroomboston.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Crystal Ballroom events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Crystal Ballroom', address: '55 Davis Square, Somerville MA 02144', city: 'Boston' },
        latitude: 42.3967,
        longitude: -71.1222,
        city: 'Boston',
        category: 'Nightlife',

/**
 * Tavern in the Square Boston Events Scraper
 * URL: https://www.taverninthesquare.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTavern(city = 'Boston') {
  console.log('🍺 Scraping Tavern...');
  ...
  try {
    ...
    await page.goto('https://www.taverninthesquare.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Tavern events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Tavern error:', error.message);
    return [];
  }
}

module.exports = scrapeTavern;

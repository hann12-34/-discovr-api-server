/**
 * Sonia Boston Events Scraper
 * Live music venue in Cambridge
 * URL: https://www.soniainboston.com/
 */
...
async function scrapeSonia(city = 'Boston') {
  console.log('🎸 Scraping Sonia Boston...');
  ...
  try {
    ...
    await page.goto('https://www.soniainboston.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Sonia events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Sonia', address: '10 Brookline Street, Cambridge MA 02139', city: 'Boston' },
        latitude: 42.3643,
        longitude: -71.1034,
        city: 'Boston',
        category: 'Nightlife',
    ...
    console.error('  ⚠️  Sonia error:', error.message);
    return [];
  }
}

module.exports = scrapeSonia;

/**
 * Lizard Lounge Boston Events Scraper
...
async function scrapeLizardLounge(city = 'Boston') {
  console.log('🦎 Scraping Lizard Lounge...');
  ...
  try {
    ...
    await page.goto('https://lizardloungeclub.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lizard Lounge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lizard Lounge error:', error.message);
    return [];
  }
}

module.exports = scrapeLizardLounge;

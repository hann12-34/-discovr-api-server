/**
 * The Foundry Boston Events Scraper
 * URL: https://thefoundry.com/boston/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFoundry(city = 'Boston') {
  ...
  try {
    ...
    await page.goto('https://thefoundry.com/boston/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Foundry events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Foundry error:', error.message);
    return [];
  }
}

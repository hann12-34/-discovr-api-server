/**
 * Laugh Boston Events Scraper
 * URL: https://www.laughboston.com/shows
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLaughBoston(city = 'Boston') {
  console.log('😂 Scraping Laugh Boston...');
  ...
  try {
    ...
    await page.goto('https://www.laughboston.com/shows', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Laugh Boston events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Laugh Boston error:', error.message);
    return [];
  }
}

module.exports = scrapeLaughBoston;

/**
 * Laugh Boston V2 Events Scraper
...
async function scrapeLaughV2(city = 'Boston') {
  console.log('😂 Scraping Laugh V2...');
  ...
  try {
    ...
    await page.goto('https://laughboston.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Laugh V2 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Laugh V2 error:', error.message);
    return [];
  }
}

module.exports = scrapeLaughV2;

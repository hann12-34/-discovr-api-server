/**
 * House of Blues Boston Boston Events Scraper
...
async function scrapeHouseofblues(city = 'Boston') {
  console.log('🎵 Scraping House of Blues Boston...');
  ...
  try {
    ...
    await page.goto('https://www.houseofblues.com/boston/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Boston',
        category: 'Nightlife',
        source: 'House of Blues Boston'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} House of Blues Boston events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  House of Blues Boston error: ${error.message}`);
    return [];
  }
}

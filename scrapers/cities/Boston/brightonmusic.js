/**
 * Brighton Music Hall Boston Events Scraper
 * URL: https://www.crossroadspresents.com
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBrightonmusic(city = 'Boston') {
  console.log('🎵 Scraping Brighton Music Hall...');
  ...
  try {
    ...
    await page.goto('https://www.crossroadspresents.com/events/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '158 Brighton Avenue, Boston, MA 02134',
          city: 'Boston'
        },
        latitude: 42.3531,
        longitude: -71.1343,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Brighton Music Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Brighton Music Hall error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeBrightonmusic;

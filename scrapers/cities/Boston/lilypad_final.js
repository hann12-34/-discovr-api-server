/**
 * Lilypad Cambridge Final Boston Events Scraper
 * URL: https://lilypadinman.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLilypadFinal(city = 'Boston') {
  console.log('🎵 Scraping Lilypad Final...');
  ...
  try {
    ...
    await page.goto('https://lilypadinman.com/calendar', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Boston',
        category: 'Nightlife',
        source: 'Lilypad Final'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Lilypad Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lilypad Final error:', error.message);
    return [];
  }
}

module.exports = scrapeLilypadFinal;

/**
 * Bowery Boston Events Scraper
 * Live music venue
 * URL: https://www.boweryboston.com/
 */
...
async function scrapeBoweryBoston(city = 'Boston') {
  console.log('🎸 Scraping Bowery Boston...');
  ...
  try {
    ...
    await page.goto('https://www.boweryboston.com/', {
    ...
    await browser.close();
    console.log(`  ✅ Found ${events.length} Bowery Boston events`);
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: { name: 'Bowery Boston', address: '82 Brookline Ave, Boston MA 02215', city: 'Boston' },
        latitude: 42.3467,
        longitude: -71.0972,
        city: 'Boston',
        category: 'Nightlife',
        source: 'Bowery Boston'
      });
    }
    ...
    console.error('  ⚠️  Bowery Boston error:', error.message);
    return [];
  }
}

module.exports = scrapeBoweryBoston;

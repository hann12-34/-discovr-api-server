/**
 * ONCE Ballroom Final Boston Events Scraper
 * URL: https://www.oncesomerville.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOnceFinal(city = 'Boston') {
  console.log('🎸 Scraping ONCE Final...');
  ...
  try {
    ...
    await page.goto('https://www.oncesomerville.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ONCE Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ONCE Final error:', error.message);
    return [];
  }
}

module.exports = scrapeOnceFinal;

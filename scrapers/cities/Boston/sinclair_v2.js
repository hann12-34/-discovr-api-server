/**
 * The Sinclair V2 Boston Events Scraper
...
async function scrapeSinclairV2(city = 'Boston') {
  console.log('🎸 Scraping Sinclair V2...');
  ...
  try {
    ...
    await page.goto('https://sinclaircambridge.com', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sinclair V2 events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sinclair V2 error:', error.message);
    return [];
  }
}

module.exports = scrapeSinclairV2;

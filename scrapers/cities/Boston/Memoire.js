/**
 * Memoire Boston Nightclub Events Scraper
 * URL: https://memoireboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMemoire(city = 'Boston') {
  console.log('💃 Scraping Memoire...');
  ...
  try {
    ...
    await page.goto('https://memoireboston.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Memoire Boston',
          address: '5 Lansdowne St, Boston, MA 02215',
          city: 'Boston'
        },
        latitude: 42.3465,
        longitude: -71.0978,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Memoire events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Memoire error:', error.message);
    return [];
  }
}

module.exports = scrapeMemoire;

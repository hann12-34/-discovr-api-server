/**
 * Sally O'Brien's Boston Events Scraper
 * URL: https://sallyobriensbar.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSallys(city = 'Boston') {
  console.log('🍀 Scraping Sallys...');
  ...
  try {
    ...
    await page.goto('https://sallyobriensbar.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '335 Somerville Ave, Somerville, MA 02143',
          city: 'Boston'
        },
        latitude: 42.3831,
        longitude: -71.0977,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Sallys events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Sallys error:', error.message);
    return [];
  }
}

module.exports = scrapeSallys;

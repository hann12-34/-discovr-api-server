/**
 * Crystal Ballroom Boston Final Events Scraper
...
async function scrapeCrystalBostonFinal(city = 'Boston') {
  console.log('💎 Scraping Crystal Boston Final...');
  ...
  try {
    ...
    await page.goto('https://www.crystalballroomboston.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Boston',
        category: 'Nightlife',
        source: 'Crystal Boston Final'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Crystal Boston Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Crystal Boston Final error:', error.message);
    return [];
  }
}

module.exports = scrapeCrystalBostonFinal;

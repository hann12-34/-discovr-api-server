/**
 * Bijou Boston Nightclub Events Scraper
 * URL: https://bijouboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBijou(city = 'Boston') {
  console.log('💎 Scraping Bijou...');
  ...
  try {
    ...
    await page.goto('https://bijouboston.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Bijou events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Bijou error:', error.message);
    return [];
  }
}

module.exports = scrapeBijou;

/**
 * FACES Boston Nightclub Events Scraper
 * URL: https://facesboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFaces(city = 'Boston') {
  console.log('🎉 Scraping FACES...');
  ...
  try {
    ...
    await page.goto('https://facesboston.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} FACES events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  FACES error:', error.message);
    return [];
  }
}

module.exports = scrapeFaces;

/**
 * Regattabar Boston Events Scraper
 * URL: https://regattabarjazz.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRegattabar(city = 'Boston') {
  console.log('🎺 Scraping Regattabar...');
  ...
  try {
    ...
    await page.goto('https://regattabarjazz.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Regattabar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Regattabar error:', error.message);
    return [];
  }
}

module.exports = scrapeRegattabar;

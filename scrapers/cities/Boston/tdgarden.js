/**
 * TD Garden Boston Events Scraper
...
async function scrapeTdgarden(city = 'Boston') {
  console.log('🎵 Scraping TD Garden...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} TD Garden events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  TD Garden error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeTdgarden;

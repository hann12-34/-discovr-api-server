/**
 * A4cade Boston Events Scraper
 * URL: https://a4cade.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeA4cade(city = 'Boston') {
  console.log('🎮 Scraping A4cade...');
  ...
  try {
    ...
    await page.goto('https://a4cade.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} A4cade events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  A4cade error:', error.message);
    return [];
  }
}

module.exports = scrapeA4cade;

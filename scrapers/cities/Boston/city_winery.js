/**
 * City Winery Boston Events Scraper
 * URL: https://www.citywinery.com/boston/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCityWinery(city = 'Boston') {
  console.log('🍷 Scraping City Winery...');
  ...
  try {
    ...
    await page.goto('https://www.citywinery.com/boston/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} City Winery events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  City Winery error:', error.message);
    return [];
  }
}

module.exports = scrapeCityWinery;

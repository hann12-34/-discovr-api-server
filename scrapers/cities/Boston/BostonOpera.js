/**
 * Boston Opera House Events Scraper
 * URL: https://www.bostonoperahouse.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBostonOpera(city = 'Boston') {
  console.log('🎭 Scraping Boston Opera...');
  ...
  try {
    ...
    await page.goto('https://www.bostonoperahouse.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Boston Opera events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Boston Opera error:', error.message);
    return [];
  }
}

module.exports = scrapeBostonOpera;

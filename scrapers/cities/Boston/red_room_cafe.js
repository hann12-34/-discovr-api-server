 ...
 * URL: https://cafe939.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRedRoom(city = 'Boston') {
  console.log('☕ Scraping Red Room...');
  ...
  try {
    ...
    await page.goto('https://cafe939.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Red Room events`);

/**
 * TD Garden Final Boston Events Scraper
...
async function scrapeTDGardenFinal(city = 'Boston') {
  console.log('🏟️ Scraping TD Garden Final...');
  ...
  try {
    ...
    await page.goto('https://www.tdgarden.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Boston',
        category: 'Nightlife',
        source: 'TD Garden Final'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} TD Garden Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  TD Garden Final error:', error.message);
    return [];
  }
}

module.exports = scrapeTDGardenFinal;

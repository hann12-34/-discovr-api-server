/**
 * MGM Music Hall Boston Events Scraper
 * URL: https://mgmmusichallfenway.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMGMMusic(city = 'Boston') {
  console.log('🎵 Scraping MGM Music Hall...');
  ...
  try {
    ...
    await page.goto('https://mgmmusichallfenway.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} MGM Music Hall events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  MGM Music Hall error:', error.message);
    return [];
  }
}

module.exports = scrapeMGMMusic;

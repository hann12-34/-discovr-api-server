/**
 * Encore Boston Harbor Events Scraper
 * URL: https://www.encorebostonharbor.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeEncore(city = 'Boston') {
  console.log('🎰 Scraping Encore...');
  ...
  try {
    ...
    await page.goto('https://www.encorebostonharbor.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Encore events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Encore error:', error.message);
    return [];
  }
}

module.exports = scrapeEncore;

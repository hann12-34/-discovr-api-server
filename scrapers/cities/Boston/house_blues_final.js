/**
 * House of Blues Boston Final Events Scraper
 * URL: https://www.houseofblues.com/boston/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHOBFinal(city = 'Boston') {
  console.log('🎵 Scraping HOB Final...');
  ...
  try {
    ...
    await page.goto('https://www.houseofblues.com/boston/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} HOB Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  HOB Final error:', error.message);
    return [];
  }
}

module.exports = scrapeHOBFinal;

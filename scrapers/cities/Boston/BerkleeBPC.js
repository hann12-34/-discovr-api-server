/**
 * Berklee Performance Center Boston Events Scraper
 * URL: https://www.berklee.edu/bpc/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeBerkleeBPC(city = 'Boston') {
  console.log('🎵 Scraping Berklee BPC...');
  ...
  try {
    ...
    await page.goto('https://www.berklee.edu/bpc/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Berklee BPC events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Berklee BPC error:', error.message);
    return [];
  }
}

module.exports = scrapeBerkleeBPC;

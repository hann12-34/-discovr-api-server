/**
 * Tunnel Boston Nightclub Events Scraper
 * URL: https://tunnelboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeTunnel(city = 'Boston') {
  console.log('🎵 Scraping Tunnel...');
  ...
  try {
    ...
    await page.goto('https://tunnelboston.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Tunnel events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Tunnel error:', error.message);
    return [];
  }
}

module.exports = scrapeTunnel;

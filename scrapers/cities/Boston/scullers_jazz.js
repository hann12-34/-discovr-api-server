/**
 * Scullers Jazz Club Boston Events Scraper
 * URL: https://scullersjazz.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeScullers(city = 'Boston') {
  console.log('🎷 Scraping Scullers...');
  ...
  try {
    ...
    await page.goto('https://scullersjazz.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Scullers events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Scullers error:', error.message);
    return [];
  }
}

module.exports = scrapeScullers;

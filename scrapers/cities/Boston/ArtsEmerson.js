/**
 * ArtsEmerson Boston Events Scraper
...
async function scrapeArtsEmerson(city = 'Boston') {
  console.log('🎭 Scraping ArtsEmerson...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ArtsEmerson events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ArtsEmerson error:', error.message);
    return [];
  }
}

module.exports = scrapeArtsEmerson;

/**
 * Symphony Hall Boston Events Scraper
...
async function scrapeSymphonyHall(city = 'Boston') {
  console.log('🎻 Scraping Symphony Hall...');
  ...
  try {
    ...
    await page.goto('https://www.bso.org/events', {

/**
 * Royale Nightclub Final Boston Events Scraper
 * URL: https://royaleboston.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRoyaleFinal(city = 'Boston') {
  console.log('🎵 Scraping Royale Final...');
  ...
  try {
    ...
    await page.goto('https://royaleboston.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Royale Final events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Royale Final error:', error.message);
    return [];
  }
}

module.exports = scrapeRoyaleFinal;

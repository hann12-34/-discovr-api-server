/**
 * Club Passim Boston Events Scraper
 * URL: https://www.clubpassim.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeClubPassim(city = 'Boston') {
  console.log('🎸 Scraping Club Passim...');
  ...
  try {
    ...
    await page.goto('https://www.clubpassim.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Club Passim events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Club Passim error:', error.message);
    return [];
  }
}

module.exports = scrapeClubPassim;

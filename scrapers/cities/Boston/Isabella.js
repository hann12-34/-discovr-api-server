/**
 * Isabella Stewart Gardner Museum Boston Events Scraper
...
async function scrapeIsabella(city = 'Boston') {
  console.log('🎨 Scraping Isabella...');
  ...
  try {
    ...
    await page.goto('https://www.gardnermuseum.org/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Isabella events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Isabella error:', error.message);
    return [];
  }
}

module.exports = scrapeIsabella;

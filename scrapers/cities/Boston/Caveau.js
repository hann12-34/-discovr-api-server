/**
 * Caveau Boston Events Scraper
 * URL: https://caveauboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCaveau(city = 'Boston') {
  console.log('🍷 Scraping Caveau...');
  ...
  try {
    ...
    await page.goto('https://caveauboston.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Caveau',
          address: '1 Broadway, Somerville, MA 02145',
          city: 'Boston'
        },
        latitude: 42.3981,
        longitude: -71.0931,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Caveau events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Caveau error:', error.message);
    return [];
  }
}

module.exports = scrapeCaveau;

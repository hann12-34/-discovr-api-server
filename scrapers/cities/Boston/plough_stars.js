/**
 * Plough and Stars Boston Events Scraper
 * URL: https://ploughandstars.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePloughStars(city = 'Boston') {
  console.log('⭐ Scraping Plough Stars...');
  ...
  try {
    ...
    await page.goto('https://ploughandstars.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Plough Stars events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Plough Stars error:', error.message);
    return [];
  }
}

module.exports = scrapePloughStars;

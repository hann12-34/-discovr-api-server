/**
 * Wang Theatre Boston Events Scraper
 * URL: https://www.citicenter.org/plan-your-visit/venues/wang-theatre
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWangTheatre(city = 'Boston') {
  console.log('🎭 Scraping Wang Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.citicenter.org/plan-your-visit/venues/wang-theatre', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wang Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wang Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeWangTheatre;

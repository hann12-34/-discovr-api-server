/**
 * Improv Asylum Boston Events Scraper
 * URL: https://www.improvasylum.com/shows
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeImprovAsylum(city = 'Boston') {
  console.log('🎭 Scraping Improv Asylum...');
  ...
  try {
    ...
    await page.goto('https://www.improvasylum.com/shows', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Improv Asylum events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Improv Asylum error:', error.message);
    return [];
  }
}

module.exports = scrapeImprovAsylum;

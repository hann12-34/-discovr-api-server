/**
 * Midway Cafe Boston Events Scraper
 * URL: https://www.midwaycafe.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMidway(city = 'Boston') {
  console.log('☕ Scraping Midway Cafe...');
  ...
  try {
    ...
    await page.goto('https://www.midwaycafe.com/events', {

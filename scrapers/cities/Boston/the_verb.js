/**
 * The Verb Hotel Boston Events Scraper
 * URL: https://theverbhotel.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVerbHotel(city = 'Boston') {
  console.log('🎸 Scraping The Verb...');
  ...
  try {
    ...
    await page.goto('https://theverbhotel.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Verb Hotel events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Verb Hotel error:', error.message);
    return [];
  }
}

module.exports = scrapeVerbHotel;

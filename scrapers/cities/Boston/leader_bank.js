/**
 * Leader Bank Pavilion Boston Events Scraper
 * URL: https://www.leaderbankpavilion.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeLeaderBank(city = 'Boston') {
  console.log('🎵 Scraping Leader Bank...');
  ...
  try {
    ...
    await page.goto('https://www.leaderbankpavilion.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Leader Bank events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Leader Bank error:', error.message);
    return [];
  }
}

module.exports = scrapeLeaderBank;

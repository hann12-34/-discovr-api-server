/**
 * Glass Onion Boston Events Scraper
 * URL: https://glassonionboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGlassOnion(city = 'Boston') {
  console.log('🧅 Scraping Glass Onion...');
  ...
  try {
    ...
    await page.goto('https://glassonionboston.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Glass Onion',
          address: '1104 Commonwealth Ave, Boston, MA 02215',
          city: 'Boston'
        },
        latitude: 42.3500,
        longitude: -71.1175,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Glass Onion events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Glass Onion error:', error.message);
    return [];
  }
}

module.exports = scrapeGlassOnion;

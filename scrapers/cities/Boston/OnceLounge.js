/**
 * ONCE Lounge Boston Events Scraper
 * URL: https://onceballroom.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOnceLounge(city = 'Boston') {
  console.log('🎵 Scraping ONCE Lounge...');
  ...
  try {
    ...
    await page.goto('https://onceballroom.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ONCE Lounge events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ONCE Lounge error:', error.message);
    return [];
  }
}

module.exports = scrapeOnceLounge;

/**
 * Venu Boston Nightclub Events Scraper
 * URL: https://venuboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeVenu(city = 'Boston') {
  console.log('🎉 Scraping Venu...');
  ...
  try {
    ...
    await page.goto('https://venuboston.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Venu events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Venu error:', error.message);
    return [];
  }
}

module.exports = scrapeVenu;

/**
 * The Casbah Boston Events Scraper
 * URL: https://www.thecasbahma.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCasbah(city = 'Boston') {
  console.log('🎵 Scraping The Casbah...');
  ...
  try {
    ...
    await page.goto('https://www.thecasbahma.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Casbah events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Casbah error:', error.message);
    return [];
  }
}

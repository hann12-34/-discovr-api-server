/**
 * House of Blues Boston Complete Events Scraper
...
async function scrapeHOBComplete(city = 'Boston') {
  console.log('🎵 Scraping HOB Complete...');
  ...
  try {
    ...
    await page.goto('https://www.houseofblues.com/boston', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} HOB Complete events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  HOB Complete error:', error.message);
    return [];
  }
}

module.exports = scrapeHOBComplete;

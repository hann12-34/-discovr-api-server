/**
 * ART Harvard Boston Events Scraper
 * URL: https://americanrepertorytheater.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeARTHarvard(city = 'Boston') {
  console.log('🎭 Scraping ART Harvard...');
  ...
  try {
    ...
    await page.goto('https://americanrepertorytheater.org/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          ...
          address: '64 Brattle St, Cambridge, MA 02138',
          city: 'Boston'
        },
        latitude: 42.3734,
        longitude: -71.1208,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ART Harvard events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  ART Harvard error:', error.message);
    return [];
  }
}

module.exports = scrapeARTHarvard;

...
async function scrapeICA(city = 'Boston') {
  console.log('🎨 Scraping ICA...');
  ...
  try {
    ...
    await page.goto('https://www.icaboston.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} ICA events`);

/**
 * Showcase Live Boston Events Scraper
 * URL: https://showcaselive.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeShowcase(city = 'Boston') {
  console.log('🎤 Scraping Showcase Live...');
  ...
  try {
    ...
    await page.goto('https://showcaselive.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Showcase Live',
          address: '97 Landsdowne St, Foxborough, MA 02035',
          city: 'Boston'
        },
        latitude: 42.0911,
        longitude: -71.2645,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Showcase events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Showcase error:', error.message);
    return [];
  }
}

module.exports = scrapeShowcase;

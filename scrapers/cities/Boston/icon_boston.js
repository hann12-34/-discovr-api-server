/**
 * Icon Boston Events Scraper
 * Popular nightclub in Boston
 * URL: https://iconboston.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIconBoston(city = 'Boston') {
  console.log('🎉 Scraping Icon Boston...');
  ...
  try {
    ...
    await page.goto('https://iconboston.com/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Icon events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️ Icon error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeIconBoston;

/**
 * Fenway Park Boston Events Scraper
...
async function scrapeFenway(city = 'Boston') {
  console.log('🎵 Scraping Fenway Park...');
  ...
  try {
    ...
    await page.goto('https://www.mlb.com/redsox/events/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Fenway Park events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error(`  ⚠️  Fenway Park error: ${error.message}`);
    return [];
  }
}

module.exports = scrapeFenway;

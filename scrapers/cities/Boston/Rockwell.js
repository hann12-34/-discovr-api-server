/**
 * Rockwell Boston Events Scraper
 * URL: https://www.rockwellsomerville.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeRockwell(city = 'Boston') {
  console.log('🎵 Scraping Rockwell...');
  ...
  try {
    ...
    await page.goto('https://www.rockwellsomerville.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Rockwell events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Rockwell error:', error.message);
    return [];
  }
}

module.exports = scrapeRockwell;

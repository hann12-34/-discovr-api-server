/**
 * Metro Boston Events Scraper
 * URL: https://www.metroboston.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMetroBoston(city = 'Boston') {
  console.log('📰 Scraping Metro Boston...');
  ...
  try {
    ...
    await page.goto('https://www.metroboston.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Metro Boston events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Metro Boston error:', error.message);
    return [];
  }
}

module.exports = scrapeMetroBoston;

/**
 * Wally's Cafe Boston Events Scraper
 * URL: https://www.wallyscafe.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeWallysCafe(city = 'Boston') {
  console.log('🎷 Scraping Wally\'s Cafe...');
  ...
  try {
    ...
    await page.goto('https://www.wallyscafe.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Wally's Cafe events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Wally\'s Cafe error:', error.message);
    return [];
  }
}

module.exports = scrapeWallysCafe;

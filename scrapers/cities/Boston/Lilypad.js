/**
 * Lilypad Cambridge Boston Events Scraper
...
async function scrapeLilypad(city = 'Boston') {
  console.log('🎵 Scraping Lilypad...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Lilypad events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Lilypad error:', error.message);
    return [];
  }
}

module.exports = scrapeLilypad;

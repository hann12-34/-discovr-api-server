/**
 * Paisley Park (Prince) Minneapolis Events Scraper
 * URL: https://officialpaisleypark.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePaisleyPark(city = 'Minneapolis') {
  console.log('💜 Scraping Paisley Park...');
  ...
  try {
    ...
    await page.goto('https://officialpaisleypark.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Paisley Park events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Paisley Park error:', error.message);
    return [];
  }
}

module.exports = scrapePaisleyPark;

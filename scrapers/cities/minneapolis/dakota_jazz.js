/**
 * Dakota Jazz Club Minneapolis Events Scraper
...
async function scrapeDakotaJazz(city = 'Minneapolis') {
  console.log('🎷 Scraping Dakota Jazz Club...');
  ...
  try {
    ...
    await page.goto('https://www.dakotacooks.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Minneapolis',
        category: 'Nightlife',
        source: 'Dakota Jazz Club'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Dakota Jazz Club events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Dakota Jazz Club error:', error.message);
    return [];
  }
}

module.exports = scrapeDakotaJazz;

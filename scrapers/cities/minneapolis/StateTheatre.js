/**
 * State Theatre Minneapolis Events Scraper
 * URL: https://hennepintheatretrust.org/venues/state-theatre
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeStateTheatre(city = 'Minneapolis') {
  console.log('🎭 Scraping State Theatre...');
  ...
  try {
    ...
    await page.goto('https://hennepintheatretrust.org/venues/state-theatre', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} State Theatre events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  State Theatre error:', error.message);
    return [];
  }
}

module.exports = scrapeStateTheatre;

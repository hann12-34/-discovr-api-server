/**
 * Xcel Energy Center Minneapolis Events Scraper
...
async function scrapeXcelEnergy(city = 'Minneapolis') {
  console.log('🏒 Scraping Xcel Energy Center...');
  ...
  try {
    ...
    await page.goto('https://www.xcelenergycenter.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Xcel Energy Center events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Xcel Energy Center error:', error.message);
    return [];
  }
}

module.exports = scrapeXcelEnergy;

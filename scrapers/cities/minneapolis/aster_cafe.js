/**
 * Aster Cafe Minneapolis Events Scraper
 * URL: https://www.astercafe.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAsterCafe(city = 'Minneapolis') {
  console.log('☕ Scraping Aster Cafe...');
  ...
  try {
    ...
    await page.goto('https://www.astercafe.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Aster Cafe events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Aster Cafe error:', error.message);
    return [];
  }
}

module.exports = scrapeAsterCafe;

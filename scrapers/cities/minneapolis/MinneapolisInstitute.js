/**
 * Minneapolis Institute of Art Events Scraper
 * URL: https://new.artsmia.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMIA(city = 'Minneapolis') {
  console.log('🎨 Scraping MIA...');
  ...
  try {
    ...
    await page.goto('https://new.artsmia.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} MIA events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  MIA error:', error.message);
    return [];
  }
}

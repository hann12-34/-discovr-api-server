/**
 * Jungle Theater Minneapolis Events Scraper
 * URL: https://jungletheater.org/shows-tickets
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeJungleTheater(city = 'Minneapolis') {
  console.log('🌴 Scraping Jungle Theater...');
  ...
  try {
    ...
    await page.goto('https://jungletheater.org/shows-tickets', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Jungle Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Jungle Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeJungleTheater;

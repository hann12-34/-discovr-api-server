/**
 * Exchange Minneapolis Events Scraper
 * Popular nightclub in Minneapolis
 * URL: https://exchangempls.com/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeExchangeMinneapolis(city = 'Minneapolis') {
  console.log('💱 Scraping Exchange Minneapolis...');
  ...
  try {
    ...
    await page.goto('https://exchangempls.com/', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: 'Exchange',
          address: '629 1st Ave N, Minneapolis, MN 55403',
          city: 'Minneapolis'
        },
        city: 'Minneapolis',
        category: 'Nightlife',
        source: 'Exchange Minneapolis'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} Exchange events`);
...
module.exports = scrapeExchangeMinneapolis;

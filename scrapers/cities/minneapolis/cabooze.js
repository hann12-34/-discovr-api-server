 ...
 * URL: https://www.cabooze.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeCabooze(city = 'Minneapolis') {
  console.log('🚂 Scraping The Cabooze...');
  ...
  try {
    ...
    await page.goto('https://www.cabooze.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Cabooze events`);

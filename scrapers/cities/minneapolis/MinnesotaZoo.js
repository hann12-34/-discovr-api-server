/**
 * Minnesota Zoo Concerts Events Scraper
 * URL: https://mnzoo.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeMinnesotaZoo(city = 'Minneapolis') {
  console.log('🦁 Scraping Minnesota Zoo...');
  ...
  try {
    ...
    await page.goto('https://mnzoo.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Minnesota Zoo events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Minnesota Zoo error:', error.message);
    return [];
  }
}

module.exports = scrapeMinnesotaZoo;

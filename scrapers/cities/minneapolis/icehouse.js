/**
 * Icehouse Minneapolis Events Scraper
 * URL: https://www.icehousempls.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeIcehouse(city = 'Minneapolis') {
  console.log('🧊 Scraping Icehouse...');
  ...
  try {
    ...
    await page.goto('https://www.icehousempls.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Icehouse events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Icehouse error:', error.message);
    return [];
  }
}

module.exports = scrapeIcehouse;

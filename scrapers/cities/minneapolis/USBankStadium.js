/**
 * US Bank Stadium Minneapolis Events Scraper
...
async function scrapeUSBankStadium(city = 'Minneapolis') {
  console.log('🏟️ Scraping US Bank Stadium...');
  ...
  try {
    ...
    await page.goto('https://www.usbankstadium.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} US Bank Stadium events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  US Bank Stadium error:', error.message);
    return [];
  }
}

module.exports = scrapeUSBankStadium;

/**
 * 331 Club Minneapolis Events Scraper
 * URL: https://the331club.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrape331Club(city = 'Minneapolis') {
  console.log('🎸 Scraping 331 Club...');
  ...
  try {
    ...
    await page.goto('https://the331club.com/events', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        venue: {
          name: '331 Club',
          address: '331 13th Ave NE, Minneapolis, MN 55413',
          city: 'Minneapolis'
        },
        latitude: 45.0001,
        longitude: -93.2550,
    ...
    console.log(`  ✅ Found ${formattedEvents.length} 331 Club events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  331 Club error:', error.message);
    return [];
  }
}

module.exports = scrape331Club;

/**
 * Orpheum Theatre Minneapolis Events Scraper
 * URL: https://hennepintheatretrust.org/venues/orpheum-theatre
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeOrpheumMpls(city = 'Minneapolis') {
  console.log('🎭 Scraping Orpheum Mpls...');
  ...
  try {
    ...
    await page.goto('https://hennepintheatretrust.org/venues/orpheum-theatre', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Orpheum Mpls events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Orpheum Mpls error:', error.message);
    return [];
  }
}

module.exports = scrapeOrpheumMpls;

/**
 * Northrop Auditorium Minneapolis Events Scraper
 * URL: https://northrop.umn.edu/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeNorthrup(city = 'Minneapolis') {
  console.log('🎭 Scraping Northrup...');
  ...
  try {
    ...
    await page.goto('https://northrop.umn.edu/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Northrup events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Northrup error:', error.message);
    return [];
  }
}

module.exports = scrapeNorthrup;

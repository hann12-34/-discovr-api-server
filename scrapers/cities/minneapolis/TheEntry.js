/**
 * 7th St Entry Minneapolis Events Scraper
...
async function scrapeSeventhEntry(city = 'Minneapolis') {
  console.log('🎸 Scraping 7th St Entry...');
  ...
  try {
    ...
    await page.goto('https://first-avenue.com/venue/7th-st-entry', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} 7th St Entry events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  7th St Entry error:', error.message);
    return [];
  }
}

module.exports = scrapeSeventhEntry;

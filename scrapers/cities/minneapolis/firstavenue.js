/**
 * First Avenue Minneapolis Events Scraper
 * Legendary live music venue in Minneapolis
...
async function scrapeFirstAvenue(city = 'Minneapolis') {
  console.log('🎸 Scraping First Avenue Minneapolis...');
  ...
  try {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid First Avenue events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  First Avenue error:', error.message);
    return [];
  }
}

module.exports = scrapeFirstAvenue;

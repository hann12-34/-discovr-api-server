 ...
 * URL: https://www.skywaytheatre.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSkyway(city = 'Minneapolis') {
  console.log('🌁 Scraping Skyway Theatre...');
  ...
  try {
    ...
    await page.goto('https://www.skywaytheatre.com/events', {

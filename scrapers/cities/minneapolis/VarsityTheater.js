 ...
 * URL: https://varsitytheater.org/events
 */
...
async function scrapeVarsity(city = 'Minneapolis') {
  console.log('🎭 Scraping Varsity Theater...');
  ...
  try {
    ...
    await page.goto('https://varsitytheater.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Varsity Theater events`);

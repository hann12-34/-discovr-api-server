/**
 * Acme Comedy Company Minneapolis Events Scraper
 * URL: https://www.acmecomedycompany.com/calendar
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeAcmeComedy(city = 'Minneapolis') {
  console.log('😂 Scraping Acme Comedy...');
  ...
  try {
    ...
    await page.goto('https://www.acmecomedycompany.com/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Acme Comedy events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Acme Comedy error:', error.message);
    return [];
  }
}

module.exports = scrapeAcmeComedy;

/**
 * Palmer's Bar Minneapolis Events Scraper
 * URL: https://www.palmersbar.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePalmerBar(city = 'Minneapolis') {
  console.log('🍺 Scraping Palmer Bar...');
  ...
  try {
    ...
    await page.goto('https://www.palmersbar.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Palmer Bar events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Palmer Bar error:', error.message);
    return [];
  }
}

module.exports = scrapePalmerBar;

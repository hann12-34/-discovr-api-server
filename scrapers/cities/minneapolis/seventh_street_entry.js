/**
 * 7th Street Entry Minneapolis Events Scraper
 * URL: https://www.first-avenue.com/venue/7th-st-entry
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeSeventhStreetEntry(city = 'Minneapolis') {
  console.log('🎸 Scraping 7th Street Entry...');
  ...
  try {
    ...
    await page.goto('https://www.first-avenue.com/venue/7th-st-entry', {
    ...
    for (const event of events) {
      ...
      formattedEvents.push({
        ...
        city: 'Minneapolis',
        category: 'Nightlife',
        source: '7th Street Entry'
      });
    }

    console.log(`  ✅ Found ${formattedEvents.length} 7th Street Entry events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  7th Street Entry error:', error.message);
    return [];
  }
}

module.exports = scrapeSeventhStreetEntry;

/**
 * Fine Line Minneapolis Events Scraper
 * Live music venue in Minneapolis
 * URL: https://first-avenue.com/venue/fine-line/
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeFineLine(city = 'Minneapolis') {
  console.log('🎸 Scraping Fine Line Minneapolis...');
  ...
  try {
    ...
    await page.goto('https://first-avenue.com/venue/fine-line/', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} valid Fine Line events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Fine Line error:', error.message);
    return [];
  }
}

module.exports = scrapeFineLine;

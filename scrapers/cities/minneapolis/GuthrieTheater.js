/**
 * Guthrie Theater Minneapolis Events Scraper
 * URL: https://www.guthrietheater.org/shows-and-tickets
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeGuthrie(city = 'Minneapolis') {
  ...
  try {
    ...
    await page.goto('https://www.guthrietheater.org/shows-and-tickets', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Guthrie Theater events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Guthrie Theater error:', error.message);
    return [];
  }
}

module.exports = scrapeGuthrie;

/**
 * The Armory Minneapolis Events Scraper
 * URL: https://www.thearmoryminneapolis.com/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeArmory(city = 'Minneapolis') {
  console.log('🏛️ Scraping The Armory...');
  ...
  try {
    ...
    await page.goto('https://www.thearmoryminneapolis.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} The Armory events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  The Armory error:', error.message);
    return [];
  }
}

module.exports = scrapeArmory;

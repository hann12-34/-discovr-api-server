/**
 * Historic State Theatre St Paul Events Scraper
 * URL: https://www.hennepintheatretrust.org/events
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapeHennepinTheatre(city = 'Minneapolis') {
  console.log('🎭 Scraping Hennepin Theatre Trust...');
  ...
  try {
    ...
    await page.goto('https://www.hennepintheatretrust.org/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Hennepin Theatre Trust events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Hennepin Theatre Trust error:', error.message);
    return [];
  }
}

module.exports = scrapeHennepinTheatre;

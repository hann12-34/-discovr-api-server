/**
 * Walker Art Center Minneapolis Events Scraper
...
async function scrapeWalkerArt(city = 'Minneapolis') {
  console.log('🎨 Scraping Walker Art...');
  ...
  try {
    ...
    await page.goto('https://walkerart.org/calendar', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Walker Art events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Walker Art error:', error.message);
    return [];
  }
}

module.exports = scrapeWalkerArt;

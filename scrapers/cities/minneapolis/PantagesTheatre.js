/**
 * Pantages Theatre Minneapolis Events Scraper
 * URL: https://hennepintheatretrust.org/venues/pantages-theatre
 */

const puppeteer = require('puppeteer');
const { v4: uuidv4 } = require('uuid');

async function scrapePantages(city = 'Minneapolis') {
  console.log('🎭 Scraping Pantages...');
  ...
  try {
    ...
    await page.goto('https://hennepintheatretrust.org/venues/pantages-theatre', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Pantages events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Pantages error:', error.message);
    return [];
  }
}

module.exports = scrapePantages;

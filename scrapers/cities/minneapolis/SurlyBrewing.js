/**
 * Surly Brewing Festival Field Minneapolis Events Scraper
...
async function scrapeSurlyBrewing(city = 'Minneapolis') {
  console.log('🍺 Scraping Surly Brewing...');
  ...
  try {
    ...
    await page.goto('https://surlybrewing.com/events', {
    ...
    console.log(`  ✅ Found ${formattedEvents.length} Surly Brewing events`);
    return formattedEvents;

  } catch (error) {
    if (browser) await browser.close();
    console.error('  ⚠️  Surly Brewing error:', error.message);
    return [];
  }
}

module.exports = scrapeSurlyBrewing;

/**
 * Import PNE Summer Night Concerts Events
 * 
 * This script scrapes events from PNE Summer Night Concerts and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const pneSummerNightConcerts = require('./scrapers/cities/vancouver/pneSummerNightConcerts');
...
async function importPNEConcertsEvents() {
  console.log('🔄 Starting PNE Summer Night Concerts import process...');
  ...
  try {
    ...
    // Scrape events
    console.log('🔍 Scraping events from PNE Summer Night Concerts...');

/**
 * Improved scraper for Biltmore Cabaret Events
...
async function scrape() {
  console.log('🔍 Scraping events from Biltmore Cabaret Events...');
  
  try {
    const sourceUrl = 'https://www.biltmorecabaretevents.com/events/';
    ...
    fs.writeFileSync('biltmore-cabaret-events-debug.html', response.data);
    console.log(`Saved HTML to biltmore-cabaret-events-debug.html`);
        ...
        elements.each((i, el) => {
          try {
            ...
            events.push({
              ...
              imageUrl,
              venue: {
                name: "Biltmore Cabaret Events",
                city: "Vancouver",
                province: "BC",
                country: "Canada"
              },
              categories: guessCategories('Biltmore Cabaret Events', title)
            });
          } catch (error) {
    ...
    console.log(`Found ${events.length} events from Biltmore Cabaret Events`);

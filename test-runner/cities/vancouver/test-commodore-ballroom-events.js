 ...
 * 
 * This script runs the Commodore Ballroom Events scraper and outputs the results
 */
...
// Add debug logging
console.log(`Testing test-commodore-ballroom-events.js...`);
...
async function testScraper() {
  console.log(`🔍 Testing scraper: ${CommodoreBallroomEvents.name}`);
  console.log(`Source URL: ${CommodoreBallroomEvents.url}`);
  console.log('--------------------------------------------');
  ...
  try {
    ...
    if (events.length === 0) {
      ...
      const outputFile = path.join(outputDir, 'commodore-ballroom-events.json');

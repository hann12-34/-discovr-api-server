/**
 * Fixed test for test-underground-comedy-club.js
...
try {
  // Original test logic
    const UndergroundComedyClubEvents = require('./undergroundComedyClubEvents');
  
  // Add debug logging
  console.log(`Testing test-underground-comedy-club.js...`);

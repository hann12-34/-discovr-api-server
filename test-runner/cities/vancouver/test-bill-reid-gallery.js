const BillReidGalleryEvents = require('./billReidGalleryEvents');

// Add debug logging
console.log(`Testing test-bill-reid-gallery.js...`);


/**
 * Test script for Bill Reid Gallery events scraper
 */
async function testBillReidGallery() {
  console.log('🔍 Testing Bill Reid Gallery scraper...');
  console.log('==================================');
...
// Run the test
try {
  testBillReidGallery().catch(console.error);

/**
 * Test Orpheum Theatre Scraper
 * 
 * This script tests the Orpheum Theatre scraper by running it and displaying the results
 */

const orpheumScraper = require('./orpheumLiveNationScraper');

// === Testing Function ===
async function testScraper() {
  console.log('=== Testing Orpheum Theatre Scraper ===');
  
  // OrpheumLiveNationScraper is an object, not a class
  const scraper = orpheumScraper;

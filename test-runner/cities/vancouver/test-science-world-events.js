/**
 * Fixed test for test-science-world-events.js
...
try {
  ...
  // Add debug logging
  console.log(`Testing test-science-world-events.js...`);
  ...
  async function testScraper() {
    console.log(`🔍 Testing scraper: ${ScienceWorldEvents.name}`);
    console.log(`Source URL: ${ScienceWorldEvents.url}`);
    console.log('--------------------------------------------');
    ...
    try {
      ...
      if (events.length === 0) {
        ...
        const outputFile = path.join(outputDir, 'science-world-events.json');

/**
 * Fixed test for test-fortune-sound-club copy.js
...
try {
  ...
  const FortuneSoundClubScraper = require('./fortuneSoundClub');
  const vancouverScrapers = require('../../scrapers/cities/vancouver');
  
  // Add debug logging
  console.log(`Testing test-fortune-sound-club copy.js...`);

/**
 * Import Yaletown Jazz Events
 * 
 * This script scrapes events from the Yaletown Jazz series and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const yaletownJazz = require('./scrapers/cities/vancouver/yaletownJazz');
...
async function importYaletownJazzEvents() {
  console.log('🔄 Starting Yaletown Jazz events import process...');
  ...
  try {
    ...
    // Scrape events
    console.log('🔍 Scraping events from Yaletown Jazz series...');

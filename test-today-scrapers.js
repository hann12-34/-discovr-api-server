...
const scrapers = [
  require('./scrapers/cities/vancouver/levelsNightclub'),
  require('./scrapers/cities/vancouver/museumOfVancouver'),
  require('./scrapers/cities/vancouver/polygonGallery'),
  require('./scrapers/cities/vancouver/theCentreVancouver'),
  require('./scrapers/cities/vancouver/helloBCEvents'),
  require('./scrapers/cities/vancouver/hrMacMillanSpaceCentre'),
  require('./scrapers/cities/vancouver/vancouverFolkFest')
];

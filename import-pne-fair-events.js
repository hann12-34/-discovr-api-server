/**
 * Import PNE Fair Events
 * 
 * This script scrapes events from the PNE Fair and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const pneFair = require('./scrapers/cities/vancouver/pneFair');
...
async function importPNEFairEvents() {
  console.log('🔄 Starting PNE Fair events import process...');
  ...
  try {
    ...
    // Scrape events
    console.log('🔍 Scraping events from PNE Fair...');

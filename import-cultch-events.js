/**
 * Import The Cultch Events Script
 * 
 * This script runs The Cultch scraper and imports events to MongoDB
 */
require('dotenv').config();
const { MongoClient } = require('mongodb');
const cultchScraper = require('./scrapers/cultch-scraper');
...
async function importCultchEvents() {
    console.log('📊 Starting The Cultch event import...');
    ...
    try {
        ...
        // Run The Cultch scraper
        console.log('🔍 Running The Cultch scraper...');
        ...
        console.log(`📋 Found ${events.length} events from The Cultch`);
...
importCultchEvents().catch(console.error);

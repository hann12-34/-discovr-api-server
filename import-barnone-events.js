/**
 * Import Bar None Club Events
 * 
 * This script scrapes events from Bar None Club and imports them into MongoDB
 */

require('dotenv').config();
const { MongoClient, ServerApiVersion } = require('mongodb');
const barNoneClubScraper = require('./scrapers/cities/vancouver/barNoneClub');
...
async function importBarNoneEvents() {
  console.log('🔄 Starting Bar None Club events import process...');
  ...
  try {
    ...
    // Scrape events
    console.log('🔍 Scraping events from Bar None Club...');
    const events = await barNoneClubScraper.scrape();

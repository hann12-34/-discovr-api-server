/**
 * Import Script for New Vancouver Venue Events
 * 
 * This script imports events from Vancouver Civic Theatres, Rogers Arena, and Chan Centre
...
// Import scrapers
const vancouverCivicTheatres = require('./scrapers/cities/vancouver/vancouverCivicTheatres');
const rogersArena = require('./scrapers/cities/vancouver/rogersArena');
const chanCentre = require('./scrapers/cities/vancouver/chanCentre');
...
async function importEvents() {
  console.log('🔄 Starting import process for new Vancouver venues...');
